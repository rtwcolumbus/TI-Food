enum 5773 "Warehouse Journal Document Type"
{
    ...
    value(37002000; FOODStagedPick) { Caption = 'Staged Pick'; }
    value(37002001; FOODDeliveryTripPick) { Caption = 'Delivery Trip Pick'; }
    value(37002002; FOODDeliveryTrip) { Caption = 'Delivery Trip'; }
}