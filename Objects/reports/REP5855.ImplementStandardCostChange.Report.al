report 5855 "Implement Standard Cost Change"
{
    ...
    // 
    // PRW17.10.03
    // P8001338, Columbus IT, Jack Reynolds, 12 AUG 14
    //   Fix problem populating revaluation journal from standard cost worksheet
        ...
        dataitem("Standard Cost Worksheet"; "Standard Cost Worksheet")
        {
            ...
            begin
                ...
                case Type of
                    Type::Item:
                        begin
                            if ("Location Code" = '') and ("Variant Code" = '') then begin // P8001030
                                UpdateItem("Standard Cost Worksheet");                        // P8001030
                            end else                                                        // P8001030
                                UpdateSKU("Standard Cost Worksheet");
                            // P8001338
                            if not ProcessedItem.Get("No.") then begin
                                ProcessedItem."No." := "No.";
                                ProcessedItem.Insert;
    ...
    var
        ...
        ProcessedItem: Record Item temporary;
    ...
    begin
        with SKU do begin
            ...
            //    until Next() = 0;
            //  end;
            Get(StdCostWksh."Location Code", StdCostWksh."No.", StdCostWksh."Variant Code");
            Validate("Indirect Cost %", StdCostWksh."New Indirect Cost %");
            Validate("Overhead Rate", StdCostWksh."New Overhead Rate");
            Validate("Standard Cost", StdCostWksh."New Standard Cost");
            "Single-Level Material Cost" := StdCostWksh."New Single-Lvl Material Cost";
    ...
    begin
        ...
        if ItemJnlLine2.Next <> 0 then
            repeat
                WorksheetLineExists := true;
                // P8001030
                if not StdCostWksh.Get("Standard Cost Worksheet"."Standard Cost Worksheet Name", "Standard Cost Worksheet".Type::Item,
                  ItemJnlLine2."Item No.", ItemJnlLine2."Location Code", ItemJnlLine2."Variant Code")
                // P8001338
                then
                    if not StdCostWksh.Get("Standard Cost Worksheet"."Standard Cost Worksheet Name", "Standard Cost Worksheet".Type::Item,
                 ItemJnlLine2."Item No.", '', '')
               then
                        WorksheetLineExists := false;
                // P8001338
                // P8001030
                if WorksheetLineExists then begin // P8001338
                    ItemJnlLine2.Validate("Unit Cost (Revalued)",
                      Round(StdCostWksh."New Standard Cost", GLSetup."Unit-Amount Rounding Precision")); // P8001030
    ...
    begin
        ...
        SKU.SetRange("Item No.", "Standard Cost Worksheet"."No.");
        SKUFound := not SKU.IsEmpty;
        // P8001030
        //CalcInvtValue.InitializeRequest(PostingDate,DocNo,HideDuplWarning,CalculatePer::Item,FALSE,FALSE,FALSE,0,FALSE);     // P8001030
        CalcInvtValue.InitializeRequest(PostingDate, DocNo, HideDuplWarning, CalculatePer::Item, SKUFound, SKUFound, false, 0, false); // P8001030
