report 717 "Inventory - Reorders"
{
    ...
    DefaultLayout = RDLC;
    RDLCLayout = './layout/InventoryReorders.rdlc';
    ...
    dataset
    {
        dataitem(Item; Item)
        {
            ...
            begin
                LotStatusMgmt.SetInboundExclusions(Item, LotStatus.FieldNo("Available for Planning"), // P8001083
        ...
        dataitem("Stockkeeping Unit"; "Stockkeeping Unit")
        {
            ...
            begin
                ...
                if "Item No." <> Item2."No." then begin // P8001083
                    if not Item2.Get("Item No.") then
                        Item2.Init();
                    // P8001083
                    LotStatusMgmt.SetInboundExclusions(Item2, LotStatus.FieldNo("Available for Planning"),
    ...
    begin
        ...
        LotStatusMgmt.QuantityAdjforItem(NewItem, LotStatusExclusionFilter, // P8001083
          NewItem.Inventory, NewItem."Quantity on Hand (Alt.)");            // P8001083
        Demand :=
