report 10110 "Vendor 1099 Information" // Version: FOODNA
{
    // PRW16.00.02
    // P8000762, VerticalSoft, Jack Reynolds, 27 JAN 10
    //   Fix to include accrual entries
    
    DefaultLayout = RDLC;
    RDLCLayout = './layout/local/Vendor1099Information.rdlc';
    ...
    begin
        ...
        with TempAppliedEntry do begin
            //SETFILTER("Document Type",'%1|%2',"Document Type"::Invoice,"Document Type"::"Credit Memo");                       // P8000762
            SetFilter("Document Type", '%1|%2|%3', "Document Type"::" ", "Document Type"::Invoice, "Document Type"::"Credit Memo"); // P8000762
