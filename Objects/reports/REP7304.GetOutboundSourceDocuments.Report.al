report 7304 "Get Outbound Source Documents"
{
    ...
    dataset
    {
        dataitem("Whse. Pick Request"; "Whse. Pick Request")
        {
            ...
            dataitem("Production Order"; "Production Order")
            {
                ...
                dataitem("Prod. Order Component"; "Prod. Order Component")
                {
                    ...
                    begin
                        ...
                        // ToBinCode := "Bin Code";                                                                               // P8001142
                        ToBinCode := Location.GetToProductionBin("Prod. Order No.", "Prod. Order Line No.", "Line No.", "Item No."); // P8001142. P8001319
            ...
            dataitem("Whse. Staged Pick Header"; "Whse. Staged Pick Header")
            {
                DataItemLink = "No." = FIELD("Document No.");
                DataItemTableView = SORTING("No.");
                dataitem("Whse. Staged Pick Line"; "Whse. Staged Pick Line")
                {
                    ...
                    begin
                        ...
                        if "Qty. to Stage (Base)" > "Qty. Staged (Base)" + "Pick to Stage Qty. (Base)" then begin
                            if WhsePickWkshCreate.FromWhseStagedPickLine(
                              PickWkshTemplate, PickWkshName, LocationCode, "Whse. Staged Pick Line")
                            then
                                LineCreated := true;
                        end;
                        // P8000322A
                    ...
                    trigger OnPreDataItem()
                    begin
                        SetFilter("Qty. Outstanding", '>0'); // P8000322A
                    end;
                }
                ...
                begin
                    // P8000322A
                    if "Whse. Pick Request"."Document Type" <> "Whse. Pick Request"."Document Type"::FOODStagedPick then
                        CurrReport.Break;
                    // P8000322A
                end;
            }
