    ...
    dataset
    {
        dataitem("Integer"; "Integer")
        {
            ...
            dataitem("Repack Order"; "Repack Order")
            {
                ...
                begin
                    // P8000496A
                    if DocEntry."Table ID" <> DATABASE::"Repack Order" then
                        CurrReport.Break;
            ...
            dataitem("Work Order"; "Work Order")
            {
                ...
                begin
                    // P8000584A
                    if DocEntry."Table ID" <> DATABASE::"Work Order" then
                        CurrReport.Break;
            ...
            dataitem("Accrual Ledger Entry"; "Accrual Ledger Entry")
            {
                ...
                begin
                    // P8000584A
                    if DocEntry."Table ID" <> DATABASE::"Accrual Ledger Entry" then
                        CurrReport.Break;
            ...
            dataitem("Container Ledger Entry"; "Container Ledger Entry")
            {
                ...
                begin
                    // P8000584A
                    if DocEntry."Table ID" <> DATABASE::"Container Ledger Entry" then
                        CurrReport.Break;
            ...
            dataitem("Maintenance Ledger"; "Maintenance Ledger")
            {
                ...
                begin
                    // P8000584A
                    if DocEntry."Table ID" <> DATABASE::"Maintenance Ledger" then
                        CurrReport.Break;
