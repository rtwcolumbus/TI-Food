report 292 "Copy Sales Document"
{
    ...
    //   Add code for Standing Orders to OnOpenPage
            ...
            if FromDocNo <> '' then begin
                case FromDocType of
                    ...
                    FromDocType::FOODStandingOrder:
                        if FromSalesHeader.Get(FromSalesHeader."Document Type"::FOODStandingOrder, FromDocNo) then
                            ;
                    // PR3.60
                    FromDocType::Order:
    ...
    begin
        if FromDocNo = '' then begin
            ...
            if FromSalesHeader."No." = '' then begin
                ...
                case FromDocType of
                    FromDocType::Quote,
                    FromDocType::FOODStandingOrder, // PR3.60
                    FromDocType::Order,
                    FromDocType::Invoice,
                    FromDocType::"Credit Memo",
                    FromDocType::"Blanket Order",
