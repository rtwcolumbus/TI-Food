report 37002102 "Shpt. Move List by Order"
{
    // PRW16.00.06
    ...
    // 
    // PRW17.10.04
    // P8001365, Columbus IT, Jack Reynolds, 04 DEC 14
    //   Fix problem with display of "No bins available" message
    // 
    // PRW18.00.01
    // P8001370, Columbus IT, Jack Reynolds, 20 JAN 15
    //   Fix problem with allowing picks from receiving and output bins
    // 
    // PRW110.0
    ...
    //   Upgrade to 13.00
    DefaultLayout = RDLC;
    RDLCLayout = './layout/ShptMoveListbyOrder.rdlc';
    ...
    dataset
    {
        ...
        dataitem(WhseReq; "Warehouse Request")
        {
            ...
            column(LocationDesc; LocationDesc)
            {
            }
            ...
            begin
                ...
                LocationDesc := StrSubstNo('%1 - %2', Location.Code, Location.Name);
            end;
        }
    }
    ...
    begin
        ...
        P800ReplMgmt.SetPickBinOverride(AllowRecvBin, AllowOutputBin); // P8001370
    end;
