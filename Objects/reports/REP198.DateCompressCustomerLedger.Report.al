report 198 "Date Compress Customer Ledger"
{
    ...
    //   Delete comments attached to ledger entries that are compressed
    ...
    begin
        with CustLedgEntry do begin
            ...
            // P8000268B
            LedgerEntryComment.SetRange("Table ID", DATABASE::"Cust. Ledger Entry");
            LedgerEntryComment.SetRange("Entry No.", "Entry No.");
            LedgerEntryComment.DeleteAll();
            // P8000268B
