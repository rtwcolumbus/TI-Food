report 492 "Copy Purchase Document"
{
    ...
    requestpage
    {
        ...
        layout
        {
            area(content)
            {
                group(Options)
                {
                    ...
                    field(AllowUnapproved; AllowUnapproved)
                    {
                        ApplicationArea = FOODBasic;
                        Caption = 'Allow Unapproved Items';
                        Enabled = EnableAllowUnapproved;
                    }
                }
            }
        }
        ...
        begin
            ...
            EnableAllowUnapproved := PurchHeader."Document Type" in
              [PurchHeader."Document Type"::Quote, PurchHeader."Document Type"::Order, PurchHeader."Document Type"::Invoice, PurchHeader."Document Type"::"Blanket Order"];
            // P8001230
            ValidateDocNo;
    ...
    begin
        ...
        CopyDocMgt.SetAllowUnapproved(AllowUnapproved); // P8001230
