report 10128 "Vendor 1099 Misc 2021" // Version: FOODNA
{
    // PRW117.3
    // P80096165, To-Increase, Jack Reynolds, 01 FEB 21
    //   Fix to include accrual entries - copied from "Vendor 1099 Misc"

    DefaultLayout = RDLC;
    RDLCLayout = './layout/local/Vendor1099Misc2021.rdlc';
    ...
    begin
        ...
        with TempVendorLedgerEntry do begin
            ...
            // SetFilter("Document Type", '%1|%2', "Document Type"::Invoice, "Document Type"::"Credit Memo");                       // P80096165
            SetFilter("Document Type", '%1|%2|%3', "Document Type"::" ", "Document Type"::Invoice, "Document Type"::"Credit Memo"); // P80096165
