report 99000788 "Prod. Order - Shortage List"
{
    ...
    DefaultLayout = RDLC;
    RDLCLayout = './layout/ProdOrderShortageList.rdlc';
            ...
            dataitem("Prod. Order Line"; "Prod. Order Line")
            {
                ...
                dataitem("Prod. Order Component"; "Prod. Order Component")
                {
                    ...
                    begin
                        ...
                        LotStatusMgmt.SetInboundExclusions(CompItem, LotStatus.FieldNo("Available for Planning"), // P8001083
                        ...
                        LotStatusMgmt.AdjustItemFlowFields(CompItem, LotStatusExclusionFilter, true, false, 2, // P8001083
                          ExcludePurch, ExcludeSalesRet, ExcludeOutput);                                     // P8001083
                        CompItem.Inventory :=
                          CompItem.Inventory -
                        ...
                        LotStatusMgmt.AdjustItemFlowFields(CompItem, LotStatusExclusionFilter, false, false, 2, // P8001083
                          ExcludePurch, ExcludeSalesRet, ExcludeOutput);                                      // P8001083
