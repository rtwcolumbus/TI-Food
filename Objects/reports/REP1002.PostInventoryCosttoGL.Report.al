report 1002 "Post Inventory Cost to G/L"
{
    ...
    //   Call InvtPost.Initialize before buffering entries
    // 
    // PRW16.00.03
    // P8000813, VerticalSoft, MMAS, 13 APR 10
    //   Report design for RTC
    //     1. Various fields formatting
    //     2. New section for "Inventory Cost Posted to G/L" totals when PostMethod is "per Posting Group"
    // 
    // PRW18.00.01
    // P8001395, Columbus IT, Jack Reynolds, 18 AUG 15
    //   Fix problem posting to G/L and creating G/L - Item Ledger Relation
    DefaultLayout = RDLC;
    RDLCLayout = './layout/PostInventoryCosttoGL.rdlc';
            ...
            dataitem(PerEntryLoop; "Integer")
            {
                ...
                dataitem(PostValueEntryToGL; "Post Value Entry to G/L")
                {
                    ...
                    begin
                        ...
                        InvtPostToGL.Initialize(PostMethod = PostMethod::"per Posting Group"); // P800466A
