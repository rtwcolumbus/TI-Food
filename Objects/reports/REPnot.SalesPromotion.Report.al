#if not CLEAN19
report 10159 "Sales Promotion" // Version: FOODNA
{
    // PRNA5.00.01
    // P8000582A, VerticalSoft, Jack Reynolds, 20 FEB 08
    //   Fix problem with invalid key and references to Item No.
    // 
    // PRNA6.00.04
    ...
    DefaultLayout = RDLC;
    RDLCLayout = './layout/local/SalesPromotion.rdlc';
