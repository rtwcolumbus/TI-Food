page 37002131 "Accrual Journal"
{
        ...
        area(processing)
        {
            group("F&unctions")
            {
                ...
                action("Suggest &Sales Accruals")
                {
                    ...
                    trigger OnAction()
                    var
                        SuggestSalesAccruals: Report "Suggest Sales Accruals";
                    begin
                        SuggestSalesAccruals.SetJnlLine(Rec);
                        SuggestSalesAccruals.RunModal;
                        CurrPage.Update(false);
                    end;
                }
                action("Suggest Sales P&ayments")
                {
                    ApplicationArea = FOODBasic;
                    Caption = 'Suggest Sales P&ayments';

                    trigger OnAction()
                    var
                        SuggestSalesPayments: Report "Suggest Sales Payments";
                    begin
                        SuggestSalesPayments.SetJnlLine(Rec);
                        SuggestSalesPayments.RunModal;
                        CurrPage.Update(false);
                    end;
                }
                ...
                action("Suggest &Purchase Accruals")
                {
                    ApplicationArea = FOODBasic;
                    ...
                    trigger OnAction()
                    var
                        SuggestPurchAccruals: Report "Suggest Purchase Accruals";
                    begin
                        SuggestPurchAccruals.SetJnlLine(Rec);
                        SuggestPurchAccruals.RunModal;
                        CurrPage.Update(false);
                    end;
                }
                action("Suggest Purchase Pa&yments")
                {
                    ApplicationArea = FOODBasic;
                    Caption = 'Suggest Purchase Pa&yments';

                    trigger OnAction()
                    var
                        SuggestPurchPayments: Report "Suggest Purchase Payments";
                    begin
                        SuggestPurchPayments.SetJnlLine(Rec);
                        SuggestPurchPayments.RunModal;
                        CurrPage.Update(false);
                    end;
                }
            }
    ...
    begin
        ...
        // P8004516
        AccrualJnlMgmt.TemplateSelection(0, PAGE::"Accrual Journal", false, Rec, JnlSelected); // PR4.00
