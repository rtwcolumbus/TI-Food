page 31 "Item List"
{
    ...
    // 
    // PR1.10, Navision US, John Nozzi, 24 MAR 01
    //   Add new Quality Control fields to List. Also, add menu button access to Item Tests so
    //   user can set them up.  Also, add menu button access to Item Lots, so that the user
    //   can review them.
    // 
    // PR1.10.02
    ...
    // 
    // PR1.30
    //   Add Item menu button item for Chemical Composition
    // 
    // PR2.00.04
    //   Document Management
    // 
    ...
    // 
    // PR3.70.06
    // P8000077A, Myers Nissi, Jack Reynolds, 22 JUL 04
    //   Change caption on second "Prices" menu item on Sales Menu button to "Line Discounts"
    // 
    // PR3.70.07
    ...
    // 
    // P8000911, Columbus IT, Jack Reynolds, 01 MAR 11
    //   Fix problem with incorrect Price and Line Discount pages
    // 
    // PRW16.00.05
    ...
    actions
    {
        area(processing)
        {
            ...
            group(PricesandDiscounts)
            {
                ...
                action(Prices_PriceTemplates)
                {
                    ApplicationArea = FOODBasic;
                    Caption = 'Special Price Templates';
                    Image = Template;
                    //The property 'PromotedCategory' can only be set if the property 'Promoted' is set to 'true'
                    //PromotedCategory = Category6;
                ...
                action("Sales Price Worksheet")
                {
                    ...
                    var
                        ProcessFns: Codeunit "Process 800 Functions";
                    begin
                        ProcessFns.RunSalesPriceWorksheet(Rec, false); // P8007748
                    end;
                }
#endif
            ...
            group("Assembly/Production")
            {
                ...
                action(Allergens)
                {
                    ...
                    begin
                        // P8006959
                        ShowAllergens;
                        if "Direct Allergen Set ID" <> xRec."Direct Allergen Set ID" then
                            CurrPage.SaveRecord;
                    end;
                }
