page 37002106 "Order Shipping-Trans. Subform"
{
    // PR4.00.02
    // P8000282A, VerticalSoft, Jack Reynolds, 23 MAR 06
    //   Transfer order subform for recording shipments from order shipping
    // 
    // PRW16.00.02
        ...
        area(processing)
        {
            group("F&unctions")
            {
                ...
                action("Change Transfer Order Line")
                {
                    ...
                    begin
                        //ChangeQty;
                        ChangeSourceLineWizard.Init("Item No.", Quantity, 0, Rec, 0); // P8007464
            ...
            group("&Line")
            {
                ...
                action("Item &Tracking Lines")
                {
                    ...
                    trigger OnAction()
                    begin
                        OpenItemTrackingLines(0); // P8000862
                    end;
                }
                action("Co&ntainers")
                {
