page 9006 "Order Processor Role Center"
{
    ...
    //   Add P800 Sales elements
    // 
    // PRW16.00.04
    // P8000916, Columbus IT, Jack Reynolds, 10 MAR 11
    //   Update for prices and contracts
    // 
    // PRW17.10.03
    // P8001364, Columbus IT, Jack Reynolds, 18 NOV 14
    //   Run proper version of sales price pages
    // 
    // PRW19.00
    ...
    actions
    {
        ...
        area(sections)
        {
            group(Action76)
            {
                ...
                action("Sales Standing Orders")
                {
                    ApplicationArea = FOODBasic;
                    Caption = 'Sales Standing Orders';
                    Image = Documents;
        ...
        area(processing)
        {
            group(Tasks)
            {
                ...
                action("Sales Price &Worksheet")
                {
                    ...
                    RunObject = Codeunit "Sales Price Worksheet";
            ...
            group(Action42)
            {
                ...
                action("&Prices")
                {
                    ...
                    Caption = '&Prices';
                    Image = SalesPrices;
                    RunObject = Codeunit "Sales Prices";
                ...
                action("&Line Discounts")
                {
                    ...
                    Image = SalesLineDisc;
                    RunObject = Codeunit "Sales Line Discounts";
