...
{
    // PR16.05
    // P80096141, To-Increase, Jack Reynolds, 19 OCT 20
    //   Support for SPickTicket was lost somewhere along the way; it has been restored
    ...
    begin
        ...
        case ReportUsage2 of
            ...
            // P80096141
            "Report Selection Usage Sales"::FOODSPickTicket:
                Rec.SetRange(Usage, "Report Selection Usage"::FOODSPickTicket);
            // P80096141
        end;
        ...
        if Rec.GetFilter(Usage) <> '' then begin
            if Evaluate(NewReportUsage, Rec.GetFilter(Usage)) then
                case NewReportUsage of
                    ...
                    // P80096141
                    "Report Selection Usage"::FOODSPickTicket:
                        ReportUsage2 := "Report Selection Usage Sales"::FOODSPickTicket;
                    // P80096141
                    else
