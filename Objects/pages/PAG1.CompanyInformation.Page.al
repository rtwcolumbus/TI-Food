...
{
    // PR3.70.04
    // P8000032A, Myers Nissi, Jack Reynolds, 12 MAY 04
    //   MSDS (Page) - set NextControl properties for several controls on this tab
    // 
    // P8000364A, VerticalSoft, Jack Reynolds, 03 AUG 06
    //   Correct misspelling of transportation on the MSDS tab
    // 
    // PR5.00
    // P8000466A, VerticalSoft, Jack Reynolds, 31 JUL 07
    //   Change caption for MSDS Country to Country/Region
    // 
    // PRW15.00.02
    // P8000602A, VerticalSoft, Jack Reynolds, 04 JUN 08
    //   Fix tab sequence problem on MSDS tab
    // 
    // PRW16.00.20
    ...
    layout
    {
        area(content)
        {
            group(General)
            {
                ...
                {
                    ShowCaption = false;
                    field("GS1 Company Prefix"; "GS1 Company Prefix")
                    {
