    ...
    layout
    {
        area(content)
        {
            repeater(Control1)
            {
                ...
                field("Sales Sample"; "Sales Sample")
                {
                    ApplicationArea = FOODBasic;
                    Visible = false;
                }
                ...
                field("Unit Price (FOB)"; "Unit Price (FOB)")
                {
                    ApplicationArea = FOODBasic;
                    Visible = false;
                }
                field("Unit Price (Freight)"; "Unit Price (Freight)")
                {
                    ApplicationArea = FOODBasic;
                    Visible = false;
                }
                ...
                field("Line Amount (Freight)"; "Line Amount (Freight)")
                {
                    ApplicationArea = FOODBasic;
                    Visible = false;
                }
                ...
                field("Staged Quantity"; "Staged Quantity")
                {
                    ApplicationArea = FOODBasic;
                    Visible = false;
                }
                ...
                field("Qty. on Prod. Order (Base)"; "Qty. on Prod. Order (Base)")
                {
                    ApplicationArea = FOODBasic;
                }
