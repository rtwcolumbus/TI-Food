#if not CLEAN20
page 10141 "Deposit Subform" // Version: FOODNA
{
    // PR4.00
    ...
    layout
    {
        area(content)
        {
            repeater(Control1020000)
            {
                ...
                field(AmountToBApplied; AmountToBApplied)
                {
    ...
    procedure DeductionManagement()
    var
        DedMgt: Codeunit "Deduction Management";
    begin
        // P8000170A
        DedMgt.ApplyFromGenJnlLine(Rec); // PR4.00
    end;
