page 9287 "Prod. BOM Mat. per Ver. Matrix"
{
    ...
    trigger OnOpenPage()
    begin
        BOMMatrixMgt.BOMMatrixFromBOM(ProdBOM, ShowLevel = ShowLevel::Multi, LocationCode); // P8001030
        SetColumnVisibility;
    end;
    ...
    begin
        ...
        Load(NewMatrixColumns, NewMatrixRecords, CurrentNoOfMatrixColumns, NewProdBOM, NewShowLevel, '');
    end;

    procedure Load(NewMatrixColumns: array[32] of Text[1024]; var NewMatrixRecords: array[32] of Record "Production BOM Version"; CurrentNoOfMatrixColumns: Integer; NewProdBOM: Record "Production BOM Header"; NewShowLevel: Option Single,Multi; NewLocationCode: Code[10])
    begin
        // P8001030 - add parameter for NewLocationCode
        ...
        LocationCode := NewLocationCode; // P8001030
    end;
