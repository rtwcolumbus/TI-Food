page 30 "Item Card"
{
    ...
    layout
    {
        area(content)
        {
            ...
            group(Replenishment)
            {
                ...
                field("Label Unit of Measure"; "Label Unit of Measure")
                {
                    ApplicationArea = FOODBasic;
                }
                group(Purchase)
                {
                    ...
                    grid(Control37002032)
                    {
                        ...
                        group("Vendor Approval Required")
                        {
                            ...
                            field(Control37002000; "Vendor Approval Required")
                            {
                                ApplicationArea = FOODBasic;
                                ColumnSpan = 2;
                                ShowCaption = false;
                    ...
                    field("Purchasing Group Code"; "Purchasing Group Code")
                    {
                        ApplicationArea = FOODBasic;
                    }
                ...
                group(Replenishment_Production)
                {
                    ...
                    field("Production Grouping Item"; "Production Grouping Item")
                    {
                        ApplicationArea = FOODBasic;
                    }
            ...
            group(ItemTracking)
            {
                ...
                field("Lot No. Assignment Method"; "Lot No. Assignment Method")
                {
                    ApplicationArea = FOODBasic;
                }
                ...
                field("Quarantine Calculation"; "Quarantine Calculation")
                {
                    ApplicationArea = FOODBasic;
                }
                field("Freshness Calc. Method"; "Freshness Calc. Method")
                {
                    ApplicationArea = FOODBasic;
                ...
                field("Lot Strength"; "Lot Strength")
                {
                    ApplicationArea = FOODBasic;
                }
                field("Country/Region of Origin Reqd."; "Country/Region of Origin Reqd.")
                {
                    ApplicationArea = FOODBasic;
                }
                field("Comm. Manifest Lot Nos."; "Comm. Manifest Lot Nos.")
                {
                    ApplicationArea = FOODBasic;
                }
                field("Comm. Manifest UOM Code"; "Comm. Manifest UOM Code")
                {
                    ApplicationArea = FOODBasic;
                }
            }
            group(Specifications)
            {
                ...
                field("Pricing Unit"; "Pricing Unit")
                {
                    ApplicationArea = FOODBasic;
                }
                ...
                field("Alternate Qty. Tolerance %"; "Alternate Qty. Tolerance %")
                {
                    ApplicationArea = FOODBasic;
                    BlankZero = true;
                }
                field("Quantity on Hand (Alt.)"; "Quantity on Hand (Alt.)")
                {
                    ApplicationArea = FOODBasic;
                    Visible = QuantityOnHandAltVisible;
                }
                field("Net Invoiced Qty. (Alt.)"; "Net Invoiced Qty. (Alt.)")
                {
                    ApplicationArea = FOODBasic;
                ...
                field("Commodity Cost Item"; "Commodity Cost Item")
                {
                    ApplicationArea = FOODBasic;
                }
            ...
            group(Warehouse)
            {
                ...
                field("Replenishment Not Required"; "Replenishment Not Required")
                {
                    ApplicationArea = FOODBasic;
                }
                field("Replenishment UOM Code"; "Replenishment UOM Code")
                {
                    ApplicationArea = FOODBasic;
                }
                ...
                field("Replenishment Areas Exist"; "Replenishment Areas Exist")
                {
                    ApplicationArea = FOODBasic;
                }
                field("Fixed Prod. Bins Exist"; "Fixed Prod. Bins Exist")
                {
                    ApplicationArea = FOODBasic;
                }
                field("Pick Class Code"; "Pick Class Code")
                {
                    ApplicationArea = FOODBasic;
                }
            }
            ...
            group(BillOfMaterials)
            {
                ...
                action(Allergens)
                {
                    ...
                    begin
                        // P8006959
                        ShowAllergens;
                        AllergenChangePending := xRec."Direct Allergen Set ID" <> "Direct Allergen Set ID"; // P80048583
                    end;
                }
    ...
    begin
        // P80048583
        if AllergenChangePending then begin
            AllergenChangePending := false;
            exit;
        end;
        // P80048583
    end;
