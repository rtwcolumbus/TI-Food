page 37002153 "Customer Accrual Plan List"
{
    // PR3.70.03
    // 
    // PR3.70.07
    ...
    //   Added as new List Page for Cust. Rebate/Promo Card
    // 
    // PRW16.00.04
    // P8000846, VerticalSoft, Jack Reynolds, 20 JUL 10
    //   Modify to include Reporting plans
    // 
    // PRW16.00.06
    ...
    CardPageID = "Customer Rebate/Promo Card";
    Editable = false;
    PageType = List;
    ...
    layout
    {
        ...
        area(factboxes)
        {
            part(Control37002000; "Accrual Plan Details FactBox")
            {
                ApplicationArea = FOODBasic;
