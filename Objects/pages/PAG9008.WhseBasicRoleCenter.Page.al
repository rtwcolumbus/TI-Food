page 9008 "Whse. Basic Role Center"
{
    ...
    actions
    {
        area(reporting)
        {
            ...
            action("&Shipment Replenish. Move List")
            {
                ApplicationArea = FOODBasic;
                Caption = '&Shipment Replenish. Move List';
                Image = Shipment;
                RunObject = Report "Shpt. Replenishment/Move List";
            }
            action("&Production Replenish. Move List")
            {
                ApplicationArea = FOODBasic;
                Caption = '&Production Replenish. Move List';
                Image = List;
                RunObject = Report "Prod. Replenishment/Move List";
            }
            action("P&ut-Away Move List")
            {
                ApplicationArea = FOODBasic;
                Caption = 'P&ut-Away Move List';
                Image = List;
        ...
        area(sections)
        {
            ...
            group("Posted Documents")
            {
                ...
                action("Posted Commodity Manifests")
                {
                    ApplicationArea = FOODBasic;
        ...
        area(processing)
        {
            ...
            action("Edit &Bin Reclassification Journal")
            {
                ApplicationArea = FOODBasic;
                Caption = 'Edit &Bin Reclassification Journal';
                Image = Edit;
