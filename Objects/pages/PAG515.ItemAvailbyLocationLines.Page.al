page 515 "Item Avail. by Location Lines"
{
    ...
    begin
        ...
        SetItem(NewItem, NewAmountType, 0);
    end;
#endif
    ...
    begin
        ...
        SetItem(NewItem, NewAmountType, AvailableFor);
    end;

#if not CLEAN19
    [Obsolete('Replaced by SetLines().', '19.0')]
    procedure SetItem(var NewItem: Record Item; NewAmountType: Option "Net Change","Balance at Date"; AvailableFor: Option " ",Sale,"Purchase Return",Transfer,Consumption,Adjustment,Planning)
    begin
        SetLines(NewItem, "Analysis Amount Type".FromInteger(NewAmountType), AvailableFor);

        OnAfterSet(Item, AmountType.AsInteger());
    end;
#endif

    procedure SetLines(var NewItem: Record Item; NewAmountType: Enum "Analysis Amount Type"; AvailableFor: Option " ",Sale,"Purchase Return",Transfer,Consumption,Adjustment,Planning)
    begin
