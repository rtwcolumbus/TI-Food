page 37002533 "Batch Planning - Pkg. by Item"
{
    // PRW16.00.04
    ...
    Caption = 'Batch Planning - Pkg. by Item';
    DeleteAllowed = false;
    InsertAllowed = false;
    PageType = ListPart;
    SourceTable = "Batch Planning - Package";
    SourceTableTemporary = true;
    SourceTableView = SORTING("Item No.", "Equipment Code", "Batch No.");
    ...
    begin
        ...
        SetCurrentKey("Item No.", "Equipment Code");

        PackageOrder.Reset;
        PackageOrder.DeleteAll;

        BatchPlanningFns.GetPackages(Package, 'ITEM');
