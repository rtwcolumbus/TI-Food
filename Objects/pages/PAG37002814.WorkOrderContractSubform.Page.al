page 37002814 "Work Order Contract Subform"
{
    // PR4.00.04
    // P8000333A, VerticalSoft, Jack Reynolds, 31 AUG 06
    //   Standard list style subform for work order contract activites
    // 
            ...
            field(AccountNo; AccountNo)
            {
                ...
                begin
                    ...
                    if (AccountNo <> xAccountNo) and (WorkOrderNo <> '') then begin
                        ...
                        WorkOrder."Contract Account" := AccountNo;
                        WorkOrder.Modify;
                    end;
    ...
    begin
        ...
        if (WorkOrderNo <> No) and (No <> '') then begin
            WorkOrderNo := No;
            WorkOrder.Get(WorkOrderNo);
            xAccountNo := WorkOrder."Contract Account";
