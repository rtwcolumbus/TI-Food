page 392 "Phys. Inventory Journal"
{
    ...
    // ApplicationArea = Basic, Suite; // P800-MegaApp
    AutoSplitKey = true;
    ...
    // UsageCategory = Tasks; // P800-MegaApp
        ...
        area(content)
        {
            ...
            repeater(Control1)
            {
                ...
                field("Qty. (Alt.) (Phys. Inventory)"; Rec."Qty. (Alt.) (Phys. Inventory)")
                {
                    ...
                    begin
                        // PR3.60
                        if not QtyAltPhysInventoryEditable then
                            exit;
                    ...
                    trigger OnValidate()
                    begin
                        QtyAltPhysInventoryOnAfterVali;
                    end;
                }
    ...
    var
        ...
        [InDataSet]
        QtyAltPhysInventoryEditable: Boolean;
    ...
    local procedure QtyAltPhysInventoryOnAfterVali()
    begin
        // PR3.60
        CurrPage.SaveRecord;
