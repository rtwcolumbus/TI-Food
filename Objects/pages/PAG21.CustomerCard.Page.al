    ...
    layout
    {
        area(content)
        {
            ...
            group(Invoicing)
            {
                ...
                field("Minimum Order Basis"; "Minimum Order Basis")
                {
                    ApplicationArea = FOODBasic;
                }
                field("Minimum Order Unit of Measure"; "Minimum Order Unit of Measure")
                {
                    ApplicationArea = FOODBasic;
                }
                ...
                group(PricesandDiscounts)
                {
                    ...
                    field("Use Sell-to Price Group"; "Use Sell-to Price Group")
                    {
                        ApplicationArea = FOODBasic;
                    ...
                    field("Price Orders at Shipment"; "Price Orders at Shipment")
                    {
                        ApplicationArea = FOODBasic;
                    }
                    field("Allow Off-Invoice Allowance"; "Allow Off-Invoice Allowance")
                    {
                        ApplicationArea = FOODBasic;
                    }
            ...
            group(Shipping)
            {
                ...
                field("Default Delivery Stop No."; "Default Delivery Stop No.")
                {
                    ApplicationArea = FOODBasic;
                }
