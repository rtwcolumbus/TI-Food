    ...
    layout
    {
        area(content)
        {
            group(General)
            {
                ...
                field("Total Maintenance Cost"; "Total Maintenance Cost")
                {
            ...
            group(Receiving)
            {
                ...
                field("Commodity Vendor Type"; "Commodity Vendor Type")
                {
                    ApplicationArea = FOODBasic;
                }
                ...
                field("Commodity Invoicing Frequency"; "Commodity Invoicing Frequency")
                {
                    ApplicationArea = FOODBasic;
                }
                field("Comm. Adv. Payment Type"; "Comm. Adv. Payment Type")
                {
                    ApplicationArea = FOODBasic;
                }
                field("Comm. Adv. Payment Amount"; "Comm. Adv. Payment Amount")
                {
                    ApplicationArea = FOODBasic;
                }
