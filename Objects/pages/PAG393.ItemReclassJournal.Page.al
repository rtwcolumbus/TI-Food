page 393 "Item Reclass. Journal"
{
    ...
    //   Add support for alternate quantities
    // 
    // P8000343A, VerticalSoft, Jack Reynolds, 05 JUN 06
    //   Add controls and support for easy lot tracking
    // 
    // PR4.00.05
    ...
    //   Code in method SetLotFields() changed to be correctly transformed into 2009.
    // 
    // PRW16.00.03
    ...
    layout
    {
        area(content)
        {
            ...
            repeater(Control1)
            {
                ...
                field("Old Container License Plate"; Rec."Old Container License Plate")
                {
                ...
                field("New Container License Plate"; Rec."New Container License Plate")
                {
                    AccessByPermission = TableData "Container Header" = R;
                    ApplicationArea = FOODBasic;
                    Visible = false;
                ...
                field("Lot No."; Rec."Lot No.")
                {
                    ...
                    begin
                        ...
                        if EasyLotTracking.AssistEdit("Lot No.") then begin // P8000566A
                            "New Lot No." := "Lot No.";                       // P8000566A
                            LotInfo.Get("Item No.", "Variant Code", "Lot No.");   // P8001083
                            "New Lot Status Code" := LotInfo."Lot Status Code"; // P8001083
                ...
                field("New Lot No."; Rec."New Lot No.")
                {
                    ...
                    begin
                        ...
                        CurrPage.SaveRecord; // P8000442A
                        Commit;              // P8000442A
                        EasyLotTracking.SetItemJnlLine(Rec, FieldNo("New Lot No."));
                        if EasyLotTracking.AssistEdit("New Lot No.") then
                            UpdateLotTracking(true);
                        CurrPage.SaveRecord;
                    end;
                    ...
                    trigger OnValidate()
                    begin
                        NewLotNoOnAfterValidate;
                    end;
                }
                field("New Lot Status Code"; Rec."New Lot Status Code")
                {
                    ApplicationArea = FOODBasic;
    ...
    begin
        ...
        SetLotFields('EDITABLE'); // P8000339A
    end;
        ...
        case Property of
            'EDITABLE':
                begin
                    ...
                    //CurrForm."New Lot No.".EDITABLE(ProcessFns.TrackingInstalled AND ("New Lot No." <> P800Globals.MultipleLotCode));
                    "Lot No.Editable" := (ProcessFns.TrackingInstalled and ("Lot No." <> P800Globals.MultipleLotCode));
                    "New Lot No.Editable" := (ProcessFns.TrackingInstalled and ("New Lot No." <> P800Globals.MultipleLotCode));
                    SetLotStatusEditable; // P8001083
                                          // P8000761
                end;
        end;
    ...
    local procedure NewLotNoOnAfterValidate()
    begin
        // P8000343A
        if "Line No." = 0 then begin
            CurrPage.SaveRecord;
    ...
    procedure SetLotStatusEditable()
    var
        LotInfo: Record "Lot No. Information";
    begin
        // P8001083
        if "New Lot No.Editable" then
            NewLotStatusEditable := not LotInfo.Get("Item No.", "Variant Code", "New Lot No.")
        else
            NewLotStatusEditable := false;
    end;
