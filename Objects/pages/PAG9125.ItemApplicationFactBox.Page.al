page 9125 "Item Application FactBox"
{
    ...
    begin
        ...
        AppliedAlt := ItemApplnEntry.OutboundAppliedAlt("Entry No.", false) - // P800066
          ItemApplnEntry.InboundAppliedAlt("Entry No.", false);               // P800066
