page 7335 "Warehouse Shipment"
{
    ...
    //   Support for running for order shipping
    // 
    // PRW16.00
        ...
        area(processing)
        {
            group("F&unctions")
            {
                ...
                action("Use Filters to Get Src. Docs.")
                {
                    ...
                    begin
                        if RunFromOrderShip then // P8000282A
                            exit;                  // P8000282A
            ...
            group("P&osting")
            {
                ...
                action("P&ost Shipment")
                {
                    ...
                    begin
                        ...
                        if Posted and RunFromOrderShip then                   // P8000282A
                                                                              // CurrPage.CLOSE;                                     // P8000282A, P8000828
                            P800WhseMgmt.WhseShipmentAfterPost(Rec);               // P8000828
                    end;
                }
    ...
    begin
        ...
        // P8000282A
        if not RunFromOrderShip then
            ShowHeader := true;

        BottomMargin := FrmHeight - (WhseShptLinesYPos + WhseShptLinesHeight);
        HdrPos := HeaderYPos;
    ...
    var
        ...
        HdrPos: Integer;
        HdrHeight: Integer;
        WhseShptLinesYPos: Integer;
        HeaderYPos: Integer;
        WhseShptLinesHeight: Integer;
    ...
    begin
        CurrPage.WhseShptLines.PAGE.RunFromOrderShipping(RunFromOrderShip); // P8000282A
        CurrPage.WhseShptLines.PAGE.PostShipmentYesNo;
        Posted := CurrPage.WhseShptLines.PAGE.ShipmentPosted; // P8000282A
    end;
    ...
    begin
        ...
        if Display then
            WhseShptLinesYPos := HdrPos + HdrHeight + 220
        else
            ;
        WhseShptLinesHeight := LineBottom - WhseShptLinesYPos;
    end;
