        ...
        with ItemJnlLine do begin
            ...
            if (not CalledFromAdjustment) and (not Correction) then // P8006484
                if Process800Fns.ContainerTrackingInstalled then begin
                    ContFns.CheckContainerAssignment2("Old Container ID", ItemJnlLine); // P80056718
                    ContFns.CheckContainerAssignment("New Container ID");
                    ContFns.ItemJnlCheckLooseInventory(ItemJnlLine);
                end;
            // P8001342
            ...
            if ((("Entry Type" = "Entry Type"::Consumption) and (ItemJnlLine."Order Line No." <> 0)) // PR3.70.01, P8001132
