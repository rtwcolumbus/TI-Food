codeunit 7380 "Phys. Invt. Count.-Management"
{
    ...
    begin
        ...
        if CalculatePhysInvtCounting.GetRequest(
             PostingDate, DocNo, SortingMethod, PrintDoc, PrintDocPerItem, ZeroQty, PrintQtyCalculated, SetCountToZero) // P8001052
        then begin
            Window.Open(Text000, TempPhysInvtItemSelection."Item No.");
            repeat
                Window.Update;
                CalcInvtQtyOnHand(DocNo, PostingDate, ZeroQty, SetCountToZero, TempPhysInvtItemSelection);
    ...
    local procedure CalcInvtQtyOnHand(DocNo: Code[20]; PostingDate: Date; ZeroQty: Boolean; SetCountToZero: Boolean; var TempPhysInvtItemSelection: Record "Phys. Invt. Item Selection" temporary)
    var
        Item: Record Item;
    ...
    begin
        ...
        CalculateInventory.InitializeRequest(PostingDate, DocNo, ZeroQty, SetCountToZero, false); // P8001052  // P80050544
