codeunit 1303 "Correct Posted Sales Invoice"
{
    ...
    var
        ...
        TableID: array[10] of Integer;
        No: array[10] of Code[20];
        ShippedQtyNoReturnedAlt: Decimal;
    begin
            ...
            repeat
                if not IsCommentLine(SalesInvoiceLine) then begin
                    ...
                    if SalesInvoiceLine.Type = SalesInvoiceLine.Type::Item then begin
                        ...
                        then begin
                            SalesInvoiceLine.CalcShippedSaleNotReturned(ShippedQtyNoReturned, ShippedQtyNoReturnedAlt, RevUnitCostLCY, false);                // P8001213
                            OnTestSalesLinesOnAfterCalcShippedQtyNoReturned(SalesInvoiceLine, ShippedQtyNoReturned);
                            if (SalesInvoiceLine.Quantity <> ShippedQtyNoReturned) or (SalesInvoiceLine."Quantity (Alt.)" <> ShippedQtyNoReturnedAlt) then // P8001213
