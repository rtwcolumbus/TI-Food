codeunit 1535 "Approvals Mgmt."
{
    ...
    procedure IsAddAllergenWorkflowEnabled(var Allergen: Record Allergen): Boolean
    var
        WorkflowManagement: Codeunit "Workflow Management";
        FoodWorkflow: Codeunit "Food Allergen Workflow";
    begin
        // P8006959
        exit(WorkflowManagement.CanExecuteWorkflow(Allergen, FoodWorkflow.RunWorkflowOnAddAllergenCode));
    end;

    [IntegrationEvent(false, false)]
    procedure OnCancelAllergenApprovalRequest(var Allergen: Record Allergen)
    begin
        // P8006959
    end;
