...
{
    // PR4.00.02
    // P8000306A, VerticalSoft, Jack Reynolds, 27 FEB 06
    //   Enhance to suggest assignment by weight
    // 
    // PRW17.10.03
    // P8001325, Columbus IT, Jack Reynolds, 27 MAY 14
    //   Fix assignment by weight for transfer receipts
    // 
    // PRW111.00
                ...
                case "Applies-to Doc. Type" of
                    ...
                    "Applies-to Doc. Type"::"Credit Memo":
                        begin
                            ...
                            P800UOMFns.ItemUnitGrossWeightAndVolume(DecimalArray, PurchLine."No.", PurchLine."Quantity (Base)", PurchLine.Quantity,
                              PurchLine."Unit of Measure Code", PurchLine."Quantity (Alt.)");
                            // P80053245
                        end;
                    "Applies-to Doc. Type"::Receipt:
                        begin
                            ...
                            P800UOMFns.ItemUnitGrossWeightAndVolume(DecimalArray, PurchRcptLine."No.", PurchRcptLine."Quantity (Base)", PurchRcptLine.Quantity,
                              PurchRcptLine."Unit of Measure Code", PurchRcptLine."Quantity (Alt.)");
                            // P80053245
                        end;
                    "Applies-to Doc. Type"::"Return Receipt":
                        begin
                            ...
                            P800UOMFns.ItemUnitGrossWeightAndVolume(DecimalArray, ReturnRcptLine."No.", ReturnRcptLine."Quantity (Base)", ReturnRcptLine.Quantity,
                              ReturnRcptLine."Unit of Measure Code", ReturnRcptLine."Quantity (Alt.)");
                            // P80053245
                        end;
                    "Applies-to Doc. Type"::"Return Shipment":
                        begin
                            ...
                            P800UOMFns.ItemUnitGrossWeightAndVolume(DecimalArray, ReturnShptLine."No.", ReturnShptLine."Quantity (Base)", ReturnShptLine.Quantity,
                              ReturnShptLine."Unit of Measure Code", ReturnShptLine."Quantity (Alt.)");
                            // P80053245
                        end;
                    "Applies-to Doc. Type"::"Transfer Receipt":
                        begin
                            ...
                            P800UOMFns.ItemUnitGrossWeightAndVolume(DecimalArray, TransferRcptLine."Item No.", TransferRcptLine."Quantity (Base)", TransferRcptLine.Quantity,
                              TransferRcptLine."Unit of Measure Code", TransferRcptLine."Quantity (Alt.)");
                            // P80053245
                        end;
                    "Applies-to Doc. Type"::"Sales Shipment":
                        begin
                            ...
                            P800UOMFns.ItemUnitGrossWeightAndVolume(DecimalArray, SalesShptLine."No.", SalesShptLine."Quantity (Base)", SalesShptLine.Quantity,
                              SalesShptLine."Unit of Measure Code", SalesShptLine."Quantity (Alt.)");
                            // P80053245
                        end;
                end;
        end;
