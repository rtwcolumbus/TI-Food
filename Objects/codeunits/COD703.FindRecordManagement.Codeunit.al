codeunit 703 "Find Record Management"
{
    ...
    procedure FindNoFromTypedValue(Type: Option " ","G/L Account",Item,Resource,"Fixed Asset","Charge (Item)",,,Container,"Accrual Plan"; Value: Code[20]; UseDefaultTableRelationFilters: Boolean): Code[20]
    var
        Item: Record Item;
        FoundNo: Code[20];
    begin
        // P80053245 - add options to Type parameter
    ...
    procedure FindRecordByDescription(var Result: Text; Type: Option " ","G/L Account",Item,Resource,"Fixed Asset","Charge (Item)",,,Container,"Accrual Plan"; SearchText: Text): Integer
    begin
        // P80053245 - add options to Type parameter
    ...
    local procedure GetRecRefAndFieldsNoByType(RecRef: RecordRef; Type: Option " ","G/L Account",Item,Resource,"Fixed Asset","Charge (Item)",,,Container,"Accrual Plan"; var SearchFieldNo: array[4] of Integer)
    var
        GLAccount: Record "G/L Account";
        Item: Record Item;
    ...
    begin
        ...
        case Type of
            ...
            Type::"Accrual Plan":
                begin
                    RecRef.Open(DATABASE::"Accrual Plan");
                    SearchFieldNo[1] := AccrualPlan.FieldNo("No.");
                    SearchFieldNo[2] := AccrualPlan.FieldNo(Name);
                    SearchFieldNo[3] := 0;
                end;
        // P80053245
        end;
