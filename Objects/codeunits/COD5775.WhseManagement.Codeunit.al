codeunit 5775 "Whse. Management"
{
    ...
    //   GetSourceType - added section for Staged Pick
    // 
    // PRW16.00.06
    ...
    begin
        ...
        case SourceType of
            ...
            DATABASE::"Pre-Process Activity Line":
                exit("Warehouse Journal Source Document"::FOODPreProcessActivity); // P8001132
            // P8001082
        ...
        with WhseWkshLine do
            case "Whse. Document Type" of
                ...
                "Whse. Document Type"::FOODStagedPick:
                    SourceType := DATABASE::"Whse. Staged Pick Line";
            // P8000756
            end;
    end;
