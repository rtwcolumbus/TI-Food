...
{
    // PRW16.00.06
    // P8001039, Columbus IT, Don Bresee, 07 MAR 12
    ...
    local procedure XferWhseRoundingAdjmts(var WhseJnlPostLine: Codeunit "Whse. Jnl.-Register Line")
    var
    ...
    local procedure PostWhseRoundingAdjmts(var WhseJnlPostLine: Codeunit "Whse. Jnl.-Register Line")
    var
    ...
    begin
        XferWhseRoundingAdjmts(WhseJnlRegisterLine); // P8001039, P80041198
        ...
        PostWhseRoundingAdjmts(WhseJnlRegisterLine); // P8001039, P80041198
    end;
