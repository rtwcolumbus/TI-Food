codeunit 229 "Document-Print"
{
    ...
    //   Print maintenanace work order
    // 
    // PR4.00.06
    // P8000496A, VerticalSoft, Jack Reynolds, 23 JUL 07
    //   Added function to print repack orders
    // 
    // PRW17.10.01
    ...
    procedure PrintSalesOrder(SalesHeader: Record "Sales Header"; Usage: Option "Order Confirmation","Work Order","Pick Instruction","Pick Ticket")
    var
        ReportSelection: Record "Report Selections";
        ReportUsage: Enum "Report Selection Usage";
        IsPrinted: Boolean;
    ...
    procedure PrintMaintWorkOrder(WorkOrder: Record "Work Order")
    var
        ReportSelection: Record "Report Selections";
    begin
        // P8000333A
        ...
        ReportSelection.PrintForCust(ReportSelection.Usage::FOODMWorkOrder, WorkOrder, 0); // P8007748, P80060684, P800144605
    end;

    procedure PrintRepackOrder(RepackOrder: Record "Repack Order")
    var
        ReportSelection: Record "Report Selections";
    begin
        // P8000496A
        RepackOrder.SetRecFilter;

        ReportSelection.PrintForCust(ReportSelection.Usage::FOODRepackOrder, RepackOrder, 0); // P8007748, P80060684, P800144605
    end;
    ...
    procedure GetSalesOrderUsage(Usage: Option "Order Confirmation","Work Order","Pick Instruction","Pick Ticket") Result: Enum "Report Selection Usage"
    var
        ReportSelections: Record "Report Selections";
        IsHandled: Boolean;
    begin
        // P8007748 - add Pick Ticket to Usage OptionString
        case Usage of
            ...
            Usage::"Pick Ticket":                            // P8007748
                exit(ReportSelections.Usage::FOODSPickTicket); // P8007748
            else
                IsHandled := false;
