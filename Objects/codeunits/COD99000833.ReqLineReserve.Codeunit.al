codeunit 99000833 "Req. Line-Reserve"
{
    ...
    //   The change to DeleteLine to allow deletion of reservation entries is now standard, but there are two places
    //   where you need to run SetItemTrackingHandling(1) and Navision only seems to have gotten one of them.
    //   Therefore one of the P800 changes has been removed but the other remains.
            ...
            then begin
                ...
                if ProdOrderComp.FindSet() then
                    repeat
                        ...
                        ReservMgt.SetItemTrackingHandling(1); // PR3.60.03
