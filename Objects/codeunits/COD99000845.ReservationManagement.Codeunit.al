codeunit 99000845 "Reservation Management"
{
    ...
    // 
    // PRW16.00.02
    // P8000779, VerticalSoft, Jack Reynolds, 24 FEB 10
    //   Fix problem caused by P8000276A with reservations from sales lines
    // 
    // PRW16.00.06
    // P8001023, Columbus IT, Jack Reynolds, 23 JAN 12
    //   Fix problem deleting reservatoin entries for item journal adjustments
    // 
    // PRW17.00
    ...
    begin
        ...
        //if SignFactor * QtyTracked * DownToQuantity < 0 then // P8000276A
        if SignFactor * QtyTracked * DownToQuantity <= 0 then  // P8000276A
            DeleteAll := true
        else
        ...
        for ReservStatus := ReservStatus::Prospect downto ReservStatus::Reservation do begin
            ...
            //if ReservEntry.FindSet and (QtyToRelease <> 0) then // P8001023
            if ReservEntry.FindSet and
              ((QtyToRelease <> 0) or                                                                                // P8001023
              ((ReservEntry."Source Type" = DATABASE::"Item Journal Line") and                                       // P8001023
               (ReservEntry."Source Subtype" in                                                                      // P8001023
                 [ItemJnlLine."Entry Type"::"Positive Adjmt.", ItemJnlLine."Entry Type"::"Negative Adjmt."]))) // P8001023
            then
                // P8000779
