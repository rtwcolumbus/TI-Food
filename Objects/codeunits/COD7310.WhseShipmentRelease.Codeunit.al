codeunit 7310 "Whse.-Shipment Release"
{
    ...
    begin
        with WhseShptHeader do begin
            ...
            repeat
                ...
                if not WhseShptLine.IsNonWarehouseItem() then begin // P8001290
    ...
    begin
        with WhseShptHeader do begin
            ...
            if not "Allow Reopen" then begin // P8000372A
            ...
            if not "Allow Reopen" then begin // P8000372A
                ...
                //N138F0000.sn
                if WhseActivLineFilter <> '' then
                    WhseActivLine.SetFilter("Whse. Document Line No.", WhseActivLineFilter);
                //N138F0000.en
    ...
    procedure AddWhseActivLineFilter(LineFilter: Text)
    begin
        WhseActivLineFilter := LineFilter;
    end;
