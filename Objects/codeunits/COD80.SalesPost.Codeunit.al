codeunit 80 "Sales-Post" // Version: FOODNA
{
        ...
        with SalesHeader do begin
            ...
            if OnSalesPayment(SalesPaymentLine) then begin
                if (not Ship) and Invoice then
                    Error(ErrorInfo.Create(Text37002671, true, SalesHeader));
                Invoice := false;
    ...
    begin
        ...
        with ItemJnlLine do begin
            ...
            if ShouldPostItemJnlLine then begin
                PostItemJnlLineBeforePost(ItemJnlLine, SalesLine, TempWhseJnlLine, PostWhseJnlLine, QtyToBeShippedBase, TrackingSpecification, PostAsItem);
    ...
    procedure PostItemJnlLineBeforePost(var ItemJnlLine: Record "Item Journal Line"; SalesLine: Record "Sales Line"; var TempWhseJnlLine: Record "Warehouse Journal Line" temporary; var PostWhseJnlLine: Boolean; QtyToBeShippedBase: Decimal; TrackingSpecification: Record "Tracking Specification"; PostAsItem: Boolean)
    var
