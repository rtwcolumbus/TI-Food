            ...
            if GenJnlLine."Account No." <> '' then
                case GenJnlLine."Account Type" of
                    ...
                    GenJnlLine."Account Type"::Employee:
                        ...
                        // P8000241A
                    GenJnlLine."Account Type"::FOODAccrualPlan:
                        AccrualFldMgmt.GetGenJnlDescription(GenJnlLine."Account No.", AccName);
                        // P8000241A
                end;
        end;
                ...
                case GenJnlLine."Bal. Account Type" of
                    ...
                    GenJnlLine."Bal. Account Type"::"IC Partner":
                        if IC.Get(GenJnlLine."Bal. Account No.") then
                            BalAccName := IC.Name;
                    // P8000241A
                    GenJnlLine."Bal. Account Type"::FOODAccrualPlan:
                        AccrualFldMgmt.GetGenJnlDescription(GenJnlLine."Bal. Account No.", BalAccName);
                        // P8000241A
                end;
        end;
