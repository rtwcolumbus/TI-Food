codeunit 37002100 "Process 800 Warehouse Mgmt."
{
    ...
    procedure PostSale(var SalesHeader: Record "Sales Header"; PostingDate: Date; PostingLocation: Code[10]; Print: Boolean)
    var
    ...
    begin
        ...
        SalesPost.SetPostingLocation(PostingLocation);
        ClearLastError;
    ...
    begin
        ...
        PurchPost.SetPostingLocation(PostingLocation);
        ClearLastError;
