table 7334 "Whse. Internal Pick Line"
{
    ...
    //   Create function SetItemTrackingLines to insert warehosue item tracking lines
    // 
    // PR5.00
    ...
    begin
        ...
        // P800-MegaApp
        WhseItemTrackingForm.InsertItemTrackingLine(TempWhseWorksheetLine, WarehouseEntry, QtyToEmpty); // P8000466A, P800-MegaApp
    end;
