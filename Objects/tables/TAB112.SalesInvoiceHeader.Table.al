table 112 "Sales Invoice Header"
{
    ...
    //     Cost is Adjusted
    //   Key - Cost is Adjusted
    // 
    // PR3.70.03
    //   Accruals
    // 
    // PR4.00.01
    // P8000285A, VerticalSoft, Jack Reynolds, 06 FEB 06
    //   Fix reference to incorrect document type on sales comment line table
    // 
    // PR4.00.06
    // P8000464A, VerticalSoft, Don Bresee, 9 APR 07
    //   Delete key for accrual suggest function
    // 
    // PRW16.00.02
    // P8000743, VerticalSoft, Jack Reynolds, 19 NOV 09
    //   Add key for Bill-to customer No.
    // 
    // PRW16.00.05
    ...
    fields
    {
        field(37002000; "Cost is Adjusted"; Boolean)
        {
        ...
        field(37002066; "Standing Order No."; Code[20])
        {
            ...
            Description = 'PR3.60';
            TableRelation = IF ("Order No." = FILTER(<> '')) "Sales Header"."No." WHERE("Document Type" = CONST(FOODStandingOrder));
        }
    ...
    keys
    {
        ...
        key(Key37002000; "Cost is Adjusted")
        {
        }
        key(Key37002001; "Shipment Date", "Delivery Route No.", "Delivery Stop No.")
        {
        }
        key(Key37002002; "Standing Order No.", "Posting Date")
        {
        }
    }
