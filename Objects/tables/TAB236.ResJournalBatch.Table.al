table 236 "Res. Journal Batch"
{
    ...
    fields
    {
        ...
        field(37002000; "Template Type"; Option)
        {
            CalcFormula = Lookup (Resource.Type WHERE(Name = FIELD("Journal Template Name")));
            Caption = 'Template Type';
            Editable = false;
            FieldClass = FlowField;
            OptionCaption = 'Resource,Time Entry';
            OptionMembers = Resource,"Time Entry";
        }
    }
