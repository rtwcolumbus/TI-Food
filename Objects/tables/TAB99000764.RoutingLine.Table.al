table 99000764 "Routing Line"
{
    ...
    fields
    {
        ...
        field(34; "Routing Link Code"; Code[10])
        {
            ...
            trigger OnValidate()
            begin
                if "Routing Link Code" = '' then // P8000219A
                    "Use ABC Cost" := false;       // P8000219A
            end;
        }
        ...
        field(37002460; "Use ABC Cost"; Boolean)
        {
            Caption = 'Use ABC Cost';

            trigger OnValidate()
            begin
                TestField("Routing Link Code");      // P8000219A
            end;
        }
    }
