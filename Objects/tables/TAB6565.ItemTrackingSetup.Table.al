...
#pragma warning restore AS0034
    ...
    // Upgrade18.0
    procedure CopyTrackingFromMaintLedgerEntry(MaintLedgerEntry: Record "Maintenance Ledger")
    begin
        "Serial No." := MaintLedgerEntry."Serial No.";
        "Lot No." := MaintLedgerEntry."Lot No.";
    end;
    // Upgrade18.0
