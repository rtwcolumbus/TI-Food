table 6550 "Whse. Item Tracking Line"
{
    ...
    //   Rounding re-work - add Quantity field

    Caption = 'Whse. Item Tracking Line';

    fields
    {
        field(37002760; Quantity; Decimal)
        {
            Caption = 'Quantity';
            DecimalPlaces = 0 : 5;
        }
        ...
        field(90; "Source Type Filter"; Option)
        {
            ...
            OptionCaption = ' ,Receipt,Shipment,Internal Put-away,Internal Pick,Production,Movement Worksheet,Assembly,,Staged Pick,Job';
            OptionMembers = " ",Receipt,Shipment,"Internal Put-away","Internal Pick",Production,"Movement Worksheet",Assembly,,"Staged Pick",Job;
        }
...
#pragma warning restore AL0603
    ...
    keys
    {
        ...
        key(Key2; "Source ID", "Source Type", "Source Subtype", "Source Batch Name", "Source Prod. Order Line", "Source Ref. No.", "Location Code")
        {
            ...
            SumIndexFields = "Quantity (Base)", "Qty. to Handle (Base)", "Qty. to Invoice (Base)", "Quantity Handled (Base)", "Quantity Invoiced (Base)", Quantity;
        }
