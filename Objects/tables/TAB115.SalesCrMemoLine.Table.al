table 115 "Sales Cr.Memo Line"
{
    ...
    //   Add field/key for accrual dates
    // 
    // PR5.00
    ...
    // 
    // PRW19.00
    // P8004516, To-Increase, Jack Reynolds, 30 Sep 15
    //   NAV 2016 refactoring
    // 
    // PRW110.0.02
    // P80054034, To-Increase, Dayakar Battini, 15 MAR 18
    //   Add field "Total Net Weight"
    // 
    // PRW111.00
    ...
    fields
    {
        ...
        field(37002120; "Promo/Rebate Amount (LCY)"; Decimal)
        {
            CalcFormula = Sum("Accrual Ledger Entry".Amount WHERE("Accrual Plan Type" = CONST(Sales),
                                                                   ...
                                                                   "Source Document Type" = CONST("Credit Memo"),
    ...
    keys
    {
        ...
        key(Key8; "Accrual Posting Date", "Bill-to Customer No.", "Sell-to Customer No.", Type, "Document No.")
        {
        }
