table 6520 "Item Tracing Buffer"
{
    ...
    //   Add Alternate Quantities
    // 
    // PRW16.00.05
    // P8000979, Columbus IT, Don Bresee, 09 SEP 11
    //   Add "Trace Quantity" field
    //   Add key for Lot Tracing form - Item No.,Variant Code,Lot No.,Location Code,Entry Type
    //   Add "Location" option to "Entry Type" field
    // 
    // PRW111.00.01
    ...
    fields
    {
        ...
        field(37002089; "Trace Quantity"; Decimal)
        {
            BlankZero = true;
    ...
    keys
    {
        ...
        key(Key37002000; "Item No.", "Variant Code", "Lot No.", "Location Code", "Entry Type")
        {
        }
    }
