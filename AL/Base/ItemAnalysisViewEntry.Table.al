table 7154 "Item Analysis View Entry"
{
    ...
    keys
    {
        ...
        key(Key2; "Analysis View Code", "Analysis Area", "Item No.", "Item Ledger Entry Type", "Entry Type", "Source Type", "Source No.", "Dimension 1 Value Code", "Dimension 2 Value Code", "Dimension 3 Value Code", "Location Code", "Posting Date", "Entry No.")
        {
            SumIndexFields = "Quantity (Alt.)", "Invoiced Quantity (Alt.)", "Sales Amount (FOB)", "Sales Amount (Freight)";
        }
    }
