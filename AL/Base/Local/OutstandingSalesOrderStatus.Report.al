report 10056 "Outstanding Sales Order Status" // Version: FOODNA
{
    // PR3.70.10
    // P8000225A, Myers Nissi, Jack Reynolds, 27 JUN 05
    //   Correct to use alternate quantities
    
    DefaultLayout = RDLC;
    RDLCLayout = './layout/local/OutstandingSalesOrderStatus.rdlc';
        ...
        dataitem(Customer; Customer)
        {
            ...
            dataitem("Sales Line"; "Sales Line")
            {
                ...
                begin
                    ...
                    // P8000225A Begin
                    if "Sales Line".PriceInAlternateUnits then begin
                        Quantity := "Quantity (Alt.)";
                        "Outstanding Quantity" := "Quantity (Alt.)" - "Qty. Shipped (Alt.)";
                    end;
                    // P8000225A End
