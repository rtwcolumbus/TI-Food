page 10041 "Sales Invoice Stats." // Version: FOODNA
{
    // PR3.60
    ...
    begin
        ...
        if SalesInvLine.Find('-') then
            repeat
                ...
                //CostLCY := CostLCY + (SalesInvLine.Quantity * SalesInvLine."Unit Cost (LCY)");  // PR3.60
                CostLCY := CostLCY +                                                              // PR3.60
                  (SalesInvLine.GetCostingQty() * SalesInvLine."Unit Cost (LCY)");                // PR3.60
