page 5779 "Warehouse Pick"
{
    ...
    //   Relocate code from OnPush trigger to function
    // 
    // PRW16.00.05
            ...
            group("&Registering")
            {
                ...
                action(RegisterPick)
                {
                    ...
                    begin
                        ...
                        if Posted and RunFromOrderShip then                   // P8000322A
                            CurrPage.Close;                                     // P8000322A
                    end;
                }
            }
            action("&Print")
    ...
    begin
        CurrPage.WhseActivityLines.PAGE.RunFromOrderShipping(RunFromOrderShip); // P8000322A
        CurrPage.WhseActivityLines.PAGE.RegisterActivityYesNo;
        Posted := CurrPage.WhseActivityLines.PAGE.PickPosted; // P8000322A
    end;
