...
#pragma warning restore AS0009
    ...
    procedure PutAwayLookupLotSerialNo(LookupType: Option "Serial No.","Lot No."; var ItemTrkgCode: Text[250]): Boolean
    begin
        // P8000282A
        if (ItemTrkgCode <> '') then
            ItemTrackingMgt.LookupLotSerialNoInfo("Item No.", "Variant Code", LookupType, ItemTrkgCode)
        else begin
            GetItem;
            case LookupType of
                LookupType::"Lot No.":
