table 36 "Sales Header"
{
    ...
    // --------------------------------------------------------------------------------
    // TOM4524     29-10-2015  GetShippingTime must be global
    // --------------------------------------------------------------------------------
    // 
    // PR1.00,
    ...
    // 
    // PR3.60.03
    //   Check for granule before calls to Delivery Route Management
    // 
    // PR3.61
    //   Add Function
    ...
    // PR3.70
    //   New Fields
    //     Off-Invoice Allowance Exists
    //     Contract Items Only
    //   Insert Customer Comments
    // 
    // PR3.70.01
    //   Add function to print pick ticket
    // 
    // PR3.70.03
    //   Added Fields
    //     Promo/Rebate Amount
    //     Commission Amount
    //   Add field ADC Started
    //   Add function StartADC
    // 
    // PR3.70.04
    ...
    //   Added Field which is assigned from sell-to customer
    //     37002460 Exclude from Sales Forecast
    //   Added code and confirm to update related sales lines
    // 
    // P8000079A, Myers Nissi, Jack Reynolds, 16 SEP 04
    //  PrintOrder - prints sales orders for filtered orders (uses report selection)
    // 
    // PR3.70.07
    // P8000119A, Myers Nissi, Don Bresee, 20 SEP 04
    //   Accruals update/fixes
    // 
    // P8000123A, Myers Nissi, Jack Reynolds, 24 SEP 04
    //   UpdateQtyToShip - taken from Order Shipping form
    // 
    // P8000126A, Myers Nissi, Jack Reynolds, 21 DEC 04
    //   Add field for Allow Order Below Minimum
    //   Add function to check order minimum
    // 
    // PR3.70.10
    // P8000212A, Myers Nissi, Jack Reynolds, 16 MAY 05
    //   Fix problem with no overdue balance credit warning
    // 
    ...
    //   OutstandingAamountLCY - duplicates flowfied (to be used in worldwide version)
    // 
    // PR4.00.02
    // P8000282A, VerticalSoft, Jack Reynolds, 23 MAR 06
    //   Add Posting Location Code
    // 
    // PR4.00.04
    // P8000372A, VerticalSoft, Phyllis McGovern, 06 SEP 06
    //   WH Overship and OverReceive
    //   Added field: 'allow reopen'
    // 
    // PR4.00.05
    // P8000410A, VerticalSoft, Jack Reynolds, 01 NOV 06
    //   Modify StartADC to retain tracking specification lines
    // 
    // PR5.00
    ...
    //   Add logic for Ship-to when assigning delivery route
    //   Check routes against shipment date
    // 
    // P8000549A, VerticalSoft, Jack Reynolds, 04 MAY 08
    //   Support for trip management
    // 
    // PRW16.00.01
    // P8000691, VerticalSoft, Jack Reynolds, 23 APR 09
    //   Update accruals when changing Order Date and Posting Date
    // 
    // P8000694, VerticalSoft, Jack Reynolds, 04 MAY 09
    //   Change name of Accrual fields; recalculate accruals for currency code changes
    // 
    // PRW16.00.02
    // P8000745, VerticalSoft, Jack Reynolds, 20 NOV 09
    //   Add Location filter to table relation for Delivery Route No.
    // 
    // PRW16.00.05
    // P8000921, Columbus IT, Don Bresee, 07 APR 11
    //   Add "FOB Pricing" field and logic
    //   Add CalculateFreight function (used by the "Calculate Freight" action and release)
    // 
    // P8000941, Columbus IT, Don Bresee, 25 JUL 11
    //   Sales Payments granule
    // 
    // P8000942, Columbus IT, Jack Reynolds, 05 MAY 11
    //   Default Salesperson from User ID
    // 
    // P8000924, Columbus IT, Jack Reynolds, 04 NOV 11
    //   Fixes to StartADC
    // 
    // P8000970, Columbus IT, Jack Reynolds, 07 NOV 11
    //   Support for Pick Ticket Count
    // 
    // PRW16.00.06
    ...
    //   Recheck lot preferences when updating sales lines
    // 
    // P8001090, Columbus IT, Jack Reynolds, 07 DEC 12
    //   Process Data Collection
    // 
    // PRW17.10.02
    // P8001287, Columbus IT, Jack Reynolds, 12 FEB 14
    //   Fix problem updating lines when changing posting date
    // 
    // PRW18.00.02
    ...
    // 
    // PRW18.00.03
    // P8006483, To-Increase, Jack Reynolds, 15 FEB 16
    //   When changing Sell-to Customer, write transaction is started before validating new bill-to customer
    // 
    ...
    // 
    // PRW110.0.01
    // P80037377, To-Increase, Dayakar Battini, 08 JUN 17
    //   fix for FOB pricing issue
    // 
    // P80041994, To-Increase, Dayakar Battini, 14 JUN 17
    //   Fix for FOB pricing issue when type blank
    // 
    // PRW110.0.02
    ...
    //   Add CreateOrderAllowance to OnInsert
    // 
    // PRW113.00
    ...
    //
    //  PRW114.00
    //  P800111572, To-Increase, Gangabhushan, 20 NOV 20
    //    CS00137145 | Error When Salesperson Coded in BC is greater than Code 10. 
    // 
    // PRW115.03
    // P80010353, To-Increase, Jack Reynolds, 23 JUL 20
    //   Restore Use Sell-to Price Group
    ...
    fields
    {
        field(37002001; "Posting Location Code"; Code[10])
        {
            Caption = 'Posting Location Code';
        }
        field(37002002; "Pick Ticket Count"; Integer)
        {
            Caption = 'Pick Ticket Count';
            Editable = false;
        }
        field(37002004; "Allow Reopen"; Boolean)
        {
            Caption = 'Allow Reopen';
        }
        field(37002039; "Allow Order Below Minimum"; Boolean)
        {
            Caption = 'Allow Order Below Minimum';
            Description = 'P8000126A';
            InitValue = false;
        }
        field(37002040; "Price at Shipment"; Boolean)
        {
            Caption = 'Price at Shipment';
            Description = 'PR3.60';
        }
        field(37002041; "Off-Invoice Allowance Exists"; Boolean)
        {
            CalcFormula = Exist("Order Off-Invoice Allowance" WHERE("Document Type" = FIELD("Document Type"),
                                                                     "Document No." = FIELD("No.")));
            Caption = 'Off-Invoice Allowance Exists';
            Description = 'PR3.70';
            Editable = false;
            FieldClass = FlowField;
        }
        field(37002042; "Contract Items Only"; Boolean)
        {
            Caption = 'Contract Items Only';
            Description = 'PR3.70';
        }
        field(37002043; "Use Sell-to Price Group"; Boolean)
        {
            Caption = 'Use Sell-to Price Group';
        }
        field(37002049; "FOB Pricing"; Boolean)
        {
            ...
            begin
                Modify;                                              // P8000921
                UpdateSalesLines(FieldCaption("FOB Pricing"), false); // P8000921
            end;
        }
        field(37002050; "Amount (Freight)"; Decimal)
        {
            ...
            AutoFormatType = 1;
            BlankZero = true;
            CalcFormula = Sum("Sales Line"."Line Amount (Freight)" WHERE("Document Type" = FIELD("Document Type"),
                                                                          "Document No." = FIELD("No.")));
        ...
        field(37002060; "Delivery Route No."; Code[20])
        {
            ...
            begin
                ...
                if CurrFieldNo = FieldNo("Delivery Route No.") then begin                             // P8000547A
                    DeliveryRouteMgmt.CheckDeliveryRouteLocation("Delivery Route No.", "Location Code"); // P8000547A
                    DeliveryRouteMgmt.CheckDeliveryRouteDOW("Delivery Route No.", "Shipment Date");      // P8000547A
                end;                                                                                  // P8000547A
                DeliveryRouteMgmt.GetDeliveryDriverNo("Shipment Date", "Delivery Route No.", "Delivery Driver No.");
                UpdateSalesLines(FieldCaption("Delivery Route No."), false);
                // PR3.60
            end;
        }
        field(37002061; "Delivery Stop No."; Code[20])
        {
            ...
            begin
                // PR3.60
                TestField(Status, Status::Open);
                UpdateSalesLines(FieldCaption("Delivery Stop No."), false);
                // PR3.60
            end;
        }
        field(37002062; "Delivery Driver No."; Code[20])
        {
            Caption = 'Delivery Driver No.';
            Description = 'PR3.60';
            Editable = false;
            TableRelation = "Delivery Driver";
        }
        field(37002063; "Delivery Route Order"; Boolean)
        {
            CalcFormula = Exist("Delivery Routing Matrix Line" WHERE("Standing Order No." = FIELD("No.")));
            Caption = 'Delivery Route Order';
            Description = 'PR3.60';
            Editable = false;
            FieldClass = FlowField;
        }
        field(37002064; "Order Frequency"; DateFormula)
        {
            Caption = 'Order Frequency';
            Description = 'PR3.60';

            trigger OnValidate()
            begin
                TestField(Status, Status::Open); // PR3.60
            end;
        }
        field(37002065; "Next Order Date"; Date)
        {
        ...
        field(37002066; "Standing Order No."; Code[20])
        {
            Caption = 'Standing Order No.';
            Description = 'PR3.60';
            TableRelation = IF ("Document Type" = CONST(Order)) "Sales Header"."No." WHERE("Document Type" = CONST(FOODStandingOrder));
        }
        field(37002067; "Delivery Trip No."; Code[20])
        {
            Caption = 'Delivery Trip No.';
        }
        field(37002100; "Lines to Ship"; Integer)
        {
        ...
        field(37002120; "Promo/Rebate Amount (LCY)"; Decimal)
        {
            CalcFormula = Sum("Document Accrual Line"."Payment Amount (LCY)" WHERE("Accrual Plan Type" = CONST(Sales),
                                                                                    ...
                                                                                    "Computation Level" = CONST(Document),
        ...
        field(37002122; "Accrual Payment"; Boolean)
        {
            Caption = 'Accrual Payment';
            Editable = false;
        }
        field(37002400; "ADC Started"; Boolean)
        {
            Caption = 'ADC Started';
            Description = 'PR3.70.03';
        }
        ...
        field(2; "Sell-to Customer No."; Code[20])
        {
            ...
            begin
                ...
                then begin
                    ...
                    if Confirmed then begin
                        ...
                        if ProcessFns.ProcessDataCollectionInstalled then
                            DataCollectionMgmt.CheckSalesHeaderModify(xRec, Rec);
                        // P8001090
                ...
                "FOB Pricing" := Cust."FOB Pricing"; // P8000921
                "Use Sell-to Price Group" := Cust."Use Sell-to Price Group"; // P8001026

                UpdateShipToCodeFromCust();
                SetBillToCustomerNo(Cust);
                UpdateLocationCode(Cust."Location Code"); // P8006483, P800-MegaApp

                // P8006483
                //IF ProcessFns.DistPlanningInstalled THEN     // PR3.60.03, P8000212A
                //  DeliveryRouteMgmt.GetSalesDeliveryRouting(Rec); // PR3.60,    P8000212A
                // P8006483
        ...
        field(12; "Ship-to Code"; Code[10])
        {
            ...
            begin
                ...
                if ProcessFns.DistPlanningInstalled then          // P8000547A
                    DeliveryRouteMgmt.GetSalesDeliveryRouting(Rec); // P8000547A
        ...
        field(19; "Order Date"; Date)
        {
            ...
            begin
                ...
                UpdateSalesLines(FieldCaption("Order Date"), false); // P8000691
            end;
        }
        field(20; "Posting Date"; Date)
        {
            ...
            begin
                ...
                UpdateSalesLines(FieldCaption("Posting Date"), false); // P8000691, P8001287
            end;
        }
        field(21; "Shipment Date"; Date)
        {
            ...
            trigger OnValidate()
            begin
                if not FromDelRtShptBool then // P80072445
                    UpdateSalesLinesByFieldNo(FieldNo("Shipment Date"), CurrFieldNo <> 0);

                if ProcessFns.DistPlanningInstalled then     // PR3.60.03
                    DeliveryRouteMgmt.GetSalesDeliveryRouting(Rec); // PR3.60
            end;
        }
    ...
    keys
    {
        ...
        key(Key37002000; "Document Type", "Shipment Date", "Delivery Route No.", "Delivery Stop No.")
        {
        }
        key(Key37002001; "Document Type", "Standing Order No.", "Posting Date")
        {
        }
    }
    ...
    begin
        TestField(Status, Status::Open); // P8000549A
        ...
        if ProcessFns.AccrualsInstalled() then
            AccrualMgmt.SalesDeleteDocument(Rec);
        // P8000119A
        ...
        if ProcessFns.DistPlanningInstalled then      // PR3.60.03
            DeliveryRouteMgmt.DeleteStandingOrder(Rec); // PR3.60

        if ProcessFns.PricingInstalled then         // PR3.70
            AllowanceMgmt.DeleteOrderAllowances(Rec); // PR3.70
    ...
    begin
        ...
        CreateOrderAllowance; // P80062458
    ...
    var
        ...
        Text37002000: Label 'All lines will be changed to match the %1 %2.\Continue?';
        Text37002001: Label 'The total %1 for this order is below the default minimum %1 of %2.';
        Text37002002: Label 'The total %1 for this order is below %2''s  minimum %1 of %3.';
        ...
        SalesAccrualMgmt: Codeunit "Sales Accrual Management";
        SkipAccrualRecalc: Boolean;
        Text37002003: Label 'Not allowed for cash customers.';
        Text37002004: Label 'One of more lots fail to meet established lot preferences.';
    ...
    begin
        ...
        // PR3.60
        if ("Document Type" = "Document Type"::FOODStandingOrder) then begin
            "Order Date" := WorkDate;
            "Posting Date" := 0D;
        end;
        // PR3.60
    ...
    begin
        ...
        case "Document Type" of
            ...
            "Document Type"::FOODStandingOrder:
                NoSeriesCode := SalesSetup."Standing Order Nos.";
                // PR3.60
        end;
    ...
    begin
        ...
        CheckLotPreferences(Field."Field Caption"); // P8001070, P80066030
            ...
            repeat
                ...
                if not IsHandled then
                    case ChangedFieldNo of
                        // P8000691
                        FieldNo("Posting Date"), FieldNo("Order Date"): // P80066030
                            if SalesLine.Type = SalesLine.Type::Item then begin // P8001287
                                if ProcessFns.AccrualsInstalled and (not SkipAccrualRecalc) then // P8000694
                                    SalesAccrualMgmt.SalesRecalcLines(SalesLine);
                                SkipAccrualRecalc := false;                                      // P8000694
                            end;
                        // P8000691
                        FieldNo("Shipment Date"):
                        ...
                        FieldNo("Currency Factor"):
                            if SalesLine.Type <> SalesLine.Type::" " then begin
                                //SalesLine.VALIDATE("Unit Price"); // P8000694
                                SalesLine.UpdateUnitPrice(0);       // P8000694
    ...
    begin
        ...
        //UpdateLocationCode(SellToCustomer."Location Code"); // P8006483
        UpdateTaxAreaCode();
    ...
    begin
        ...
        if "Use Sell-to Price Group" then begin
            ...
            "Customer Price Group" := SellToCust."Customer Price Group";
            "Customer Disc. Group" := SellToCust."Customer Disc. Group";
        end else begin
            // P8001026
            "Customer Price Group" := BillToCustomer."Customer Price Group";
            "Customer Disc. Group" := BillToCustomer."Customer Disc. Group";  // P8001026
        end;                                                      // P8001026
        CreateOrderAllowance; // PR3.70
        ...
        "Price at Shipment" := Cust."Price Orders at Shipment"; // PR3.60
        "Contract Items Only" := Cust."Contract Items Only"; // PR3.70
        "Invoice Disc. Code" := BillToCustomer."Invoice Disc. Code";
        // "Customer Disc. Group" := Cust."Customer Disc. Group";  // P8001026, moved up
        "Language Code" := BillToCustomer."Language Code";
        SetSalespersonCode(SetSalesperson(BillToCustomer."Salesperson Code"), "Salesperson Code"); // P8000942
    ...
    procedure CreateOrderAllowance()
    begin
        // PR3.70 Begin
        if ProcessFns.PricingInstalled then begin
            GetCust("Bill-to Customer No.");
            if Cust."Allow Off-Invoice Allowance" then
                AllowanceMgmt.GetOrderAllowances(Rec)
            else
                AllowanceMgmt.DeleteOrderAllowances(Rec);
        end;
        // PR3.70 End
    end;

    procedure PrintPickTicket(ShowRequestForm: Boolean)
    var
        SalesHeader: Record "Sales Header";
    ...
    begin
        ...
        with SalesHeader do begin
            Copy(Rec);
            ReportSelection.SetRange(Usage, ReportSelection.Usage::FOODSPickTicket);
            ReportSelection.SetFilter("Report ID", '<>0');
            ReportSelection.Find('-');
            repeat
                REPORT.RunModal(ReportSelection."Report ID", ShowRequestForm, false, SalesHeader);
    ...
    begin
        ...
        REPORT.Run(REPORT::"Terminal Market Pick Ticket", false, false, SalesHeader);
    end;

    procedure PrintOrder(ShowRequestForm: Boolean)
    var
        SalesHeader: Record "Sales Header";
        ReportSelection: Record "Report Selections";
    begin
    ...
    begin
        ...
        ContainerHeader.SetRange("Document Subtype", "Document Type");
        ContainerHeader.SetRange("Document No.", "No.");
        ...
        if SalesLine.Find('-') then
            repeat
                if SalesLine.Type = SalesLine.Type::Item then begin
                    if SalesLine."Alt. Qty. Transaction No." <> 0 then
                        AltQtyMgmt.DeleteAltQtyLines(SalesLine."Alt. Qty. Transaction No.");

                    // P8000924
                    //      SalesLineReserve.RetainTrackingSpec; // P8000410A
                    //      SalesLineReserve.DeleteLine(SalesLine);
                    //      SalesLine."Lot No." := ''; // P8000043A
                    // P8000924
                end;
                case "Document Type" of
                    "Document Type"::Order:
                ...
                SalesLine.UpdateLotTracking(true, 0); // P8000924
                SalesLine.Modify;
            until SalesLine.Next = 0;
    ...
    begin
        ...
        if SalesLine.Find('-') then begin
            repeat
                if SalesLine.GetContainerQuantity(true) <> 0 then // P80046533
                    SalesLine.Validate("Qty. to Ship", SalesLine.GetContainerQuantity(true)) // P80046533
                else
    ...
    procedure CheckOrderMinimum(Mode: Code[10])
    var
        GLSetup: Record "General Ledger Setup";
        SalesSetup: Record "Sales & Receivables Setup";
        Customer: Record Customer;
        ...
        MinValue: Decimal;
        Text001: Label 'Order is below minimum %1 of %2';
        Text002: Label 'Order is below minimum %1 of %2 %3';
        MinText: Text[250];
        Result: Boolean;
    begin
        // P8000126A
        if ("Document Type" <> "Document Type"::Order) or "Allow Order Below Minimum" then
            exit;

        Customer.Get("Sell-to Customer No.");
        if Customer."Minimum Order Basis" = Customer."Minimum Order Basis"::" " then begin
            SalesSetup.Get;
            Customer."Minimum Order Basis" := SalesSetup."Minimum Order Basis";
            Customer."Minimum Order Amount" := SalesSetup."Minimum Order Amount";
            Customer."Minimum Order Unit of Measure" := SalesSetup."Minimum Order Unit of Measure";
        end;
        ...
        case Customer."Minimum Order Basis" of
            Customer."Minimum Order Basis"::" ", Customer."Minimum Order Basis"::None:
                exit;
            Customer."Minimum Order Basis"::Amount:
                begin
                    GLSetup.Get;
                    MinText := StrSubstNo(Text001, Format(Customer."Minimum Order Basis"),
                      Format(Customer."Minimum Order Amount", 0,
                        StrSubstNo('<Precision,%1><Integer Thousand><Decimal>', GLSetup."Amount Decimal Places")));
                    if SalesLine.Find('-') then
                        repeat
                            MinValue += SalesLine."Line Amount";
                        until SalesLine.Next = 0;
                    Result := Customer."Minimum Order Amount" <= MinValue;
                end;
            Customer."Minimum Order Basis"::Weight:
                begin
                    MinText := StrSubstNo(Text002, Format(Customer."Minimum Order Basis"),
                      Customer."Minimum Order Amount", Customer."Minimum Order Unit of Measure");
                    SalesLine.SetRange(Type, SalesLine.Type::Item);
                    SalesLine.SetFilter("No.", '<>%1', '');
                    if SalesLine.Find('-') then
                        repeat
                            MinValue += P800UOMFns.ItemWeight(SalesLine."No.", SalesLine."Quantity (Base)", SalesLine."Quantity (Alt.)");
                        until SalesLine.Next = 0;
                    MinValue := MinValue / P800UOMFns.UOMtoMetricBase(Customer."Minimum Order Unit of Measure");
                    Result := Customer."Minimum Order Amount" <= MinValue;
                end;
            Customer."Minimum Order Basis"::Quantity:
                begin
                    MinText := StrSubstNo(Text001, Format(Customer."Minimum Order Basis"), Customer."Minimum Order Amount");
                    SalesLine.SetRange(Type, SalesLine.Type::Item);
                    SalesLine.SetFilter("No.", '<>%1', '');
                    if SalesLine.Find('-') then
                        repeat
                            MinValue += SalesLine.Quantity;
                        until SalesLine.Next = 0;
                    Result := Customer."Minimum Order Amount" <= MinValue;
                end;
        end;
    ...
    procedure OutstandingAmountLCY(): Decimal
    var
        SalesLine: Record "Sales Line";
    begin
        // P8000290A
    ...
    procedure CalculateFreight(RecalcOverrides: Boolean)
    var
        SalesLine: Record "Sales Line";
        HeaderBasedCalculation: Boolean;
    begin
        // P8000921
        SalesSetup.Get;
        SalesSetup.TestField("Delivered Pricing Calc. Method");
        SalesSetup.TestField("Del. Pricing Calc. Codeunit ID");
        if not "FOB Pricing" then begin
            HeaderBasedCalculation :=
              (SalesSetup."Delivered Pricing Calc. Method" = SalesSetup."Delivered Pricing Calc. Method"::Header);
            if RecalcOverrides or (not HeaderBasedCalculation) then begin
                SalesLine.SetRange("Document Type", "Document Type");
                SalesLine.SetRange("Document No.", "No.");
                SalesLine.SetFilter(Type, '<>%1', SalesLine.Type::" ");
                if SalesLine.FindSet then
                    repeat
                        if RecalcOverrides then
                            SalesLine."Freight Entered by User" := false;
                        if HeaderBasedCalculation then
                            SalesLine.Modify(true)
                        else
                            if not SalesLine."Freight Entered by User" then begin
                                SalesLine.Validate("Unit Price (FOB)");
                                SalesLine.Modify(true);
                            end;
                    until (SalesLine.Next = 0);
            end;
    ...
    procedure SetSalesperson(CustSalesperson: Code[20]): Code[20]
    var
    ...
    procedure PriceGroupCustomerNo(): Code[20]
    begin
        // P8001026
        if "Use Sell-to Price Group" then
    ...
    begin
        ...
        SalesHeader := Rec;
        SalesHeader.SetRecFilter;
        ReceivingLabelMgmt.WorksheetLinesForSalesHdr(SalesHeader, LabelWorksheetLine);
        ReceivingLabelMgmt.RunWorksheet(LabelWorksheetLine);
    end;

    procedure CheckLotPreferences(ChangedFieldName: Text[100])
    var
        SalesLine: Record "Sales Line";
    ...
    begin
        // P8001070
        if not (ChangedFieldName in [FieldCaption("Shipment Date"), FieldCaption("Shipping Agent Code"),
          FieldCaption("Shipping Agent Service Code"), FieldCaption("Shipping Time"), FieldCaption("Requested Delivery Date"),
          FieldCaption("Promised Delivery Date"), FieldCaption("Outbound Whse. Handling Time")])
        then
            exit;
        ...
        if SalesLine.FindSet then
            repeat
                ...
                if (SalesLine."Lot No." <> '') and (SalesLine."Lot No." <> P800Globals.MultipleLotCode) then begin
                    TempLotInfo."Lot No." := SalesLine."Lot No.";
                    TempLotInfo.Insert;
                end else begin
                    ...
                    if ResEntry.Find('-') then
                        repeat
                            TempLotInfo."Lot No." := ResEntry."Lot No.";
                            TempLotInfo.Insert;
                ...
                if TempLotInfo.FindSet then begin
                    ...
                    repeat
                        UseAllLots := UseAllLots and SalesLine.CheckLotPreferences(TempLotInfo."Lot No.", true);
                    until TempLotInfo.Next = 0;
                end;
            until SalesLine.Next = 0;

        if not UseAllLots then
            Error(Text37002004);
    end;

    procedure Settlement(): Boolean
    var
        SalesLine: Record "Sales Line";
    begin
        SalesLine.SetRange("Document Type", "Document Type");
        SalesLine.SetRange("Document No.", "No.");
        SalesLine.SetRange(Settlement, true);
        exit(not SalesLine.IsEmpty);
    end;
    ...
    procedure FromDelRtShpt(pDelRtShpt: Boolean)
    begin
        // P80072445
        FromDelRtShptBool := pDelRtShpt;
    end;
