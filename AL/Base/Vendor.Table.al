...
{
    // PR3.70.06
    // P8000080A, Myers Nissi, Jack Reynolds, 14 SEP 04
    //   OnDelete - delete pickup locations
    // 
    // PR3.70.07
    ...
    //   Field for Total Maintenance Cost
    //   When deleting delete related vendor trades
    // 
    // PRW15.00.01
    // P8000547A, VerticalSoft, Jack Reynolds, 02 MAY 08
    //   Add default Delivery Route No.
    // 
    // PRW15.00.02
    // P8000604A, VerticalSoft, Jack Reynolds, 05 JUN 08
    //   Fix incorrect spelling on Minimum Order Amount
    // 
    // PRW16.00.04
    ...
    //   Maintain delivery routes on deletion
    // 
    // PRW16.00.06
    ...
    fields
    {
        ...
        field(37002060; "Default Delivery Route No."; Code[20])
        {
            Caption = 'Default Delivery Route No.';
            TableRelation = "Delivery Route";
        }
        field(37002685; "Comm. Rcpt. Lot Nos."; Code[20])
        {
            Caption = 'Comm. Rcpt. Lot Nos.';
            TableRelation = "No. Series";
        }
        field(37002686; "Commodity Vendor Type"; Option)
        {
            Caption = 'Commodity Vendor Type';
            ...
            begin
                // P8000902
                if ("Commodity Vendor Type" <> "Commodity Vendor Type"::Producer) then
                    Validate("Producer Zone Code", '');
                if ("Commodity Vendor Type" = "Commodity Vendor Type"::Hauler) and
                   ("Comm. Adv. Payment Type" > "Comm. Adv. Payment Type"::"Fixed Amount")
                then
                    Validate("Comm. Adv. Payment Type", 0);
            end;
        }
        field(37002687; "Commodity Invoicing Frequency"; Option)
        {
            Caption = 'Commodity Invoicing Frequency';
            OptionCaption = 'Manual,Manifest,Monthly';
            OptionMembers = Manual,Manifest,Monthly;
        }
        field(37002688; "Producer Zone Code"; Code[20])
        {
            ...
            begin
                ...
                if ("Producer Zone Code" <> '') then
                    TestField("Commodity Vendor Type", "Commodity Vendor Type"::Producer);
            end;
        }
        field(37002689; "Comm. Adv. Payment Type"; Option)
        {
            Caption = 'Comm. Adv. Payment Type';
            OptionCaption = ' ,Fixed Amount,Calculated';
            OptionMembers = " ","Fixed Amount",Calculated;

            trigger OnValidate()
            begin
                // P8000902
                if ("Comm. Adv. Payment Type" <> "Comm. Adv. Payment Type"::"Fixed Amount") then
                    Validate("Comm. Adv. Payment Amount", 0);
                if ("Comm. Adv. Payment Type" > "Comm. Adv. Payment Type"::"Fixed Amount") and
                   ("Commodity Vendor Type" = "Commodity Vendor Type"::Hauler)
                then
                    FieldError("Commodity Vendor Type");
            end;
        }
        field(37002690; "Comm. Adv. Payment Amount"; Decimal)
        {
            AutoFormatType = 1;
            BlankZero = true;
            Caption = 'Comm. Adv. Payment Amount';

            trigger OnValidate()
            begin
                // P8000902
                if ("Comm. Adv. Payment Amount" <> 0) then
                    TestField("Comm. Adv. Payment Type", "Comm. Adv. Payment Type"::"Fixed Amount");
            end;
        }
        field(37002800; "Total Maintenance Cost"; Decimal)
        {
            AutoFormatType = 1;
    ...
    keys
    {
        ...
        key(Key37002000; "Default Delivery Route No.")
        {
        }
    }
