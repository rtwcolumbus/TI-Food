page 157 "Item Availability by Periods"
{
    ...
    trigger OnOpenPage()
    begin
        AvailableFor := LotStatusMgmt.ItemAvailabilityContext(Context); // P8001083
    end;
    ...
    begin
        CurrPage.ItemAvailLines.PAGE.SetLines(Rec, PeriodType, AmountType, AvailableFor); // P8001083
    end;
