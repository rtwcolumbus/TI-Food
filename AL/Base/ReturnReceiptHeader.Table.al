...
{
    // PR3.70
    //   Fix bugs with reference to comments
    // 
    // PR3.70.03
    //   Accruals
    // 
    ...
    keys
    {
        ...
        key(Key5; "Posting Date", "Bill-to Customer No.", "Sell-to Customer No.")
        {
        }
    ...
    var
        SalesRcpt: Record "Return Receipt Header";
        LabelWorksheetLine: Record "Label Worksheet Line" temporary;
        ReceivingLabelMgmt: Codeunit "Label Worksheet Management";
    begin
        // P8001047
        SalesRcpt := Rec;
        SalesRcpt.SetRecFilter;
        ReceivingLabelMgmt.WorksheetLinesForSalesRcpt(SalesRcpt, LabelWorksheetLine);
