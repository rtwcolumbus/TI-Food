...
{
    // PR3.70.01
    //   Add setup menu item for extra charges
    // 
    // PR3.70.03
    //   Accruals
    // 
    ...
    // 
    // PR4.00.05
    // P8000451B, VerticalSoft, Jack Reynolds, 19 FEB 07
    //   Not updating account name for accrual accounts
    // 
    // PRW16.00.05
    ...
    layout
    {
        area(content)
        {
            ...
            repeater(Control1)
            {
                ...
                field("ABC Direct Account"; "ABC Direct Account")
                {
                    ApplicationArea = FOODBasic;
                    Visible = false;
                }
                field("ABC Overhead Account"; "ABC Overhead Account")
                {
                    ApplicationArea = FOODBasic;
                    Visible = false;
                }
                ...
                field("Sales Plan Account (Accrual)"; "Sales Plan Account (Accrual)")
                {
                    ApplicationArea = FOODBasic;
                }
                ...
                field("Sales Account (Freight)"; "Sales Account (Freight)")
                {
                    ApplicationArea = FOODBasic;
                    Visible = false;
                }
