...
{
    // PR5.00
    // P8000500A, VerticalSoft, Jack Reynolds, 06 AUG 07
    //   Support for alternate quantity as value type
    // 
    // PRW16.00.05
    ...
    procedure DrillDown(CurrentAnalysisArea: Option; ItemStatisticsBuffer: Record "Item Statistics Buffer"; CurrentItemAnalysisViewCode: Code[10]; ItemFilter: Text; LocationFilter: Text; DateFilter: Text; Dim1Filter: Text; Dim2Filter: Text; Dim3Filter: Text; BudgetFilter: Text; LineDimOption: Option Item,Period,Location,"Dimension 1","Dimension 2","Dimension 3"; LineDimCodeBuf: Record "Dimension Code Buffer"; ColDimOption: Option Item,Period,Location,"Dimension 1","Dimension 2","Dimension 3"; ColDimCodeBuf: Record "Dimension Code Buffer"; SetColumnFilter: Boolean; ValueType: Option "Sales Amount","Cost Amount","Sales Quantity","Sales Quantity (Alt.)","Sales Amount (FOB)","Sales Amount (Freight)"; ShowActualBudget: Option "Actual Amounts","Budgeted Amounts",Variance,"Variance%","Index%")
    begin
        DrillDownAmount(
            ...
            ShowActualBudget::"Index%":
                begin
                    ...
                    case ValueType of
                        ...
                        // P8000500A
                        ValueType::FOODSalesQuantityAlt:
            ...
            ShowActualBudget::"Budgeted Amounts":
                begin
                    ...
                    case ValueType of
                        ...
                        // P8000921
                        ValueType::FOODSalesAmountFOB:
                            PAGE.Run(0, ItemAnalysisViewBudgetEntry, ItemAnalysisViewBudgetEntry."Sales Amount (FOB)");
                        ValueType::FOODSalesAmountFreight:
                            PAGE.Run(0, ItemAnalysisViewBudgetEntry, ItemAnalysisViewBudgetEntry."Sales Amount (Freight)");
                        // P8000921
                        ValueType::"Cost Amount":
                        ...
                        // P8000500A
                        ValueType::FOODSalesQuantityAlt:
                            PAGE.Run(0, ItemAnalysisViewBudgetEntry, ItemAnalysisViewBudgetEntry."Quantity (Alt.)");
                    // P8000500A
                    end;
                end;
        end;
    ...
    begin
        ...
        case ValueType of
            ...
            ValueType::FOODSalesAmountFOB:
                begin
                    ItemStatisticsBuffer.CalcFields("Analysis - Sales Amt (FOB)");
                    Amount := ItemStatisticsBuffer."Analysis - Sales Amt (FOB)";
                end;
            ValueType::FOODSalesAmountFreight:
                begin
                    ItemStatisticsBuffer.CalcFields("Analysis - Sales Amt (Freight)");
                    Amount := ItemStatisticsBuffer."Analysis - Sales Amt (Freight)";
                end;
            // P8000921
            ValueType::"Cost Amount":
                begin
            ...
            ValueType::FOODSalesQuantityAlt:
                begin
                    ItemStatisticsBuffer.CalcFields("Analysis - Quantity (Alt.)");
                    Amount := ItemStatisticsBuffer."Analysis - Quantity (Alt.)";
                end;
        // P8000500A
        end;
    ...
    begin
        ...
        case ValueType of
            ...
            ValueType::FOODSalesAmountFOB:
                begin
                    ItemStatisticsBuffer.CalcFields("Analysis-Budg. Sales (FOB)");
                    Amount := ItemStatisticsBuffer."Analysis-Budg. Sales (FOB)";
                end;
            ValueType::FOODSalesAmountFreight:
                begin
                    ItemStatisticsBuffer.CalcFields("Analysis-Budg. Sales (Freight)");
                    Amount := ItemStatisticsBuffer."Analysis-Budg. Sales (Freight)";
                end;
            // P8000921
            ValueType::"Cost Amount":
                begin
            ...
            ValueType::FOODSalesQuantityAlt:
                begin
                    ItemStatisticsBuffer.CalcFields("Analysis - Budgeted Qty (Alt.)");
                    Amount := ItemStatisticsBuffer."Analysis - Budgeted Qty (Alt.)";
                end;
        // P8000500A
        end;
