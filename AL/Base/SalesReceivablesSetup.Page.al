    ...
    layout
    {
        area(content)
        {
            group(General)
            {
                ...
                field("Sales Contracts Mandatory"; "Sales Contracts Mandatory")
                {
                ...
                field("Deduction Management Cust. No."; "Deduction Management Cust. No.")
                {
                    ApplicationArea = FOODBasic;
                }
                field("Resolve Ded. With Orig. Cust."; "Resolve Ded. With Orig. Cust.")
                {
                    ApplicationArea = FOODBasic;
                }
                field("Recent Sales Calculation"; "Recent Sales Calculation")
                {
                    ApplicationArea = FOODBasic;
                }
                field("Terminal Market Item Level"; "Terminal Market Item Level")
                {
                    ApplicationArea = FOODBasic;
                }
                field("Default Customer Price Group"; "Default Customer Price Group")
                {
                    ApplicationArea = FOODBasic;
                }
                field("Delivered Pricing Calc. Method"; "Delivered Pricing Calc. Method")
                {
                    ApplicationArea = FOODBasic;
                }
                field("Del. Pricing Calc. Codeunit ID"; "Del. Pricing Calc. Codeunit ID")
                {
                    ApplicationArea = FOODBasic;
                }
                field(CodeunitCaption; Process800Utility.GetObjectCaption(5, "Del. Pricing Calc. Codeunit ID"))
                {
                    ApplicationArea = FOODBasic;
                    Caption = 'Codeunit Name';
                }
                field("Calc. Freight on Release/Post"; "Calc. Freight on Release/Post")
                {
                    ApplicationArea = FOODBasic;
                }
            ...
            group("Number Series")
            {
                ...
                field("Deduction Management Doc. Nos."; "Deduction Management Doc. Nos.")
                {
                    ApplicationArea = FOODBasic;
                }
                ...
                field("Standing Order Nos."; "Standing Order Nos.")
                {
                    ApplicationArea = FOODBasic;
                }
                field("<Sales Contract Nos.>"; "Sales Contract Nos.")
                {
                    ApplicationArea = FOODBasic;
                }
            }
