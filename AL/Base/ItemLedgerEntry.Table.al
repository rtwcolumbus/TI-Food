...
#pragma warning restore AS0009
        ...
        key(Key37002098; "Entry Type", "Item No.", "Variant Code", "Source Type", "Source No.", "Posting Date")
        {
            SumIndexFields = Quantity, "Invoiced Quantity", "Invoiced Quantity (Alt.)";
        }
        key(Key37002099; "Item No.", "Variant Code", "Location Code", "Posting Date")
        {
        }
        key(Key37002000; "Item No.", "Variant Code", "Global Dimension 1 Code", "Global Dimension 2 Code", "Location Code", "Posting Date")
        {
            Enabled = false;
        }
        key(Key37002001; "Item No.", "Variant Code", "Lot No.", Positive, "Posting Date")
        {
        }
        key(Key37002002; "Item No.", "Variant Code", "Location Code", "Lot No.", "Serial No.", "Posting Date")
        {
            SumIndexFields = Quantity, "Quantity (Alt.)";
        }
        key(Key37002003; "Item No.", "Variant Code", "Drop Shipment", "Location Code", "Lot No.", "Serial No.")
        {
            SumIndexFields = Quantity, "Quantity (Alt.)";
        }
        key(Key37002004; "Posting Date", "Item No.", "Location Code")
        {
            Enabled = false;
            SumIndexFields = Quantity, "Quantity (Alt.)";
        }
        key(Key37002005; "Item No.", "Entry Type", "Order Type", "Order No.", "Location Code", "Posting Date")
        {
            Enabled = false;
            SumIndexFields = Quantity, "Quantity (Alt.)";
        }
        key(Key37002006; "Item Category Code", "Item No.", "Entry Type")
        {
        }
        key(Key37002007; "Delivery Route No.", "Source Type", "Source No.", "Item No.", "Variant Code", "Posting Date")
        {
        }
        key(Key37002008; "Item No.", "Location Code", "Lot No.", "Posting Date")
        {
        }
        key(Key37002009; "Item No.", "Lot No.", "Posting Date")
        {
        }
        key(Key37002010; "Location Code", "Item No.", "Variant Code", Open, Positive, "Expiration Date")
        {
        }
        key(Key37002011; "Location Code", "Item No.", "Variant Code", Open, Positive, "Posting Date")
        {
        }
        key(Key37002012; "Item Category Code", "Entry Type", "Posting Date", "Global Dimension 1 Code", "Global Dimension 2 Code")
        {
            Enabled = false;
            SumIndexFields = Quantity, "Quantity (Alt.)";
        }
        key(Key37002013; "Item No.", Open, "Variant Code", "Location Code", "Lot No.")
        {
