codeunit 408 DimensionManagement
{
    ...
    procedure TypeToTableID3(Type: Option " ","G/L Account",Item,Resource,"Fixed Asset","Charge (Item)",,,Container,"Accrual Plan") TableId: Integer
    begin
    ...
    begin
        ...
        exit(TableID in [0, Database::"Accrual Plan"]); // P800142669
    end;
