table 25 "Vendor Ledger Entry"
{
    ...
    // 
    // PRW16.00.02
    // P8000762, VerticalSoft, Jack Reynolds, 27 JAN 10
    //   Add Boolean field to flag entries that are created form Accruals
    // 
    // PRW16.00.04
    ...
    fields
    {
        field(37002120; "Accrual Entry"; Boolean)
        {
    ...
    keys
    {
        ...
        key(Key16; "Vendor No.", "Comm. Reference Date")
        {
        }
