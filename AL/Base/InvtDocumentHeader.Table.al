table 5850 "Invt. Document Header"
{
    ...
    fields
    {
        ...
        field(30; Correction; Boolean)
        {
            ...
            begin
                // P800127049 
                if Correction <> xRec.Correction then begin
                    InvtDocLine.SetRange("Document Type", "Document Type");
                    InvtDocLine.SetRange("Document No.", "No.");
                    InvtDocLine.SetFilter("FOOD Container License Plate", '<>%1', '');
                    if InvtDocLine.FindSet(true) then
                        repeat
                            InvtDocLine."FOOD Container License Plate" := '';
                            InvtDocLine."FOOD Old License Plate" := '';
                            InvtDocLine."FOOD Old Container ID" := '';
                            InvtDocLine."FOOD New License Plate" := '';
                            InvtDocLine."FOOD New Container ID" := '';
                            InvtDocLine.Modify();
