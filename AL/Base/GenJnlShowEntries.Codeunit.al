    ...
    begin
        ...
        case "Account Type" of
            ...
            "Account Type"::FOODAccrualPlan:
                begin
                    AccrualLedgEntry.SetCurrentKey("Accrual Plan Type", "Accrual Plan No.", "Posting Date");
                    AccrualLedgEntry.SetRange("Accrual Plan No.", "Account No.");
                    if AccrualLedgEntry.Find('+') then
                        AccrualLedgEntry.SetRange("Accrual Plan Type", AccrualLedgEntry."Accrual Plan Type");
                    PAGE.Run(PAGE::"Accrual Ledger Entries", AccrualLedgEntry);
                end;
                // P8000241A
        end;
