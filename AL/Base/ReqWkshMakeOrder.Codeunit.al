...
{
    // PR4.00.02
    // P8000312A, VerticalSoft, Jack Reynolds, 28 MAR 06
    //   Add function to return first new order number
    // 
    // PR4.00.06
    // P8000489A, VerticalSoft, Jack Reynolds, 26 JUN 07
    //   Fix problem with automatic lot number assignment
    // 
    // PR5.00
    // P8000505A, VerticalSoft, Jack Reynolds, 10 AUG 07
    //   Fix problem synchronizing purchase lot tracking with sales lot tracking
    ...
    begin
        with RequisitionLine do begin
            ...
            PurchOrderLine.UpdateLotTracking(true); // P8000505A
        end;
    ...
    begin
        ...
        with ReqLine2 do begin
            ...
            if FirstPurchOrderNo = '' then                 // P8000312A
                FirstPurchOrderNo := PurchOrderHeader."No."; // P8000312A
    ...
    procedure GetFirstOrder(): Code[20]
    begin
        // P8000312A
        exit(FirstPurchOrderNo);
    end;
