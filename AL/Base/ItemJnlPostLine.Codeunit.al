codeunit 22 "Item Jnl.-Post Line"
{
    ...
    begin
        ...
        with ItemJnlLine do begin
            ...
            if "Item Shpt. Entry No." <> 0 then
                ...
                if Subcontracting then
                    // InsertCapLedgEntry(CapLedgEntry,Quantity,"Invoiced Quantity")                 // PR3.60
                    InsertCapLedgEntry(CapLedgEntry,                                                 // PR3.60
                GetCostingQty(FieldNo(Quantity)), GetCostingQty(FieldNo("Invoiced Quantity"))) // PR3.60
                else
    ...
    begin
        ...
        repeat
            ...
            if StartApplication then begin
                ...
                ItemLedgEntry.CalcFields("Reserved Quantity (Alt.)"); // P8000552A
                ...
                OldItemLedgEntry.CalcFields("Reserved Quantity");
                OldItemLedgEntry.CalcFields("Reserved Quantity (Alt.)"); // P8000552A
            ...
            if (AppliedQty <> 0) or (AppliedAltQty <> 0) then begin // PR3.60
                ...
                if (ItemLedgEntry."Remaining Quantity" + ItemLedgEntry."Reserved Quantity" = 0) and   // PR3.60
                                                                                                      // (ItemLedgEntry."Remaining Quantity (Alt.)" = 0)                                 // PR3.60, P8000552A
    ...
    local procedure InsertApplEntry(ItemLedgEntryNo: Integer; InboundItemEntry: Integer; OutboundItemEntry: Integer; TransferedFromEntryNo: Integer; PostingDate: Date; Quantity: Decimal; CostToApply: Boolean; AltQuantity: Decimal)
    var
    ...
    begin
        ...
        if OldItemLedgEntry.GetCostingInvQty = 0 then begin // P80043524
    ...
    begin
        ...
        if (ItemJnlLine."Old Container ID" = '') or
           ((ItemJnlLine."Line No." = ItemJnlLine."Container Master Line No.") and (ItemJnlLine."Line No." <> 0) and // P800122712
