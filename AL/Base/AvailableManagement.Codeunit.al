codeunit 5400 "Available Management"
{
    ...
    begin
        ...
        with CopyOfItem do begin
            // P8001083
            if (not SkipInvAdjustment) and (LotStatusExclusionFilter <> '') then // P8007748
                LotStatusMgmt.QuantityAdjforItem(CopyOfItem, LotStatusExclusionFilter, Inventory, "Quantity on Hand (Alt.)"); // P8001352
                                                                                                                              // P8001083
            ...
            // P8001083
            LotStatusMgmt.AdjustItemFlowFields(CopyOfItem, LotStatusExclusionFilter, false, true, 0, // P8001352
    ...
    procedure SetSkipInvAdjustment(Flag: Boolean)
    begin
        // P8007748
        SkipInvAdjustment := Flag;
    end;
