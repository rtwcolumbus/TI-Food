page 9285 "Transfer Routes Matrix"
{
    ...
    var
        ...
        Show: Option "In-Transit Code","Shipping Agent Code","Shipping Agent Service Code",,,,"Default Delivery Route No.";
    ...
    procedure Load(NewMatrixColumns: array[32] of Text[1024]; var NewMatrixRecords: array[32] of Record Location; NewCurrentNoOfMatrixColumns: Integer; NewShow: Option "In-Transit Code","Shipping Agent Code","Shipping Agent Service Code",,,,"Default Delivery Route No.")
    begin
    ...
    begin
        ...
        if TransferRoute.Get(Code, MatrixRecords[MATRIX_ColumnOrdinal].Code) then
            case Show of
                ...
                // P8000954
                Show::"Default Delivery Route No.":
                    Specification := TransferRoute."Default Delivery Route No.";
                // P8000954
                else
