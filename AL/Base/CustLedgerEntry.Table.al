table 21 "Cust. Ledger Entry"
{
    ...
    //   Add Accrual Plan option to Bal. Account Type
    // 
    // P8000240A, Myers Nissi, Jack Reynolds, 29 AUG 05
    //   Change option string for deduciton type
    // 
    // PR4.00.01
    ...
    fields
    {
        field(37002000; Comment; Boolean)
        {
            CalcFormula = Exist ("Ledger Entry Comment Line" WHERE("Table ID" = CONST(21),
        ...
        field(37002194; "Original Document Type"; Option)
        {
            CalcFormula = Lookup ("Cust. Ledger Entry"."Document Type" WHERE("Entry No." = FIELD("Original Entry No.")));
        ...
        field(37002195; "Original Document No."; Code[20])
        {
            CalcFormula = Lookup ("Cust. Ledger Entry"."Document No." WHERE("Entry No." = FIELD("Original Entry No.")));
        ...
        field(37002196; "Assigned To"; Code[50])
        {
            ...
            var
                UserSelection: Codeunit "User Selection";
            begin
                UserSelection.ValidateUserName("Assigned To"); // P8000170A
            end;
        }
        field(37002197; "Unresolved Deduction"; Boolean)
        {
            Caption = 'Unresolved Deduction';
            Editable = false;
        }
        ...
        field(47; "Applies-to ID"; Code[50])
        {
            ...
            begin
                ...
                // P8000170A
                if ("Applies-to ID" <> '') and P800Fns.DedMgtInstalled then
                    DedMgt.TestCustLedgerAppliesTo(Rec);
            end;
        }
    ...
    keys
    {
        ...
        key(Key37002000; "Document Type", Open, "Customer No.", "Posting Date")
        {
        }
        key(Key37002001; "Customer No.", "Original Customer No.", Open, "Posting Date")
        {
        }
    }
    ...
    procedure AmountWithDiscount(Date: Date): Decimal
    begin
        // P8000170A
        CalcFields("Remaining Amount");
        if Date <= "Pmt. Discount Date" then
