page 6550 "Whse. Item Tracking Lines"
{
    ...
    begin
        with WhseItemTrkgLine2 do begin
            ...
            case SourceType of
                ...
                DATABASE::"Whse. Staged Pick Line", // P8000322A
    ...
    begin
        ...
        // P80069310
        Rec."New Lot No." := NewLotNo;
        Rec."New Serial No." := NewSerialNo;
        Rec."New Expiration Date" := NewExpiredDate;
        // P80069310
    ...
    procedure SetReclassData(pNewSerialNo: Code[50]; pNewLotNo: Code[50]; pNewExpiredDate: Date)
    begin
        // P80069310
        NewSerialNo := pNewSerialNo;
        NewLotNo := pNewLotNo;
        NewExpiredDate := pNewExpiredDate;
    end;
