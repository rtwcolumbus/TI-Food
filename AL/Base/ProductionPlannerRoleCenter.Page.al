...
{
    // PRW16.00.02
    // P8000685, VerticalSoft, Jack Reynolds, 17 APR 09
    //   Add Action to display Lot History page
    // 
    // PRW16.00.03
    ...
    //   Remove Production Worksheet, Add Batch Planning
    // 
    // P8000889, Columbus IT, Jack Reynolds, 02 MAR 11
    //   Added an action to run the Production Sequence page
    // 
    // PRW16.00.06
    ...
    // 
    // PRW17.00.01
    // P8001187, Columbus IT, Jack Reynolds, 31 JUL 13
    //   Remove Home Items
    // 
    // PRW19.00
    ...
    //   Remove Production BOM, add Visual Production Sequencer
    ...
    actions
    {
        ...
        area(sections)
        {
            ...
            group(Worksheets)
            {
                ...
                action("Batch Planning Worksheets")
                {
                    ApplicationArea = FOODBasic;
                    Caption = 'Batch Planning Worksheets';
                    Image = ExecuteBatch;
                    RunObject = Page "Batch Planning Worksheet Names";
                }
            ...
            group("Product Design")
            {
                ...
                action("Item Process BOMs")
                {
                    ApplicationArea = FOODBasic;
                    Caption = 'Item Process BOMs';
                    Image = BOM;
                ...
                action("Co-Product Process BOMs")
                {
                    ApplicationArea = FOODBasic;
                    Caption = 'Co-Product Process BOMs';
                    Image = BOM;
                    RunObject = Page "Co-Product Process List";
                }
                action(Action37002016)
                {
                    ApplicationArea = FOODBasic;
                    Caption = 'Certified';
                    Image = Certificate;
        ...
        area(creation)
        {
            ...
            action("Co-Product Process")
            {
                ...
                //The property 'PromotedCategory' can only be set if the property 'Promoted' is set to 'true'
                //PromotedCategory = Process;
                RunObject = Page "Co-Product Process";
                RunPageMode = Create;
            }
            action("&Routing")
            {
        ...
        area(processing)
        {
            ...
            group("Basic Pla&nning")
            {
                Caption = 'Basic Pla&nning';
                action("Quick Planner")
                {
                    ApplicationArea = FOODBasic;
                    Caption = 'Quick Planner';
                    Image = Replan;
                    RunObject = Page "Quick Planner";
                }
                action("Batch Planning Worksheet")
                {
                    ApplicationArea = FOODBasic;
                ...
                action("Production Sequencer")
                {
                    ApplicationArea = FOODBasic;
                    Caption = 'Production Sequencer';
                    Image = Replan;
                    RunObject = Page "Production Sequence";
                }
                action("Daily Production Planning")
                {
                    ApplicationArea = FOODBasic;
