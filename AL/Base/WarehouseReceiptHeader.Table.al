table 7316 "Warehouse Receipt Header"
{
    ...
    fields
    {
        ...
        field(11028580; "Loading Dock"; Code[20])
        {
    ...
    trigger OnDelete()
    begin
        UpdateContainersOnDelete; // P8001323, P8008014
    ...
    var
        ...
        Text37002700: Label 'One or more containers have been marked to be received for this receipt.';
    ...
    begin
        ...
        WHReceiptLine.Reset;
        WHReceiptLine.SetRange("No.", "No.");
        if WHReceiptLine.Find('-') then
            repeat
                WHReceiptLine.Validate("Qty. to Receive", 0);
                WHReceiptLine.Modify;
                PurchLine.Reset;
                PurchLine.SetRange("Document Type", PurchLine."Document Type"::Order);
                PurchLine.SetRange("Document No.", WHReceiptLine."Source No.");
                PurchLine.SetRange(PurchLine."Line No.", WHReceiptLine."Source Line No.");
                ...
                if PurchLine.Find('-') then
                    repeat
                        ...
                        PurchLine.ADCStarting(true); // P8001297
    ...
    local procedure UpdateContainersOnDelete()
    var
    ...
    begin
        ...
        if P800Functions.ContainerTrackingInstalled then begin
            ContainerHeader.SetRange("Whse. Document Type", ContainerHeader."Whse. Document Type"::Receipt);
            ContainerHeader.SetRange("Whse. Document No.", "No.");
            // P8008014
            //  ContainerHeader.SETRANGE(Receive,TRUE);
            //  IF NOT ContainerHeader.ISEMPTY THEN
            if ContainerHeader.FindSet(true) then // P80046533
                repeat
                    //      IF (ContainerHeader."Document Type" <> DATABASE::"Transfer Line") OR (ContainerHeader."Ship/Receive") THEN // P80046533
                    if ContainerHeader."Ship/Receive" then // P80046533
                        Error(Text37002700)
                    else begin
            ...
            //  ContainerHeader.SETRANGE(Receive);
            //  ContainerHeader.SETFILTER("Document Type",'<>%1',DATABASE::"Transfer Line");
            //  IF NOT ContainerHeader.ISEMPTY THEN
            //    ERROR(Text37002700);
            // P8008014
        end;
