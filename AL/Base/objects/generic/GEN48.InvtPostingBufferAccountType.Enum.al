enum 48 "Invt. Posting Buffer Account Type"
{
    ...
    value(20; FOODWriteoffCompany)
    {
        Caption = 'Writeoff (Company)';
    }
    value(21; FOODWriteoffVendor)
    {
        Caption = 'Writeoff (Vendor)';
    }
    value(22; FOODInvtAccrualECInterim)
    {
        Caption = 'Invt. Accrual-EC (Interim)';
    }
    value(23; FOODDirectCostAppliedEC)
    {
        Caption = 'Direct Cost Applied-EC';
    }
    value(24; FOODABCDirect)
    {
        Caption = 'ABC Direct';
    }
    value(25; FOODABCOverhead)
    {
        Caption = 'ABC Overhead';
    }
}
