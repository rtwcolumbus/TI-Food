enum 77 "Report Selection Usage"
{
    ...
    value(67; FOODContainer) { Caption = 'Container'; }
    value(68; FOODSPickTicket) { Caption = 'S.Pick Ticket'; }
    value(69; FOODMWorkOrder) { Caption = 'M.Work Order'; }
    value(70; FOODRepackOrder) { Caption = 'Repack Order'; }
}
