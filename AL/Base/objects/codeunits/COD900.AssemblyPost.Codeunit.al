codeunit 900 "Assembly-Post"
{
    ...
    begin
        UndoPostingMgt.CollectItemLedgEntries(
          ...
          Abs(ItemJnlLine."Quantity (Base)"), 0, ApplyToEntry); // P8001132
    ...
    begin
        with PostedAsmHeader do begin
            ...
            UndoPostingMgt.CollectItemLedgEntries(
              TempItemLedgEntry, DATABASE::"Posted Assembly Header", "No.", 0, "Quantity (Base)", 0, "Item Rcpt. Entry No."); // P8001132
        ...
        with PostedAsmLine do begin
            ...
            repeat
                if (Type = Type::Item) and ("Item Shpt. Entry No." <> 0) then begin
                    ...
                    UndoPostingMgt.CollectItemLedgEntries(
                      TempItemLedgEntry, DATABASE::"Posted Assembly Line", "Document No.", "Line No.", "Quantity (Base)", 0, "Item Shpt. Entry No."); // P8001132
