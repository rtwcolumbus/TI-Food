codeunit 5771 "Whse.-Sales Release"
{
    ...
    begin
        ...
        // WarehouseRequest.SetRange(Type, WarehouseRequest.Type); // P8008713
        ...
        if SalesLine."Location Code" <> '' then begin // P8000723
            ...
            if WarehouseRequest.Find() then
                if WarehouseRequest."Delivery Trip" <> '' then
                    if (WarehouseRequest."Delivery Route No." <> SalesHeader."Delivery Route No.") or
                       (WarehouseRequest."Shipment Date" <> SalesHeader."Shipment Date")
                    then
                        WarehouseRequest."Delivery Trip" := '';
            // P800125182
