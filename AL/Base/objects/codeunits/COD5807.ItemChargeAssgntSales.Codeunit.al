            ...
            case "Applies-to Doc. Type" of
                ...
                "Applies-to Doc. Type"::"Credit Memo":
                    begin
                        ...
                        P800UOMFns.ItemUnitGrossWeightAndVolume(DecimalArray, SalesLine."No.", SalesLine."Quantity (Base)", SalesLine.Quantity,
                          SalesLine."Unit of Measure Code", SalesLine."Quantity (Alt.)");
                        // P80053245
                    end;
