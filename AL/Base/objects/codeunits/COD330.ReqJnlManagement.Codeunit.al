codeunit 330 ReqJnlManagement
{
    ...
    //   When lookung up name use "Req. Wksh. Names" or "Req. Wksh. Names-Extended"
    ...
    var
        ...
        ReqWkshNamesExtended: Page "Req. Wksh. Names-Extended";
    begin
        Commit();
        ...
        // P8000312A
        ReqWkshTemp.Get(ReqWkshName."Worksheet Template Name");
        if (ReqWkshTemp.Type = ReqWkshTemp.Type::"Req.") and (not ReqWkshTemp.Recurring) then begin
            ReqWkshNamesExtended.SetTableView(ReqWkshName);
            ReqWkshNamesExtended.LookupMode(true);
            if ReqWkshNamesExtended.RunModal = ACTION::LookupOK then begin
                ReqWkshNamesExtended.GetRecord(ReqWkshName);
                CurrentJnlBatchName := ReqWkshName.Name;
