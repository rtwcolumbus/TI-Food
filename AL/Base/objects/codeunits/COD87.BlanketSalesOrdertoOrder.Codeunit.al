codeunit 87 "Blanket Sales Order to Order"
{
    ...
    //   Copy lot preferences from blanket order instead of customer
    // 
    // PR4.00.05
    // P8000440A, VerticalSoft, Jack Reynolds, 25 JAN 07
    //   Support for Line Discount Unit Amount
    // 
    // PRW110.0
            ...
            repeat
                ...
                if (BlanketOrderSalesLine.Type = BlanketOrderSalesLine.Type::" ") or (BlanketOrderSalesLine."Qty. to Ship" <> 0) then begin
                    ...
                    if (SalesOrderLine."No." <> '') and (SalesOrderLine.Type <> SalesOrderLine.Type::" ") then begin
                        ...
                        SalesOrderLine."Line Discount Type" := BlanketOrderSalesLine."Line Discount Type";
                        case SalesOrderLine."Line Discount Type" of
                            SalesOrderLine."Line Discount Type"::Percent:
                                SalesOrderLine."Line Discount %" := BlanketOrderSalesLine."Line Discount %";
                            SalesOrderLine."Line Discount Type"::Amount:
                                SalesOrderLine."Line Discount Amount" := BlanketOrderSalesLine."Line Discount Amount";
                            SalesOrderLine."Line Discount Type"::"Unit Amount":
                                SalesOrderLine."Line Discount Unit Amount" := BlanketOrderSalesLine."Line Discount Unit Amount";
                        end;
                        SalesOrderLine.Validate("Line Discount %");
                        // P8000440A
                    ...
                    if ProcessFns.TrackingInstalled then                                              // P8000153A
                        LotSpecFns.CopyLotPrefSlsLineToSalesLine(BlanketOrderSalesLine, SalesOrderLine); // P8000210A
