codeunit 392 "Reminder-Make"
{
    ...
    begin
        ...
        if HeaderExists then
            ...
            if ExcludeDeductions then                               // P8002753
                CustLedgEntry.SetRange("Unresolved Deduction", false); // P8002753
    ...
    begin
        ...
        Set(Cust2, CustLedgEntry2, ReminderHeaderReq2, OverdueEntriesOnly2, IncludeEntriesOnHold2, false, CustLedgEntryLinefeeOn);
    end;
    
    procedure Set(Cust2: Record Customer; var CustLedgEntry2: Record "Cust. Ledger Entry"; ReminderHeaderReq2: Record "Reminder Header"; OverdueEntriesOnly2: Boolean; IncludeEntriesOnHold2: Boolean; ExcludeDeductions2: Boolean; var CustLedgEntryLinefeeOn: Record "Cust. Ledger Entry")
    begin
        // P8002753 - add parameter for ExcludeDeductions
        Cust := Cust2;
        ...
        ExcludeDeductions := ExcludeDeductions2; // P8002753
    ...
    begin
        // P80096141 - Original signature
        SuggestLines(ReminderHeader2, CustLedgEntry2, OverdueEntriesOnly2, IncludeEntriesOnHold2, false, CustLedgEntryLinefeeOn);
    end;

    procedure SuggestLines(ReminderHeader2: Record "Reminder Header"; var CustLedgEntry2: Record "Cust. Ledger Entry"; OverdueEntriesOnly2: Boolean; IncludeEntriesOnHold2: Boolean; ExcludeDeductions2: Boolean; var CustLedgEntryLinefeeOn: Record "Cust. Ledger Entry")
    begin
        // P8002753 - add parameter for ExcludeDeductions
