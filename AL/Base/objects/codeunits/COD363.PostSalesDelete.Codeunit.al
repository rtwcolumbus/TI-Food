codeunit 363 "PostSales-Delete"
{
    ...
    //   Delete alternated quantity entries for posted documents
    ...
    begin
        ...
        if P800Fns.AltQtyInstalled then                                                            // P8000198A
            AltQtyMgt.DeletePostedDocEntries(DATABASE::"Sales Shipment Line", SalesShptHeader."No."); // P8000198A
    ...
    begin
        ...
        if P800Fns.AltQtyInstalled then                                                          // P8000198A
            AltQtyMgt.DeletePostedDocEntries(DATABASE::"Sales Invoice Line", SalesInvHeader."No."); // P8000198A
    ...
    begin
        ...
        if P800Fns.AltQtyInstalled then                                                             // P8000198A
            AltQtyMgt.DeletePostedDocEntries(DATABASE::"Sales Cr.Memo Line", SalesCrMemoHeader."No."); // P8000198A
    ...
    begin
        ...
        if P800Fns.AltQtyInstalled then                                                             // P8000198A
            AltQtyMgt.DeletePostedDocEntries(DATABASE::"Return Receipt Line", ReturnRcptHeader."No."); // P8000198A
