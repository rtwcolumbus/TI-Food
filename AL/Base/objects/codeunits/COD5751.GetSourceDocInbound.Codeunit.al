codeunit 5751 "Get Source Doc. Inbound"
{
    ...
    //   Added logic when creating receipt from ADC
    // 
    // PRW19.00
    ...
    begin
        ...
        GetSourceDocuments.SetAssignContainers; // P8008014
    ...
    begin
        ...
        GetSourceDocuments.SetAssignContainers; // P8001323
    ...
    begin
        ...
        ADCStarted := PurchHeader."ADC Started"; // P8004516
    ...
    begin
        ...
        ADCStarted := SalesHeader."ADC Started"; // P8004516
        exit(CreateWhseReceiptHeaderFromWhseRequest(WhseRqst));
    end;
    ...
    begin
        ...
        ADCStarted := TransHeader."ADC Started"; // P8004516
        exit(CreateWhseReceiptHeaderFromWhseRequest(WhseRqst));
    end;
