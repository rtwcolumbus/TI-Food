        ...
        repeat
            ...
            if not IsHandled then
                if ((ItemJnlLine."Value Entry Type" = "Cost Entry Type"::"Direct Cost") and (ItemJnlLine."Item Charge No." = '')) or
                   ((ItemJnlLine.GetCostingQty(ItemJnlLine.FieldNo("Invoiced Quantity")) <> 0) and (ItemJnlLine.Amount <> 0))                     // PR3.61, P8000106A
                then begin
    ...
    begin
        ...
        repeat
            ...
            if ItemJnlLine."Inventory Value Per" <> ItemJnlLine."Inventory Value Per"::" " then
                ...
                if ((ItemJnlLine."Value Entry Type" = "Cost Entry Type"::"Direct Cost") and (ItemJnlLine."Item Charge No." = '')) or
                       ((ItemJnlLine.GetCostingQty(ItemJnlLine.FieldNo("Invoiced Quantity")) <> 0) and (ItemJnlLine.Amount <> 0)) // P8000106A
                then begin
                    LineCount := LineCount + 1;
                    ...
                    if not IsHandled then begin
                        ...
                        OriginalQuantityAlt := ItemJnlLine."Quantity (Alt.)"; // P8000591A
                        ItemJnlLine.AutoLotNo(true); // P8000250B, P8001234, P8001314
                        ...
                        if (ItemJnlLine."Entry Type" = ItemJnlLine."Entry Type"::Transfer) and (ItemJnlLine."Alt. Qty. Transaction No." <> 0) then // P8000631A
