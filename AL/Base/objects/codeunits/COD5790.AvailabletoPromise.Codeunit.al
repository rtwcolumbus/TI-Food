codeunit 5790 "Available to Promise"
{
    ...
    begin
        ...
        if not IsHandled then begin
            ...
            LotStatusMgmt.AdjustItemFlowFields(Item, LotStatusExclusionFilter, true, false, 2, false, false, false); // P8001083, P8001132
    ...
    begin
        ...
        if not IsHandled then
            LotStatusMgmt.AdjustItemFlowFields(Item, LotStatusExclusionFilter, false, true, 0, // P8001083
    ...
    begin
        ...
        if not IsHandled then
            LotStatusMgmt.AdjustItemFlowFields(Item, LotStatusExclusionFilter, false, true, 1, // P8001083
              ExcludePurch, ExcludeSalesRet, ExcludeOutput);                                 // P8001083
    ...
    begin
        ...
        LotStatusMgmt.AdjustItemFlowFields(Item, LotStatusExclusionFilter, true, false, 2, false, false, false); // P8001083
    ...
    begin
        ...
        if not ExcludePurch then // P8001083
        ...
        with TransferLine do
            if FindLinesWithItemToPlan(Item, true, false) then
                repeat
                    ...
                    OutstandingQty := 0;
                    QtyInTransit := 0;
                    LotStatusMgmt.QuantityAdjForTransfer(TransferLine, LotStatusExclusionFilter, OutstandingQty, QtyInTransit);
                    UpdateScheduledReceipt(AvailabilityAtDate, "Receipt Date", OutstandingQty + QtyInTransit);
                // P8001083
                until Next() = 0;
    end;
    ...
    begin
        ...
        with SalesLine do begin
            ...
            if not ExcludeSalesRet then // P8001083
                if FindLinesWithItemToPlan(Item, "Document Type"::"Return Order") then
                    repeat
                        CalcFields("Reserved Qty. (Base)");
