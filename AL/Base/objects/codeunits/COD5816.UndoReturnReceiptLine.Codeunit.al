codeunit 5816 "Undo Return Receipt Line"
{
    ...
    begin
        with ReturnRcptLine do begin
            if SalesHeader.Get(SalesHeader."Document Type"::"Return Order", "Return Order No.") then // PR3.61.02
    ...
    begin
        ...
        if ReturnRcptLine.Type = "Sales Line Type"::Item then begin
            ...
            if not IsHandled then begin
                ...
                ReturnRcptLine."Document No.", ReturnRcptLine."Line No.", ReturnRcptLine."Quantity (Base)", ReturnRcptLine."Quantity (Alt.)", ReturnRcptLine."Item Rcpt. Entry No.");
    ...
    begin
        ...
        with ReturnRcptLine do begin
            ...
            UndoPostingMgt.CollectItemLedgEntries(
                TempApplyToEntryList, DATABASE::"Return Receipt Line", "Document No.", "Line No.", "Quantity (Base)", "Quantity (Alt.)", "Item Rcpt. Entry No."); // P8000267B
    ...
    begin
        with OldReturnRcptLine do begin
            ...
            NewReturnRcptLine."Quantity (Alt.)" := -"Quantity (Alt.)"; // PR3.60
            ...
            NewReturnRcptLine."Qty. Invoiced (Alt.)" := NewReturnRcptLine."Quantity (Alt.)"; // PR3.70
            ...
            // PR3.60 Begin
            if OldReturnRcptLine.AltQtyEntriesExist then
                AltQtyMgmt.UndoAltQtyEntries(
                  DATABASE::"Return Receipt Line", OldReturnRcptLine."Document No.", OldReturnRcptLine."Line No.",
                  DATABASE::"Return Receipt Line", NewReturnRcptLine."Document No.", NewReturnRcptLine."Line No.",
                  false);
            // PR3.60 End
        end;
    end;
    ...
    begin
        ...
        with ReturnRcptLine do begin
            ...
            UndoPostingMgt.UpdateSalesLine(SalesLine, Quantity, "Quantity (Base)", "Quantity (Alt.)", TempGlobalItemLedgEntry); // P8000267B
