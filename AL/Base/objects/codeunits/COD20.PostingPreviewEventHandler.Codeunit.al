codeunit 20 "Posting Preview Event Handler"
{
    ...
    var
        ...
        TempAccrualLedgerEntry: Record "Accrual Ledger Entry" temporary;
        TempContainerLedgerEntry: Record "Container Ledger Entry" temporary;
        TempMaintenanceLedger: Record "Maintenance Ledger" temporary;
    ...
    var
        ...
        ValueEntriesPreview: Page "Value Entries Preview";
        ...
        case TableNo of
            ...
            Database::"Value Entry":
                ...
                begin
                    ...
                    ValueEntriesPreview.Set(TempValueEntry, TempExtraCharge);
                    ValueEntriesPreview.Run;
                    Clear(ValueEntriesPreview);
                end;
            // P8007748
            Database::"Item Ledger Entry":
                begin
            ...
            Database::"Accrual Ledger Entry":
                Page.Run(Page::"Accrual Ledger Entries Preview", TempAccrualLedgerEntry);
            Database::"Container Ledger Entry":
                Page.Run(Page::"Cont. Ledger Entries Preview", TempContainerLedgerEntry);
            Database::"Maintenance Ledger":
                Page.Run(Page::"Maint. Ledger Entries Preview", TempMaintenanceLedger);
            // P8004516
            else
    ...
    begin
        ...
        // P8007748
        InsertDocumentEntry(TempAccrualLedgerEntry, TempDocumentEntry);
        InsertDocumentEntry(TempContainerLedgerEntry, TempDocumentEntry);
        InsertDocumentEntry(TempMaintenanceLedger, TempDocumentEntry);
        // P8007748
    ...
    [EventSubscriber(ObjectType::Table, 37002128, 'OnAfterInsertEvent', '', false, false)]
    local procedure OnAfterInsertAccrualLedgerEntry(var Rec: Record "Accrual Ledger Entry"; RunTrigger: Boolean)
    begin
        // P8007748
        if Rec.IsTemporary then
            exit;
        ...
        PreventCommit;
        TempAccrualLedgerEntry := Rec;
        TempAccrualLedgerEntry."Document No." := '***';
        TempAccrualLedgerEntry.Insert;
    end;

    [EventSubscriber(ObjectType::Table, 37002576, 'OnAfterInsertEvent', '', false, false)]
    local procedure OnAfterInsertContainerLedgEntry(var Rec: Record "Container Ledger Entry"; RunTrigger: Boolean)
    begin
        // P8007748
        if Rec.IsTemporary then
            exit;
        ...
        PreventCommit;
        TempContainerLedgerEntry := Rec;
        TempContainerLedgerEntry."Document No." := '***';
        TempContainerLedgerEntry.Insert;
    end;

    [EventSubscriber(ObjectType::Table, 37002667, 'OnAfterInsertEvent', '', false, false)]
    local procedure OnAfterInsertValueEntryExtraCharge(var Rec: Record "Value Entry Extra Charge"; RunTrigger: Boolean)
    begin
        // P8007748
        if Rec.IsTemporary then
            exit;
        ...
        PreventCommit;
        TempExtraCharge := Rec;
        TempExtraCharge.Insert;
    end;

    [EventSubscriber(ObjectType::Table, 37002802, 'OnAfterInsertEvent', '', false, false)]
    local procedure OnAfterInsertMaintenanceLedger(var Rec: Record "Maintenance Ledger"; RunTrigger: Boolean)
    begin
        // P8007748
        if Rec.IsTemporary then
            exit;
        ...
        PreventCommit;
        TempMaintenanceLedger := Rec;
        TempMaintenanceLedger."Document No." := '***';
        TempMaintenanceLedger.Insert;
    end;
