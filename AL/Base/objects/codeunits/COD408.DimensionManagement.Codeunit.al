...
{
    // PR2.00
    //   ShowDefaultDim - modify for dimensions 1 and 2
    //   SetupObjectNoList - modify for Process Setup
    // 
    // PR3.10
    //   Update for Attain 3.10
    // 
    // PR3.61
    //   Add function UpdateTempJnlLineDefaultDim
    // 
    // PR3.70.03
    //   Add accrual plan dimensions
    // 
    // PR3.70.05
    // P8000063A, Myers Nissi, Jack Reynolds, 24 JUN 04
    //   SetupObjectNoList - change Dimensions property for local variable TableIDArray
    // 
    // PR3.70.10
    ...
    // 
    // PR4.00.02
    // P8000288A, VerticalSoft, Jack Reynolds, 08 FEB 06
    //   SetupObjectNoList - correct incorrect array indices
    // 
    // PR4.00.04
    // P8000333A, VerticalSoft, Jack Reynolds, 05 MAY 06
    //   Add support for Asset and PM Order tables
    // 
    // P8000335A, VerticalSoft, Jack Reynolds, 20 SEP 06
    //   New function to add work order dimensions to dimension buffer
    // 
    // PR4.00.05
    // P8000413A, VerticalSoft, Jack Reynolds, 02 APR 07
    //   ShowDefaultDim has been removed from SP3 but is required for P800 so it has been retained as P800 function
    // 
    // PR4.00.06
    // P8000484A, VerticalSoft, Jack Reynolds, 05 JUN 07
    //   Fix problem in TypeToTableID3 that had ignored Accrual Plans
    // 
    // PRW16.00.01
    // P8000729, VerticalSoft, Jack Reynolds, 18 SEP 09
    //   Fix problem with container lines on sales orders
    // 
    // PRW16.00.06
    // P8001048, Columbus IT, Don Bresee, 23 MAR 12
    //   Save and restore temp table filters in UpdateTempJnlLineDefaultDim
    // 
    // PRW17.00
    ...
    //
    // PRW118.05
    // P800142669, To Increase, Gangabhushan, 16 MAR 22
    //   CS00213711 | Commissions not allowing to set default dimensions      
    ...
    procedure TypeToTableID1(Type: Option "G/L Account",Customer,Vendor,"Bank Account","Fixed Asset","IC Partner",Employee,,"Accrual Plan") TableId: Integer
    begin
        case Type of
            Type::"G/L Account":
    ...
    [Obsolete('Replaced by procedures SalesLineTypeToTableID() or PurchLineTypeToTableID()', '20.0')]
        procedure TypeToTableID3(LineType: Option " ","G/L Account",Item,Resource,"Fixed Asset","Charge (Item)",,,Container,"Accrual Plan") TableId: Integer
    begin
    ...
    begin
        // P8000484A - extend options for Type to include Accrual Plan
        // P8000729 - add option for Type to include Container
        case LineType of
            "Sales Line Type"::" ":
                exit(0);
            ...
            // P8000729
            "Sales Line Type"::FOODContainer:
                exit(DATABASE::Item);
            // P8000729
            // P8000484A
            "Sales Line Type"::FOODAccrualPlan:
                exit(DATABASE::"Accrual Plan");
            // P8000484A
        end;
    ...
    begin
        case LineType of
            ...
            "Sales Line Type"::"Charge (Item)":
                exit(DATABASE::"Item Charge");
            // P8000729
            "Purchase Line Type"::FOODContainer:
                exit(DATABASE::Item);
            // P8000729
            // P8000484A
            "Purchase Line Type"::FOODAccrualPlan:
                exit(DATABASE::"Accrual Plan");
            // P8000484A
        end;
    ...
    begin
        ...
        DefaultDimInsertTempObject(TempAllObjWithCaption, DATABASE::"Process Setup"); // P8000288A, P80053245
    ...
    begin
        ...
        Result := TableID in [0, Database::"Accrual Plan"]; // P800142669
    ...
    procedure ShowDefaultDim(TableID: Integer; No: Code[20]; var ShortcutDimCode: array[8] of Code[20])
    var
        DefaultDim: Record "Default Dimension";
        i: Integer;
    begin
        // P8000413A
        GetGLSetup(GLSetupShortcutDimCode); // P800131478
