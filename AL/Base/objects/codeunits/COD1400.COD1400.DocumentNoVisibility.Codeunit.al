codeunit 1400 DocumentNoVisibility
{
    ...
    //   Support for maintenance work orders
    SingleInstance = true;
    ...
    var
        ...
        IsWorkOrderNoInitialized: Boolean;
        WorkOrderNoVisible: Boolean;
    ...
    procedure WorkOrderNoIsVisible(DocNo: Code[20]): Boolean
    var
        NoSeriesCode: Code[20];
    ...
    begin
        ...
        if IsWorkOrderNoInitialized then
            exit(WorkOrderNoVisible);
        IsWorkOrderNoInitialized := true;

        MaintSetup.Get;
        NoSeriesCode := MaintSetup."Work Order Nos.";
        WorkOrderNoVisible := ForceShowNoSeriesForDocNo(NoSeriesCode);
        exit(WorkOrderNoVisible);
    end;
