codeunit 5750 "Whse.-Create Source Document"
{
    ...
    // ID          Date        Description
    // --------------------------------------------------------------------------------
    // N138F0000 , 07-11-2014, Initial Version
    // --------------------------------------------------------------------------------
    // 
    // PR5.00
    ...
    begin
        ...
        with WhseShptLine do begin
            InitNewLine(WhseShptHeader."No.", UserInteraction); // P80053245
            ...
            // IF "Location Code" = WhseShptHeader."Location Code" THEN                               // P8001290
            if ("Location Code" = WhseShptHeader."Location Code") and (not IsNonWarehouseItem()) then // P8001290
    ...
    begin
        ...
        WhseReceiptLine.InitNewLine(WhseReceiptHeader."No.", UserInteraction); // P80053245
        ...
        // IF "Location Code" = WhseReceiptHeader."Location Code" THEN                               // P8001290
        if (WhseReceiptLine."Location Code" = WhseReceiptHeader."Location Code") and (not WhseReceiptLine.IsNonWarehouseItem()) then // P8001290
    ...
    begin
        ...
        WhseShptLine.InitNewLine(WhseShptHeader."No.", UserInteraction); // P80053245
    ...
    begin
        ...
        with WhseReceiptLine do begin
            InitNewLine(WhseReceiptHeader."No.", UserInteraction); // P80053245
            SetSource(DATABASE::"Purchase Line", PurchLine."Document Type".AsInteger(), PurchLine."Document No.", PurchLine."Line No.");
            PurchLine.TestField("Unit of Measure Code");
            SetItemData(
              PurchLine."No.", PurchLine.Description, PurchLine."Description 2", PurchLine."Location Code",
            ...
            // IF "Location Code" = WhseReceiptHeader."Location Code" THEN                               // P8001290
            if ("Location Code" = WhseReceiptHeader."Location Code") and (not IsNonWarehouseItem()) then // P8001290
    ...
    begin
        with WhseShptLine do begin
            ...
            //N138F0000.sn
            if UserInteraction then begin
                if TempWhseShptLine.FindLast then;
                if WhseShptLine."Line No." > TempWhseShptLine."Line No." then
                    LineNo := WhseShptLine."Line No."
                else
                    LineNo := TempWhseShptLine."Line No." + 10000;
                TempWhseShptLine := WhseShptLine;
                TempWhseShptLine."Line No." := LineNo;
    ...
    begin
        ...
        with WhseShptLine do begin
            ...
            "Assigned User ID" := WhseShptHeader."Assigned User ID"; // P8001323
        end;
    end;
