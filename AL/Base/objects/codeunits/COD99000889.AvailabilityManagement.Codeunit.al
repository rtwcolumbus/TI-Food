codeunit 99000889 AvailabilityManagement
{
    ...
    begin
        ...
        // P8001083
        LotStatusMgmt.SetInboundExclusions(Item, LotStatus.FieldNo("Available for Sale"),
          ExcludePurch, ExcludeSalesRet, ExcludeOutput);
        AvailToPromise.SetAvailableFor(LotStatusExclusionfilter, ExcludePurch, ExcludeSalesRet, ExcludeOutput);
        // P8001083
                    ...
                    case "Source Type" of
                        "Source Type"::Sales:
                            begin
                                ...
                                LotStatusMgmt.SetInboundExclusions(Item, LotStatus.FieldNo("Available for Sale"),
                                  ExcludePurch, ExcludeSalesRet, ExcludeOutput);
                                CapableToPromise.SetAvailableFor(LotStatusExclusionfilter, ExcludePurch, ExcludeSalesRet, ExcludeOutput);
                                // P8001083
