codeunit 364 "PostPurch-Delete"
{
    ...
    begin
        ...
        if P800Fns.AltQtyInstalled then                                                          // P8000198A
            AltQtyMgt.DeletePostedDocEntries(DATABASE::"Purch. Rcpt. Line", PurchRcptHeader."No."); // P8000198A
    ...
    begin
        ...
        if P800Fns.AltQtyInstalled then                                                        // P8000198A
            AltQtyMgt.DeletePostedDocEntries(DATABASE::"Purch. Inv. Line", PurchInvHeader."No."); // P8000198A
    ...
    begin
        ...
        if P800Fns.AltQtyInstalled then                                                               // P8000198A
            AltQtyMgt.DeletePostedDocEntries(DATABASE::"Purch. Cr. Memo Line", PurchCrMemoHeader."No."); // P8000198A
    ...
    begin
        ...
        if P800Fns.AltQtyInstalled then                                                              // P8000198A
            AltQtyMgt.DeletePostedDocEntries(DATABASE::"Return Shipment Line", ReturnShptHeader."No."); // P8000198A
