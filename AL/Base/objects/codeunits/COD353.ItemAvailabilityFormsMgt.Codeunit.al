codeunit 353 "Item Availability Forms Mgt"
{
    ...
    //   Fix problem with Lot Status and drill down on Item Availability
    // 
    // PRW18.00
    ...
    var
        ...
        AvailabilityType: Option Date,Variant,Location,Bin,"Event",BOM,UOM,Lot;
        QtyByUnitOfMeasure: Decimal;
        AvailabilityContext: Code[12];
    ...
    begin
        with Item do begin
            ItemTrackingCode := "Item Tracking Code"; // P8001132
            Init();
            "Item Tracking Code" := ItemTrackingCode; // P8001132
            CalcFields(
              "Qty. on Purch. Order",
              "Qty. on Sales Order",
    ...
    begin
        ...
        // P8001083
        PlannedOrderReceiptTotal :=
          ItemTotal."Planned Order Receipt (Qty.)" +
          ItemTotal."Purch. Req. Receipt (Qty.)";
        ScheduledReceiptTotal :=
          ItemTotal."FP Order Receipt (Qty.)" +
          ItemTotal."Rel. Order Receipt (Qty.)" +
          ItemTotal."Qty. on Purch. Order" +
          ItemTotal."Qty. in Transit" +
          ItemTotal."Trans. Ord. Receipt (Qty.)" +
          ItemTotal."Qty. on Sales Return"; // P8001352
        PlannedOrderReleasesTotal :=
          ItemTotal."Planned Order Release (Qty.)" +
          ItemTotal."Purch. Req. Release (Qty.)";
        // P8001083
    end;
    ...
    begin
        ...
        AvailableMgt.SetAvailableFor(LotStatusExclusionFilter, ExcludePurch, ExcludeSalesRet, ExcludeOutput); // P8001132
    ...
    begin
        ...
        // P8001132
        if What in [Item.FieldNo("Qty. in Transit"), Item.FieldNo("Trans. Ord. Receipt (Qty.)")] then
    ...
    begin
        ...
        ItemAvailLineList.InitLotStatus(ItemTotal, LotStatusExclusionFilter, ExcludePurch, ExcludeSalesRet, ExcludeOutput); // P8001158
    ...
    procedure ShowItemAvailFromSalesLine(var SalesLine: Record "Sales Line"; AvailabilityType: Option Date,Variant,Location,Bin,"Event",BOM,UOM,Lot)
    var
        Item: Record Item;
    ...
    begin
        with SalesLine do begin
            ...
            case AvailabilityType of
                ...
                AvailabilityType::Lot:
                    ShowItemAvailByLot(Item);
            end;
        end;
    end;

    procedure ShowItemAvailFromPurchLine(var PurchLine: Record "Purchase Line"; AvailabilityType: Option Date,Variant,Location,Bin,"Event",BOM,UOM,Lot)
    var
        Item: Record Item;
        NewDate: Date;
        NewVariantCode: Code[10];
    ...
    procedure ShowItemAvailFromProdOrderComp(var ProdOrderComp: Record "Prod. Order Component"; AvailabilityType: Option Date,Variant,Location,Bin,"Event",BOM,UOM,LOT)
    var
        Item: Record Item;
        NewDate: Date;
        NewVariantCode: Code[10];
    ...
    begin
        with ProdOrderComp do begin
            ...
            AvailabilityContext := 'CONSUMPTION'; // P8001132
    ...
    procedure ShowItemAvailFromTransLine(var TransLine: Record "Transfer Line"; AvailabilityType: Option Date,Variant,Location,Bin,"Event",BOM,UOM,Lot)
    var
        Item: Record Item;
        NewDate: Date;
        NewVariantCode: Code[10];
    ...
    begin
        with TransLine do begin
            ...
            AvailabilityContext := 'TRANSFER'; // P8001132
    ...
    procedure ShowItemAvailFromWhseActivLine(var WhseActivLine: Record "Warehouse Activity Line"; AvailabilityType: Option Date,Variant,Location,Bin,"Event",BOM,UOM,Lot)
    var
        Item: Record Item;
        NewDate: Date;
        NewVariantCode: Code[10];
    ...
    begin
        with WhseActivLine do begin
            ...
            if "Activity Type" in ["Activity Type"::Pick, "Activity Type"::"Invt. Pick"] then
                case "Source Type" of
                    DATABASE::"Sales Line":
                        if "Source Subtype" in [SalesLine."Document Type"::Order, SalesLine."Document Type"::Invoice] then
                            AvailabilityContext := 'SALE';
                    DATABASE::"Purchase Line":
                        if "Source Subtype" in [PurchLine."Document Type"::"Credit Memo", PurchLine."Document Type"::"Return Order"] then
                            AvailabilityContext := 'PURCHASE';
                    DATABASE::"Prod. Order Component":
                        AvailabilityContext := 'CONSUMPTION';
                    DATABASE::"Transfer Line":
                        AvailabilityContext := 'TRANSFER';
                end;
            // P8001083
    ...
    procedure ShowItemAvailFromItemJnlLine(var ItemJnlLine: Record "Item Journal Line"; AvailabilityType: Option Date,Variant,Location,Bin,"Event",BOM,UOM,Lot)
    var
        Item: Record Item;
        NewDate: Date;
        NewVariantCode: Code[10];
        ...
        with ItemJnlLine do begin
            ...
            case "Entry Type" of
                ...
                "Entry Type"::"Negative Adjmt.":
                    AvailabilityContext := 'ADJUSTMENT';
    ...
    procedure ShowItemAvailFromInvtDocLine(var InvtDocLine: Record "Invt. Document Line"; AvailabilityType: Option Date,Variant,Location,Bin,"Event",BOM,,Lot)
    var
        Item: Record Item;
        NewDate: Date;
        NewVariantCode: Code[10];
...
#pragma warning restore AA0139
    ...
    begin
        ...
        ItemAvailByEvent.SetContext(AvailabilityContext); // P8001144
    ...
    begin
        ...
        ItemAvailByLoc.SetContext(AvailabilityContext); // P8001132
    ...
    begin
        ...
        ItemAvailByPeriods.SetContext(AvailabilityContext); // P8001132
    ...
    begin
        ...
        ItemAvailByVariant.SetContext(AvailabilityContext); // P8001132
    ...
    local procedure ShowItemAvailByLot(var Item: Record Item)
    var
        ItemAvailByLot: Page "Item Availability by Lot No.";
    begin
        ItemAvailByLot.SetContext(AvailabilityContext);
        ItemAvailByLot.SetRecord(Item);
        ItemAvailByLot.SetTableView(Item);
        ItemAvailByLot.Run();
    end;
    ...
    begin
        ItemAvailByBOMLevel.SetContext(AvailabilityContext); // P8001144
        if FieldCaption <> '' then
    ...
    procedure ByLot(): Integer
    begin
        exit(AvailabilityType::Lot);
    end;

    procedure SetAvailableFor(ExclusionFilter: Text[1024]; Purch: Boolean; SalesRet: Boolean; Output: Boolean)
    begin
        // P8001132
        LotStatusExclusionFilter := ExclusionFilter;
        ExcludePurch := Purch;
        ExcludeSalesRet := SalesRet;
        ExcludeOutput := Output;
    end;

    procedure GetTotals(var Item: Record Item; var PlannedOrderReleases: Decimal; var PlannedOrderReceipt: Decimal; var ScheduledReceipt: Decimal)
    begin
        // P8001132
        Item := ItemTotal;
        PlannedOrderReleases := PlannedOrderReleasesTotal;
        PlannedOrderReceipt := PlannedOrderReceiptTotal;
        ScheduledReceipt := ScheduledReceiptTotal;
    end;
