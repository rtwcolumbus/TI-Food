codeunit 86 "Sales-Quote to Order"
{
    ...
    //   Calculate accruals for orders that are created
    // 
    // PRW18.00
    ...
    begin
        ...
        with SalesHeader do begin
            ...
            SalesOrderHeader.CreateOrderAllowance; // P80053245
        ...
        if SalesQuoteLine.FindSet() then
            repeat
                ...
                if not IsHandled then begin
                    ...
                    SalesOrderLine.GetLotNo; // P8000043A, P8001352
                    ...
                    if ProcessFns.TrackingInstalled then                         // P8000153A, P8001352
                        LotSpecFns.CopyLotPrefCustomerToSalesLine(SalesOrderLine); // P8000153A, P8000210A, P8001352
                end;
