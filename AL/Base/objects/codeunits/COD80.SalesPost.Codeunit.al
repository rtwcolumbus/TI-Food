codeunit 80 "Sales-Post" // Version: FOODNA
{
    ...
    begin
        ...
        PostingLocation := SavedPostingLocationCode; // P8006603
        OnCodeGetPostingLocation(PostingLocation); // P800162917
        ...
        with SalesLine do begin
            ...
            if not IsHandled then
                if (ReturnRcptHeader."No." <> '') and ("Return Receipt No." = '') and not RoundingLineInserted then
                    InsertReturnReceiptLine(ReturnRcptHeader, SalesLine, CostBaseAmount, SalesHeader, PostAsItem); // P8007748
                            ...
                            if Abs(SalesLineToShip."Qty. to Ship") > Abs(QtyToInvoice) + Abs(TempPostedATOLink."Assembled Quantity") then
                                ItemLedgShptEntryNo :=
                                  PostItemJnlLine(
                                    ...
                                    SalesLineToShip."Qty. to Ship (Alt.)" - QtyToInvoiceAlt, // PR3.60, P80060684
                                    0, 0, 0, 0, '', DummyTrackingSpecification, false, PostAsItem); // PR3.60, P8007748
                    end;
            	end;
            end else
    ...
    begin
        ...
        with TempItemChargeAssgntSales do begin
            ...
            ItemJnlLine2.Amount := "Amount to Handle" *                                                // P8000971
...
#pragma warning restore AA0005
    ...
    begin
        ...
        ShouldProcessShipmentRelation := PostAsItem and (SalesLine."Qty. to Ship" <> 0); // PR3.61
	    ...
	    if WhseShip and (SalesLine.Type = SalesLine.Type::Item) then // P8001323
    ...
    local procedure InsertReturnReceiptLine(ReturnRcptHeader: Record "Return Receipt Header"; SalesLine: Record "Sales Line"; CostBaseAmount: Decimal; var SalesHeader: Record "Sales Header"; PostAsItem: Boolean)
    var
        ReturnRcptLine: Record "Return Receipt Line";
        IsHandled: Boolean;
    begin
    ...
    procedure PostItemTrackingForReceipt(SalesHeader: Record "Sales Header"; SalesLine: Record "Sales Line"; TrackingSpecificationExists: Boolean; var TempTrackingSpecification: Record "Tracking Specification" temporary; PostAsItem: Boolean)
    var
        ItemEntryRelation: Record "Item Entry Relation";
        ReturnRcptLine: Record "Return Receipt Line";
        SalesShptLine: Record "Sales Shipment Line";
    ...
    [Obsolete('Replaced by event OnCodeGetPostingLocation', 'FOOD-22')] // P800162917
    ...
    // P800162917
    [IntegrationEvent(false, false)]
    local procedure OnCodeGetPostingLocation(var PostingLocation: Code[10])
    begin
    end;
