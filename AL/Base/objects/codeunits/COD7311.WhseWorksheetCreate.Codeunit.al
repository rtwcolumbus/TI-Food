codeunit 7311 "Whse. Worksheet-Create"
{
    ...
    //   Add FindLastWhseWkshLine to FindWhseStagedPickLine
    ...
    procedure FromWhseStagedPickLine(WhseWkshTemplateName: Code[10]; WhseWkshName: Code[10]; LocationCode: Code[10]; WhseStagedPickLine: Record "Whse. Staged Pick Line"): Boolean
    var
        WhseWkshLine: Record "Whse. Worksheet Line";
    begin
        // P8000322A
        with WhseStagedPickLine do begin
            WhseWkshLine.SetCurrentKey(
              "Whse. Document Type", "Whse. Document No.", "Whse. Document Line No.");
            WhseWkshLine.SetRange("Whse. Document Type", WhseWkshLine."Whse. Document Type"::FOODStagedPick);
            WhseWkshLine.SetRange("Whse. Document No.", "No.");
            WhseWkshLine.SetRange("Whse. Document Line No.", "Line No.");
            if WhseWkshLine.Find('-') then
                exit;

            FindLastWhseWkshLine(WhseWkshLine, WhseWkshTemplateName, WhseWkshName, LocationCode); // P8001301
            ...
            WhseWkshLine.Description := Description;
            WhseWkshLine."Due Date" := "Due Date";
            WhseWkshLine."Qty. Handled" := "Qty. Staged" + "Pick to Stage Qty.";
            WhseWkshLine."Qty. Handled (Base)" := "Qty. Staged (Base)" + "Pick to Stage Qty. (Base)";
            WhseWkshLine.Validate(Quantity, "Qty. to Stage");
            WhseWkshLine."To Zone Code" := "Zone Code";
            WhseWkshLine."To Bin Code" := "Bin Code";
            WhseWkshLine."Shelf No." := "Shelf No.";
            WhseWkshLine."Whse. Document Type" := WhseWkshLine."Whse. Document Type"::FOODStagedPick;
            WhseWkshLine."Whse. Document No." := "No.";
            WhseWkshLine."Whse. Document Line No." := "Line No.";
