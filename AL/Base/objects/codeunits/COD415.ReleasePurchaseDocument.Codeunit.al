codeunit 415 "Release Purchase Document"
{
    ...
    begin
        ...
        CheckMandatoryFields(PurchLine, PurchaseHeader);
    end;

    local procedure CheckMandatoryFields(var PurchaseLine: Record "Purchase Line"; PurchaseHeader: Record "Purchase Header")
    var
        Item: Record "Item";
        IsHandled: Boolean;
    begin
        ...
        if PurchaseLine.FindSet() then
            repeat
                ...
                // P8000935
                if PurchSetup."Check COO at Order Release" and PurchaseLine.IsInventoriableItem then // P8001213
                    if ProcessFns.TrackingInstalled then
                        P800Tracking.CheckPurchLineCOO(PurchaseLine);
                // P8000935
                PurchaseLine.TestApprovedItem(PurchaseHeader."Allow Unapproved Items"); // P8001230
