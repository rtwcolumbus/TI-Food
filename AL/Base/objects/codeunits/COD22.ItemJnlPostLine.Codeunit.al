...
{
    // PR2.00
    //   Modify expiration date checking
    //   Add release date checking
    //   Create Lot No. Information record
    //   Support for physical count with item tracking
    // 
    // PR3.10
    //   Consumption Journal now contained in Item Journal
    // 
    // PR3.60
    //   Add logic for alternate quantities
    //   Add call to UpdateSalesDocFlag when adding value entries
    // 
    // PR3.60.02
    //   Fix problem with inserting extra physical ledger entries
    // 
    // PR3.60.03
    //   Fix problem with alternate quantity checking in PostItem
    // 
    // PR3.61
    //   Add logice for alt. qty. on transfers
    //   Add logic for physical counts with item tracking
    //   Add logic for container tracking
    // 
    // PR3.61.01
    //   Fix problem with costing for physical count and item tracking
    //   Fix problem with checking base quantity for negative quantities
    //   Fix problems with transfers and alternate quantities
    // 
    // PR3.61.02
    //   Fix permission problem with alt. quantity
    //   Fix alternate quantity problem with "undo" transactions
    // 
    // PR3.61.03
    //   Fix error message reference to Alt. Qty. instead of Quantity
    // 
    // PR3.70
    //   Integration of P800 into 3.70
    //   Allow adjustments to slide through for blocked items
    //   Fix problem with physical inventory ledger not being updated if Tracking granule is not licensed
    // 
    // PR3.70.01
    //   When posting output if the gen prod posting group is blank on the prod order then get from item
    //     being produced
    //   Allow Loose Lot Control when posting lot tracked items
    //   Extra Charges
    // 
    // PR3.70.03
    //   Modified PostFlushedConsump Function
    ...
    //   RunWithCheck - blank Lot no. from item journal line
    // 
    // PR3.70.05
    // P8000062B, Myers Nissi, Jack Reynolds, 21 JUN 04
    //   InsertValueEntry - move extra charges to value entry before posting cost to G/L
    // 
    // PR3.70.06
    // P8000078A, Myers Nissi, Steve Post, 03 AUG 04
    //   added Exclude from sales forecast to InitItemLedgEntry
    // 
    // P8000089A, Myers Nissi, Jack Reynolds, 18 AUG 04
    //   InsertItemLedgeEntry - restore original code that prohibits consumption from allowing inventory to go negative
    // 
    // P8000101A, Myers Nissi, Jack Reynolds, 25 AUG 04
    //   PostConsumption - bypass alternate quantity check if rounding entry
    // 
    // P8000102A, Myers Nissi, Jack Reynolds, 25 AUG 04
    //   InsertValueEntry - use costing quantity when setting valued quantity for rounding entries
    // 
    // P8000114A, Myers Nissi, Jack Reynolds, 10 SEP 04
    //   CalcAdjustedCost - if the costing quantity is zero then set costs to zero
    // 
    // PR3.70.07
    // P8000122A, Myers Nissi, Jack Reynolds, 24 SEP 04
    //   PostConsumption - skip alternate quantity check of base quantity for revaluation lines
    // 
    // P8000138A, Myers Nissi, Jack Reynolds, 28 OCT 04
    //   Integrate 3.70 Service Pack 2
    // 
    // P8000139A, Myers Nissi, Jack Reynolds, 29 OCT 04
    //   UpdateItemLedgEntry - update "Invoiced Quantity (Alt.)" when item is not costed in alternate units
    // 
    // P8000140A, Myers Nissi, Jack Reynolds, 19 NOV 04
    //   Code - call container function to post to container ledger
    // 
    // PR3.70.08
    // P8000166A, Myers Nissi, Jack Reynolds, 11 JAN 05
    //   InsertConsumpEntry - don't call RemoveExcessAltQty for revaluation entries
    // 
    // P8000184A, Myers Nissi, Jack Reynolds, 15 FEB 05
    //   InsertItemLedgEntry - test alternate quantity as well as quantity for open entries
    // 
    // PR3.70.09
    // P8000205A, Myers Nissi, Jack Reynolds, 09 MAR 05
    //   CalcAdjustedCost - check costing quantity before dividing to calculate adjusted costs
    // 
    // PR3.70.10
    ...
    //   UpdateAdjmtProp - if entry is for shared component then update adjustment property on all production order lines
    // 
    // P8000275A, VerticalSoft, Jack Reynolds, 29 DEC 05
    //   Fix problem setting invoiced quantity on value entries
    // 
    // P8000277A, VerticalSoft, Jack Reynolds, 04 JAN 06
    //   Fix problem setting Output Completely Invd. Date on item application entry
    // 
    // P8000281A, VerticalSoft, Jack Reynolds, 24 JAN 06
    //   Fix problem with no lot number for lot tracked items
    // 
    // PR4.00.02
    // P8000287A, VerticalSoft, Jack Reynolds, 08 FEB 06
    //   Add call to Process 800 codeunit to transfer P800 fields to item ledger
    // 
    // PR4.00.03
    ...
    //   Maintain cost of linked maintenence ledger entries
    // 
    // P8000374A, VerticalSoft, Jack Reynolds, 07 SEP 06
    //   Don't apply entry if Don't Apply flag set on item journal line
    // 
    // P8000375A, VerticalSoft, Jack Reynolds, 07 SEP 06
    //   InsertValueEntry - call function to insert ABC Cost Detail
    // 
    // P8000335A, VerticalSoft, Jack Reynolds, 20 SEP 06
    //   New function to return item register
    // 
    // PR4.00.05
    // P8000430A, VerticalSoft, Jack Reynolds, 16 JAN 07
    //   RunWithCheck - don't blank lot number if item charge number exists
    // 
    // PR4.00.06
    // P8000487A, VerticalSoft, Jack Reynolds, 12 JUN 07
    //   Fix problem with reference to G/L entry number in value entry records
    // 
    // P8000496A, VerticalSoft, Jack Reynolds, 10 AUG 07
    //   Support for repack orders
    // 
    // PR5.00
    // P8000466A, VerticalSoft, Jack Reynolds, 15 JUN 07
    //   Fix from P8000487A has been removed
    //   Maintain "Shipped Qty. Not Ret. (alt.)"
    // 
    // P8000494A, VerticalSoft, Don Bresee, 18 JUL 07
    //   Add "Override Loose Lot Control"
    // 
    // PRW15.00.01
    // P8000538A, VerticalSoft, Jack Reynolds, 22 OCT 07
    //   check for alternate quantity lines with non-zero quantity and zero alternate quantity
    // 
    // P8000540A, VerticalSoft, Don Bresee, 01 NOV 07
    //   Convert consumption bin contents to required UOM
    // 
    // P8000541A, VerticalSoft, Jack Reynolds, 05 NOV 07
    //   Fix problem with MoveApplication with alternate quantities
    // 
    // P8000542A, VerticalSoft, Jack Reynolds, 05 NOV 07
    //   Fix problem with checks for inbound and outbound bins when called by adjust cost
    // 
    // P8000552A, VerticalSoft, Don Bresee, 12 DEC 07
    //   Use Reserved Quantity (Alt.) in application process
    // 
    ...
    // 
    // P8000594A, VerticalSoft, Don Bresee, 02 APR 08
    //   Rework Whse UOM conversion on cunsumption posting
    // 
    ...
    // 
    // PRW15.00.03
    // P8000635, VerticalSoft, Jack Reynolds, 27 OCT 08
    //   Fix problem Setting Cost is Adjusted for shared components
    // 
    // P8000631A, VerticalSoft, Don Bresee, 12 JAN 09
    //   Add Central Container Bin
    // 
    // PRW16.00.01
    // P8000670, VerticalSoft, Jack Reynolds, 29 JAN 09
    //   Fix problem of consuming shared component against output of same order
    // 
    // PRW16.00.02
    // P8000747, VerticalSoft, Don Bresee, 24 NOV 09
    //   Update Lot Card with new expiration date
    // 
    // P8000756, VerticalSoft, Jack Reynolds, 08 JAN 10
    //   ApplyItemLedgEntry - new code requires modifications for alternate quantity
    // 
    // PRW16.00.04
    ...
    // 
    // P8000899, Columbus IT, Jack Reynolds, 11 MAR 11
    //   Support for validating lot freshness
    // 
    // PRW16.00.05
    ...
    // 
    // P8001046, Columbus IT, Don Bresee, 23 MAR 12
    //   Fix issue with Rounding Adjmts. (Fixed Alt. Qty. Adjustments where Quantity is zero)
    // 
    // P8001067, Columbus IT, Don Bresee, 09 MAY 12
    //   Add special Rounding Adjmts. logic for transfer entries
    // 
    // P8001069, Columbus IT, Don Bresee, 11 MAY 12
    //   Bypass check for alt. qty. lines for rounding adjustments
    // 
    ...
    //   Add "Supplier Lot No." to lot posting, split line logic
    // 
    // P8001082, Columbus IT, Don Bresee, 15 JAN 13
    //   Update Pre-Process Per Order Blending Activities when Output is posted
    // 
    // P8001128, Columbus IT, Don Bresee, 15 JAN 13
    //   Change handling of Prod. Order Line quantities when Output is posted
    // 
    // PRW17.00
    // P8001134, Columbus IT, Don Bresee, 16 FEB 13
    //   Add logic for handling of new "Order Type" options
    // 
    // P8001143, Columbus IT, Don Bresee, 13 MAR 13
    //   Add new field "Sales Quantity" for pricing quantity on sales invoicing entries
    // 
    ...
    // 
    // PRW17.00.01
    // P8001192, Columbus IT, Jack Reynolds, 09 AUG 13
    ...
    //   Add ResetItemReg routine for Adjust Cost Job
    // 
    // PRW17.10.02
    ...
    // 
    // PRW18.00.02
    // P8004479, To-Increase, Jack Reynolds, 22 OCT 15
    //   Fix problem with overhead rate for SKUs
    // 
    // PRW19.00
    // P8004516, To-Increase, Jack Reynolds, 9 NOV 15
    //   Refactoring of CheckIsCyclicalLoop
    // 
    ...
    // 
    // PRW110.0.01
    // P80037519, To-Increase, Dayakar Battini, 17 MAY 17
    //   Fix container removal issue when more than outstanding quantity
    // 
    // P80041198, To-Increase, Jack Reynolds, 08 MAY 17
    //   General changes and refactoring for NAV 2017 CU7
    // 
    // P80041717, To-Increase, Dayakar Battini, 13 JUN 17
    //   Fix issue with wrong Item Jnl quantity
    // 
    // PRW110.0.02
    // P80043524, To-Increase, Jack Reynolds, 12 JUL 17
    //   Fix alternagte quantity problem with UndoQuantityPosting
    // 
    ...
    //   Set Applied entries to Adjust for BOM Orders
    // 
    // P80052671, To-Increase, Dayakar Battini, 06 FEB 18
    //   Correct handling of Altqty to remove when QtyPosting with containers.
    // 
    // PRW111.00
    ...
    // 
    // P80071900, To-Increase, Gangabhushan, 01 APR 19
    //   TI-12934 - The container line is missing the alternate quantity in Output Journal
    // 
    // PRW111.00.03
    // P80079197, To-Increase, Gangabhushan, 18 JUL 19
    //   TI-13290-Request for New Events
    //
    // P80093156, To Increase, Gangabhushan, 21 FEB 20
    //   CS00093580 - Container output issue from Output Journals posting
    // 
    // PRW113.00
    ...
    //
    // PRW118.05
    // P800140944, To Increase, Gangabhushan, 11 MAR 22
    //   CS00210747 | Undo Receipt does not update the ILE Remaining Qty alt value on the original ILE
    //
    // PRW119.03
    // P800145506, To Increase, Gangabhushan, 25 MAY 22
    //   Container Line Quantity is not getting updated properly when we use UOM other then Base UOM 
    //
    // P800122712, To Increase, Gangabhushan, 25 MAY 22
    //   Quality Control Samples
    //
    // PRW120.02
    // P800147498, To Increase, Gangabhushan, 19 JUL 22
    //   CS00221794 | Add A Subscription Event
    //
    // PRW121.02
    // P800164365, To Increase, Gangabhushan, 21 FEB 23
    //   CS00223981 | Sub-lot creation from a container lot status change results in an error
    ...
    var
        ...
        P800CreateWhseAct: Codeunit "Process 800 Create Whse. Act.";
        RoundingAdjmtMgmt: Codeunit "Rounding Adjustment Mgmt.";
        OutputContainerExists: Boolean;
        TempContConsEntry: Record "Warehouse Entry" temporary;
        ...
        LotComboOrderNo: Code[20];
        LotComboOrderLineNo: Integer;
        BOMEntryType: Option "Non-Output",Output,"By-Product Output";
    ...
    begin
        ...
        if (not ItemJnlLine2."Phys. Inventory") and // P8000267B
          (not ItemJnlLine2.Correction)             // P8000267B
          and (ItemJnlLine2."Item Charge No." = '') // P8000430A
        then                                        // P8000043A
            ItemJnlLine2."Lot No." := '';             // P8000043A
    ...
    begin
        ...
        with ItemJnlLine do begin
            ...
            if Process800Fns.ContainerTrackingInstalled then         // P8001342
                ContainerFns.GetItemJnlContainerQuantity(ItemJnlLine); // P8001342
            ...
            if not IsHandled then
                if GlobalItemTrackingSetup.TrackingRequired() and (("Quantity (Base)" <> 0) or ("Quantity (Alt.)" <> 0)) and // P8000281A
            ...
            IF ProcessFns.AltQtyInstalled THEN // PR3.61.02
                AltQtyMgmt.InitTempAltQtyItemJnlLine(ItemJnlLine); // PR3.61.01
            ...
            then begin
                ...
                if not IsHandled then begin
                    ...
                    if IsAssemblyOutputLine() then
                        TestField("Order Line No.", 0); // PR3.60
                                                        //ELSE                           // PR3.60
                                                        //  TESTFIELD("Order Line No."); // PR3.60
                end;
            end;
            ...
            ItemJnlLineQuantity := Quantity; // P8001323
            ...
            then
                ...
                if CostInAlternateUnits then // PR4.00
                    QtyPerUnitOfMeasure := 1        // PR4.00
                else
            ...
            // P8000140A Begin
            if not "Skip Container Posting" then begin
                Item.Get("Item No.");
                if (Item."Item Type" = Item."Item Type"::Container) and
                  ProcessFns.ContainerTrackingInstalled
                then
                    ContainerFns.ItemJnlPostContainer(ItemJnlLine); // P8001133
            end;
            // P8000140A End
    ...
    begin
        ...
        while SplitItemJnlLine(ItemJnlLine, PostItemJnlLine) do
            if PostItemJnlLine or ForceContainerPosting(ItemJnlLine) then // P8001323
                Code();
    ...
    var
        ...
        IsHandled: Boolean;
    begin
        if ItemJnlLine.TrackAlternateUnits and                                              // P8000101A
          not (ItemJnlLine."Value Entry Type" in [ItemJnlLine."Value Entry Type"::Rounding, // P8000101A
            ItemJnlLine."Value Entry Type"::Revaluation])                                   // P8000122A
        then begin                                                                      // PR3.60, P8000538A
            AltQtyMgmt.CheckBaseQty(ItemJnlLine."Item No.",                               // PR3.60
              ItemJnlLine."Serial No.", ItemJnlLine."Lot No.",                             // PR3.60
              ItemJnlLine."Alt. Qty. Transaction No.",                                    // PR3.60
              ItemJnlLine.FieldCaption("Quantity (Base)"), ItemJnlLine."Quantity (Base)"); // PR3.60
                                                                                           // P8000538A
            AltQtyMgmt.CheckZeroAltQty(ItemJnlLine."Item No.",
              ItemJnlLine."Serial No.", ItemJnlLine."Lot No.",
              ItemJnlLine."Alt. Qty. Transaction No.");
        end;
        // P8000538A
    ...
    begin
        ...
        with ItemJnlLine do begin
            ...
            if Subcontracting then
                // ValuedQty := "Invoiced Quantity"                      // PR3.60
                ValuedQty := GetCostingQty(FieldNo("Invoiced Quantity")) // PR3.60
            else
            ...
            if LastOperation and ("Output Quantity" <> 0) then begin
                ...
                If not IsHandled THEN BEGIN
                    ...
                    // PR3.60
                    if MfgItem.CostInAlternateUnits then
                        Amount := "Quantity (Alt.)" * MfgUnitCost; // PR4.00
                                                                   // PR3.60
                ...
                if not IsHandled then begin
                    ...
                    if ProcessFns.ProcessInstalled() then                               // P8001082
                        PreProcessMgmt.UpdatePerOrderBlending(ProdOrderLine, ItemJnlLine); // P8001082
    ...
    begin
        ...
        if ItemJnlLine.Subcontracting then
            // InsertCapLedgEntry(CapLedgEntry, ItemJnlLine.Quantity, ItemJnlLine."Invoiced Quantity") // PR3.60
            InsertCapLedgEntry(CapLedgEntry,                                                 // PR3.60
                ItemJnlLine.GetCostingQty(ItemJnlLine.FieldNo(Quantity)), ItemJnlLine.GetCostingQty(ItemJnlLine.FieldNo("Invoiced Quantity"))) // PR3.60
        else
    ...
    begin
        ...
        with ItemJnlLine do begin
            ...
            // PR3.60
            if ("Value Entry Type" = "Value Entry Type"::"Direct Cost") and TrackAlternateUnits and (not Adjustment) then
                if ("Rounding Adjustment Type" = 0) then // P8001069
                    if "Phys. Inventory" then
                        AltQtyMgmt.CheckBaseQty("Item No.", "Serial No.", "Lot No.",
                          "Alt. Qty. Transaction No.",
                          FieldCaption("Qty. (Alt.) (Phys. Inventory)"), // PR3.61.03
                          "Qty. (Phys. Inventory)" * "Qty. per Unit of Measure")
                    else begin // P8000538A
                        AltQtyMgmt.CheckBaseQty("Item No.", "Serial No.", "Lot No.",
                          "Alt. Qty. Transaction No.", FieldCaption("Quantity (Base)"), Abs("Quantity (Base)")); // PR3.60.03, PR3.61.01
                                                                                                                 // P8000538A
            ...
            // P8000538A
            if ("Quantity (Base)" * "Quantity (Alt.)" < 0) then
                Error(Text37002000,
                      FieldCaption("Quantity (Base)"), FieldCaption("Quantity (Alt.)"));
            // PR3.60

            // IF (Quantity <> 0) AND                            // PR3.60
            if ((Quantity <> 0) or ("Quantity (Alt.)" <> 0)) and // PR3.60
               ("Item Charge No." = '') and
            ...
            then
                ...
                //IF ("Invoiced Quantity" <> 0) OR Adjustment OR                                // PR3.60
                if ("Invoiced Quantity" <> 0) or ("Invoiced Qty. (Alt.)" <> 0) or Adjustment or // PR3.60
            ...
            if "Alt. Qty. Transaction No." <> 0 then            // PR3.60
                AltQtyMgmt.DeleteItemJnlAltQtyLines(ItemJnlLine); // PR3.60

            if ("Rounding Adjustment Type" = 0) then // P8000548A
                PostRoundingAdjustments;               // P8000548A
        end;
    ...
    begin
        ...
        with ItemJnlLine do begin
            ...
            if TrackAlternateUnits and                                // P8000166A
              ("Value Entry Type" <> "Value Entry Type"::Revaluation) // P8000166A
            then                                           // PR3.60
                AltQtyMgmt.RemoveExcessAltQtys(ItemJnlLine); // PR3.60
            ...
            if "Value Entry Type" <> "Value Entry Type"::Revaluation then begin
                ...
                if Location."Bin Mandatory" and (not CalledFromInvtPutawayPick) then begin
                    ...
                    if GetItemResult and Item.IsInventoriableType() then begin
                        ...
                        ResolveProdInBinUnits(WhseJnlLine); // P8000540A
        ...
        PostItem();
        if ItemJnlLine.TrackAlternateUnits then // PR3.60
            AltQtyMgmt.RestoreExcessAltQtys;      // PR3.60
        if PostWhseJnlLine then
            // WhseJnlRegisterLine.RegisterWhseJnlLine(WhseJnlLine); // P8001039, P8007748
            PostWhseLineAndRndgAdjmts;                                         // P8001039
    ...
    begin
        with ItemJnlLine do begin
            ...
            // P8001323
            if (GlobalItemLedgEntry.Quantity < 0) or (GlobalItemLedgEntry."Quantity (Alt.)" < 0) then
                RemoveFromContainer(ItemJnlLine);
            // P8001323
            InitValueEntry(GlobalValueEntry, GlobalItemLedgEntry);

            if Item.Type = Item.Type::Inventory then begin
                GlobalItemLedgEntry."Remaining Quantity" := GlobalItemLedgEntry.Quantity;
                GlobalItemLedgEntry."Remaining Quantity (Alt.)" := GlobalItemLedgEntry."Quantity (Alt.)"; // PR3.60
                                                                                                          //GlobalItemLedgEntry.Open := GlobalItemLedgEntry."Remaining Quantity" <> 0;      // PR3.60
                GlobalItemLedgEntry.Open := (GlobalItemLedgEntry."Remaining Quantity" <> 0) or    // PR3.60
                  (GlobalItemLedgEntry."Remaining Quantity (Alt.)" <> 0);                         // PR3.60
            end else begin
                GlobalItemLedgEntry."Remaining Quantity" := 0;
                GlobalItemLedgEntry.Open := false;
            end;
            //GlobalItemLedgEntry.Positive := GlobalItemLedgEntry."Remaining Quantity" > 0;   // PR3.60
            GlobalItemLedgEntry.Positive := (GlobalItemLedgEntry."Remaining Quantity" > 0) or // PR3.60
              (GlobalItemLedgEntry."Remaining Quantity (Alt.)" > 0);                          // PR3.60
            ...
            if not "Don't Apply" then begin // P8000374A, P8000548A
                ApplyItemLedgEntry(GlobalItemLedgEntry, OldItemLedgEntry, GlobalValueEntry, false);
                RoundingAdjmtMgmt.ProcessNewEntry(ItemJnlLine, GlobalItemLedgEntry); // P8000548A, P8001039
            end;                                                                  // P8000548A
            CheckApplFromInProduction(GlobalItemLedgEntry, "Applies-from Entry");
            if (GlobalItemLedgEntry."Entry Type" = GlobalItemLedgEntry."Entry Type"::Transfer) and // PR3.61.01
              ProcessFns.AltQtyInstalled                                                           // PR3.61.02
            then                                                                                   // PR3.61.02
                AltQtyMgmt.InitTempAltQtyItemJnlLine(ItemJnlLine);                                   // PR3.61.01
            AutoTrack(GlobalItemLedgEntry, IsReserved);

            if ("Entry Type" = "Entry Type"::Transfer) and AverageTransfer then
                InsertTransferEntry(GlobalItemLedgEntry, OldItemLedgEntry, TotalAppliedQty, TotalAppliedQtyAlt); // PR3.61

            if ("Entry Type" = "Entry Type"::Transfer) and (Item.Type = Item.Type::FOODContainer) then      // P8001290
                InsertTransferEntry(GlobalItemLedgEntry, OldItemLedgEntry, GlobalItemLedgEntry.Quantity, 0); // P8001290
            ...
            InsertItemLedgEntryNeeded := (not "Phys. Inventory") or (Quantity <> 0) or ("Quantity (Alt.)" <> 0) or ("Phys. Inventory" and (ItemJnlLine."Lot No." <> '')); // PR2.00
            ...
            if InsertItemLedgEntryNeeded then begin
              ...
              // GlobalItemLedgEntry.Quantity,TRUE);                                    // PR3.60
              GlobalItemLedgEntry.Quantity, true, GlobalItemLedgEntry."Quantity (Alt.)"); // PR3.60
                OnItemQtyPostingOnAfterInsertApplEntry(ItemJnlLine, TempSplitItemJnlLine, GlobalItemLedgEntry);
            end;
            AddToContainer(ItemJnlLine); // P8001323
        end;
    ...
    begin
        ...
        with ItemJnlLine do
            // if ((Quantity <> 0) or ("Invoiced Quantity" <> 0)) and          // PR3.60
            if ((Quantity <> 0) or ("Invoiced Quantity" <> 0) or               // PR3.60
                ("Quantity (Alt.)" <> 0) or ("Invoiced Qty. (Alt.)" <> 0)) and // PR3.60
    ...
    begin
        ...
        with ItemJnlLine do begin
            if ("Value Entry Type" = "Value Entry Type"::"Direct Cost") and
               ...
               not Adjustment
            then
                // IF (Quantity = 0) AND ("Invoiced Quantity" <> 0) THEN BEGIN // PR3.60
                if (GetCostingQty(FieldNo(Quantity)) = 0) and                  // PR3.60
               (GetCostingQty(FieldNo("Invoiced Quantity")) <> 0)          // PR3.60
            then begin                                                     // PR3.60
            ...
            if (GlobalValueEntry."Valued Quantity" <= 0) and // P8000277A
               (GlobalItemLedgEntry."Quantity (Alt.)" = GlobalItemLedgEntry."Invoiced Quantity (Alt.)") and // PR4.00
    ...
    begin
        ...
        //CompItem.TESTFIELD("Rounding Precision");                                  // PR3.70.03
        CompItem.GetItemUOMRndgPrecisionError(ProdOrderComp."Unit of Measure Code"); // PR3.70.03
        ...
        with ItemJnlLine do begin
            ...
            //"Bin Code" := ProdOrderComp."Bin Code"; // P8001291
        ...
        with ValueEntry do
            if ("Valued Quantity" > 0) and not ("Expected Cost" or ItemJnlLine.Adjustment) then begin
                ...
                then begin
                    ...
                    TotalAmount := ItemJnlLine.Amount + ItemJnlLine."Discount Amount" - "Extra Charge"; // P800-MegaApp 
                    IsHandled := false;
                ...
                if "Drop Shipment" then begin
                    if LastDirectCost <> 0 then begin
                        ...
                        ItemCostMgt.FindUpdateUnitCostSKU(Item, "Location Code", "Variant Code", true, LastDirectCost, false, 0); // P8001386
                    end;
                end else begin
                    UpdateSKU := true;
    ...
    begin
        ...
        if not ItemApplnEntry.CostApplication() then begin
            ...
            // P8000466A
            ItemLedgEntry1."Remaining Quantity (Alt.)" := ItemLedgEntry1."Remaining Quantity (Alt.)" -
              ItemApplnEntry."Quantity (Alt.)";
            // P8000466A
            ItemLedgEntry1.Open := (ItemLedgEntry1."Remaining Quantity" <> 0) or // P8000466A
              (ItemLedgEntry1."Remaining Quantity (Alt.)" <> 0);                 // P8000466A
            ItemLedgEntry1.Modify();

            ItemLedgEntry2."Remaining Quantity" := ItemLedgEntry2."Remaining Quantity" + ItemApplnEntry.Quantity;
            // P8000466A
            ItemLedgEntry2."Remaining Quantity (Alt.)" := ItemLedgEntry2."Remaining Quantity (Alt.)" +
              ItemApplnEntry."Quantity (Alt.)";
            // P8000466A
            ItemLedgEntry2.Open := (ItemLedgEntry2."Remaining Quantity" <> 0) or // P8000466A
              (ItemLedgEntry2."Remaining Quantity (Alt.)" <> 0);                 // P8000466A
            ...
            if Abs(ItemLedgEntry2."Shipped Qty. Not Returned") > Abs(ItemLedgEntry2.Quantity) then
                ItemLedgEntry2.FieldError("Shipped Qty. Not Returned", Text004); // Assert - should never happen
                                                                                 // P8000466A
            ItemLedgEntry2."Shipped Qty. Not Ret. (Alt.)" := ItemLedgEntry2."Shipped Qty. Not Ret. (Alt.)" -
              Abs(ItemApplnEntry."Quantity (Alt.)");
            if Abs(ItemLedgEntry2."Shipped Qty. Not Ret. (Alt.)") > Abs(ItemLedgEntry2."Quantity (Alt.)") then
                ItemLedgEntry2.FieldError("Shipped Qty. Not Ret. (Alt.)", Text004); // Assert - should never happen
                                                                                    // P8000466A
            ItemLedgEntry2.Modify();
            ...
            if (ItemApplnEntry.Quantity > 0) or (ItemApplnEntry."Quantity (Alt.)" > 0) then // P8000466A
                if not ZeroApplication(ItemApplnEntry."Item Ledger Entry No.") then
                    ...
                    //   0, 0, ItemApplnEntry."Posting Date", ItemApplnEntry.Quantity, true); // P8000466A
                      0, 0, ItemApplnEntry."Posting Date", ItemApplnEntry.Quantity, true, ItemApplnEntry."Quantity (Alt.)"); // P8000466A
        end;
    ...
    begin
        ...
        TotalAppliedQty := 0;
        TotalAppliedQtyAlt := 0; // P8000466A
        CostApplication := false;
        if ApplyWith <> 0 then begin
            ItemLedgEntry2.Get(ApplyWith);
            if (ItemLedgEntry2.Quantity > 0) or (ItemLedgEntry2."Quantity (Alt.)" > 0) then begin // P8000466A
            ...
            if not (((ItemLedgEntry.Quantity > 0) or (ItemLedgEntry2."Quantity (Alt.)" > 0)) and // P8000466A
                                                                                                 // not(Costprovider(ItemLedgEntry))
            ...
            if ((ItemLedgEntry."Remaining Quantity" <> 0) or (ItemLedgEntry."Remaining Quantity (Alt.)" <> 0)) and
               ((ItemLedgEntry2."Remaining Quantity" <> 0) or (ItemLedgEntry2."Remaining Quantity (Alt.)" <> 0))
            then
                // P8000599A
                CostApplication := false;
            if CostApplication then
                ...
                CreateItemJnlLineFromEntry(ItemLedgEntry2, ItemLedgEntry2."Remaining Quantity", // P8000466A
                  ItemLedgEntry2."Remaining Quantity (Alt.)", ItemJnlLine);                     // P8000466A
            ...
            CreateItemJnlLineFromEntry(ItemLedgEntry, ItemLedgEntry."Remaining Quantity", // P8000466A
              ItemLedgEntry."Remaining Quantity (Alt.)", ItemJnlLine);                    // P8000466A
    ...
    var
        ...
        ValueEntry: Record "Value Entry";
    begin
        if (ItemLedgEntry.Quantity > 0) or (ItemLedgEntry."Quantity (Alt.)" > 0) then begin // P8000466A
            GlobalItemLedgEntry := ItemLedgEntry;
        ...
        if not ItemApplnEntry.CheckIsCyclicalLoop(ApplyWithItemLedgEntry, GlobalItemLedgEntry) then begin
            CreateItemJnlLineFromEntry(GlobalItemLedgEntry, GlobalItemLedgEntry.Quantity, // P8000466A
              GlobalItemLedgEntry."Quantity (Alt.)", ItemJnlLine);                        // P8000466A
            ...
            InsertApplEntry(
              ...
              // GlobalItemLedgEntry.Quantity,TRUE);                                    // P8000466A
              GlobalItemLedgEntry.Quantity, true, GlobalItemLedgEntry."Quantity (Alt.)"); // P8000466A
    ...
    begin
        ...
        // IF (ItemLedgEntry."Remaining Quantity" = 0) OR                                                    // PR3.60
        if ((ItemLedgEntry."Remaining Quantity" = 0) and (ItemLedgEntry."Remaining Quantity (Alt.)" = 0)) or // PR3.60
        ...
        repeat
            ...
            if not CausedByTransfer and not PostponeReservationHandling then begin
                ...
                if UseReservationApplication then begin
                    ...
                    AppliedAltQty := -Abs(ReservEntry."Quantity (Alt.)"); // PR3.60
                end;
            end else
                StartApplication := true;
            ...
            if StartApplication then begin
                ...
                // PR3.60, P8000552A
                if Abs(OldItemLedgEntry."Remaining Quantity (Alt.)" - OldItemLedgEntry."Reserved Quantity (Alt.)") >
                   Abs(ItemLedgEntry."Remaining Quantity (Alt.)" - ItemLedgEntry."Reserved Quantity (Alt.)")
                then
                    AppliedAltQty := ItemLedgEntry."Remaining Quantity (Alt.)" - ItemLedgEntry."Reserved Quantity (Alt.)"
                else
                    AppliedAltQty := -(OldItemLedgEntry."Remaining Quantity (Alt.)" - OldItemLedgEntry."Reserved Quantity (Alt.)");
                // PR3.60
                ...
                then
                    if not AllowProdApplication(OldItemLedgEntry, ItemLedgEntry) then begin // PR3.70
                        AppliedQty := 0;
                        AppliedAltQty := 0;                                                  // PR3.70
                    end;                                                                   // PR3.70
                if ItemJnlLine."Applies-from Entry" <> 0 then begin
                    AppliesFromItemLedgEntry.Get(ItemJnlLine."Applies-from Entry");
                    if ItemApplnEntry.CheckIsCyclicalLoop(AppliesFromItemLedgEntry, OldItemLedgEntry) then begin // P8000548A
                        AppliedQty := 0;
                        AppliedAltQty := 0;                                                                       // P8000548A
                    end;                                                                                        // P8000548A
                end;
                OnApplyItemLedgEntryOnAfterSetAppliedQtyZero(OldItemLedgEntry, ItemLedgEntry, AppliedQty);
            end;

            RoundingAdjmtMgmt.PreProcessApplQtys(                          // P8000548A
              ItemLedgEntry, OldItemLedgEntry, AppliedQty, AppliedAltQty); // P8000548A

            CheckIsCyclicalLoop(ItemLedgEntry, OldItemLedgEntry, PrevAppliedItemLedgEntry, AppliedQty, AppliedAltQty); // P8004516

            // IF AppliedQty <> 0 THEN BEGIN                        // PR3.60
            if (AppliedQty <> 0) or (AppliedAltQty <> 0) then begin // PR3.60
                if not OldItemLedgEntry.Positive and
                   ((OldItemLedgEntry."Remaining Quantity" = -AppliedQty) or              // P8000756
                     (OldItemLedgEntry."Remaining Quantity (Alt.)" = -AppliedAltQty)) and // P8000756
                ...
                UpdateOldItemLedgerEntryRemainingQuantity(OldItemLedgEntry, AppliedQty, AppliedAltQty);
                ...
                if ItemLedgEntry.Positive then begin
                    ...
                    if ItemLedgEntry."Posting Date" >= OldItemLedgEntry."Posting Date" then
                        InsertApplEntry(
                          ...
                          //OldItemLedgEntry."Entry No.",0,ItemLedgEntry."Posting Date",-AppliedQty,FALSE)              // PR3.60
                          OldItemLedgEntry."Entry No.", 0, ItemLedgEntry."Posting Date", -AppliedQty, false, -AppliedAltQty) // PR3.60
                    else
                        InsertApplEntry( // UP
                          OldItemLedgEntry."Entry No.", ItemLedgEntry."Entry No.",
                          //OldItemLedgEntry."Entry No.",0,OldItemLedgEntry."Posting Date",-AppliedQty,FALSE);              // P8000138A
                          OldItemLedgEntry."Entry No.", 0, OldItemLedgEntry."Posting Date", -AppliedQty, false, -AppliedAltQty); // P8000138A

                    if ItemApplnEntry."Cost Application" then
                        ItemLedgEntry."Applied Entry to Adjust" := true;

                    // P8000856
                    if (OldItemLedgEntry."Commodity Class Code" <> '') then
                        CommItemMgmt.InsertingItemApplForEntry(OldItemLedgEntry);
                    // P8000856
                end else begin
                    ...
                    if ProcessFns.TrackingInstalled then
                        P800ItemTracking.CheckLotUsable(GlobalItemTrackingCode, ItemLedgEntry)
                    else
                        // PR3.60 End
                        CheckPostingDateWithExpirationDate(ItemLedgEntry);

                    ItemLedgEntry."Release Date" := 0D; // PR3.60
                    ...
                    InsertApplEntry(
                      ...
                      //ItemLedgEntry."Posting Date",AppliedQty,TRUE);             // PR3.60
                      ItemLedgEntry."Posting Date", AppliedQty, true, AppliedAltQty); // PR3.60

                    if ItemApplnEntry."Cost Application" then
                        OldItemLedgEntry."Applied Entry to Adjust" := true;

                    // P8000856
                    if (ItemLedgEntry."Commodity Class Code" <> '') then
                        CommItemMgmt.InsertingItemApplForEntry(ItemLedgEntry);
                    // P8000856
                end;
                ...
                if (ItemLedgEntry."Entry Type" = ItemLedgEntry."Entry Type"::Transfer) and
                   ((AppliedQty < 0) or (AppliedAltQty < 0)) and // PR3.61.01
                ...
                then begin
                    ...
                    if AverageTransfer then begin                                                   // PR3.61
                        TotalAppliedQty := TotalAppliedQty + AppliedQty;                              // PR3.61
                        TotalAppliedQtyAlt := TotalAppliedQtyAlt + AppliedAltQty;                     // PR3.61
                    end else                                                                        // PR3.61
                        InsertTransferEntry(ItemLedgEntry, OldItemLedgEntry, AppliedQty, AppliedAltQty); // PR3.61
                end;

                // P8001067
                if (ItemLedgEntry."Rounding Adjustment Type" = ItemLedgEntry."Rounding Adjustment Type"::"Near-Zero") and
                   (OldItemLedgEntry."Entry Type" = OldItemLedgEntry."Entry Type"::Transfer) and
                   ((AppliedQty > 0) or (AppliedAltQty > 0)) and (not CausedByTransfer)
                then
                    InsertTransferEntry(OldItemLedgEntry, ItemLedgEntry, AppliedQty, AppliedAltQty);
                // P8001067

                UpdateItemLedgerEntryRemainingQuantity(ItemLedgEntry, AppliedQty, AppliedAltQty, OldItemLedgEntry, CausedByTransfer);

                ItemLedgEntry.CalcReservedQuantity();
                // if ItemLedgEntry."Remaining Quantity" + ItemLedgEntry."Reserved Quantity" = 0 then // PR3.60
                if (ItemLedgEntry."Remaining Quantity" + ItemLedgEntry."Reserved Quantity" = 0) and   // PR3.60
                   (ItemLedgEntry."Remaining Quantity (Alt.)" + ItemLedgEntry."Reserved Quantity (Alt.)" = 0) // P8000552A
                then                                                                                  // PR3.60
                    exit;

                if RoundingAdjmtMgmt.FixedAltQtyApplComplete(ItemLedgEntry) then // P8000548A
                    exit;                                                          // P8000548A
            end;
    ...
    local procedure UpdateItemLedgerEntryRemainingQuantity(var ItemLedgerEntry: Record "Item Ledger Entry"; AppliedQty: Decimal; AppliedAltQty: Decimal; var OldItemLedgEntry: Record "Item Ledger Entry"; CausedByTransfer: Boolean)
    begin
        ...
        // PR3.60
        ItemLedgerEntry."Remaining Quantity (Alt.)" := ItemLedgerEntry."Remaining Quantity (Alt.)" - AppliedAltQty;
        ItemLedgerEntry.Open := (ItemLedgerEntry."Remaining Quantity" <> 0) or (ItemLedgerEntry."Remaining Quantity (Alt.)" <> 0);
        // PR3.60
    ...
    begin
        ...
        if (OldItemLedgEntry."Remaining Quantity" <> 0) and
            (Abs(OldItemLedgEntry."Remaining Quantity") <= Abs(OldItemLedgEntry."Reserved Quantity"))
        then
            // P8001046
    ...
    local procedure UpdateOldItemLedgerEntryRemainingQuantity(var OldItemLedgerEntry: Record "Item Ledger Entry"; AppliedQty: Decimal; AppliedAltQty: Decimal)
    begin
        ...
        // PR3.60, P800140944
        OldItemLedgerEntry."Remaining Quantity (Alt.)" := OldItemLedgerEntry."Remaining Quantity (Alt.)" + AppliedAltQty;
        OldItemLedgerEntry.Open := (OldItemLedgerEntry."Remaining Quantity" <> 0) or (OldItemLedgerEntry."Remaining Quantity (Alt.)" <> 0);
        // PR3.60, P800140944
    ...
    begin
        AllowApplication :=
          ...
          ((OldItemLedgEntry."Order No." = ItemLedgEntry."Order No.") and
           (ItemLedgEntry."Order Line No." <> 0) and // P8000670, P8001132
    ...
    local procedure InsertTransferEntry(var ItemLedgEntry: Record "Item Ledger Entry"; var OldItemLedgEntry: Record "Item Ledger Entry"; AppliedQty: Decimal; AppliedAltQty: Decimal)
    var
        ...
        IsHandled: Boolean;
    begin
        // PR3.61 - added parameter for applied alternate quantity
        with ItemJnlLine do begin
            InitItemLedgEntry(NewItemLedgEntry);
            NewItemLedgEntry."Applies-to Entry" := 0;
            NewItemLedgEntry.Quantity := -AppliedQty;
            NewItemLedgEntry."Quantity (Alt.)" := -AppliedAltQty; // PR3.61
            if ("Rounding Adjustment Type" = "Rounding Adjustment Type"::"Near-Zero") then // P8001067
                RoundingAdjmtMgmt.UpdateItemTransferQtys(NewItemLedgEntry);                  // P8001067
            NewItemLedgEntry."Invoiced Quantity" := NewItemLedgEntry.Quantity;
            NewItemLedgEntry."Invoiced Quantity (Alt.)" := NewItemLedgEntry."Quantity (Alt.)"; // PR3.61
            NewItemLedgEntry."Remaining Quantity" := NewItemLedgEntry.Quantity;
            NewItemLedgEntry."Remaining Quantity (Alt.)" := NewItemLedgEntry."Quantity (Alt.)"; // PR3.61
            ...
            NewItemLedgEntry.Open := (NewItemLedgEntry."Remaining Quantity" <> 0) or    // PR3.61
              (NewItemLedgEntry."Remaining Quantity (Alt.)" <> 0);                      // PR3.61
            // P8001290
            if (Item.Type = Item.Type::FOODContainer) then begin
                NewItemLedgEntry."Remaining Quantity" := 0;
                NewItemLedgEntry.Open := false;
            end;
            // P8001290
            NewItemLedgEntry.Positive := (NewItemLedgEntry."Remaining Quantity" > 0) or // PR3.61
              (NewItemLedgEntry."Remaining Quantity (Alt.)" > 0);                       // PR3.61
            ...
            if ("Rounding Adjustment Type" = "Rounding Adjustment Type"::"Near-Zero") then // P8001067
                RoundingAdjmtMgmt.UpdateItemTransferFields(NewItemLedgEntry, ItemLedgEntry);  // P8001067
            if not IsHandled then
                if Item."Item Tracking Code" <> '' then begin
            ...
            if ("Rounding Adjustment Type" = "Rounding Adjustment Type"::"Near-Zero") then                  // P8001067
                RoundingAdjmtMgmt.UpdateValueTransferFields(GlobalValueEntry, NewValueEntry, NewItemLedgEntry); // P8001067

            OnInsertTransferEntryOnBeforeInsertApplEntry(NewItemLedgEntry, ItemLedgEntry);
            // IF AverageTransfer THEN BEGIN                                    // P8001290
            if AverageTransfer or (Item.Type = Item.Type::FOODContainer) then begin // P8001290
                InsertApplEntry(
                  NewItemLedgEntry."Entry No.", NewItemLedgEntry."Entry No.", ItemLedgEntry."Entry No.",
                  //0,NewItemLedgEntry."Posting Date",NewItemLedgEntry.Quantity,TRUE); // PR3.60
                  0, NewItemLedgEntry."Posting Date", NewItemLedgEntry.Quantity, true,    // PR3.60
                  NewItemLedgEntry."Quantity (Alt.)");                                 // PR3.60
                NewItemLedgEntry."Completely Invoiced" := ItemLedgEntry."Completely Invoiced";
            end else begin
                InsertApplEntry(
                  NewItemLedgEntry."Entry No.", NewItemLedgEntry."Entry No.", ItemLedgEntry."Entry No.",
                  //OldItemLedgEntry."Entry No.",NewItemLedgEntry."Posting Date",NewItemLedgEntry.Quantity,TRUE); // PR3.60
                  OldItemLedgEntry."Entry No.", NewItemLedgEntry."Posting Date",                                   // PR3.60
                  NewItemLedgEntry.Quantity, true, NewItemLedgEntry."Quantity (Alt.)");                             // PR3.60
            ...
            RoundingAdjmtMgmt.ProcessNewEntry(ItemJnlLine, NewItemLedgEntry); // P8000548A, P8001039
            ...
            if ("Rounding Adjustment Type" = "Rounding Adjustment Type"::"Near-Zero") then           // P8001067
                RoundingAdjmtMgmt.UpdateTransferEntryDims(ItemJnlLine, NewItemLedgEntry, NewValueEntry); // P8001067
    ...
    begin
        ...
        InitLotComboOrderLineNo; // P8001134
        with ItemJnlLine do begin
            ItemLedgEntry.Init();
            ...
            ItemLedgEntry."Supply Chain Group Code" := "Supply Chain Group Code"; // P8000931
            ...
            ItemLedgEntry."Release Date" := "Release Date"; // PR3.60
            ItemLedgEntry."Rounding Adjustment Type" := "Rounding Adjustment Type"; // P8000548A
            ...
            then begin
                ...
                // PR3.60
                ItemLedgEntry."Quantity (Alt.)" := -"Quantity (Alt.)";
                ItemLedgEntry."Invoiced Quantity (Alt.)" := -"Invoiced Qty. (Alt.)";
                // PR3.60
            end else begin
                ItemLedgEntry.Quantity := Quantity;
                ItemLedgEntry."Invoiced Quantity" := "Invoiced Quantity";
            ...
            // P8000466A
            if (ItemLedgEntry."Quantity (Alt.)" < 0) and ("Entry Type" <> "Entry Type"::Transfer) then
                ItemLedgEntry."Shipped Qty. Not Ret. (Alt.)" := ItemLedgEntry."Quantity (Alt.)";
            // P8000466A
        end;
    ...
    begin
        ...
        with ItemJnlLine do begin
            // if ItemLedgEntry.Open then begin                                     // P8000548A
            if RoundingAdjmtMgmt.EntryOpenAfterAdjustments(ItemLedgEntry) then begin // P8000548A 
                IsHandled := false;
                ...
                if not IsHandled then
                    if not (("Document Type" in ["Document Type"::"Purchase Return Shipment", "Document Type"::"Purchase Receipt"]) and
                            ("Job No." <> ''))
                    then
                        if ((ItemLedgEntry.Quantity < 0) or (ItemLedgEntry."Quantity (Alt.)" < 0)) and GlobalItemTrackingCode.IsSpecific() then // P8000184A
                            Error(Text018, "Serial No.", "Lot No.", "Item No.", "Variant Code");

                if GlobalItemTrackingCode."SN Specific Tracking" then begin
                    if ((ItemLedgEntry.Quantity > 0) or (ItemLedgEntry."Quantity (Alt.)" < 0)) then // P8000184A
                ...
                if ("Document Type" <> "Document Type"::"Purchase Return Shipment") and ("Job No." = '') then
                    if (Item.Reserve = Item.Reserve::Always) and ((ItemLedgEntry.Quantity < 0) or (ItemLedgEntry."Quantity (Alt.)" < 0)) then begin // P8000184A
                        IsHandled := false;
            ...
            (ItemLedgEntry."Quantity (Alt.)" = ItemLedgEntry."Invoiced Quantity (Alt.)") and // PR3.60
            ...
            if TrackAlternateUnits then
                if "Phys. Inventory" then
                    AltQtyMgmt.CreatePhysAltQtyEntries(ItemJnlLine, ItemLedgEntry)
                else
                    AltQtyMgmt.ItemJnlLineToItemLedgEntry(ItemJnlLine, ItemLedgEntry);
            // PR3.61.01
    ...
    begin
        ...
        with ItemJournalLine do begin
            ...
            // PR3.60
            PhysInvtLedgEntry."Lot No." := "Lot No.";
            PhysInvtLedgEntry."Serial No." := "Serial No.";
            PhysInvtLedgEntry."Quantity (Alt.)" := "Quantity (Alt.)";
            PhysInvtLedgEntry."Qty. (Alt.) (Calculated)" := "Qty. (Alt.) (Calculated)";
            PhysInvtLedgEntry."Qty. (Alt.) (Phys. Inventory)" := "Qty. (Alt.) (Phys. Inventory)";
            // PR3.60
            // P8001323
            if "Entry Type" = "Entry Type"::"Positive Adjmt." then begin
                PhysInvtLedgEntry."Container ID" := "New Container ID";
            end else begin
                PhysInvtLedgEntry."Container ID" := "Old Container ID";
            end;
            PhysInvtLedgEntry."Container License Plate" := "Container License Plate";
            // P8001323
    ...
    procedure InsertApplEntry(ItemLedgEntryNo: Integer; InboundItemEntry: Integer; OutboundItemEntry: Integer; TransferedFromEntryNo: Integer; PostingDate: Date; Quantity: Decimal; CostToApply: Boolean; AltQuantity: Decimal)
    var
    ...
    begin
        ...
        if Item.IsNonInventoriableType or Item.IsContainerType then // P80066030
            exit;
        ...
        if Quantity < 0 then begin
            ...
            if OldItemApplnEntry.FindFirst() then begin
                ...
                ItemApplnEntry."Quantity (Alt.)" := ItemApplnEntry."Quantity (Alt.)" + AltQuantity; // PR3.70
        ...
        if not ItemApplnEntryExists then begin
            ...
            ItemApplnEntry."Quantity (Alt.)" := AltQuantity; // PR3.60
    ...
    begin
        with ItemApplnEntry do begin
            if (Quantity > 0) or ("Quantity (Alt.)" > 0) then // P8000277A
                exit("Posting Date");
    ...
    begin
        ...
        with ItemJnlLine do begin
            ...
            if (ItemLedgEntry.Quantity > 0) or
               ...
               // P8000971
               (ItemLedgEntry."Quantity (Alt.)" > 0) or
               (ItemLedgEntry."Invoiced Quantity (Alt.)" > 0) or
               // P8000971
            ...
            InvoicedQuantityNotEmpty := ("Invoiced Quantity" <> 0) or ("Invoiced Qty. (Alt.)" <> 0); // PR3.60
            ...
            if InvoicedQuantityNotEmpty then begin
                // ValueEntry."Valued Quantity" := "Invoiced Quantity";                      // PR3.60
                ValueEntry."Valued Quantity" := GetCostingQty(FieldNo("Invoiced Quantity")); // PR3.60
                if ("Value Entry Type" = "Value Entry Type"::"Direct Cost") and
                   ("Item Charge No." = '')
                then
                    if ("Entry Type" <> "Entry Type"::Output) or
                       // (ItemLedgEntry."Invoiced Quantity" = 0) // PR3.60
                       (ItemLedgEntry.GetCostingInvQty = 0)       // PR3.60
                    then
                        // ValueEntry."Invoiced Quantity" := "Invoiced Quantity"; // P8000275A
                        ValueEntry."Invoiced Quantity" := GetCostingQty(FieldNo("Invoiced Quantity")); // PR3.60
                ValueEntry."Expected Cost" := false;
            end else begin
                // ValueEntry."Valued Quantity" := Quantity;                      // PR3.60
                ValueEntry."Valued Quantity" := GetCostingQty(FieldNo(Quantity)); // PR3.60
            ...
            if "Value Entry Type" <> "Value Entry Type"::Rounding then begin
                //IF ("Entry Type" = "Entry Type"::Output) AND                              // P8000496A
                if (("Entry Type" = "Entry Type"::Output) or                                // P8001083
                                                                                            // (("Entry Type" = "Entry Type"::"Positive Adjmt.") AND (Repack > 0))) AND // P8000496A, P8001083, P8001134
                    (("Entry Type" = "Entry Type"::"Positive Adjmt.") and                        // P8001134
                     ("Order Type" in ["Order Type"::FOODRepack, "Order Type"::FOODSalesRepack]))) and // P8001134
                   ("Value Entry Type" <> "Value Entry Type"::Revaluation)
                then begin
                    CostAmt := Amount;
                    ...
                    then begin
                        ...
                        // P8000856
                        if Item."Commodity Cost Item" and (not ValueEntry."Expected Cost") then
                            CommItemMgmt.AdjustPurchVariance(ItemLedgEntry, VarianceAmount, VarianceAmountACY);
                        // P8000856
            ...
            case true of
                            ...
                            case "Entry Type" of
                                "Entry Type"::Sale:
                                    begin                                                        // P8000921
                                        ...
                                        ValueEntry."Sales Amount (FOB)" := "Amount (FOB)";         // P8000921
                                        ValueEntry."Sales Amount (Freight)" := "Amount (Freight)"; // P8000921
                                        ValueEntry."Sales Quantity" := Signed(GetPricingQty(FieldNo("Invoiced Quantity"))); // P8001143
                                    end;                                                         // P8000921
                                "Entry Type"::Purchase:
                ...
                (not ValueEntry."Expected Cost") and (not ValueEntry.Inventoriable):
                    if "Entry Type" = "Entry Type"::Sale then begin
                        ...
                        ValueEntry."Sales Amount (Freight)" := "Amount (Freight)"; // P8000921
                        ValueEntry."Sales Quantity" := Signed(GetPricingQty(FieldNo("Invoiced Quantity"))); // P8001143
                        if Item.IsNonInventoriableType() or Item.IsContainerType() then begin // P80066030
    ...
    begin
        ...
        with ItemJnlLine do begin
            ...
            if ValueEntry."Entry Type" = ValueEntry."Entry Type"::Rounding then begin
                ValueEntry."Valued Quantity" := ItemLedgEntry.GetCostingQty; // P8000102A
                ValueEntry."Invoiced Quantity" := 0;
                ValueEntry."Cost per Unit" := 0;
                ValueEntry."Sales Amount (Actual)" := 0;
                ValueEntry."Sales Amount (FOB)" := 0;     // P8000921
                ValueEntry."Sales Amount (Freight)" := 0; // P8000921
                ValueEntry."Sales Quantity" := 0; // P8001143
            ...
            ShouldCalcExpectedCost :=
               ...
               //(((Quantity = 0) and ("Invoiced Quantity" <> 0)) or                                               // PR4.00
               (((GetCostingQty(FieldNo(Quantity)) = 0) and (GetCostingQty(FieldNo("Invoiced Quantity")) <> 0)) or // PR4.00
            ...
            if ShouldCalcExpectedCost then begin
                ...
                CalcExpectedCost(
                  ...
                  InvoicedQty,
                  //ItemLedgEntry.Quantity,    // PR4.00
                  ItemLedgEntry.GetCostingQty, // PR4.00
                  ...
                  //ItemLedgEntry.Quantity = ItemLedgEntry."Invoiced Quantity"); // PR4.00
                  ItemLedgEntry.GetCostingQty = ItemLedgEntry.GetCostingInvQty); // PR4.00
            end;

            if ExtraCharge then                             // PR3.70.01, P8000062B
                ExtraChargeMgmt.MoveToValueEntry(ValueEntry, ItemLedgEntry); // PR3.70.01, P8000062B
                                                                             // P8000375A
            if InvtSetup."ABC Detail Posting" and
              (ValueEntry."Item Ledger Entry Type" = ValueEntry."Item Ledger Entry Type"::Output) and
              (ValueEntry."Entry Type" = ValueEntry."Entry Type"::"Indirect Cost")
            then
                P800BOMFns.InsertValueEntryABCDetail(ValueEntry, ItemLedgEntry);
            // P8000375A
            ...
            P800CoreFns.UpdateSalesDocFlag(ValueEntry); // PR3.60
            InsertItemReg(0, 0, ValueEntry."Entry No.", 0);
        ...
        with ItemLedgEntry do
            ...
            then begin
                ...
                if (Positive or "Job Purchase") and
                   ((Quantity <> "Remaining Quantity") or ("Quantity (Alt.)" <> "Remaining Quantity (Alt.)")) and not "Applied Entry to Adjust" and // PR3.60
                ...
                if (ValueEntry."Entry Type" = ValueEntry."Entry Type"::"Direct Cost") and
                   ...
                   // (ItemJnlLine.Quantity = 0) AND (ValueEntry."Invoiced Quantity" <> 0) // PR3.60
                   (ItemJnlLine.GetCostingQty(ItemJnlLine.FieldNo(Quantity)) = 0) and      // PR3.60
                   (ValueEntry."Invoiced Quantity" <> 0)                                   // PR3.60
                then begin
                    if ValueEntry."Invoiced Quantity" <> 0 then begin
                        // P8001132
                        // "Invoiced Quantity" := "Invoiced Quantity" + ValueEntry."Invoiced Quantity";
                        if Item.CostInAlternateUnits() then begin
                            "Invoiced Quantity (Alt.)" := "Invoiced Quantity (Alt.)" + ValueEntry."Invoiced Quantity";
                            if (ItemJnlLine.Signed(1) > 0) then
                                "Invoiced Quantity" := "Invoiced Quantity" + ItemJnlLine."Invoiced Qty. (Base)"
                            else
                                "Invoiced Quantity" := "Invoiced Quantity" - ItemJnlLine."Invoiced Qty. (Base)";
                        end else begin
                            "Invoiced Quantity" := "Invoiced Quantity" + ValueEntry."Invoiced Quantity";
                            if (ItemJnlLine.Signed(1) > 0) then
                                "Invoiced Quantity (Alt.)" := "Invoiced Quantity (Alt.)" + ItemJnlLine."Invoiced Qty. (Alt.)"
                            else
                                "Invoiced Quantity (Alt.)" := "Invoiced Quantity (Alt.)" - ItemJnlLine."Invoiced Qty. (Alt.)";
                        end;
                        // P8001132
                        if Abs("Invoiced Quantity (Alt.)") > Abs("Quantity (Alt.)") then // P8001132
                            Error(Text030, "Entry No.");                                    // P8001132
                        CheckInvoicedQuantity(ItemLedgEntry, ValueEntry, ModifyEntry);
                    end;

                    if ("Entry Type" <> "Entry Type"::Output) and
                       ("Invoiced Quantity (Alt.)" = "Quantity (Alt.)") and // PR3.60
    ...
    begin
        with OutboundItemLedgEntry do begin
            ...
            // P8000466A
            "Shipped Qty. Not Ret. (Alt.)" := "Shipped Qty. Not Ret. (Alt.)" + Abs(ItemJnlLine."Quantity (Alt.)");
            if "Shipped Qty. Not Ret. (Alt.)" > 0 then
                FieldError("Shipped Qty. Not Ret. (Alt.)", Text004);
            // P8000466A
            "Applied Entry to Adjust" := true;
            Modify();
        end;
    ...
    begin
        ...
        //ValueEntry."Valued Quantity" := ItemLedgEntry.Quantity;    // PR3.61
        ValueEntry."Valued Quantity" := ItemLedgEntry.GetCostingQty; // PR3.61
    ...
    begin
        ...
        with PosValueEntry do begin
            ...
            repeat
                if "Partial Revaluation" then begin
                    AdjustedCostLCY := AdjustedCostLCY +
                        //"Cost Amount (Actual)" / "Valued Quantity" * PosItemLedgEntry.Quantity;    // PR3.60
                        "Cost Amount (Actual)" / "Valued Quantity" * PosItemLedgEntry.GetCostingQty; // PR3.60
                    AdjustedCostACY := AdjustedCostACY +
                        //"Cost Amount (Actual) (ACY)" / "Valued Quantity" * PosItemLedgEntry.Quantity;    // PR3.60
                        "Cost Amount (Actual) (ACY)" / "Valued Quantity" * PosItemLedgEntry.GetCostingQty; // PR3.60
                end else begin
            ...
            if PosItemLedgEntry.GetCostingQty <> 0 then begin // P8000114A, P8000205A
                AdjustedCostLCY := AdjustedCostLCY * AppliedQty / PosItemLedgEntry.GetCostingQty; // PR3.60
                AdjustedCostACY := AdjustedCostACY * AppliedQty / PosItemLedgEntry.GetCostingQty;  // PR3.60
                DiscountAmount := DiscountAmount * AppliedQty / PosItemLedgEntry.GetCostingQty;   // PR3.60
                                                                                                  // P8000114A Begin
            end else begin
                AdjustedCostLCY := 0;
                AdjustedCostACY := 0;
    ...
    local procedure CreateItemJnlLineFromEntry(ItemLedgEntry: Record "Item Ledger Entry"; NewQuantity: Decimal; NewQuantityAlt: Decimal; var ItemJnlLine: Record "Item Journal Line")
    begin
        // P8000466A - add parameter for NewQuantityAlt
        Clear(ItemJnlLine);
        with ItemJnlLine do begin
            "Entry Type" := ItemLedgEntry."Entry Type"; // no mapping needed
            Quantity := Signed(NewQuantity);
            "Quantity (Alt.)" := Signed(NewQuantityAlt); // P8000466A, P8001132
    ...
    begin
        ...
        with ValueEntry do begin
            ...
            "Sales Amount (FOB)" := Round("Sales Amount (FOB)");         // P8000921
            "Sales Amount (Freight)" := Round("Sales Amount (Freight)"); // P8000921
    ...
    var
        CostCalcMgt: Codeunit "Cost Calculation Management";
        OldQuantity: Decimal;
        OldInvoicedQuantity: Decimal;
    begin
        with ItemJnlLine do begin
            // PR3.60
            OldQuantity := Quantity;
            OldInvoicedQuantity := "Invoiced Quantity";
            Quantity := GetCostingQty(FieldNo(Quantity));
            "Invoiced Quantity" := GetCostingQty(FieldNo("Invoiced Quantity"));
            // PR3.60
            ...
            "Invoiced Quantity" := OldInvoicedQuantity;
            // PR3.60
        end;
    ...
    var
        ...
        DistrQuantity: Decimal;
        CalcReleaseDate: Date;
        LotNoInfo: Record "Lot No. Information";
        SerialNoInfo: Record "Serial No. Information";
        NonDistrFreightAmount: Decimal;
        QuantityForUnitAmount: Decimal;
        PostItemJnlLine: Boolean;
        IsHandled: Boolean;
    begin
        ...
        Invoice := (ItemJnlLine2."Invoiced Qty. (Base)" <> 0) or (ItemJnlLine2."Invoiced Qty. (Alt.)" <> 0) or // PR3.61
          ItemJnlLine2."Phys. Inventory"; // PR3.60
        ...
        if not ItemJnlLine2.Correction and
            ((ItemJnlLine2."Quantity (Base)" <> 0) or (ItemJnlLine2."Quantity (Alt.)" <> 0) or // PR3.61
           ItemJnlLine2."Phys. Inventory") and // PR3.60
           TrackingSpecExists
        then begin
            if DisableItemTracking then begin
                ...
                // P80066030
                if ItemJnlLine2.CostInAlternateUnits and (not ItemJnlLine2.Adjustment) then
                    NonDistrQuantity := ItemJnlLine2."Quantity (Alt.)"
                else
                    // P80066030
                NonDistrQuantity :=
                ...
                NonDistrFreightAmount := ItemJnlLine2."Amount (Freight)"; // P8000921
                ...
                repeat
                    ...
                    // PR3.60 Begin
                    if GlobalItemTrackingSetup."Lot No. Required" and ProcessFns.TrackingInstalled then begin
                        if P800ItemTracking.LotStatus(TempTrackingSpecification, 'CREATE', // P8000229A
                          GlobalItemTrackingCode."Allow Loose Lot Control" or ItemJnlLine2."Override Loose Lot Control") // P8000229A, P8000494A
                        then                                                              // P8000229A
                            P800ItemTracking.CreateLotNoInfo(TempTrackingSpecification, LotNoInfo)
                        else // PR3.61.02
                            LotNoInfo.Get(ItemJnlLine2."Item No.", ItemJnlLine2."Variant Code", TempTrackingSpecification."Lot No.");

                        P800ItemTracking.GetLotDates(ItemJnlLine2."Item No.", ItemJnlLine2."Variant Code",
                          TempTrackingSpecification."Lot No.", ItemJnlLine2."Document Date", GlobalItemTrackingCode,
                          CalcExpirationDate, CalcReleaseDate);
                        // P8000747
                        if (TempTrackingSpecification."New Expiration Date" <> 0D) then
                            CalcExpirationDate := TempTrackingSpecification."New Expiration Date"
                        else
                            CalcExpirationDate := TempTrackingSpecification."Expiration Date";
                        if (LotNoInfo."Expiration Date" <> CalcExpirationDate) then begin
                            LotNoInfo."Expiration Date" := CalcExpirationDate;
                            LotNoInfo.Modify;
                        end;
                        // P8000747
                        P800ItemTracking.SetLotFieldsFromTracking(TempTrackingSpecification, LotNoInfo); // P8001106
                        OnBeforeP800ItemTrackingPostLotData(LotNoInfo, ItemJnlLine2, TempTrackingSpecification, CalcExpirationDate, CalcReleaseDate); // P800147498
                        P800ItemTracking.PostLotData(ItemJnlLine2, TempTrackingSpecification."Source Subtype",
                          LotNoInfo, GlobalItemTrackingCode."Allow Loose Lot Control" or ItemJnlLine2."Override Loose Lot Control", // P8000494A
                          CalcExpirationDate, CalcReleaseDate); // PR3.70.01
                    end;
                    // PR3.60 End
                    ...
                    PostItemJnlLine :=
                      ...
                      SetupTempSplitItemJnlLine(
                        ...
                        NonDistrAmountACY, NonDistrDiscountAmount, NonDistrFreightAmount, Invoice);  // P8001213
    ...
    begin
        ...
        if not IsHandled then
            if ((ItemJnlLine2."Quantity (Base)" <> 0) or (ItemJnlLine2."Quantity (Alt.)" <> 0)) and ItemJnlLine2.TrackingExists() then begin // PR3.61.01
                ...
                if TempTrackingSpecification.FindFirst() then begin
                    ...
                    TempTrackingSpecification."Quantity (Alt.)" := SignFactor * ItemJnlLine2."Quantity (Alt.)";               // PR3.60
                    TempTrackingSpecification."Quantity Handled (Base)" := SignFactor * ItemJnlLine2."Quantity (Base)";
                    TempTrackingSpecification."Quantity Handled (Alt.)" := SignFactor * ItemJnlLine2."Quantity (Alt.)";       // PR3.60
                    ...
                    TempTrackingSpecification."Quantity Invoiced (Alt.)" := SignFactor * ItemJnlLine2."Invoiced Qty. (Alt.)"; // PR3.60
                    TempTrackingSpecification."Qty. to Invoice (Base)" :=
                      SignFactor * (ItemJnlLine2."Quantity (Base)" - ItemJnlLine2."Invoiced Qty. (Base)");
                    TempTrackingSpecification."Qty. to Invoice (Alt.)" :=                                  // PR3.60
                      SignFactor * (ItemJnlLine2."Quantity (Alt.)" - ItemJnlLine2."Invoiced Qty. (Alt.)"); // PR3.60
                    TempTrackingSpecification."Qty. to Handle (Base)" := 0;
                    TempTrackingSpecification."Qty. to Handle (Alt.)" := 0; // PR3.60
        ...
        if TempSplitItemJnlLine.FindFirst() then begin
            ...
            // PR3.60 Begin
            if ItemJnlLine."Phys. Inventory" and ProcessFns.TrackingInstalled then begin
                ItemJnlLineOrigin := ItemJnlLine2;
        ...
        if ItemJnlLine."Phys. Inventory" then
            ...
            if ProcessFns.TrackingInstalled then begin
                // Cleanup tracking lines that have quantity of zero
                ResEntry.SetRange("Source Type", DATABASE::"Item Journal Line");
                ResEntry.SetRange("Source ID", ItemJnlLine2."Journal Template Name");
                ResEntry.SetRange("Source Batch Name", ItemJnlLine2."Journal Batch Name");
    ...
    begin
        ...
        if SignFactor * ItemJnlLine2.Quantity > 0 then begin        // Only expiration dates on supply.
            ...
            if ItemJnlLine2."Entry Type" = ItemJnlLine2."Entry Type"::Transfer then begin
                ...
                if ((ItemJnlLine2."Order Type" = ItemJnlLine2."Order Type"::Transfer) and // P8000609A
                    (ItemJnlLine2."Order No." <> '')) or
                   // (ItemJnlLine2.Repack > 0)                                           // P8000609A, P8001083, P8001134
                   ((ItemJnlLine2."Order Type" = ItemJnlLine2."Order Type"::FOODRepack) and // P8001134
                    (ItemJnlLine2."Order No." <> ''))                                   // P8001134
                then
                    if TempTrackingSpecification."New Expiration Date" = 0D then
                        TempTrackingSpecification."New Expiration Date" := ExistingExpirationDate;
                ...
                if (TempTrackingSpecification."New Lot No." <> '') and
                   ((ItemJnlLine2."Order Type" <> ItemJnlLine2."Order Type"::Transfer) or
                    (ItemJnlLine2."Order No." = '')) and // P8001132
                                                         // (ItemJnlLine2.Repack = 0) // P8000609A, P8001083, P8001134
                   ((ItemJnlLine2."Order Type" <> ItemJnlLine2."Order Type"::FOODRepack) or // P8001134
                    (ItemJnlLine2."Order No." = ''))                                    // P8001134
                then begin
    ...
    begin
        ...
        ShouldInsertCorrValueEntries := OldItemLedgEntry.GetCostingInvQty = 0; // P80043524
        ...
        if ShouldInsertCorrValueEntries then begin
            ...
            if not IsHandled then
              ...
              0, OldItemLedgEntry.GetCostingQty); // P80043524
            InsertCorrValueEntry(
              OldValueEntry, NewValueEntry, NewItemLedgEntry, ItemJnlLine."Document Line No.", -1,
              NewItemLedgEntry.GetCostingQty, 0); // P80043524
            InsertCorrValueEntry(
              OldValueEntry, NewValueEntry, NewItemLedgEntry, ItemJnlLine."Document Line No.", -1,
              0, NewItemLedgEntry.GetCostingQty); // P80043524
        end else
            InsertCorrValueEntry(
              OldValueEntry, NewValueEntry, NewItemLedgEntry, ItemJnlLine."Document Line No.", -1,
              NewItemLedgEntry.GetCostingQty, NewItemLedgEntry.GetCostingQty); // P80043524
        ...
        if NewItemLedgEntry.Positive then begin
            ...
            InsertApplEntry(
              ...
              //-OldItemLedgEntry.Quantity,FALSE);                                   // PR3.60
              -OldItemLedgEntry.Quantity, false, -OldItemLedgEntry."Quantity (Alt.)"); // PR3.60
        end;
    ...
    begin
        ...
        NewItemLedgEntry."Invoiced Quantity" := NewItemLedgEntry.Quantity;
        // PR3.60 Begin
        NewItemLedgEntry."Quantity (Alt.)" := -OldItemLedgEntry."Quantity (Alt.)";           // P8006787
        NewItemLedgEntry."Remaining Quantity (Alt.)" := -OldItemLedgEntry."Quantity (Alt.)"; // P8006787
        // P8000466A
        if NewItemLedgEntry."Quantity (Alt.)" > 0 then
            NewItemLedgEntry."Shipped Qty. Not Ret. (Alt.)" := 0
        else
            NewItemLedgEntry."Shipped Qty. Not Ret. (Alt.)" := NewItemLedgEntry."Quantity (Alt.)";
        // P8000466A
        NewItemLedgEntry."Invoiced Quantity (Alt.)" := NewItemLedgEntry."Quantity (Alt.)";
        // PR3.60 End
        NewItemLedgEntry.Positive := NewItemLedgEntry."Remaining Quantity" > 0;
        NewItemLedgEntry.Open := NewItemLedgEntry."Remaining Quantity" <> 0;
        ...
        if OldItemLedgEntry.Positive then
            ...
            NewItemLedgEntry."Applies-to Entry" := 0;
        NewItemLedgEntry."Posting Date/Time" := CurrentDateTime; // P8001017;
        ...
        // PR3.60 Begin
        if OldItemLedgEntry.AltQtyEntriesExist then
            AltQtyMgmt.UndoAltQtyEntries(
              DATABASE::"Item Ledger Entry", '', OldItemLedgEntry."Entry No.",
              DATABASE::"Item Ledger Entry", '', NewItemLedgEntry."Entry No.",
              true);
        // PR3.60 End
    ...
    begin
        ...
        OldItemLedgEntry."Invoiced Quantity (Alt.)" := OldItemLedgEntry."Quantity (Alt.)"; // PR3.60
    ...
    begin
        ...
        NewValueEntry."Sales Amount (FOB)" := 0;     // P8000921
        NewValueEntry."Sales Amount (Freight)" := 0; // P8000921
        NewValueEntry."Sales Quantity" := 0; // P8001143
        ...
        if ProcessFns.FreshProInstalled then
            ExtraChargeMgmt.CopyEntryExtraCharge(
              OldValueEntry."Entry No.", NewValueEntry."Entry No.", Sign, NewValueEntry."Expected Cost", QtyToShip); // PR4.00, P8000487A, P8001132, P80061261
        // PR3.70.01 End
    ...
    begin
        ...
        if ItemTrackingCode."Create Lot No. Info on posting" and (not Process800Fns.TrackingInstalled()) then // Upgrade18.0
    ...
    begin
        ...
        if not ItemJnlLine."Phys. Inventory" then // PR3.61, P9800-MegaApp
            ItemJnlLine.CheckTrackingIsEmpty();
        if ItemJnlLine."Entry Type" <> ItemJnlLine."Entry Type"::Transfer then // P8000343A, P800-MegaApp
    ...
    begin
        BOMEntryType := GetBOMEntryType(ItemLedgEntryType, Adjustment, OrderType, OrderNo, OrderLineNo); // P8001134
    ...
    begin
        ...
        if Adjustment then
            ...
            // THEN
            if (BOMEntryType = BOMEntryType::"Non-Output") then
                // P8001134
                exit;
    ...
    begin
        ...
        if not IsBOMOrderType(OrderType) then // P8001134
        ...
        //                          ValueEntry."Item Ledger Entry Type"::"Assembly Output"]
        // THEN
        if (BOMEntryType = BOMEntryType::Output) then
            // P8001134
            exit;
            ...
            if not Get(OrderType, OrderNo, OrderLineNo) then
                case OrderType of
                    "Order Type"::Production:
                        // P8000267B, P8001132
                        if (OrderLineNo = 0) or (BOMEntryType = BOMEntryType::"By-Product Output") then begin
                            ...
                            if ProdOrderLine.FindSet then
                                repeat
                                    ...
                                    SetOrderAdjmtProperties(ItemLedgEntryType, OrderType, OrderNo, ProdOrderLine."Line No.", OriginalPostingDate, ValuationDate);
                    ...
                    "Order Type"::FOODLotCombination:
                        begin
                            SetLotCombination(ItemJnlLine);
                            SetOrderAdjmtProperties(ItemLedgEntryType, OrderType, OrderNo, OrderLineNo, OriginalPostingDate, ValuationDate);
                        end;
                    "Order Type"::FOODRepack:
                        if (ItemLedgEntryType <> ValueEntry."Item Ledger Entry Type"::Transfer) then begin
                            RepackOrder.Get(OrderNo);    // P8001195
                            SetRepackOrder(RepackOrder); // P8001195
                            SetOrderAdjmtProperties(ItemLedgEntryType, OrderType, OrderNo, 0, OriginalPostingDate, ValuationDate);
                        end;
                    "Order Type"::FOODSalesRepack:
                        begin
                            // P8001195
                            if SalesShipmentLine.Get(OrderNo, OrderLineNo) then
                                SetSalesRepack(OrderNo, OrderLineNo, SalesShipmentLine."No.", SalesShipmentLine."Variant Code", SalesShipmentLine."Location Code") // P80064362
                            else begin
                                SalesShipment.Get(OrderNo);
                                SalesLine.Get(SalesLine."Document Type"::Order, SalesShipment."Order No.", OrderLineNo);
                                SetSalesRepack(OrderNo, OrderLineNo, SalesLine."No.", SalesLine."Variant Code", SalesLine."Location Code"); // P80064362
                            end;
                            // P8001195
                            SetOrderAdjmtProperties(ItemLedgEntryType, OrderType, OrderNo, OrderLineNo, OriginalPostingDate, ValuationDate);
                        end;
            ...
            if FindSet() then
                repeat
                    ...
                    if (RevExpCostToBalance <> 0) or (RevExpCostToBalanceACY <> 0) then begin
                        ...
                        ValueEntry3."Sales Amount (FOB)" := 0;     // P8000921
                        ValueEntry3."Sales Amount (Freight)" := 0; // P8000921
                        ValueEntry3."Sales Quantity" := 0; // P8001143
    ...
    begin
        ...
        with ItemLedgEntry do begin
            ...
            if (OldItemLedgEntry."Remaining Quantity" < Abs(Quantity)) and
               (OldItemLedgEntry."Remaining Quantity" < OldItemLedgEntry.Quantity) and             // P8000466A
               ((not Item.TrackAlternateUnits) or                                                                  // P8000541A
                 ((OldItemLedgEntry."Remaining Quantity (Alt.)" < Abs("Quantity (Alt.)")) and           // P8000466A, P8000541A
                  (OldItemLedgEntry."Remaining Quantity (Alt.)" < OldItemLedgEntry."Quantity (Alt.)"))) // P8000466A, P8000541A
            then begin
                Enough := false;
                Application.Reset();
    ...
    begin
        ...
        if TempTouchedItemLedgerEntries.Find('-') then begin
            ...
            repeat
                ...
                if (TouchedItemLedgEntry."Remaining Quantity" <> 0) or (TouchedItemLedgEntry."Remaining Quantity (Alt.)" <> 0) then begin // P8000466A
    ...
    begin
        ...
        exit(SetupTempSplitItemJnlLine(ItemJnlLine2, SignFactor, NonDistrQuantity, NonDistrAmount, NonDistrAmountACY, NonDistrAmountACY, NonDistrFreightAmount, Invoice));
    end;

    procedure SetupTempSplitItemJnlLine(ItemJnlLine2: Record "Item Journal Line"; SignFactor: Integer; var NonDistrQuantity: Decimal; var NonDistrAmount: Decimal; var NonDistrAmountACY: Decimal; var NonDistrDiscountAmount: Decimal; var NonDistrFreightAmount: Decimal; Invoice: Boolean): Boolean
    var
        ...
        PostItemJnlLine: Boolean;
    begin
        // P8001213 - add parameter for NonDistrFreightAmount
        with TempSplitItemJnlLine do begin
            // PR3.60 Begin
            if ItemJnlLine2."Phys. Inventory" and ProcessFns.TrackingInstalled then begin
                "Qty. (Calculated)" := TempTrackingSpecification."Qty. (Calculated)";
                Validate("Qty. (Phys. Inventory)", TempTrackingSpecification."Qty. (Phys. Inventory)");
                if TrackAlternateUnits then begin
                    "Qty. (Alt.) (Calculated)" := TempTrackingSpecification."Qty. (Alt.) (Calculated)";
                    Validate("Qty. (Alt.) (Phys. Inventory)", TempTrackingSpecification."Qty. (Alt.) (Phys. Inventory)");
                end;
                Validate("Unit Amount", ItemJnlLine2."Unit Amount"); // PR3.61.01
            end else begin
                // PR3.60 End
                ...
                if TrackAlternateUnits then                                                            // PR3.60
                    "Quantity (Alt.)" := SignFactor * TempTrackingSpecification."Qty. to Handle (Alt.)"; // PR3.60
                if Invoice then begin
                    ...
                    if TrackAlternateUnits then                                                                  // PR3.60
                        "Invoiced Qty. (Alt.)" := SignFactor * TempTrackingSpecification."Qty. to Invoice (Alt.)"; // PR3.60
                end;
                ...
                if ItemJnlLine2."Phys. Inventory" and (not ProcessFns.TrackingInstalled) then // PR3.60
            ...
            //  FloatingFactor := Quantity / NonDistrQuantity; // PR3.60
            // PR3.60 Begin
            if NonDistrQuantity <> 0 then begin
                DistrQuantity := GetCostingQty(FIELDNO(Quantity)); // PR3.70.01
                FloatingFactor := DistrQuantity / NonDistrQuantity;
            end;
            // PR3.60
            if FloatingFactor < 1 then begin
                Amount := Round(NonDistrAmount * FloatingFactor, GLSetup."Amount Rounding Precision");
                "Amount (Freight)" :=                                                                // P8000921
                  Round(NonDistrFreightAmount * FloatingFactor, GLSetup."Amount Rounding Precision"); // P8000921
                ...
                NonDistrFreightAmount := NonDistrFreightAmount - "Amount (Freight)"; // P8000921
                NonDistrAmountACY := NonDistrAmountACY - "Amount (ACY)";
                NonDistrDiscountAmount := NonDistrDiscountAmount - "Discount Amount";
                //    NonDistrQuantity := NonDistrQuantity - Quantity; // PR3.60
                NonDistrQuantity := NonDistrQuantity - DistrQuantity; // PR3.60
                "Setup Time" := 0;
                "Run Time" := 0;
                "Stop Time" := 0;
                "Setup Time (Base)" := 0;
                ...
                "Amount (Freight)" := NonDistrFreightAmount; // P8000921
                "Amount (ACY)" := NonDistrAmountACY;
                "Discount Amount" := NonDistrDiscountAmount;
            end;
            "Amount (FOB)" := Amount - "Amount (Freight)"; // P8000921

            // P8001192
            if "Entry Type" = "Entry Type"::Sale then
                QuantityForUnitAmount := GetPricingQty(FieldNo(Quantity))
            else
                QuantityForUnitAmount := GetCostingQty(FieldNo(Quantity));
            if QuantityForUnitAmount <> 0 then
                // P8001192
                if Round("Unit Amount" * Quantity, GLSetup."Amount Rounding Precision") <> Amount then
                    if ("Unit Amount" = "Unit Cost") and ("Unit Cost" <> 0) then begin
                        "Unit Amount" := Round(Amount / QuantityForUnitAmount, 0.00001);             // P8001192
                        "Unit Cost" := Round(Amount / QuantityForUnitAmount, 0.00001);               // P8001192
                        "Unit Cost (ACY)" := Round("Amount (ACY)" / QuantityForUnitAmount, 0.00001); // P8001192
                    end else
                        "Unit Amount" := Round(Amount / QuantityForUnitAmount, 0.00001);             // P8001192
            ...
            "Release Date" := TempTrackingSpecification."Release Date"; // PR3.60
            "Supplier Lot No." := TempTrackingSpecification."Supplier Lot No."; // P8001106
            "Creation Date" := TempTrackingSpecification."Lot Creation Date";                             // P8008351
            "Country/Region of Origin Code" := TempTrackingSpecification."Country/Region of Origin Code"; // P8008351
    ...
    procedure SetExtraChargeBuffer(var ExtraChargeBuffer: Record "Extra Charge Posting Buffer" temporary; Qty: Decimal)
    begin
        // PR3.70.01 Begin
        ExtraCharge := ExtraChargeBuffer.Find('-');
        ExtraChargeMgmt.SetBufferForItemPosting(ExtraChargeBuffer, Qty);
        // PR3.70.01 End
    end;

    procedure GetItemReg(var Rec: Record "Item Register")
    begin
        // P8000335A
        Rec := ItemReg;
    end;

    local procedure ResolveProdInBinUnits(var WhseJnlLine: Record "Warehouse Journal Line")
    var
        ProdBinContent: Record "Bin Content";
        ItemUOM: Record "Item Unit of Measure";
        BinContent: Record "Bin Content";
        QtyNeeded: Decimal;
        QtyToConvert: Decimal;
        NewSourceQty: Decimal;
        WhseReg: Record "Warehouse Register";
    begin
        // P8000540A, P8000594A
        with WhseJnlLine do begin
            GetProdInBinContents(ProdBinContent, WhseJnlLine, "Unit of Measure Code");
            if (ProdBinContent."Remaining Qty. (Base)" >= "Qty. (Base)") then
                exit;

            ItemUOM.SetCurrentKey("Item No.", "Qty. per Unit of Measure");
            ItemUOM.SetRange("Item No.", "Item No.");
            ItemUOM.SetFilter(Code, '<>%1', "Unit of Measure Code");
            if ItemUOM.Find('-') then
                repeat
                    if GetProdInBinContents(BinContent, WhseJnlLine, ItemUOM.Code) then begin
                        QtyNeeded := Quantity - ProdBinContent."Remaining Quantity";
                        QtyToConvert :=
                          Round(QtyNeeded * "Qty. per Unit of Measure" / ItemUOM."Qty. per Unit of Measure", 0.00001);
                        if (QtyToConvert > BinContent."Remaining Quantity") then begin
                            QtyToConvert := BinContent."Remaining Quantity";
                            NewSourceQty :=
                              Round(QtyToConvert * ItemUOM."Qty. per Unit of Measure" / "Qty. per Unit of Measure", 0.00001);
                            if (NewSourceQty > QtyNeeded) then
                                NewSourceQty := QtyNeeded;
                        end else begin
                            QtyToConvert := Round(QtyToConvert, 1, '>');
                            if (QtyToConvert > BinContent."Remaining Quantity") then
                                QtyToConvert := BinContent."Remaining Quantity";
                            NewSourceQty :=
                              Round(QtyToConvert * ItemUOM."Qty. per Unit of Measure" / "Qty. per Unit of Measure", 0.00001);
                        end;
                        P800CreateWhseAct.SetSourceCode("Source Code");
                        WhseJnlRegisterLine.GetWhseRegister(WhseReg); // P80041198
                        P800CreateWhseAct.SetWhseRegister(WhseReg);
                        P800CreateWhseAct.RegisterUOMConversion2(
                          "Location Code", "From Bin Code", "Item No.", "Variant Code",
                          ItemUOM.Code, "Unit of Measure Code", "Lot No.", "Serial No.",
                          QtyToConvert, NewSourceQty);
                        P800CreateWhseAct.GetWhseRegister(WhseReg);
                        WhseJnlRegisterLine.SetWhseRegister(WhseReg); // P80041198
                        GetProdInBinContents(ProdBinContent, WhseJnlLine, "Unit of Measure Code");
                    end;
                until (ProdBinContent."Remaining Qty. (Base)" >= "Qty. (Base)") or (ItemUOM.Next = 0);
        end;
    end;

    local procedure GetProdInBinContents(var BinContent: Record "Bin Content"; var WhseJnlLine: Record "Warehouse Journal Line"; UOMCode: Code[10]): Boolean
    begin
        // P8000540A
        with WhseJnlLine do begin
            BinContent."Remaining Quantity" := 0;
            BinContent."Remaining Qty. (Base)" := 0;
            if not BinContent.Get(
                     "Location Code", "From Bin Code", "Item No.", "Variant Code", UOMCode)
            then
                exit(false);
            ...
            BinContent.CalcFields("Remaining Qty. (Base)");
            exit(BinContent."Remaining Qty. (Base)" > 0);
        end;
    end;

    local procedure PostRoundingAdjustments()
    begin
        // P8000548A
        if RoundingAdjmtMgmt.AdjustmentsToPost() then begin
            RoundingAdjmtMgmt.SaveItemPostingData(
              ItemJnlLine, GlobalItemLedgEntry, GlobalValueEntry, TempTrackingSpecification); // P8001133
            repeat
                RoundingAdjmtMgmt.BuildAdjustmentJnlLine(ItemJnlLine); // P8001133
                PostItem;
            until not RoundingAdjmtMgmt.AdjustmentsToPost();
            RoundingAdjmtMgmt.RestoreItemPostingData(
              ItemJnlLine, GlobalItemLedgEntry, GlobalValueEntry, TempTrackingSpecification); // P8001133
        end;
    end;

    procedure GetRegisters(var ItemReg2: Record "Item Register"; var ItemApplnEntryNo2: Integer; var WhseReg2: Record "Warehouse Register"; var GLReg2: Record "G/L Register"; var NextVATEntryNo2: Integer; var NextTransactionNo2: Integer; var WhseJnlPostLine: Codeunit "Whse. Jnl.-Register Line")
    begin
        // P8000888
        ItemReg2 := ItemReg;
        ItemApplnEntryNo2 := ItemApplnEntryNo;
        WhseJnlPostLine.GetWhseRegister(WhseReg2); // P80041198, P80051677
        InventoryPostingToGL.GetGLRegister(GLReg2, NextVATEntryNo2, NextTransactionNo2);
    end;
    ...
    begin
        // P8000888
        if (ItemReg2."No." <> 0) then begin
            ItemReg := ItemReg2;
            ItemLedgEntryNo := ItemReg2."To Entry No.";
            PhysInvtEntryNo := ItemReg2."To Phys. Inventory Entry No.";
            ValueEntryNo := ItemReg2."To Value Entry No.";
            CapLedgEntryNo := ItemReg2."To Capacity Entry No.";
            ItemApplnEntryNo := ItemApplnEntryNo2;
        end;
        WhseJnlRegisterLine.SetWhseRegister(WhseReg2); // P80041198
        InventoryPostingToGL.SetGLRegister(GLReg2, NextVATEntryNo2, NextTransactionNo2);
    end;

    local procedure PostWhseLineAndRndgAdjmts()
    var
        TempWhseJnlLine: Record "Warehouse Journal Line" temporary;
    begin
        // P8001039
        OnBeforePostWhseLineAndRndgAdjmts; // P80082969
        XferRegsToWhse(WhseJnlRegisterLine); // P805529, P80041198
        if RoundingAdjmtMgmt.GetWhseAdjmts(TempWhseJnlLine) then
            WhseJnlRegisterLine.SetWhseRoundingAdjmts(TempWhseJnlLine); // P80041198
        OnPostWhseLineAndRndgAdjmtsOnBeforeWhseJnlRegisterLine(ItemJnlLine, WhseJnlLine); // P80082969
        WhseJnlRegisterLine.Run(WhseJnlLine); // P80041198
        if RoundingAdjmtMgmt.WhseAdjmtsToPost() then begin
            WhseJnlRegisterLine.ClearWhseRoundingAdjmts; // P80041198
            repeat
                RoundingAdjmtMgmt.BuildWhseAdjmtJnlLine(WhseJnlLine);
                WhseJnlRegisterLine.Run(WhseJnlLine); // P80041198
            until (not RoundingAdjmtMgmt.WhseAdjmtsToPost());
        end;
        XferRegsFromWhse(WhseJnlRegisterLine); // P805529, P80041198
    end;
    ...
    local procedure InitLotComboOrderLineNo()
    begin
        // P8001134
        with ItemJnlLine do begin
            if ("Order Type" <> "Order Type"::FOODLotCombination) then
                Clear(LotComboOrderNo)
            else begin
                if ("Order No." <> LotComboOrderNo) then begin
                    LotComboOrderNo := "Order No.";
                    LotComboOrderLineNo := ItemLedgEntryNo;
                end;
                "Order Line No." := LotComboOrderLineNo;
            end;
        end;
    end;

    procedure IsBOMOrderType(OrderType: Option): Boolean
    begin
        // P8001134
        with ItemJnlLine do
            exit(OrderType in ["Order Type"::FOODLotCombination, "Order Type"::FOODRepack, "Order Type"::FOODSalesRepack]);
    end;

    procedure GetBOMEntryType(ItemLedgEntryType: Option; Adjustment: Boolean; OrderType: Option; OrderNo: Code[20]; OrderLineNo: Integer): Integer
    var
        ProdOrderLine: Record "Prod. Order Line";
    begin
        // P8001134
        with ItemJnlLine do
            case OrderType of
                "Order Type"::Production:
                    if (ItemLedgEntryType = "Entry Type"::Output) then begin
                        if not Adjustment then begin
                            ProdOrderLine.SetFilter(Status, '%1|%2', ProdOrderLine.Status::Released, ProdOrderLine.Status::Finished);
                            ProdOrderLine.SetRange("Prod. Order No.", OrderNo);
                            ProdOrderLine.SetRange("Line No.", OrderLineNo);
                            if ProdOrderLine.FindFirst and ProdOrderLine."By-Product" then
                                exit(BOMEntryType::"By-Product Output");
                        end;
                        exit(BOMEntryType::Output);
                    end;
                "Order Type"::Assembly:
                    if (ItemLedgEntryType = "Entry Type"::"Assembly Output") then
                        exit(BOMEntryType::Output);
                else
                    if IsBOMOrderType(OrderType) then
                        if (ItemLedgEntryType = "Entry Type"::"Positive Adjmt.") then
                            exit(BOMEntryType::Output);
            end;
        exit(BOMEntryType::"Non-Output");
    end;

    procedure ResetItemReg(): Boolean
    var
        LastItemReg: Record "Item Register";
    begin
        // P8001227
        if (ItemReg."No." <> 0) then begin
            LastItemReg.FindLast;
            if (LastItemReg."No." <> ItemReg."No.") then
                exit(true);
        end;
        if PostToGL then
            exit(InventoryPostingToGL.ResetGLReg());
    end;

    procedure SetContainerFunctions(var ContFns: Codeunit "Container Functions")
    begin
        // P8001342
        ContainerFns := ContFns;
    end;

    local procedure ForceContainerPosting(ItemJnlLine: Record "Item Journal Line"): Boolean
    begin
        // P8001323
        with ItemJnlLine do
            exit(("Entry Type" = "Entry Type"::Transfer) and (("Old Container ID" <> '') or ("New Container ID" <> '')));
    end;

    local procedure RemoveFromContainer(ItemJnlLine: Record "Item Journal Line")
    var
        ContainerFunctions: Codeunit "Container Functions";
        Handled: Boolean;
        OriginalQty: Decimal; // P800145506
    begin
        // P8001323
        // P80079197
        OnBeforeRemoveFromContainer(ItemJnlLine, Handled);
        if Handled then
            exit;
        // P80079197
        if (ItemJnlLine."Old Container ID" = '') or
               ((ItemJnlLine."Line No." = ItemJnlLine."Container Master Line No.") and (ItemJnlLine."Sample Test No." = 0) and // P800122712, P800164365
                (not (ItemJnlLine."Document Type" in ["Item Ledger Document Type"::"Inventory Receipt", "Item Ledger Document Type"::"Inventory Shipment"]))) // P800127049
            then
            exit;

        ContainerHeader.Get(ItemJnlLine."Old Container ID");
        if not ContainerHeader.Mark then begin
            ContainerHeader.TestField("Bin Code", ItemJnlLine."Bin Code");

            if (ItemJnlLine."Container Master Line No." <> 0) and
              ((ItemJnlLine."Location Code" <> ItemJnlLine."New Location Code") or (ItemJnlLine."Bin Code" <> ItemJnlLine."New Bin Code"))
            then begin
                ContainerHeader.Mark(true);
                ContainerHeader.Validate("Location Code", ItemJnlLine."New Location Code");
                ContainerHeader.Validate("Bin Code", ItemJnlLine."New Bin Code");
                ContainerHeader.Modify;
            end;
        end;

        if ItemJnlLine."Container Master Line No." <> 0 then
            exit;

        // P800145506
        if ItemJnlLineOrigin."Quantity (Base)" = ItemJnlLine."Quantity (Base)" then
            OriginalQty := ItemJnlLineOrigin.Quantity
        else
            OriginalQty := Round(ItemJnlLine.Quantity / ItemJnlLine."Qty. per Unit of Measure", 0.00001);
        // P800145506
        PostContainerLine.SetUsageParms(ItemJnlLine."Posting Date", ItemJnlLine."Document No.", '', ItemJnlLine."Source Code");
        ContainerFunctions.RemoveFromContainer(ItemJnlLine."Old Container ID", ItemJnlLine."Item No.", ItemJnlLine."Variant Code",
          ItemJnlLine."Unit of Measure Code", ItemJnlLine."Lot No.", ItemJnlLine."Serial No.", Abs(OriginalQty), Abs(ItemJnlLine."Quantity (Alt.)"), // P800145506
          PostContainerLine);
    end;

    local procedure AddToContainer(ItemJnlLine: Record "Item Journal Line")
    var
    ...
    begin
        // P8001323
        if (ItemJnlLine."New Container ID" = '') or (ItemJnlLine."Container Master Line No." <> 0) then
            exit;

        if ItemJnlLine."Entry Type" <> ItemJnlLine."Entry Type"::Transfer then begin
            LotNo := ItemJnlLine."Lot No.";
            SerialNo := ItemJnlLine."Serial No.";
        end else begin
            LotNo := ItemJnlLine."New Lot No.";
            SerialNo := ItemJnlLine."New Serial No.";
        end;
        ...
        ContainerLine.Reset;
        ContainerLine.SetRange("Container ID", ItemJnlLine."New Container ID");
        ContainerLine.SetRange("Item No.", ItemJnlLine."Item No.");
        ContainerLine.SetRange("Variant Code", ItemJnlLine."Variant Code");
        ContainerLine.SetRange("Unit of Measure Code", ItemJnlLine."Unit of Measure Code");
        ...
        if ContainerLine.FindFirst then begin
            ...
            if (Item."Alternate Unit of Measure" <> '') and Item."Catch Alternate Qtys." then
                ContainerLine."Quantity (Alt.)" += Abs(ItemJnlLine."Quantity (Alt.)");
            AltQty := ContainerLine."Quantity (Alt.)"; // P80071900
            ContainerLine.Quantity += Abs(OriginalQty);  // P80041717 // P80093156
            ContainerLine.Validate(Quantity);
            if (Item."Alternate Unit of Measure" <> '') and Item."Catch Alternate Qtys." then
                ContainerLine.Validate("Quantity (Alt.)", AltQty); // P80071900
            ...
            ContainerLine.Init;
            ContainerLine."Container ID" := ItemJnlLine."New Container ID";
            ContainerLine.Validate("Item No.", ItemJnlLine."Item No.");
            ContainerLine.Validate("Variant Code", ItemJnlLine."Variant Code");
            ContainerLine.Validate("Unit of Measure Code", ItemJnlLine."Unit of Measure Code");
            ContainerLine.Validate("Lot No.", LotNo);
            ContainerLine.Validate("Serial No.", SerialNo);
            ContainerLine.Validate(Quantity, Abs(OriginalQty));  // P80041717 // P80093156
            // P80071900
            if (Item."Alternate Unit of Measure" <> '') and Item."Catch Alternate Qtys." then
                ContainerLine.Validate("Quantity (Alt.)", Abs(ItemJnlLine."Quantity (Alt.)"));
            // P80071900
            ContainerLine.Insert;
        end;

        PostContainerUse(ItemJnlLine, ContainerLine, ContainerLine2.Quantity, ContainerLine2."Quantity (Alt.)");
        OnAfterAddToContainer(ItemJnlLine, ContainerLine); // P80079197
    end;

    local procedure PostContainerUse(ItemJnlLine: Record "Item Journal Line"; ContainerLine: Record "Container Line"; OriginalQty: Decimal; OriginalQtyAlt: Decimal)
    begin
        // P8001323
    ...
    local procedure CheckIsCyclicalLoop(ItemLedgEntry: Record "Item Ledger Entry"; OldItemLedgEntry: Record "Item Ledger Entry"; var PrevAppliedItemLedgEntry: Record "Item Ledger Entry"; var AppliedQty: Decimal; var AppliedAltQty: Decimal)
    var
        PrevProcessedProdOrder: Boolean;
        IsHandled: Boolean;
    begin
        // P8004516 - add parameter AppliedAltQty
        IsHandled := false;
        ...
        if not PrevProcessedProdOrder then
            if (AppliedQty <> 0) or (AppliedAltQty <> 0) then // P8004516
                if ItemLedgEntry.Positive then begin
                    if ItemApplnEntry.CheckIsCyclicalLoop(ItemLedgEntry, OldItemLedgEntry) then begin // P8004516
                        AppliedQty := 0;
                        AppliedAltQty := 0;                                                            // P8004516
                    end;                                                                             // P8004516
                end else
                    if ItemApplnEntry.CheckIsCyclicalLoop(OldItemLedgEntry, ItemLedgEntry) then begin // P8004516
                        AppliedQty := 0;
                        AppliedAltQty := 0;                                                            // P8004516
                    end;                                                                             // P8004516
    ...
    local procedure XferRegsToWhse(var WhseJnlPostLine: Codeunit "Whse. Jnl.-Register Line")
    var
    ...
    begin
        // P805529
        InventoryPostingToGL.GetGLRegister(GLReg2, NextVATEntryNo2, NextTransactionNo2);
        WhseJnlPostLine.SetRegisters2(ItemReg, ItemApplnEntryNo, GLReg2, NextVATEntryNo2, NextTransactionNo2);
    end;

    local procedure XferRegsFromWhse(var WhseJnlPostLine: Codeunit "Whse. Jnl.-Register Line")
    var
        GLReg2: Record "G/L Register";
        NextVATEntryNo2: Integer;
        NextTransactionNo2: Integer;
    begin
        // P805529
        WhseJnlPostLine.GetRegisters2(ItemReg, ItemApplnEntryNo, GLReg2, NextVATEntryNo2, NextTransactionNo2);
        ItemLedgEntryNo := ItemReg."To Entry No.";
        PhysInvtEntryNo := ItemReg."To Phys. Inventory Entry No.";
        ValueEntryNo := ItemReg."To Value Entry No.";
        CapLedgEntryNo := ItemReg."To Capacity Entry No.";
        InventoryPostingToGL.SetGLRegister(GLReg2, NextVATEntryNo2, NextTransactionNo2);
    end;
    ...
    begin
        with ItemLedgEntry do
            // P80050651
            if ("Entry Type" = "Entry Type"::"Positive Adjmt.") and IsBOMOrderType then
                Readjust := true
            else
                // P80050651
    ...
    [IntegrationEvent(false, false)]
    local procedure OnAfterAddToContainer(var ItemJournalLine: Record "Item Journal Line"; var ContainerLine: Record "Container Line")
    begin
        // P80079197
    end;

    [IntegrationEvent(false, false)]
    local procedure OnBeforeRemoveFromContainer(var ItemJournalLine: Record "Item Journal Line"; var Handled: Boolean)
    begin
        // P80079197
    end;

    [IntegrationEvent(false, false)]
    local procedure OnBeforePostWhseLineAndRndgAdjmts()
    begin
        // P80082969
    end;

    [IntegrationEvent(false, false)]
    local procedure OnPostWhseLineAndRndgAdjmtsOnBeforeWhseJnlRegisterLine(var ItemJournalLine: Record "Item Journal Line"; var WarehouseJournalLine: Record "Warehouse Journal Line")
    begin
        // P80082969
    end;
    ...
    // P800147498
    [IntegrationEvent(false, false)]
    local procedure OnBeforeP800ItemTrackingPostLotData(var LotNoInformation: Record "Lot No. Information"; var ItemJnlLine: Record "Item Journal Line"; var TempTrackingSpecification: Record "Tracking Specification" temporary; var CalcExpirationDate: Date; var CalcReleaseDate: Date)
    begin
    end;
