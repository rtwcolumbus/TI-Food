                            ...
                            repeat
                                if (ECToPost."Cost To Post (Expected)" <> 0) or (ECToPost."Cost To Post (Expected) (ACY)" <> 0) then begin
                                    ...
                                    InitInvtPostBuf(
                                      ...
                                      TempGlobalInvtPostingBuffer."Account Type"::FOODInvtAccrualECInterim,
                                ...
                                if (ECToPost."Cost To Post" <> 0) or (ECToPost."Cost To Post (ACY)" <> 0) then begin
                                    ...
                                    InitInvtPostBuf(
                                      ...
                                      TempGlobalInvtPostingBuffer."Account Type"::FOODDirectCostAppliedEC,
                                      //ECToPost."Extra Charge Code", // P8000466A
                            ...
                            repeat
                                ...
                                if PostABCToGL then begin                                      // P8000466A
                                    ...
                                    InitInvtPostBuf(                                             // P8000466A
                                      ValueEntry,
                                      TempGlobalInvtPostingBuffer."Account Type"::Inventory,
                                      TempGlobalInvtPostingBuffer."Account Type"::FOODABCDirect,
                                ...
                                if PostABCToGL then begin                                      // P8000466A
                                    ...
                                    InitInvtPostBuf(                                             // P8000466A
                                      ValueEntry,
                                      TempGlobalInvtPostingBuffer."Account Type"::Inventory,
                                      TempGlobalInvtPostingBuffer."Account Type"::FOODABCOverhead,
                                      //ValueEntryABCDetail."Resource No.",                      // P8000466A
                                      ABCCostToPost, ABCCostToPostACY, false);
                                end;                                                           // P8000466A
                            ...
                            case ItemLedgerEntry."Writeoff Responsibility" of
                                ...
                                ItemLedgerEntry."Writeoff Responsibility"::Company:
                                    InitInvtPostBuf(
                                      ValueEntry,
                                      TempGlobalInvtPostingBuffer."Account Type"::Inventory,
                                      TempGlobalInvtPostingBuffer."Account Type"::FOODWriteoffCompany,
                                      CostToPost, CostToPostACY, false); // PR4.00
                                ItemLedgerEntry."Writeoff Responsibility"::Vendor:
                                    InitInvtPostBuf(
                                      ValueEntry,
                                      TempGlobalInvtPostingBuffer."Account Type"::Inventory,
                                      TempGlobalInvtPostingBuffer."Account Type"::FOODWriteoffVendor,
                                      CostToPost, CostToPostACY, false); // PR4.00
                            end;
                        end;
                        // PR3.61.01 End
    ...
    begin
        with TempGlobalInvtPostingBuffer do begin
            ...
            if TempInvtPostBuf.Find('-') then     // P8000466A
                repeat                                // P8000466A
                    TempGlobalInvtPostingBuffer := TempInvtPostBuf; // P8000466A
                    ...
                    if Find() then begin
                        ...
                        OnUpdateGlobalInvtPostBufOnBeforeModify(TempGlobalInvtPostingBuffer, TempInvtPostBuf); // P800-MegaApp
                        Modify();
                    end else begin
    ...
    begin
        with ValueEntry do begin
            ...
            if ProcessFns.FreshProInstalled then
                ExtraChargeMgmt.UpdatePostedCharge("Entry No.", TempGlobalInvtPostingBuffer."Interim Account");
            if InvtSetup."ABC Detail Posting" and (not TempGlobalInvtPostingBuffer."Interim Account") then begin
                ValueEntryABCDetail.SetRange("Entry No.", "Entry No.");
