codeunit 1104 "Cost Account Allocation"
{
    ...
    begin
        // CalcItemShare(CostAllocationTarget,ValueEntry."Item Ledger Entry Type"::Sale,ValueEntry.FIELDNO("Invoiced Quantity")); // P8001143
        CalcItemShare(CostAllocationTarget, ValueEntry."Item Ledger Entry Type"::Sale, ValueEntry.FieldNo("Sales Quantity"));       // P8001143
    end;
    ...
    begin
        case SumFieldNo of
            ...
            ValueEntry.FieldNo("Purchase Amount (Actual)"):
                ...
                // P8001143
            ValueEntry.FieldNo("Sales Quantity"):
                begin
                    ValueEntry.CalcSums("Sales Quantity");
                    exit(ValueEntry."Sales Quantity");
                end;
                // P8001143
        end;
    end;
