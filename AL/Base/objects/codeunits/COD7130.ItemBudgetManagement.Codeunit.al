codeunit 7130 "Item Budget Management"
{
    ...
    procedure BudgetDrillDown(ItemBudgetName: Record "Item Budget Name"; ItemFilter: Text; SourceTypeFilter: Option; SourceNoFilter: Text; DateFilter: Text; GlobalDim1Filter: Text; GlobalDim2Filter: Text; BudgetDim1Filter: Text; BudgetDim2Filter: Text; BudgetDim3Filter: Text; RowDimOption: Option Item,Customer,Vendor,Period,Location,"Global Dimension 1","Global Dimension 2","Budget Dimension 1","Budget Dimension 2","Budget Dimension 3"; RowDimCodeBuf: Record "Dimension Code Buffer"; ColDimOption: Option Item,Customer,Vendor,Period,Location,"Global Dimension 1","Global Dimension 2","Budget Dimension 1","Budget Dimension 2","Budget Dimension 3"; ColDimCodeBuf: Record "Dimension Code Buffer"; ValueType: Option "Sales Amount","Cost Amount",Quantity,,"Sales Amount (FOB)","Sales Amount (Freight)"; LinesOnly: Boolean)
    begin
    ...
    begin
        ...
        case ValueType of
            ...
            ValueType::FOODSalesAmountFOB:
                begin
                    ItemStatisticsBuf.CalcFields("Budg. Sales Amount (FOB)");
                    exit(ItemStatisticsBuf."Budg. Sales Amount (FOB)");
                end;
            ValueType::FOODSalesAmountFreight:
                begin
                    ItemStatisticsBuf.CalcFields("Budg. Sales Amount (Freight)");
                    exit(ItemStatisticsBuf."Budg. Sales Amount (Freight)");
                end;
            // P8000921
            ValueType::"Cost Amount":
                begin
    ...
    begin
        ...
        case ValueType of
            ...
            ValueType::FOODSalesAmountFOB:
                begin
                    ItemStatisticsBuf.CalcFields("Budg. Sales Amount (FOB)");
                    ItemStatisticsBuf.Validate("Budg. Sales Amount (FOB)", NewAmount);
                end;
            ValueType::FOODSalesAmountFreight:
                begin
                    ItemStatisticsBuf.CalcFields("Budg. Sales Amount (Freight)");
                    ItemStatisticsBuf.Validate("Budg. Sales Amount (Freight)", NewAmount);
                end;
            // P8000921
            ValueType::"Cost Amount":
                begin
