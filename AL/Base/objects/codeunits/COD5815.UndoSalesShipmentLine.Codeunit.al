codeunit 5815 "Undo Sales Shipment Line"
{
    ...
    begin
        ...
        UndoPostingMgt.UpdateSalesLine(
            ...
            SalesShptLine."Quantity (Base)" - SalesShptLine."Qty. Invoiced (Base)", SalesShptLine."Quantity (Alt.)" - SalesShptLine."Qty. Invoiced (Alt.)", TempGlobalItemLedgEntry);  // P8000267B
