table 32 "Item Ledger Entry"
{
    ...
    //   Refactoring for calculating reserved quantity
...
#pragma warning restore AS0009
    ...
    begin
        ...
        IsHandled := false;
        OnBeforeCalculateRemQuantity(Rec, ItemLedgEntryNo, PostingDate, RemQty, RemQtyAlt, IsHandled);
        if IsHandled then
            exit;
    ...
    begin
        ...
        if "Serial No." = '' then
            CalcFields("Reserved Quantity", "Reserved Quantity (Alt.)") // // P800155629
        else begin
            ...
            ReservationEntry.CalcSums("Quantity (Base)", "Quantity (Alt.)"); // // P800155629
            "Reserved Quantity (Alt.)" := ReservationEntry."Quantity (Alt.)";
    ...
    [IntegrationEvent(false, false)]
    local procedure OnBeforeCalculateRemQuantity(ItemLedgerEntry: Record "Item Ledger Entry"; ItemLedgEntryNo: Integer; PostingDate: Date; var RemQty: Decimal; var RemQtyAlt: Decimal; var IsHandled: Boolean)
    begin
    end;
