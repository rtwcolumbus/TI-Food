table 242 "Source Code Setup"
{
    ...
    //   Field 37002560 - Container Journal - Code 10
    // 
    // PR3.70.08
    ...
    fields
    {
        field(37002120; "Accrual Journal"; Code[10])
        {
            Caption = 'Accrual Journal';
            Description = 'PR3.70.03';
            TableRelation = "Source Code";
        }
        field(37002121; "Scheduled Accrual Journal"; Code[10])
        {
            Caption = 'Scheduled Accrual Journal';
            TableRelation = "Source Code";
        }
        field(37002190; "Deduction Management"; Code[10])
        {
            Caption = 'Deduction Management';
            Description = 'PR3.70.08';
            TableRelation = "Source Code";
        }
        field(37002210; "Repack Order"; Code[10])
        {
            Caption = 'Repack Order';
            TableRelation = "Source Code";
        }
        field(37002400; "NAV Anywhere"; Code[10])
        {
            ObsoleteState = Pending;
            ObsoleteReason = 'Functionality moved to FOODANY Extension App';
            ObsoleteTag = 'FOOD-16';
        }
        field(37002560; "Container Journal"; Code[10])
        {
        ...
        field(37002680; "Commodity Cost Adjustment"; Code[10])
        {
            Caption = 'Commodity Cost Adjustment';
            TableRelation = "Source Code";
        }
        field(37002685; "Commodity Manifest"; Code[10])
        {
            Caption = 'Commodity Manifest';
            TableRelation = "Source Code";
        }
        field(37002800; "Work Order"; Code[10])
        {
            Caption = 'Work Order';
            TableRelation = "Source Code";
        }
        field(37002801; "Maintenance Labor Journal"; Code[10])
        {
            Caption = 'Maintenance Labor Journal';
            TableRelation = "Source Code";
        }
        field(37002802; "Maintenance Material Journal"; Code[10])
        {
            Caption = 'Maintenance Material Journal';
            TableRelation = "Source Code";
        }
        field(37002803; "Maintenance Contract Journal"; Code[10])
        {
            Caption = 'Maintenance Contract Journal';
            TableRelation = "Source Code";
        }
        field(37002804; "Maintenance Journal"; Code[10])
        {
            Caption = 'Maintenance Journal';
            TableRelation = "Source Code";
        }
        // P800122712
        field(37002543; "Quality Control Sample"; Code[10])
        {
