table 7390 "Create Pick Parameters"
{
    ...
    fields
    {
        field(37002000; "Disable Remaining Qty. Line"; Boolean)
        {
            Caption = 'Disable Remaining Qty. Line';
            DataClassification = SystemMetadata;
        }
        field(37002001; "Create Pick Per Source Doc."; Boolean)
        {
            Caption = 'Create Pick Per Source Doc.';
            DataClassification = SystemMetadata;
        }
        ...
        field(3; "Whse. Document"; Option)
        {
            ...
            OptionCaption = 'Pick Worksheet,Shipment,Movement Worksheet,Internal Pick,Production,Assembly,Staged Pick,Delivery Trip Pick,Delivery Trip,Job';
            OptionMembers = "Pick Worksheet",Shipment,"Movement Worksheet","Internal Pick",Production,Assembly,FOODStagedPick,FOODDeliveryTripPick,FOODDeliveryTrip,Job;
            DataClassification = SystemMetadata;
        }
