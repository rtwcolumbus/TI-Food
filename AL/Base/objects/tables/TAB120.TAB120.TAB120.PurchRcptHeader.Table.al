table 120 "Purch. Rcpt. Header"
{
    ...
    //   Added field Pickup Location Code and Pickup Load No.
    // 
    // PRW16.00.04
    ...
    keys
    {
        ...
        key(Key5; "Posting Date", "Pay-to Vendor No.", "Buy-from Vendor No.")
        {
        }
    ...
    var
        PurchRcpt: Record "Purch. Rcpt. Header";
        LabelWorksheetLine: Record "Label Worksheet Line" temporary;
        ReceivingLabelMgmt: Codeunit "Label Worksheet Management";
    begin
        // P8001047
        PurchRcpt := Rec;
        PurchRcpt.SetRecFilter;
        ReceivingLabelMgmt.WorksheetLinesForPurchRcpt(PurchRcpt, LabelWorksheetLine);
