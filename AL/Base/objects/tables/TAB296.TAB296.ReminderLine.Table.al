    ...
    fields
    {
        ...
        field(5; "Entry No."; Integer)
        {
            ...
            begin
                ...
                "Unresolved Deduction" := CustLedgEntry."Unresolved Deduction"; // P8002753
        ...
        field(37002190; "Unresolved Deduction"; Boolean)
        {
            AccessByPermission = TableData "Deduction Line" = R;
