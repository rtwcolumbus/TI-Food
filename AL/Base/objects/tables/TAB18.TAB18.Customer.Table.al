table 18 Customer
{
    // PR3.60
    //   New Fields
    //     Add Price Orders at Shipment
    //     Default Delivery Route No.
    //     Default Delivery Stop No.
    // 
    // PR3.70
    //   New Fields
    ...
    // 
    // PRW16.00.20
    // P8000663, VerticalSoft, Jack Reynolds, 23 JAN 09
    //   Add fields "No. of Standing Orders" and "Bill-To No. of Standing Orders"
    // 
    // PRW16.00.05
    // P8000921, Columbus IT, Don Bresee, 07 APR 11
    //   Add "FOB Pricing" field
    // 
    ...
    fields
    {
        field(37002000; "Minimum Order Basis"; Option)
        {
            ...
            OptionCaption = ' ,None,Amount,Weight,Quantity';
            OptionMembers = " ","None",Amount,Weight,Quantity;

            trigger OnValidate()
            begin
                // P8000126A
                if ("Minimum Order Basis" <> xRec."Minimum Order Basis") or
                   ("Minimum Order Basis" in ["Minimum Order Basis"::" ", "Minimum Order Basis"::None]) then begin
        ...
        field(37002040; "Price Orders at Shipment"; Boolean)
        {
            Caption = 'Price Orders at Shipment';
            Description = 'PR3.10';
        }
        field(37002041; "Allow Off-Invoice Allowance"; Boolean)
        {
            Caption = 'Allow Off-Invoice Allowance';
            Description = 'PR3.70';
        }
        ...
        field(37002061; "Default Delivery Stop No."; Code[20])
        {
            Caption = 'Default Delivery Stop No.';
            Description = 'PR3.10';
        }
        field(37002062; "No. of Standing Orders"; Integer)
        {
            CalcFormula = Count ("Sales Header" WHERE("Document Type" = CONST(FOODStandingOrder),
                                                      "Sell-to Customer No." = FIELD("No.")));
            Caption = 'No. of Standing Orders';
            Editable = false;
            FieldClass = FlowField;
        }
        field(37002063; "Bill-To No. of Standing Orders"; Integer)
        {
            CalcFormula = Count ("Sales Header" WHERE("Document Type" = CONST(FOODStandingOrder),
                                                      "Bill-to Customer No." = FIELD("No.")));
            Caption = 'Bill-To No. of Standing Orders';
            Editable = false;
            FieldClass = FlowField;
        }
        field(1; "No."; Code[20])
    ...
    keys
    {
        ...
        key(Key37002000; "Default Delivery Route No.", "Default Delivery Stop No.")
        {
        }
    }
