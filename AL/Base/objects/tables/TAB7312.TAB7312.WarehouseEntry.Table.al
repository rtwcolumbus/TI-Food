table 7312 "Warehouse Entry"
{
    ...
    //   Add remaining qty fields, change "Open" key
    //   Staged Picks
    // 
    // PR5.00
    // P8000466A, VerticalSoft, Jack Reynolds, 31 JUL 07
    //   Add keys for Lot an Serial number
    // 
    // PRW15.00.01
    // P8000592A, VerticalSoft, Don Bresee, 13 MAR 08
    //   Add new fields - Quantity (Alt.), Remaining Qty. (Alt.)
    // 
    // PRW15.00.03
    ...
    //   Add SumIndexFields to improve Bin Status performance
    ...
    fields
    {
        ...
        field(37002001; "Registering Date/Time"; DateTime)
        {
            Caption = 'Registering Date/Time';
        }
        field(37002020; Open; Boolean)
        {
            Caption = 'Open';
        }
        field(37002021; "Remaining Quantity"; Decimal)
        {
            Caption = 'Remaining Quantity';
            DecimalPlaces = 0 : 5;
        }
        field(37002022; "Remaining Qty. (Base)"; Decimal)
        {
        ...
        field(37002081; "Remaining Qty. (Alt.)"; Decimal)
        {
            AccessByPermission = TableData "Alternate Quantity Line" = R;
            BlankZero = true;
            CaptionClass = StrSubstNo('37002080,0,7,%1', "Item No.");
            Caption = 'Remaining Qty. (Alt.)';
            DecimalPlaces = 0 : 5;
            Description = 'P8000591A';
        }
    }
...
#pragma warning restore AS0009
        {
            SumIndexFields = "Qty. (Base)", Quantity, Cubage, Weight;
        }
        ...
        key(Key37002000; "Location Code", "Bin Code", "Item No.", "Variant Code", "Unit of Measure Code", Open, "Lot No.", "Serial No.")
        {
            SumIndexFields = "Remaining Quantity", "Remaining Qty. (Base)", "Remaining Qty. (Alt.)", Quantity, "Qty. (Base)";
        }
    }
