table 5766 "Warehouse Activity Header"
{
    ...
    //   Add field to identify picks/put-aways related to delivery trips
    // 
    // PRW19.00
    ...
    fields
    {
        ...
        field(3; "Location Code"; Code[10])
        {
            ...
            begin
                ...
                case Type of
                    Type::"Invt. Put-away":
                        if not Location.RequirePutaway("Location Code") then // P8000282A
                            Location.TestField("Require Put-away", true)        // P8000282A
                        else                                                 // P8000282A
                    ...
                    Type::"Invt. Pick":
                        if not Location.RequirePicking("Location Code") then // P8000282A
                            Location.TestField("Require Pick", true)            // P8000282A
                        else                                                 // P8000282A
    ...
    begin
        ...
        if Type = Type::Pick then
            BindSubscription(OrderShippingReceiving);
        // P80071648
        WhseActivLine2.SetRange("Activity Type", Type);
        WhseActivLine2.SetRange("No.", "No.");
