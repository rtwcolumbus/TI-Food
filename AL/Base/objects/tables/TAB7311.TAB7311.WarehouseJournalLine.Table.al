table 7311 "Warehouse Journal Line"
{
    ...
    //   Fix problem with From and To bins when zero quantity and non-zero alternate quantity
    //   Warehouse Item Journal Fix
    //
    // PRW120.4
    ...
    //   Code removed to avoid Container error in Warehouse Phy. Inv. Journals. 
    ...
    fields
    {
        ...
        field(10; Quantity; Decimal)
        {
            ...
            begin
                ...
                then
                    if not "Phys. Inventory" then // P800160088
                        ExchangeFromToBin();
...
#pragma warning restore AS0009
    ...
    // P800160088
    local procedure IsPositive(): Boolean
    begin
        exit((Quantity > 0) or ((Quantity = 0) and ("Quantity (Alt.)" >= 0)));
    end;

    // P800160088
    local procedure FixFromToBin(): Boolean
    begin
