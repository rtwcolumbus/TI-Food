table 13 "Salesperson/Purchaser"
{
    ...
    fields
    {
        ...
        field(37002000; "User ID"; Code[50])
        {
            Caption = 'User ID';
    ...
    var
        ...
        Text37002000: Label 'You can have only one %1 per User ID.';
    ...
    procedure CheckDuplicateUser()
    var
        SalespersonPurchaser: Record "Salesperson/Purchaser";
    begin
        // P8000941
        if ("User ID" = '') or ("User ID" = xRec."User ID") then // P800163700
            exit;
        SalespersonPurchaser.SetRange("User ID", "User ID");
        SalespersonPurchaser.SetFilter(Code, '<>%1', Code);
        if not SalespersonPurchaser.IsEmpty then
            Error(Text37002000, TableCaption);
    end;
