table 83 "Item Journal Line"
{
    ...
    // 
    // PR3.10
    //   Add fields for expected quantity (from output and consumption journals)
    //   Add key for production order number
    // 
    // PR3.60
    //   Add fields/logic for alternate quantities
    // 
    // PR3.61
    //   Add fields/logic for item tracking on physical count
    //   Add fields/logic for container tracking
    // 
    // PR3.61.01
    //   Add Fields
    //     Writeoff Responsibility
    //   Set Phys. Inventory in SetupNewLine
    // 
    // PR3.70.01
    //   New Fields
    ...
    // 
    // PR3.70.05
    // P8000064A, Myers Nissi, Jack Reynolds, 28 JUN 04
    //   PostedQuantity - returns quantity already posted for output and consumption entries
    //   ConsumedIntermediate - returns TRUE if line is for consumption of an intermediate on a suborder;
    //     also returns (as parameters) the production order number and line number of the intermediate
    // 
    // P8000065A, Myers Nissi, Jack Reynolds, 28 JUN 04
    //   Field 13 - Quantity
    //   UpdateLotTracking - clear the EasyLT flag
    //   SetEasyLotTracking - set the EasyLT flag
    // 
    // PR3.70.06
    // P8000070A, Myers Nissi, Jack Reynolds, 15 JUL 04
    //   Field 3 - Item No.
    // 
    // P8000073A, Myers Nissi, Jack Reynolds, 21 JUL 04
    //   PostedQuantity - adjust quantity by "Qty. per Unit of Measure"
    // 
    // P8000078A, Myers Nissi, Steve Post, 26 JUL 04
    //    Add Field
    //      Exclude from Sales Forecast
    // 
    ...
    // 
    // P8000086A, Myers Nissi, Jack Reynolds, 11 AUG 04
    //   Skip calls to item tracking VerifyChange if physical inventory and tracking is installed
    // 
    // P8000093A, Myers Nissi, Jack Reynolds, 20 AUG 04
    //   PostedQuantity - modify to return result for consumption lines without a component line
    // 
    // P8000106A, Myers Nissi, Jack Reynolds, 02 SEP 04
    //   Modify to support alternate quantities in revaluation journal
    // 
    // P8000111A, Myers Nissi, Jack Reynolds, 09 SEP 04
    //   Added function to support drill down on posted quantity
    // 
    // PR3.70.07
    // P8000142A, Myers Nissi, Jack Reynolds, 18 NOV 04
    //   GetCostingQty - exit with zero if line is for a container
    // 
    ...
    //   Function to check lot preferences
    // 
    // PR3.70.08
    // P8000172A, Myers Nissi, Jack Reynolds, 20 JAN 05
    //   CheckLotPreference - exit with TRUE if not a consumption line or lot tracking not installed
    // 
    // PR3.70.10
    // P8000222A, Myers Nissi, Jack Reynolds, 16 JUN 05
    //   Fix problem iwth revaluation of output entries where Invoiced Quantity (Alt.) was not being set
    // 
    ...
    //   For capacity lines call function to set costs from ABC
    // 
    // P8000250B, Myers Nissi, Jack Reynolds, 17 OCT 05
    //   Support for automatic lot number assignment on inbound purchases, sales, output
    // 
    // PR4.00.01
    // P8000271A, VerticalSoft, Jack Reynolds, 06 DEC 05
    //   Fix problem where ReserveItemJnlLine.VerifyChange was deleting tracking lines created by easy lot tracking
    // 
    // P8000276A, VerticalSoft, Jack Reynolds, 03 JAN 06
    //   Fix problem with zero quantity and non-zero alternate quantity
    // 
    // PR4.00.02
    // P8000296A, VerticalSoft, Jack Reynolds, 13 FEB 06
    //   Clear produciton order component line number if item is not amoung the components
    // 
    // P8000300A, VerticalSoft, Jack Reynolds, 21 FEB 06
    //   Fix problem validating location code when no item number has been specified
    // 
    // P8000308A, VerticalSoft, Jack Reynolds, 10 MAR 06
    //   Set alternate physical quantity when base physical quantity is entered
    // 
    // P8000313A, VerticalSoft, Jack Reynolds, 22 MAR 06
    ...
    //   Add function to return Boolean indicating if lot tracking is required
    // 
    // PR4.00.03
    // P8000343A, VerticalSoft, Jack Reynolds, 05 JUN 06
    //   Enhanced to support easy lot tracking for new lot number in reclass journal
    // 
    // PR4.00.04
    // P8000366A, VerticalSoft, Jack Reynolds, 15 AUG 06
    //   Fix "another user has modified ..." problem with OpenItemTrackingLines
    // 
    ...
    //   Add field Bypass Pick
    // 
    // PR4.00.05
    // P8000411A, VerticalSoft, Jack Reynolds, 03 NOV 06
    //   Create dimension for physical journal records
    // 
    // P8000421A, VerticalSoft, Jack Reynolds, 06 DEC 06
    //   Fix problems with PostedQuantity function when production order component line number is zero
    // 
    // PR4.00.06
    // P8000478A, VerticalSoft, Jack Reynolds, 30 MAY 07
    //   Don't allow changing UOM on physical journal
    // 
    ...
    //  UpdateLotTracking - additional code to allow deletion of trcking lines
    // 
    // P8000494A, VerticalSoft, Don Bresee, 18 JUL 07
    //   Remove "Bypass Pick", add "Override Loose Lot Control"
    // 
    // PRW15.00.01
    ...
    //   Allow deletion of tracking lines with deletion of journal line
    // 
    // P8000581A, VerticalSoft, Jack Reynolds, 20 FEB 08
    //   Remove "Exclude From Sales Forecast"
    // 
    // P8000586A, VerticalSoft, Jack Reynolds, 01 MAR 08
    //   Fix problem clearing alternate quantity if item number is changed
    // 
    // P8000548A, VerticalSoft, Don Bresee, 05 MAR 08
    //   Add new field - Rounding Adjustment Type
    // 
    // PRW15.00.02
    // P8000607A, VerticalSoft, Jack Reynolds, 20 JUN 08
    //   Fix calculation of Posted Quantity for consumption lines
    // 
    // PRW15.00.03
    ...
    // 
    // PRW16.00.02
    // P8000756, VerticalSoft, Jack Reynolds, 05 JAN 10
    ...
    // 
    // P8000874, VerticalSoft, Jack Reynolds, 01 OCT 10
    //   Fix problem with dimensions being reset
    // 
    ...
    //   Add key for Phys. Invt. Jnl. sorting by bin, add logic for journal page
    // 
    ...
    //   Fix problem reassigning lot number when posting
    // 
    ...
    // 
    // PRW18.00.03
    // P8006536, To-Increase, Jack Reynolds, 26 FEB 16
    //   Fix problem with overheade rate and indirect % not coming from SKU
    // 
    // PRW19.00
    ...
    // 
    // P8008400, To-Increase, Jack Reynolds, 13 FEB 17
    //   Fix problem validating Amount when item is set to price in alternate units
    // 
    // P8008438, To-Increase, Jack Reynolds, 17 FEB 17
    //   Fix problem setting bin on output and cousumption lines
    // 
    // PRW110.0
    ...
    // 
    // PRW111.00.02
    // P80073223, To-Increase, Jack Reynolds, 12 APR 19
    //   Fix problem with Auto Lot Nos and Revaluation
    // 
    // P80074504, To-Increase, Gangabhushan, 16 MAY 19
    //   CS00060647 - Negative adjustment of item in container in item journal not possible
    // 
    // P80075859, To-Increase, Jack Reynolds, 18 JUN 19
    //   Problem with costing in alternate units and non-base unit of measure
    //
    // PRW111.00.03
    ...
    //
    // PRW121.4
    // P800164877, To Incrase, Gangabhushan, 07 Mar 23 
    //   Upgrade- Keys renumbered should be handled in next version
    ...
    fields
    {
        ...
        field(37002001; "Don't Apply"; Boolean)
        {
            Caption = 'Don''t Apply';
        }
        ...
        field(37002022; "New Lot Status Code"; Code[10])
        {
            ...
            trigger OnValidate()
            begin
                CheckMoveContainer(FieldCaption("New Lot Status Code")); // P8001323
                // P8001083
        ...
        field(37002049; "Amount (FOB)"; Decimal)
        {
            AutoFormatType = 1;
            BlankZero = true;
            Caption = 'Amount (FOB)';
        ...
        field(37002050; "Amount (Freight)"; Decimal)
        {
            AutoFormatType = 1;
            BlankZero = true;
            Caption = 'Amount (Freight)';
            Editable = false;
        }
        ...
        field(37002081; "Quantity (Alt.)"; Decimal)
        {
            ...
            begin
                ...
                if CurrFieldNo = FieldNo("Quantity (Alt.)") then
                ...
                if (CurrFieldNo = FieldNo("Quantity (Alt.)")) then begin
                    ...
                    AltQtyMgmt.CheckSummaryTolerance1("Alt. Qty. Transaction No.", "Item No.",
                                                     FieldCaption("Quantity (Alt.)"),
                                                     "Quantity (Base)", "Quantity (Alt.)");
                end;

                if ("Entry Type" = "Entry Type"::Output) and               // P8000222A
                   ("Value Entry Type" <> "Value Entry Type"::Revaluation) // P8000222A
                then                                                       // P8000222A
                    "Invoiced Qty. (Alt.)" := 0
                else
        ...
        field(37002085; "Invoiced Qty. (Alt.)"; Decimal)
        {
            AccessByPermission = TableData "Alternate Quantity Line" = R;
            BlankZero = true;
        ...
        field(37002088; "Qty. (Alt.) (Calculated)"; Decimal)
        {
            ...
            trigger OnValidate()
            begin
                Validate("Qty. (Alt.) (Phys. Inventory)"); // PR3.60
            end;
        }
        field(37002089; "Qty. (Alt.) (Phys. Inventory)"; Decimal)
        {
            ...
            begin
                ...
                if (CurrFieldNo = FieldNo("Qty. (Alt.) (Phys. Inventory)")) then begin
                    ...
                    Item.TestField("Catch Alternate Qtys.", true);
                    AltQtyMgmt.CheckSummaryTolerance1("Alt. Qty. Transaction No.", "Item No.",
                                                     FieldCaption("Qty. (Alt.) (Phys. Inventory)"),
                                                     "Qty. (Phys. Inventory)" * "Qty. per Unit of Measure",
                                                     "Qty. (Alt.) (Phys. Inventory)");
                end;

                "Quantity (Alt.)" := 0;
                // PR3.61
                if Quantity = 0 then
                    if "Qty. (Alt.) (Calculated)" <= "Qty. (Alt.) (Phys. Inventory)" then
                ...
                if ("Entry Type" = "Entry Type"::"Positive Adjmt.") then
                    ...
                    Validate("Quantity (Alt.)", "Qty. (Alt.) (Calculated)" - "Qty. (Alt.) (Phys. Inventory)");
                // PR3.60
            end;
        }
        field(37002090; "Scrap Quantity (Alt.)"; Decimal)
        {
            AccessByPermission = TableData "Alternate Quantity Line" = R;
            BlankZero = true;
            Caption = 'Scrap Quantity (Alt.)';
            DecimalPlaces = 0 : 5;
            Description = 'PR3.60';
        }
        field(37002100; "Pick Source Type"; Option)
        {
            Caption = 'Pick Source Type';
            ...
            begin
                // P8000631A
                CheckMoveContainer(FieldCaption("Pick Source Type")); // P8001323
                if "Pick Source Type" <> 0 then begin
                    TestField("Location Code");
                    GetLocation("Location Code");
                    Location.TestField("Shipment Bin Code (1-Doc)");
                    TestField("New Bin Code", Location."Shipment Bin Code (1-Doc)");
                end;
                if "Pick Source Type" <> xRec."Pick Source Type" then
                    Validate("Pick Source No.", '');
            end;
        }
        field(37002101; "Pick Source No."; Code[20])
        {
            Caption = 'Pick Source No.';
            Description = 'P8000631A';
            TableRelation = IF ("Pick Source Type" = CONST("Sales Order")) "Sales Header"."No." WHERE("Document Type" = CONST(Order),
                                                                                                     "Location Code" = FIELD("Location Code"))
            ELSE
            IF ("Pick Source Type" = CONST("Purchase Return Order")) "Purchase Header"."No." WHERE("Document Type" = CONST("Return Order"),
                                                                                                                                                                                                "Location Code" = FIELD("Location Code"))
            ELSE
            IF ("Pick Source Type" = CONST("Outbound Transfer")) "Transfer Header" WHERE("Transfer-from Code" = FIELD("Location Code"));

            trigger OnValidate()
            begin
                // P8000631A
                CheckMoveContainer(FieldCaption("Pick Source No.")); // P8001323
                if ("Pick Source No." <> '') then
                    TestField("Pick Source Type");
                if "Pick Source No." <> xRec."Pick Source No." then
                    Validate("Pick Source Line No.", 0);
                if "Pick Source No." <> '' then begin
                    TestField("Item No.");
                    CheckPickSourceDocLine;
                end;
            end;
        }
        field(37002102; "Pick Source Line No."; Integer)
        {
            BlankZero = true;
            Caption = 'Pick Source Line No.';
            Description = 'P8000631A';
            TableRelation = IF ("Item No." = FILTER(<> ''),
                                "Pick Source Type" = CONST("Sales Order")) "Sales Line"."Line No." WHERE("Document Type" = CONST(Order),
                                                                                                        "Document No." = FIELD("Pick Source No."),
                                                                                                        Type = CONST(Item),
                                                                                                        "No." = FIELD("Item No."))
            ELSE
            IF ("Item No." = FILTER(<> ''),
                                                                                                                 "Pick Source Type" = CONST("Purchase Return Order")) "Purchase Line"."Line No." WHERE("Document Type" = CONST("Return Order"),
                                                                                                                                                                                                      "Document No." = FIELD("Pick Source No."),
                                                                                                                                                                                                      Type = CONST(Item),
                                                                                                                                                                                                      "No." = FIELD("Item No."))
            ELSE
            IF ("Item No." = FILTER(<> ''),
                                                                                                                                                                                                               "Pick Source Type" = CONST("Outbound Transfer")) "Transfer Line"."Line No." WHERE("Document No." = FIELD("Pick Source No."),
                                                                                                                                                                                                                                                                                                "Item No." = FIELD("Item No."));

            trigger OnValidate()
            begin
                // P8000631A
                CheckMoveContainer(FieldCaption("Pick Source Line No.")); // P8001323
                if "Pick Source Line No." <> 0 then begin
                    TestField("Pick Source No.");
                    CheckPickSourceDocLine;
                end;
            end;
        }
        field(37002460; "Expected Output Quantity"; Decimal)
        {
            Caption = 'Expected Output Quantity';
            DecimalPlaces = 0 : 5;
            Description = 'PR3.10';
            Editable = false;
        }
        field(37002461; "Expected Quantity"; Decimal)
        {
        ...
        field(37002560; "Container License Plate"; Code[50])
        {
            ...
            begin
                ...
                if 0 < Sign then
                    Validate("New Container License Plate", "Container License Plate")
                else
                    Validate("Old Container License Plate", "Container License Plate");
            end;
        }
        field(37002561; "Old Container License Plate"; Code[50])
        {
            Caption = 'Container License Plate';
            ...
            begin
                // P8001323
                CheckMoveContainer(FieldCaption("Old Container License Plate"));

                if "Old Container License Plate" <> xRec."Old Container License Plate" then
                    if "Old Container License Plate" = '' then begin
                        "Old Container ID" := '';
                        if xRec."Old Container License Plate" = "New Container License Plate" then begin
                            "New Container License Plate" := '';
                            "New Container ID" := '';
                        end;
                    end else begin
                        ContainerHeader.SetRange("License Plate", "Old Container License Plate");
                        ...
                        // P80056718
                        if ("Entry Type" = "Entry Type"::Consumption) and (ContainerHeader."Document Type" = DATABASE::"Prod. Order Component") then begin
                            GetLocation("Location Code");
                            if Location."Pick Production by Line" then
                                ContainerDocumentLineNo := "Order Line No."
                            else
                                ContainerDocumentLineNo := 0;
                            if (ContainerHeader."Document Subtype" <> ProductionOrder.Status::Released) or
                               (ContainerHeader."Document No." <> "Order No.") or
                               (ContainerHeader."Document Line No." <> ContainerDocumentLineNo)
                            then
                                Error(Text37002011, ContainerHeader.DocumentType, ContainerHeader."Document No.");
                        end else
                            // P80056718
                        ...
                        ContainerLine.SetRange("Container ID", "Old Container ID");
                        ...
                        if "Entry Type" = "Entry Type"::Transfer then begin
                            if "Bin Code" <> ContainerHeader."Bin Code" then begin
                                Validate("Bin Code", ContainerHeader."Bin Code");
                                if "Location Code" = "New Location Code" then
                                    Validate("New Bin Code", ContainerHeader."Bin Code");
                            end;
                            if ("Location Code" = "New Location Code") and ("Bin Code" = "New Bin Code") then begin
                                "New Container License Plate" := "Old Container License Plate";
                                "New Container ID" := "Old Container ID";
                            end;
                        end;
                    end;
            end;
        }
        field(37002562; "Old Container ID"; Code[20])
        {
            Caption = 'Old Container ID';
        }
        field(37002563; "New Container License Plate"; Code[50])
        {
            ...
            begin
                // P8001323
                CheckMoveContainer(FieldCaption("New Container License Plate"));

                if "New Container License Plate" <> xRec."New Container License Plate" then
                    if "New Container License Plate" = '' then
                        "New Container ID" := ''
                    else begin
                        ContainerHeader.SetRange("License Plate", "New Container License Plate");
                        if "Entry Type" = "Entry Type"::Transfer then begin
                            ContainerHeader.SetRange("Location Code", "New Location Code");
                            if "New Bin Code" <> '' then
                                ContainerHeader.SetRange("Bin Code", "New Bin Code");
                        end else begin
                            ContainerHeader.SetRange("Location Code", "Location Code");
                            if "Bin Code" <> '' then
                                ContainerHeader.SetRange("Bin Code", "Bin Code");
                        ...
                        if "Entry Type" = "Entry Type"::Transfer then begin
                            if "New Bin Code" <> ContainerHeader."Bin Code" then
                                Validate("New Bin Code", ContainerHeader."Bin Code");
                        end else begin
        ...
        field(37002564; "New Container ID"; Code[20])
        {
        ...
        field(37002566; "Skip Container Posting"; Boolean)
        {
            Caption = 'Skip Container Posting';
        }
        field(37002567; "Shipping Container"; Boolean)
        {
            Caption = 'Shipping Container';
        }
        field(37002568; "Loose Qty. (Base)"; Decimal)
        {
            Caption = 'Loose Qty. (Base)';
            DecimalPlaces = 0 : 5;
            Editable = false;
        }
        field(37002569; "Loose Qty. (Alt.)"; Decimal)
        {
            Caption = 'Loose Qty. (Alt.)';
            DecimalPlaces = 0 : 5;
            Editable = false;
        }
        ...
        field(37002665; "Creation Date"; Date)
        {
        ...
        field(37002760; "Override Loose Lot Control"; Boolean)
        {
            Caption = 'Override Loose Lot Control';
        ...
        field(3; "Item No."; Code[20])
        {
            ...
            begin
                ...
                if "Item No." <> xRec."Item No." then begin
                    ...
                    if ("Location Code" <> '') then begin
                        ...
                        if IsDefaultBin() and Item.IsInventoriableType() then
                            if not SetBinFromProdOrder("Bin Code") then // P8000631A
                    ...
                    if "Alt. Qty. Transaction No." <> 0 then
                        AltQtyMgmt.DeleteAltQtyLines("Alt. Qty. Transaction No.");
                    "Quantity (Alt.)" := 0;
                    "Invoiced Qty. (Alt.)" := 0;
                ...
                then begin
                    ...
                    "Indirect Cost %" := Item.IndirectCostPct("Variant Code", "Location Code"); // P8001030
                    "Overhead Rate" := Item.OverheadRate("Variant Code", "Location Code");      // P8001030
                ...
                if ("Item No." <> xRec."Item No.") and
                   ...
                   ("Gen. Prod. Posting Group" = '') or // PR3.60
                ...
                case "Entry Type" of
                    ...
                    "Entry Type"::Consumption:
                        if FindProdOrderComponent(ProdOrderComp) then
                            // P8006959
                            if ProdOrderComp.Count = 0 then begin
                ...
                if ((not ("Order Type" in ["Order Type"::Production, "Order Type"::Assembly])) or ("Order No." = '')) and
                  ((not "Phys. Inventory") or ("Phys. Inventory" and ("Item No." <> xRec."Item No."))) then
                    // P8000874
                    CreateDimFromDefaultDim(Rec.FieldNo("Item No."));

                OnBeforeVerifyReservedQty(Rec, xRec, FieldNo("Item No."));
                if ItemExists(xRec."Item No.") and                           // P8000271A
                  (not (ProcessFns.TrackingInstalled and "Phys. Inventory")) // P8000086A
                then                                                         // P8000271A
                ...
                if Item."Catch Alternate Qtys." then                              // P8000070A
                    AltQtyMgmt.AssignNewTransactionNo("Alt. Qty. Transaction No."); // P8000070A

                AutoLotNo(false); // P8000250B, P8001234, P8001314

                UpdateProdBin; // P8000631A
            end;
        }
        field(4; "Posting Date"; Date)
        {
            ...
            begin
                ...
                CheckMoveContainer(FieldCaption("Posting Date")); // P8001323
        ...
        field(7; "Document No."; Code[20])
        {
            ...
            trigger OnValidate()
            begin
                CheckMoveContainer(FieldCaption("Document No.")); // P8001323
                AutoLotNo(false); // P8000250B, P8001234, P8001314
            end;
        }
        ...
        field(9; "Location Code"; Code[10])
        {
            ...
            begin
                ...
                CheckMoveContainer(FieldCaption("Location Code")); // P8001323
                ...
                if "Location Code" <> xRec."Location Code" then begin
                    AutoLotNo(false); // P8001234, P8001314
                    "Bin Code" := '';
                    if CurrFieldNo <> 0 then begin
                        GetItem();
                        if Item.IsInventoriableType() then
        ...
        field(13; Quantity; Decimal)
        {
            ...
            var
                ...
                Sign: Decimal;
            begin
                // P8000478A - original code for TESTFIELD of Phys. Inventory has been restored
                ...
                if not PhysInvtEntered then
                    if CurrFieldNo = FieldNo(Quantity) then // PR2.00
                        TestField("Phys. Inventory", false);
                ...
                if "Container License Plate" <> '' then begin
                    if xRec.Quantity = 0 then
                        ...
                        xSign := xRec.Signed(Abs(xRec.Quantity) / xRec.Quantity);
                    if Quantity = 0 then
                        Sign := xRec.Signed(1)
                    else
                        Sign := xRec.Signed(Abs(Quantity) / Quantity);
                    if xSign <> Sign then begin
                        "Container License Plate" := '';
                        "Old Container License Plate" := '';
                        "Old Container ID" := '';
                        "New Container License Plate" := '';
                ...
                UpdateLotTracking(EasyLT); // P8000043A, P8000065A
                ...
                if CurrFieldNo = FieldNo(Quantity) then // P8000250B
                    AutoLotNo(false);                     // P8000250B, P8001234, P8001314
            end;
        }
                            ...
                            "Entry Type"::"Assembly Output":
                                begin
                                    ...
                                    if TrackAlternateUnits then                                               // PR3.60
                                        AltQtyMgmt.AdjustPerBaseAmount("Item No.", "Qty. per Unit of Measure"); // PR3.60
            ...
            begin
                ...
                if "Entry Type" in ["Entry Type"::Purchase, "Entry Type"::"Positive Adjmt.", "Entry Type"::Consumption] then
                    if Item."Costing Method" = Item."Costing Method"::Standard then begin
                        ...
                        "Unit Cost" := Round(UnitCost * UOMCostFactor, GLSetup."Unit-Amount Rounding Precision"); // P80075859
                    end;
            ...
            begin
                ...
                if "Entry Type" <> "Entry Type"::Sale then begin
                    ...
                    if PriceInAlternateUnits then
                        TestField("Quantity (Alt.)") // P8000106A
                    else                           // P8000106A
                        TestField(Quantity);
                end;
                // P8008400

                //"Unit Amount" := Amount / Quantity; // P8000106A
                //"Unit Amount" := Amount / GetCostingQty(FIELDNO(Quantity)); // PR3.60, P8000981
                "Unit Amount" := Amount / GetPricingQty(FieldNo(Quantity));   // PR3.60, P8000981
        ...
        field(42; "Reason Code"; Code[10])
        {
            ...
            trigger OnValidate()
            begin
                UpdateItemJnlLineForContainer(FieldNo("Reason Code")); // P8001323
            end;
        }
            ...
            begin
                ...
                if "New Location Code" <> xRec."New Location Code" then begin
                    ...
                    if "Container Master Line No." = 0 then begin
                        ...
                        UpdateItemJnlLineForContainer(FieldNo("New Location Code"));
                        UpdateItemJnlLineForContainer(FieldNo("New Bin Code"));
                    end;
                    // P8001323
                end;
        ...
        field(54; "Qty. (Phys. Inventory)"; Decimal)
        {
            ...
            begin
                ...
                if Item.TrackAlternateUnits then begin
                    if Item."Catch Alternate Qtys." then begin
                        if "Qty. (Phys. Inventory)" = 0 then
                            QuantityAlt := "Qty. (Alt.) (Calculated)"
                        else
                            QuantityAlt := Round(Quantity * Item.AlternateQtyPerBase, 0.00001);
                        if "Qty. (Phys. Inventory)" <= "Qty. (Calculated)" then
                            "Qty. (Alt.) (Phys. Inventory)" := "Qty. (Alt.) (Calculated)" - QuantityAlt
                        else
                            "Qty. (Alt.) (Phys. Inventory)" := "Qty. (Alt.) (Calculated)" + QuantityAlt;
                        ...
                        AltQtyMgmt.InitAlternateQty("Item No.", "Alt. Qty. Transaction No.", "Qty. (Phys. Inventory)",
                          "Qty. (Alt.) (Phys. Inventory)");
                    Validate("Qty. (Alt.) (Phys. Inventory)");
                ...
                // P8001323
                if xRec."Container License Plate" <> '' then begin
                    "Container License Plate" := xRec."Old Container License Plate" + xRec."New Container License Plate";
                    if "Entry Type" = "Entry Type"::"Positive Adjmt." then begin
                        "New Container License Plate" := "Container License Plate";
                        "New Container ID" := xRec."Old Container ID" + xRec."New Container ID";
                    end else begin
                        "Old Container License Plate" := "Container License Plate";
                        "Old Container ID" := xRec."Old Container ID" + xRec."New Container ID";
                    end;
                end;
                // P8001323
...
#pragma warning restore
                ...
                case "Order Type" of
                    ...
                    "Order Type"::Assembly:
                        begin
                            ...
                            case "Order Type" of
                                "Order Type"::Production:
                                    begin
                                        ...
                                        "Work Shift Code" := ProdOrder."Work Shift Code"; // P8001231
                                        AutoLotNo(false); // P8001234, P8001314
                            ...
                            if "Order Type" = "Order Type"::Production then begin // P8001132
                                                                                  // PR3.60
                                if ("Gen. Bus. Posting Group" = '') and ("Item No." <> '') then
                                    Validate("Item No.");
                                // PR3.60
                                UpdateProdBin; // P8000631A
                            end; // P8001132
        ...
        field(5402; "Variant Code"; Code[10])
        {
            ...
            begin
                ...
                then begin
                    ...
                    "Overhead Rate" := Item.OverheadRate("Variant Code", "Location Code");
                    // P8001030
                    GetUnitAmount(FieldNo("Variant Code"));
                    //"Unit Cost" := UnitCost;
                    "Unit Cost" := Round(UnitCost * UOMCostFactor, GLSetup."Unit-Amount Rounding Precision"); // PR3.60 - Navision Bug?, P80075859
                    Validate("Unit Amount");
                    Validate("Unit of Measure Code");
                    if ItemExists(xRec."Item No.") and                           // P8000271A
                      (not (ProcessFns.TrackingInstalled and "Phys. Inventory")) // P8000086A
        ...
        field(5403; "Bin Code"; Code[20])
        {
            ...
            var
                ...
                IsHandled: Boolean;
            begin
                CheckMoveContainer(FieldCaption("Bin Code")); // P8001323
        ...
        field(5406; "New Bin Code"; Code[20])
        {
            ...
            begin
                ...
                if "New Bin Code" <> xRec."New Bin Code" then begin
                    ...
                    Validate("Pick Source Type", 0); // P8000631A
                                                     // P8001323
                    if (CurrFieldNo = FieldNo("New Bin Code")) and ("Container Master Line No." = 0) then begin
                        "New Container License Plate" := '';
                        "New Container ID" := '';
                    end else
        ...
        field(5407; "Unit of Measure Code"; Code[10])
        {
            ...
            begin
                ...
                if CurrFieldNo = FieldNo("Unit of Measure Code") then // P8000478A
                    TestField("Phys. Inventory", false);                 // P8000478A
                ...
                if "Entry Type" = "Entry Type"::Consumption then begin
                    // "Indirect Cost %" := ROUND(Item."Indirect Cost %" * "Qty. per Unit of Measure",0.00001); // PR3.60
                    "Overhead Rate" :=
                      Round(Item.OverheadRate("Variant Code", "Location Code") * "Qty. per Unit of Measure", // P8001030
                        GLSetup."Unit-Amount Rounding Precision");                                          // P8001030
                    "Unit Amount" := Round(UnitCost * UOMCostFactor, GLSetup."Unit-Amount Rounding Precision"); // P80075859
                end;
                if TrackAlternateUnits then                                    // PR3.60
                    AltQtyMgmt.RestorePerBaseAmount("Qty. per Unit of Measure"); // PR3.60
...
#pragma warning restore
        ...
        field(5802; "Inventory Value (Calculated)"; Decimal)
        {
            ...
            begin
                ReadGLSetup();
                if GetCostingQty(FieldNo(Quantity)) = 0 then // P8000106A
                    "Unit Cost (Calculated)" := 0              // P8000106A
                else                                         // P8000106A
                    "Unit Cost (Calculated)" :=
                      Round("Inventory Value (Calculated)" / GetCostingQty(FieldNo(Quantity)), GLSetup."Unit-Amount Rounding Precision"); // P8000106A
            end;
        }
            ...
            begin
                ...
                then begin
                    if CurrFieldNo <> FieldNo("Unit Cost (Revalued)") then
                        if GetCostingQty(FieldNo(Quantity)) = 0 then // P8000106A
                            "Unit Cost (Revalued)" := 0                // P8000106A
                        else                                         // P8000106A
                            "Unit Cost (Revalued)" :=
                              Round("Inventory Value (Revalued)" / GetCostingQty(FieldNo(Quantity)), GLSetup."Unit-Amount Rounding Precision"); // P800106A
            ...
            begin
                ...
                if "Unit Cost (Revalued)" <> xRec."Unit Cost (Revalued)" then
                    Validate(
                      ...
                      Round(
                        "Unit Cost (Revalued)" * GetCostingQty(FieldNo(Quantity)), GLSetup."Amount Rounding Precision")); // P8000106A
            end;
        }
        ...
        field(5884; "Prod. Order Comp. Line No."; Integer)
        {
            ...
            begin
                ...
                P800ProdOrderMgt.AssignConsumptionSource(Rec); // PR3.60

                // P8000856
                if ProcessFns.CommCostInstalled() then
                    CommItemMgmt.ItemJnlModify(Rec);
                // P8000856
        ...
        field(6500; "Serial No."; Code[50])
        {
            ...
            begin
                ...
                P800ItemTracking.ItemJnlValidateSerial(xRec, Rec); // PR3.61
            end;
        }
        field(6501; "Lot No."; Code[50])
        {
            ...
            begin
                ...
                P800ItemTracking.ItemJnlValidateLot(xRec, Rec); // PR3.61
            end;
        }
        ...
        field(6503; "New Serial No."; Code[50])
        {
            ...
            trigger OnValidate()
            begin
                CheckMoveContainer(FieldCaption("New Serial No.")); // P8001323
            end;
        }
        field(6504; "New Lot No."; Code[50])
        {
            ...
            trigger OnValidate()
            begin
                CheckMoveContainer(FieldCaption("New Lot No.")); // P8001323
                P800ItemTracking.ItemJnlValidateNewLot(xRec, Rec); // P8000343A
            end;
        }
    ...
    keys
    {
        ...
        // P800164877 Renamed Keys Key6,Key7 to Key15 and Key16 also Key5 to Key37002000. These should be renamed again in next version Key15-Key5 and Key16-Key6 
        key(Key15; "Journal Template Name", "Journal Batch Name", "Item No.", "Location Code", "Variant Code")
        {
        }
        key(Key16; "Journal Template Name", "Journal Batch Name", "Document No.")
        {
        }
        key(Key37002000; "Entry Type", "Order No.")
        {
        }
    }
    ...
    begin
        ...
        if "Phys. Inventory" then
            ItemJnlLineReserve.SetDeleteItemTracking(true)
        else
            // P8000947
            ItemJnlLineReserve.SetDeleteItemTracking(DeleteTracking); // P8000572A
    ...
    begin
        ...
        if "Phys. Inventory" and ProcessFns.TrackingInstalled then // PR3.61
            P800ItemTracking.ItemJnlInsertPhysical(Rec);             // PR3.61
    ...
    begin
        ...
        if "Phys. Inventory" and ProcessFns.TrackingInstalled then // PR3.61
            P800ItemTracking.ItemJnlModifyPhysical(Rec);             // PR3.61
    ...
    var
        ...
        EasyLT: Boolean;
        Text37002000: Label 'This will delete all lines for container %1.\Continue?''';
        Text37002001: Label '%1 cannot be changed when moving containers.';
        Text37002002: Label 'Item %1 is not allowed for container %2';
        Text37002003: Label '%1 is not allowed for %2 %3.';
        Text37002004: Label '%1 %2 is not allowed for %3 %4.';
        DeleteTracking: Boolean;
        Text37002005: Label 'must be at least %1';
        CommItemMgmt: Codeunit "Commodity Item Management";
        Text37002006: Label 'The line cannot be split. The new line will be added at the end of the journal.';
        Text37002007: Label 'Different lots for item %1 cannot be combined.';
        Text37002008: Label 'Container %1 cannot have multiple items.';
        ContainerFns: Codeunit "Container Functions";
        Text37002009: Label 'Container %1 is already being moved.';
        Text37002010: Label 'Locations and/or Bin Codes must be different when moving containers.';
        Text37002011: Label 'Container has been assigned to %1 %2.';
        Text37002012: Label 'You cannot move a container while changing dimensions.';
        Text37002013: Label 'Dimensions';
        Text37002014: Label 'Tracking';
    ...
    begin
        ...
        //Amount := ROUND(GetCostingQty(FIELDNO(Quantity)) * "Unit Amount"); // PR3.60, P8000981
        Amount := Round(GetPricingQty(FieldNo(Quantity)) * "Unit Amount");   // PR3.60, P8000981
    ...
    begin
        ...
        if ("Entry Type" = "Entry Type"::Transfer) and ("Location Code" = "New Location Code") then
            if (xRec."Bin Code" = "New Bin Code") then // P8000631A
                "New Bin Code" := "Bin Code";
    end;
    ...
    begin
        ...
        then
            if not Item.CostInAlternateUnits then // P80075859
        ...
        case "Entry Type" of
            ...
            "Entry Type"::"Positive Adjmt.":
                "Unit Amount" :=
                  Round(
                    ((UnitCostValue - "Overhead Rate") * UOMCostFactor) / (1 + "Indirect Cost %" / 100), // P80075859
                    GLSetup."Unit-Amount Rounding Precision");
            "Entry Type"::"Negative Adjmt.":
                "Unit Amount" := UnitCostValue * UOMCostFactor; // P80075859
            "Entry Type"::Transfer:
                "Unit Amount" := 0;
        end;
    ...
    var
        ...
        CurrFldNo: Integer;
    begin
        CurrFldNo := CurrFieldNo; // P8000408A
        ...
        Rec := Line;
        CurrFieldNo := CurrFldNo; // P8000408A
    end;
    ...
    begin
        CheckMoveContainer(Text37002014); // P8001323
        ItemJnlLineReserve.CallItemTracking(Rec, IsReclass);
        Get("Journal Template Name", "Journal Batch Name", "Line No."); // P8000366A
        // PR3.60 Begin
        if TrackAlternateUnits then
            AltQtyMgmt.UpdateItemJnlLine(Rec);
        // PR3.60 End
        GetLotNo; // P8000043A
        GetNewLotNo; // P8000343A
        Modify;   // P8000043A
    end;
    ...
    begin
        ...
        CheckMoveContainer(FieldCaption("Shortcut Dimension 1 Code")); // P8001323
    ...
    begin
        ...
        then begin
            ...
            //"Unit Cost" := UnitCost;
            "Unit Cost" := Round(UnitCost * UOMCostFactor, GLSetup."Unit-Amount Rounding Precision"); // PR3.60 - Navision Bug?, 
            Validate("Unit Amount");
    ...
    begin
        ...
        if ShortcutDimCode <> '' then                                    // P8001323
            CheckMoveContainer(FieldCaption("Shortcut Dimension 1 Code")); // P8001323
        DimMgt.ValidateShortcutDimValues(FieldNumber, ShortcutDimCode, "Dimension Set ID");
    end;
    ...
    begin
        ...
        if NewShortcutDimCode <> '' then                                 // P8001323
            CheckMoveContainer(FieldCaption("Shortcut Dimension 1 Code")); // P8001323
        DimMgt.ValidateShortcutDimValues(FieldNumber, NewShortcutDimCode, "New Dimension Set ID");
    end;
    ...
    begin
        ...
        if ItemLedgEntry2."Quantity (Alt.)" <> 0 then                   // P8000106A
            Validate("Quantity (Alt.)", ItemLedgEntry2."Quantity (Alt.)"); // P8000106A
    ...
    begin
        ...
        ItemJnlLine."Supply Chain Group Code" := SalesLine."Supply Chain Group Code"; // P8007748
    ...
    begin
        ...
        "Supply Chain Group Code" := PurchLine."Supply Chain Group Code"; // P8007748
        ...
        // P8007748
        "Receiving Reason Code" := PurchLine."Receiving Reason Code";
        Farm := PurchLine.Farm;
        Brand := PurchLine.Brand;
        //"Country/Region of Origin Code" := PurchLine."Country/Region of Origin Code"; // P8008351
        // P8007748
        //"Creation Date" := PurchLine."Creation Date"; // P8007748, P8008351
    ...
    begin
        with ValueEntry do begin
            ...
            if ItemLedgEntry.GetCostingQty <> 0 then // P8000756
                UnitCost :=
                  ("Cost Amount (Expected)" + "Cost Amount (Actual)") / ItemLedgEntry.GetCostingQty; // P8000756
        end;

        exit(Abs(UnitCost * UOMCostFactor)); // P80075859
    end;
        ...
        case "Entry Type" of
            ...
            "Entry Type"::"Positive Adjmt.":
                "Unit Cost" :=
                  Round(
                    "Unit Amount" * (1 + "Indirect Cost %" / 100), GLSetup."Unit-Amount Rounding Precision") +
                  "Overhead Rate" * UOMCostFactor; // P80075859
            "Entry Type"::"Negative Adjmt.":
                if not "Phys. Inventory" then
                    "Unit Cost" := UnitCost * UOMCostFactor; // P80075859
        end;
    ...
    begin
        CheckMoveContainer(Text37002013); // P8001323
    ...
    begin
        // P80066030
        if (Item.Type = Item.Type::FOODContainer) and
           ("Entry Type" in ["Entry Type"::Purchase, "Entry Type"::Sale, "Entry Type"::Transfer, "Entry Type"::"Positive Adjmt.", "Entry Type"::"Negative Adjmt."])
        then
            exit;
        // P80066030
    ...
    procedure TestCatchAlternateUnits()
    begin
        // P80091260
        GetItem;
        Item.TestField("Alternate Unit of Measure");
    ...
    begin
        // PR3.60
        if CostInAlternateUnits and (not Adjustment) then
            case FldNo of
                FieldNo(Quantity), FieldNo("Quantity (Base)"):
                    exit("Quantity (Alt.)");
                FieldNo("Invoiced Quantity"), FieldNo("Invoiced Qty. (Base)"):
                    exit("Invoiced Qty. (Alt.)");
                FieldNo("Scrap Quantity"), FieldNo("Scrap Quantity (Base)"):
                    exit("Scrap Quantity (Alt.)");
            end;
        case FldNo of
            FieldNo(Quantity):
                exit(Quantity);
    ...
    begin
        // P8000981
        if ("Entry Type" <> "Entry Type"::Sale) then
            exit(GetCostingQty(FldNo));

        if PriceInAlternateUnits and (not Adjustment) then
            case FldNo of
                FieldNo(Quantity), FieldNo("Quantity (Base)"):
                    exit("Quantity (Alt.)");
                FieldNo("Invoiced Quantity"), FieldNo("Invoiced Qty. (Base)"):
    ...
    begin
        ...
        if ProcessFns.TrackingInstalled then begin
            EasyLotTracking.SetItemJnlLine(Rec, 0); // P8000343A
            "Lot No." := EasyLotTracking.GetLotNo;
        end;
    end;

    procedure GetNewLotNo()
    var
        EasyLotTracking: Codeunit "Easy Lot Tracking";
    begin
        // P8000343A
        if ProcessFns.TrackingInstalled then begin
            ...
            "New Lot No." := EasyLotTracking.GetNewLotNo("New Lot Status Code"); // P8001083
        end;
    end;
    ...
    begin
        // P8000043A
        EasyLT := false; // P8000065A
        if "Phys. Inventory" or ((CurrFieldNo = 0) and (not ForceUpdate) and ("Container Master Line No." = 0)) then // P8001323
            exit;
        ...
        Clear(ItemJnlLineReserve); // P8000343A
        ItemJnlLineReserve.SetDeleteItemTracking(true);  // P8000466A
        ItemJnlLineReserve.DeleteLine(Rec); // P8000276A
        ItemJnlLineReserve.SetDeleteItemTracking(false); // P8000466A
        QtyToHandle := "Quantity (Base)";
        QtyToHandleAlt := "Quantity (Alt.)";
        EasyLotTracking.SetItemJnlLine(Rec, 0); // P8000343A
        EasyLotTracking.SetNewLotNo(xRec."New Lot No.", "New Lot No."); // P8000343A
        EasyLotTracking.SetNewLotStatus(xRec."New Lot Status Code", "New Lot Status Code"); // P8001083
    ...
    procedure SetEasyLotTracking()
    begin
        EasyLT := true; // P8000065A
    end;

    procedure PostedQuantity(): Decimal
    var
        ProdOrderLine: Record "Prod. Order Line";
        ProdOrderComp: Record "Prod. Order Component";
    ...
    begin
        ...
        case "Entry Type" of
            "Entry Type"::Output:
                if ProdOrderLine.Get(ProdOrderLine.Status::Released, "Order No.", "Order Line No.") then // P8001132
                    exit(ProdOrderLine."Finished Quantity");
            "Entry Type"::Consumption:
                // P8000093A Begin
                begin
                    ItemLedger.SetCurrentKey("Order Type", "Order No.", "Order Line No.", "Entry Type", "Prod. Order Comp. Line No."); // P8000267B, P8001132
                    ItemLedger.SetRange("Order Type", "Order Type"::Production); // P8001132
                    ItemLedger.SetRange("Order No.", "Order No.");               // P8001132
                    ItemLedger.SetRange("Order Line No.", "Order Line No.");     // P8001132
                    ItemLedger.SetRange("Prod. Order Comp. Line No.", "Prod. Order Comp. Line No.");
                    ItemLedger.SetRange("Entry Type", "Entry Type"::Consumption);
                    // P8000421A
                    if "Prod. Order Comp. Line No." = 0 then begin
                        ItemLedger.SetRange("Item No.", "Item No.");
                        if ItemLedger.Find('-') then
                            repeat
                                PostQty -= ItemLedger.Quantity;                // P8000607A
                                                                               //  EXIT(Quantity / "Qty. per Unit of Measure"); // P8000607A
                            until ItemLedger.Next = 0;
                        exit(PostQty / "Qty. per Unit of Measure");      // P8000607A
                    end else begin
                        // P8000421A
                        ItemLedger.CalcSums(Quantity);
                        exit(-ItemLedger.Quantity / "Qty. per Unit of Measure");
                    end; // P8000421A
                         // P8000093A End
                end;
        end;
    ...
    procedure PostedQuantityDrillDown()
    var
        ItemLedger: Record "Item Ledger Entry";
    begin
        // P8000111A
        ...
        case "Entry Type" of
            "Entry Type"::Output:
                ItemLedger.SetRange("Entry Type", "Entry Type"::Output);
            "Entry Type"::Consumption:
                begin
                    ItemLedger.SetRange("Prod. Order Comp. Line No.", "Prod. Order Comp. Line No.");
                    ItemLedger.SetRange("Entry Type", "Entry Type"::Consumption);
        ...
        PAGE.RunModal(0, ItemLedger);
    end;

    procedure ConsumedIntermediate(var ProdOrderNo: Code[20]; var ProdOrderLineNo: Integer): Boolean
    var
        ProdOrder: Record "Production Order";
        ProdOrderLine: Record "Prod. Order Line";
    begin
        ...
        if "Entry Type" <> "Entry Type"::Consumption then
            exit(false);
        if not ProdOrder.Get(ProdOrder.Status::Released, "Order No.") then // P8001132
            exit(false);
        if not ProdOrder.Suborder then
            exit(false);
        ProdOrderLine.SetRange(Status, ProdOrderLine.Status::Released);
        ProdOrderLine.SetRange("Prod. Order No.", ProdOrder."Batch Prod. Order No.");
        ProdOrderLine.SetRange("Item No.", "Item No.");
        ProdOrderLine.SetRange("By-Product", false);
        if not ProdOrderLine.Find('-') then
            exit(false);
        if ProdOrderLine.Next <> 0 then // P8000904
            exit(false);                  // P8000904
    ...
    begin
        // P8000153A
        if ("Entry Type" <> "Entry Type"::Consumption) or (not ProcessFns.TrackingInstalled) then
            exit(true); // P8000172A

        LotAgeFilter.SetRange("Table ID", DATABASE::"Prod. Order Component");
        LotAgeFilter.SetRange(Type, ProdOrder.Status::Released);
        LotAgeFilter.SetRange(ID, "Order No.");                          // P8001132
        LotAgeFilter.SetRange("Prod. Order Line No.", "Order Line No."); // P8001132
        LotAgeFilter.SetRange("Line No.", "Prod. Order Comp. Line No.");

        LotSpecFilter.SetRange("Table ID", DATABASE::"Prod. Order Component");
        LotSpecFilter.SetRange(Type, ProdOrder.Status::Released);
        LotSpecFilter.SetRange(ID, "Order No.");                          // P8001132
        LotSpecFilter.SetRange("Prod. Order Line No.", "Order Line No."); // P8001132
        LotSpecFilter.SetRange("Line No.", "Prod. Order Comp. Line No.");

        if (not LotAgeFilter.Find('-')) and (not LotSpecFilter.Find('-')) then // P8000313A
            exit(true);                                                          // P8000313A

        LotInfo.Get("Item No.", "Variant Code", LotNo); // Moved from above      // P8000313A
    ...
    begin
        ...
        if Posting then // P8001314
            xRec := Rec;  // P8001314

        if P800Tracking.AutoAssignLotNo(Rec, xRec, "Lot No.") then begin // P8001234
            if "Line No." <> 0 then
                Modify;
    ...
    procedure LotTrackingRequired(): Boolean
    var
    ...
    begin
        ...
        case "Entry Type" of
            "Entry Type"::Purchase:
                exit(ItemTracking."Lot Purchase Inbound Tracking" or ItemTracking."Lot Purchase Outbound Tracking");
            "Entry Type"::Sale:
                exit(ItemTracking."Lot Sales Inbound Tracking" or ItemTracking."Lot Sales Outbound Tracking");
            "Entry Type"::"Positive Adjmt.":
                exit(ItemTracking."Lot Pos. Adjmt. Inb. Tracking" or ItemTracking."Lot Pos. Adjmt. Outb. Tracking");
            "Entry Type"::"Negative Adjmt.":
                exit(ItemTracking."Lot Neg. Adjmt. Inb. Tracking" or ItemTracking."Lot Neg. Adjmt. Outb. Tracking");
            "Entry Type"::Transfer:
                exit(ItemTracking."Lot Transfer Tracking");
            "Entry Type"::Consumption:
                exit(ItemTracking."Lot Manuf. Outbound Tracking");
            "Entry Type"::Output:
                exit(ItemTracking."Lot Manuf. Inbound Tracking");
        end;
    end;

    procedure SetDeleteTracking(Flag: Boolean)
    begin
        // P8000572A
        DeleteTracking := Flag;
    end;

    local procedure SetBinFromProdOrder(var BinCode: Code[20]): Boolean
    begin
        // P8000631A
        case "Entry Type" of
            "Entry Type"::Consumption:
                begin
                    BinCode := Location.GetToProductionBin("Order No.", "Order Line No.", "Prod. Order Comp. Line No.", "Item No."); // P8001142, P8001319
                    exit(true);
                end;
            "Entry Type"::Output:
                begin
                    BinCode := Location.GetFromProductionBin("Order No.", "Order Line No."); // P8001142
                    exit(true);
                end;
        end;
    end;

    local procedure UpdateProdBin()
    begin
        // P8000631A
        if ("Location Code" <> '') and ("Item No." <> '') and (not "Phys. Inventory") then begin
            GetLocation("Location Code");
            if Location."Bin Mandatory" then // P80084388
                if not SetBinFromProdOrder("Bin Code") then
                    WMSManagement.GetDefaultBin("Item No.", "Variant Code", "Location Code", "Bin Code");
        end;
    end;

    local procedure CheckPickSourceDocLine()
    var
        SalesLine: Record "Sales Line";
        PurchLine: Record "Purchase Line";
        TransLine: Record "Transfer Line";
        AvailLineFound: Boolean;
        QtyInJnl: Decimal;
    begin
        // P8000631A
    ...
    begin
        ...
        if ("Pick Source Line No." <> 0) then begin
            ...
            SalesLine.TestField("Unit of Measure Code", "Unit of Measure Code");
            QtyInJnl := GetPickQtyInJnl("Pick Source Line No.");
            if ((SalesLine."Outstanding Quantity" - SalesLine.GetContainerQuantity('') - QtyInJnl) < Quantity) then  //P8001373, P80046533
                SalesLine.FieldError(Quantity, StrSubstNo(Text37002005,
                  SalesLine."Quantity Shipped" + SalesLine.GetContainerQuantity('') + Quantity + QtyInJnl));  //P8001373, P80046533
        end else begin
            SalesLine.SetRange("Document Type", SalesLine."Document Type"::Order);
            SalesLine.SetRange("Document No.", "Pick Source No.");
            SalesLine.SetRange(Type, SalesLine.Type::Item);
            SalesLine.SetRange("No.", "Item No.");
            SalesLine.SetRange("Unit of Measure Code", "Unit of Measure Code");
            SalesLine.FindSet;
            repeat
                QtyInJnl := GetPickQtyInJnl(SalesLine."Line No.");
                if ((SalesLine."Outstanding Quantity" - SalesLine.GetContainerQuantity('') - QtyInJnl) >= Quantity) then  //P8001373, P80046533
                    AvailLineFound := true;
            until AvailLineFound or (SalesLine.Next = 0);
            if not AvailLineFound then
                SalesLine.FieldError(Quantity, StrSubstNo(Text37002005,
                  SalesLine."Quantity Shipped" + SalesLine.GetContainerQuantity('') + Quantity + QtyInJnl)); // P80046533
        end;
    end;

    local procedure CheckPickPurchase()
    var
        PurchLine: Record "Purchase Line";
        AvailLineFound: Boolean;
        QtyInJnl: Decimal;
    begin
        ...
        if ("Pick Source Line No." <> 0) then begin
            ...
            PurchLine.TestField("Unit of Measure Code", "Unit of Measure Code");
            QtyInJnl := GetPickQtyInJnl("Pick Source Line No.");
            if ((PurchLine."Outstanding Quantity" - PurchLine.GetContainerQuantity('') - QtyInJnl) < Quantity) then  //P8001373, P80046533
                PurchLine.FieldError(Quantity, StrSubstNo(Text37002005,
                  PurchLine."Return Qty. Shipped" + PurchLine.GetContainerQuantity('') + Quantity + QtyInJnl));  //P8001373, P80046533
        end else begin
            PurchLine.SetRange("Document Type", PurchLine."Document Type"::"Return Order");
            PurchLine.SetRange("Document No.", "Pick Source No.");
            PurchLine.SetRange(Type, PurchLine.Type::Item);
            PurchLine.SetRange("No.", "Item No.");
            PurchLine.SetRange("Unit of Measure Code", "Unit of Measure Code");
            PurchLine.FindSet;
            repeat
                QtyInJnl := GetPickQtyInJnl(PurchLine."Line No.");
                if ((PurchLine."Outstanding Quantity" - PurchLine.GetContainerQuantity('') - QtyInJnl) >= Quantity) then  //P8001373, P80046533
                    AvailLineFound := true;

            until AvailLineFound or (PurchLine.Next = 0);
            if not AvailLineFound then
                PurchLine.FieldError(Quantity, StrSubstNo(Text37002005,
                  PurchLine."Return Qty. Shipped" + PurchLine.GetContainerQuantity('') + Quantity + QtyInJnl)); // P80046533
        end;
    end;

    local procedure CheckPickTransfer()
    var
        TransLine: Record "Transfer Line";
        AvailLineFound: Boolean;
        QtyInJnl: Decimal;
    begin
        ...
        if ("Pick Source Line No." <> 0) then begin
            ...
            TransLine.TestField("Unit of Measure Code", "Unit of Measure Code");
            QtyInJnl := GetPickQtyInJnl("Pick Source Line No.");
            if ((TransLine."Outstanding Quantity" - TransLine.GetContainerQuantity(0, '') - QtyInJnl) < Quantity) then // P80046533
                TransLine.FieldError(Quantity, StrSubstNo(Text37002005,
                  TransLine."Quantity Shipped" + TransLine.GetContainerQuantity(0, '') + Quantity + QtyInJnl)); // P80046533
        end else begin
            TransLine.SetRange("Document No.", "Pick Source No.");
            TransLine.SetRange("Item No.", "Item No.");
            TransLine.SetRange("Unit of Measure Code", "Unit of Measure Code");
            TransLine.FindSet;
            repeat
                QtyInJnl := GetPickQtyInJnl(TransLine."Line No.");
                if ((TransLine."Outstanding Quantity" - TransLine.GetContainerQuantity(0, '') - QtyInJnl) >= Quantity) then // P80046533
                    AvailLineFound := true;
            until AvailLineFound or (TransLine.Next = 0);
            if not AvailLineFound then
                TransLine.FieldError(Quantity, StrSubstNo(Text37002005,
                  TransLine."Quantity Shipped" + TransLine.GetContainerQuantity(0, '') + Quantity + QtyInJnl)); // P80046533
        end;
    ...
    local procedure GetPickQtyInJnl(PickSourceLineNo: Integer) QtyInJnl: Decimal
    var
        ItemJnlLine2: Record "Item Journal Line";
    begin
        // P8000631A
        ...
        ItemJnlLine2.SetRange("Unit of Measure Code", "Unit of Measure Code");
        ItemJnlLine2.SetRange("Pick Source Type", "Pick Source Type");
        ItemJnlLine2.SetRange("Pick Source No.", "Pick Source No.");
        ItemJnlLine2.SetRange("Pick Source Line No.", PickSourceLineNo);
        if ItemJnlLine2.FindSet then
            repeat
                QtyInJnl := QtyInJnl + ItemJnlLine2.Quantity;
            until (ItemJnlLine2.Next = 0);
    end;

    procedure SetSortByBin(SortByBin: Boolean)
    begin
        // P8001104
        if SortByBin then
            SetCurrentKey("Journal Template Name", "Journal Batch Name", "Location Code", "Bin Code")
        else
            SetCurrentKey("Journal Template Name", "Journal Batch Name", "Line No.");
    end;

    procedure UpdateSortByBin(var SortByBin: Boolean)
    var
        LinesSortedByBin: Record "Item Journal Line";
    begin
        // P8001104
        LinesSortedByBin.SetSortByBin(true);
        SortByBin := (CurrentKey = LinesSortedByBin.CurrentKey);
    end;

    procedure CalcSortByBinLineNo(BelowxRec: Boolean; xRecLineNo: Integer): Integer
    var
        LinesSortedByLineNo: Record "Item Journal Line";
        PrevJnlLine: Record "Item Journal Line";
    begin
        // P8001104
        if (CurrentKey = LinesSortedByLineNo.CurrentKey) then begin
            if BelowxRec then
                exit(xRecLineNo + 10000);
            PrevJnlLine.SetRange("Journal Template Name", "Journal Template Name");
            PrevJnlLine.SetRange("Journal Batch Name", "Journal Batch Name");
            PrevJnlLine.SetFilter("Line No.", '<%1', xRecLineNo);
            if not PrevJnlLine.FindLast then
                PrevJnlLine."Line No." := 0;
            if ((xRecLineNo - PrevJnlLine."Line No.") > 1) then
                exit((xRecLineNo + PrevJnlLine."Line No.") div 2);
            Message(Text37002006);
        end;
    end;

    procedure AssignSortByBinLineNo(NewJnlLineNo: Integer): Integer
    var
        LastJnlLine: Record "Item Journal Line";
    begin
        // P8001104
        if (NewJnlLineNo <> 0) then
            exit(NewJnlLineNo);
        ...
        if LastJnlLine.FindLast then
            exit(LastJnlLine."Line No." + 10000);
        exit(10000);
    end;
    ...
    begin
        ...
        ItemJournalLine.SetFilter("Line No.", '<>%1', "Line No.");
        ItemJournalLine.SetRange("Container Master Line No.", "Container Master Line No.");
        if ItemJournalLine.IsEmpty then
            exit(true);

        if not Confirm(Text37002000, false, "Old Container License Plate") then
            exit(false);

        ItemJournalLine.FindSet;
        repeat
            ItemJournalLine."Container Master Line No." := 0;
    ...
    begin
        // P8001323
        TestField("Entry Type", "Entry Type"::Transfer);
        if "Dimension Set ID" <> "New Dimension Set ID" then
            Error(Text37002012);
        TestField("Pick Source Type", 0);
        TestField("Old Container License Plate");
        if "Container Master Line No." <> 0 then
            Error(Text37002009, "Old Container License Plate");
        TestField("New Location Code");
        Location.Get("New Location Code");
        if Location."Bin Mandatory" then
            TestField("New Bin Code");
        if ("Location Code" = "New Location Code") and ("Bin Code" = "New Bin Code") then
            Error(Text37002010);

        ContainerHeader.Get("Old Container ID");
        ContainerType.Get(ContainerHeader."Container Type Code");
        if ContainerType.TrackInventory then
            AddContainerLineForMove(ContainerHeader);
        ...
        // First, we'll filll in the current item journal line
        TempContainerLine.Reset;
        "Container Master Line No." := "Line No." - 1;
        if "Item No." <> '' then
        ...
        if TempContainerLine.FindSet then begin
            ...
            if ItemJournalLine.Next = 0 then
                LineNoIncrement := 10000
            else
                LineNoIncrement := Round((ItemJournalLine."Line No." - "Line No.") / 1000, 1, '<');
            ItemJournalLine."Line No." := "Line No.";

            repeat
                ItemJournalLine.Init;
                ItemJournalLine."Container Master Line No." := "Line No." - 1;
                ItemJournalLine."Line No." += LineNoIncrement;
                ItemJournalLine."Posting Date" := "Posting Date";
                ItemJournalLine."Document No." := "Document No.";
                ItemJournalLine."Document Date" := "Document Date";
                ItemJournalLine."Entry Type" := "Entry Type"::Transfer;
                ItemJournalLine."Source Code" := "Source Code";
                ItemJournalLine."Reason Code" := "Reason Code";
                ItemJournalLine."Posting No. Series" := "Posting No. Series";
                ItemJournalLine.Insert;

                ItemJournalLine.Validate("Item No.", TempContainerLine."Item No.");
                ItemJournalLine.Validate("Variant Code", TempContainerLine."Variant Code");
                ItemJournalLine.Validate("Unit of Measure Code", TempContainerLine."Unit of Measure Code");
                ItemJournalLine.Validate("Location Code", "Location Code");
                ItemJournalLine.Validate("Bin Code", "Bin Code");
                ItemJournalLine.Validate("Serial No.", TempContainerLine."Serial No.");
                ItemJournalLine.Validate("Lot No.", TempContainerLine."Lot No.");
                ItemJournalLine.Validate("New Location Code", "New Location Code");
                ItemJournalLine."New Bin Code" := "New Bin Code";
                ItemJournalLine.Validate(Quantity, TempContainerLine.Quantity);
                if Item.Get("Item No.") then
                    if Item.TrackAlternateUnits and (not Item."Catch Alternate Qtys.") then
                        ItemJournalLine."Quantity (Alt.)" := Round(ItemJournalLine."Quantity (Base)" * Item.AlternateQtyPerBase(), 0.00001)
                    else
                        if TempContainerLine."Quantity (Alt.)" <> 0 then
                            ItemJournalLine.Validate("Quantity (Alt.)", TempContainerLine."Quantity (Alt.)");
                ItemJournalLine."Old Container License Plate" := "Old Container License Plate";
                ItemJournalLine."Old Container ID" := "Old Container ID";
                ItemJournalLine."New Container License Plate" := "Old Container License Plate";
                ItemJournalLine."New Container ID" := "Old Container ID";
                ItemJournalLine.Modify;
            until TempContainerLine.Next = 0;
        end;
    end;

    local procedure AddContainerLineForMove(ContainerHeader: Record "Container Header")
    var
    ...
    begin
        ...
        ItemJnlLine.Validate("Item No.", ContainerHeader."Container Item No.");
        ...
        ItemJnlLine."Old Container License Plate" := ContainerHeader."License Plate";
        ItemJnlLine."Old Container ID" := ContainerHeader.ID;
        ItemJnlLine."New Container License Plate" := ContainerHeader."License Plate";
        ItemJnlLine."New Container ID" := ContainerHeader.ID;
        ItemJnlLine."Container Master Line No." := ItemJnlLine."Line No.";
        ItemJnlLine.Insert;

        if ContainerHeader."Container Serial No." <> '' then begin
            CreateReservEntry.CreateReservEntryFor(
              DATABASE::"Item Journal Line", ItemJnlLine."Entry Type", ItemJnlLine."Journal Template Name", ItemJnlLine."Journal Batch Name", 0, ItemJnlLine."Line No.",
                1, 1, 1, ContainerHeader."Container Serial No.", '');
            ItemJnlLine2."Serial No." := ContainerHeader."Container Serial No."; // P800144605
            CreateReservEntry.SetNewTrackingFromItemJnlLine(ItemJnlLine2);       // P800144605
            CreateReservEntry.CreateEntry(ContainerHeader."Container Item No.", '', ItemJnlLine."Location Code", ItemJnlLine.Description, ItemJnlLine."Posting Date", 0D, 0, 3);
        end;
    end;
    ...
    begin
        // P8001323
        if "Old Container ID" <> '' then begin
            ContainerLine.SetRange("Container ID", "Old Container ID");
            if "Item No." <> '' then
                ContainerLine.SetRange("Item No.", "Item No.");
            if "Variant Code" <> '' then
    ...
    begin
        // P8001323
        if "New Container ID" <> '' then begin
            TestField("Item No.");
            TestField("Unit of Measure Code");
            ContainerHeader.Get("New Container ID");
            ...
            then
                Error(Text37002002, Item."No.", "New Container License Plate");

            if ContainerHeader."Document Type" = 0 then begin
                ContainerLine.SetRange("Container ID", "New Container ID");
                ContainerLine.SetFilter("Item No.", '<>%1', "Item No.");
                if not ContainerLine.IsEmpty then
                    Error(Text37002008, "New Container License Plate");
                ...
                if ContainerUsage."Single Lot" and ("Lot No." <> '') then begin
                    ...
                    ContainerLine.SetFilter("Variant Code", '<>%1', "Variant Code");
                    if not ContainerLine.IsEmpty then
                        Error(Text37002007, "Item No.");
                end;
            end;
        end;
    end;

    local procedure UpdateItemJnlLineForContainer(FldNo: Integer)
    var
        ItemJournalLine: Record "Item Journal Line";
    begin
        // P8001323
    ...
    procedure SetConsumptionQty(OutputLine: Record "Item Journal Line")
    var
        Item: Record Item;
        ProdOrderLine: Record "Prod. Order Line";
        ProdOrderComp: Record "Prod. Order Component";
    ...
    begin
        // P8008050 moved the function from page to table
        // This routine will recalculate the expected consumption for the specified output

        OutputJnlLine.SetRange("Journal Template Name", OutputLine."Journal Template Name");
        OutputJnlLine.SetRange("Journal Batch Name", OutputLine."Journal Batch Name");
        OutputJnlLine.SetRange("Order Type", OutputJnlLine."Order Type"::Production); // P8001132
        OutputJnlLine.SetRange("Order No.", OutputLine."Order No.");                  // P8001132
        OutputJnlLine.SetRange("Order Line No.", OutputLine."Order Line No.");        // P8001132
        OutputJnlLine.SetFilter("Line No.", '<>%1', OutputLine."Line No.");
        BaseQty := "Output Quantity (Base)" +                         // P8000064A
          Round(PostedQuantity * "Qty. per Unit of Measure", 0.00001); // P8000064A
        if OutputJnlLine.Find('-') then
            repeat
                BaseQty := BaseQty + OutputJnlLine."Output Quantity (Base)" +                             // P8000064A
                  Round(OutputJnlLine.PostedQuantity * OutputJnlLine."Qty. per Unit of Measure", 0.00001); // P8000064A
            until OutputJnlLine.Next = 0;

        /*PR2.00 Begin
        // PR1.10.03 Begin
        ProdOrderLine.GET(ProdOrderLine.Status::Released,OutputLine."Prod. Order No.",OutputLine."Prod. Order Line No.");
        ProdBOMVersion.GET(ProdOrderLine."Production BOM No.",ProdOrderLine."Production BOM Version Code");
        ItemUOM.GET(OutputLine."Item No.",ProdBOMVersion."Unit of Measure Code");
        // PR1.10.03 End
        PR2.00 End*/
        ...
        ConsumpJnlLine.SetRange("Order No.", OutputLine."Order No.");                   // P8001132
        ConsumpJnlLine.SetRange("Order Line No.", OutputLine."Order Line No.");         // P8001132
        if ConsumpJnlLine.Find('-') then
            repeat
                Item.Get(ConsumpJnlLine."Item No."); // PR3.60

                if ProdOrderComp.Get(ProdOrderComp.Status::Released,
                  ConsumpJnlLine."Order No.", ConsumpJnlLine."Order Line No.", // P8001132
                  ConsumpJnlLine."Prod. Order Comp. Line No.") then begin
                    //Qty := BaseQty * ProdOrderComp."Quantity (Base)" / ItemUOM."Qty. per Unit of Measure"; // PR1.10.03, PR2.00
                    // P8000316A
                    //Qty := BaseQty * ProdOrderComp."Quantity (Base)"; // PR2.00
                    //Qty := Qty / ConsumpJnlLine."Qty. per Unit of Measure";
                    Qty := ProdOrderComp.ProdOrderNeeds;
                    ProdOrderLine.Get(ProdOrderLine.Status::Released, OutputLine."Order No.", OutputLine."Order Line No."); // P8001132
                    Qty := ProdOrderComp.Quantity * Qty * BaseQty / ProdOrderLine."Quantity (Base)";
                    // P8000316A
                    if Item.GetItemUOMRndgPrecision(ProdOrderComp."Unit of Measure Code", true) then  // PR3.70.03, P8000595A
                        Qty := Round(Qty, Item."Rounding Precision", '>');
                    if (ConsumpJnlLine."Expected Quantity" = ConsumpJnlLine.Quantity) and  // P8000064A
                      (ConsumpJnlLine.PostedQuantity = 0)                                  // P8000064A
                    then begin                                                             // P8000064A
                        ConsumpJnlLine.SetEasyLotTracking;                                   // P8000065A
                        ConsumpJnlLine.Validate(Quantity, Qty);                               // P8000064A
                    end;                                                                   // P8000065A
                    ConsumpJnlLine.Validate("Expected Quantity", Qty);
