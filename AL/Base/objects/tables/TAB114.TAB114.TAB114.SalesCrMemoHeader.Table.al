table 114 "Sales Cr.Memo Header"
{
    ...
    //
    // PRW119.03
    // P800142710, To-Increase, Gangabhushan, 04 APR 22
    //   CS00213688 | Accrual Journal does not calculate Credit Memo with Order Date
    //
    // P800149934, To-Increase, Gangabhushan, 08 AUG 22
        ...
        if ValueEntry.FindSet then
            repeat
                ...
                if ItemLedgerEntry."Document Type" = ItemLedgerEntry."Document Type"::"Sales Return Receipt" then begin
                    ...
                    exit(ReturnReceiptHeader."Order Date");
                end;
                // P800142710
                if ItemLedgerEntry."Document Type" = ItemLedgerEntry."Document Type"::"Sales Credit Memo" then begin
                    ...
                    exit(SalesCrMemoHeader."Document Date"); // P800149934
                end;
            // P800142710
