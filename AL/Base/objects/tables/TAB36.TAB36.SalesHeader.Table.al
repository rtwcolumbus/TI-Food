table 36 "Sales Header"
{
    ...
    begin
        ...
        CheckOrderMinimum('MESSAGE'); // P8000126A
    ...
    begin
        ...
        "Price at Shipment" := Customer."Price Orders at Shipment"; // PR3.60
        "Contract Items Only" := Customer."Contract Items Only"; // PR3.70
    ...
    begin
        ...
        if ProcessFns.PricingInstalled then begin
            GetCust("Bill-to Customer No.");
            if Customer."Allow Off-Invoice Allowance" then
