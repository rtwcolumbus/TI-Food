table 81 "Gen. Journal Line"
{
    ...
    //   Add Accrual Plan option to Account Type, Bal. Account Type
    // 
    // PR4.00.04
    // P8000393A, VerticalSoft, Jack Reynolds, 29 SEP 06
    //   New funcion to return TempJnlLineDim from dimension management codeunit
    // 
    // PRW16.00.02
    // P8000762, VerticalSoft, Jack Reynolds, 28 JAN 10
    //   Add Accrual Entry field
    // 
    // PRW16.00.04
    ...
    fields
    {
        field(37002120; "Accrual Plan Type"; Option)
        {
        ...
        field(37002121; "Accrual Entry Type"; Option)
        {
            Caption = 'Accrual Entry Type';
            InitValue = Payment;
            ...
            trigger OnValidate()
            begin
                AccrualFldMgmt.GenJnlValidate(FieldNo("Accrual Entry Type"), xRec, Rec); // P8000241A
            end;
        }
        field(37002122; "Accrual Bal. Acc. Type"; Option)
        {
            Caption = 'Accrual Bal. Acc. Type';
            OptionCaption = 'None,Customer,Vendor,G/L Account';
            OptionMembers = "None",Customer,Vendor,"G/L Account";

            trigger OnValidate()
            begin
                AccrualFldMgmt.GenJnlValidate(FieldNo("Accrual Bal. Acc. Type"), xRec, Rec); // P8000241A
            end;
        }
        field(37002123; "Accrual Bal. Acc. No."; Code[20])
        {
            Caption = 'Accrual Bal. Acc. No.';
            TableRelation = IF ("Accrual Bal. Acc. Type" = CONST(Customer)) Customer
            ELSE
            IF ("Accrual Bal. Acc. Type" = CONST(Vendor)) Vendor
            ELSE
            IF ("Accrual Bal. Acc. Type" = CONST("G/L Account"),
                                     "Accrual Entry Type" = CONST(Payment)) "G/L Account";

            trigger OnValidate()
            begin
                AccrualFldMgmt.GenJnlValidate(FieldNo("Accrual Bal. Acc. No."), xRec, Rec); // P8000241A
            end;
        }
        field(37002124; "Accrual Source No."; Code[20])
        {
            ...
            trigger OnValidate()
            begin
                AccrualFldMgmt.GenJnlValidate(FieldNo("Accrual Source No."), xRec, Rec); // P8000241A
            end;
        }
        field(37002125; "Accrual Source Doc. Type"; Option)
        {
            ...
            trigger OnValidate()
            begin
                AccrualFldMgmt.GenJnlValidate(FieldNo("Accrual Source Doc. Type"), xRec, Rec); // P8000241A
            end;
        }
        field(37002126; "Accrual Source Doc. No."; Code[20])
        {
            Caption = 'Accrual Source Doc. No.';

            trigger OnValidate()
            begin
                AccrualFldMgmt.GenJnlValidate(FieldNo("Accrual Source Doc. No."), xRec, Rec); // P8000241A
            end;
        }
        field(37002127; "Accrual Source Doc. Line No."; Integer)
        {
            BlankZero = true;
            ...
            trigger OnValidate()
            begin
                AccrualFldMgmt.GenJnlValidate(FieldNo("Accrual Source Doc. Line No."), xRec, Rec); // P8000241A
            end;
        }
        field(37002128; "Accrual Entry"; Boolean)
        {
            Caption = 'Accrual Entry';
        }
        field(37002129; "Scheduled Accrual No."; Code[10])
        {
            Caption = 'Scheduled Accrual No.';

            trigger OnValidate()
            begin
                AccrualFldMgmt.GenJnlValidate(FieldNo("Scheduled Accrual No."), xRec, Rec); // P8002746
            end;
        }
        field(37002190; "Deduction Management Entry"; Boolean)
        {
            Caption = 'Deduction Management Entry';
        }
        field(37002191; "Deduction Type"; Option)
        {
            Caption = 'Deduction Type';
            OptionCaption = ' ,Writeoff,Accrual Plan';
            OptionMembers = " ",Writeoff,"Accrual Plan";
        }
        field(37002192; "Original Entry No."; Integer)
        {
            Caption = 'Original Entry No.';
        }
        field(37002193; "Original Customer No."; Code[20])
        {
            Caption = 'Original Customer No.';
        }
        field(37002196; "Assigned To"; Code[50])
        {
            Caption = 'Assigned To';
            DataClassification = EndUserIdentifiableInformation;
        }
        field(37002685; "Comm. Reference Date"; Date)
        {
            Caption = 'Comm. Reference Date';
        }
        ...
        field(3; "Account Type"; Enum "Gen. Journal Account Type")
        {
            ...
            begin
                // P8000170A Begin
                if ("Account Type" <> xRec."Account Type") and ("Document Type" = "Document Type"::Payment) then
                    ErrorIfDeductionsExist;
                // P8000170A
                ...
                // P8000241A
                if P800Fns.AccrualsInstalled() then
                    AccrualFldMgmt.GenJnlValidate(FieldNo("Account Type"), xRec, Rec);
                // P8000241A
            end;
        }
        field(4; "Account No."; Code[20])
        {
            ...
            ELSE
            IF ("Account Type" = CONST(FOODAccrualPlan)) "Accrual Plan"."No.";
            ...
            begin
                // P8000170A Begin
                if ("Account No." <> xRec."Account No.") and ("Document Type" = "Document Type"::Payment) then
                    ErrorIfDeductionsExist;
                // P8000170A
                ...
                // P8000241A
                if P800Fns.AccrualsInstalled() then
                    AccrualFldMgmt.GenJnlValidate(FieldNo("Account No."), xRec, Rec);
                // P8000241A
        ...
        field(6; "Document Type"; Enum "Gen. Journal Document Type")
        {
            ...
            begin
                // P8000170A Begin
                if ("Document Type" <> xRec."Document Type") and (xRec."Document Type" = "Document Type"::Payment) then
                    ErrorIfDeductionsExist;
                // P8000170A
                Validate("Payment Terms Code");
        ...
        field(11; "Bal. Account No."; Code[20])
        {
            ...
            ELSE
            IF ("Bal. Account Type" = CONST(FOODAccrualPlan)) "Accrual Plan"."No.";
            ...
            begin
                ...
                // P8000241A
                if P800Fns.AccrualsInstalled() then
                    AccrualFldMgmt.GenJnlValidate(FieldNo("Bal. Account No."), xRec, Rec);
                // P8000241A
        ...
        field(35; "Applies-to Doc. Type"; Enum "Gen. Journal Document Type")
        {
            ...
            begin
                ...
                // P8000170A Begin
                if ("Applies-to Doc. Type" <> xRec."Applies-to Doc. Type") and ("Document Type" = "Document Type"::Payment) then
                    ErrorIfDeductionsExist;
                // P8000170A
            end;
        }
        field(36; "Applies-to Doc. No."; Code[20])
        {
            ...
            begin
                // P8000170A Begin
                if ("Applies-to Doc. No." <> xRec."Applies-to Doc. No.") and ("Document Type" = "Document Type"::Payment) then
                    ErrorIfDeductionsExist;
                // P8000170A
        ...
        field(48; "Applies-to ID"; Code[50])
        {
            ...
            begin
                // P8000170A Begin
                if ("Applies-to ID" <> xRec."Applies-to ID") and ("Document Type" = "Document Type"::Payment) then
                    ErrorIfDeductionsExist;
                // P8000170A
        ...
        field(63; "Bal. Account Type"; Enum "Gen. Journal Account Type")
        {
            ...
            begin
                ...
                // P8000241A
                if P800Fns.AccrualsInstalled() then
                    AccrualFldMgmt.GenJnlValidate(FieldNo("Bal. Account Type"), xRec, Rec);
                // P8000241A
            end;
        }
        ...
        field(79; "Source No."; Code[20])
        {
            ...
            ELSE
            IF ("Source Type" = CONST(FOODAccrualPlan)) "Accrual Plan"."No.";
    ...
    begin
        ...
        // P8000170A Begin
        if P800Fns.DedMgtInstalled then
            DedMgt.DeleteGenJnlLineDeductions(Rec);
        // P8000170A End
    end;
    ...
    var
        ...
        Text37002000: Label 'Deduction lines exist.';
    ...
    begin
        // P8000170A Begin
        if (Amount >= 0) and ("Document Type" = "Document Type"::Payment) then
            ErrorIfDeductionsExist;
        // P8000170A
    ...
    procedure DeductionsExist(): Boolean
    var
        DeductionLine: Record "Deduction Line";
    begin
        // P8000170A
        DeductionLine.SetRange("Source Table No.", DATABASE::"Gen. Journal Line");
        DeductionLine.SetRange("Source ID", "Journal Template Name");
        DeductionLine.SetRange("Source Batch Name", "Journal Batch Name");
        DeductionLine.SetRange("Source Ref. No.", "Line No.");
        exit(DeductionLine.Find('-'));
    end;

    procedure ErrorIfDeductionsExist()
    begin
        // P8000170A
        if DeductionsExist then
            Error(Text37002000);
    end;

    procedure AmountToBApplied(): Decimal
    var
        DeductionMgt: Codeunit "Deduction Management";
        CustLedger: Record "Cust. Ledger Entry";
    begin
        // PR4.00
        if ("Account Type" <> "Account Type"::Customer) or ("Posting Date" = 0D) then // P8000920
            exit;

        if DeductionsExist then
            exit(DedMgt.AmountApplied(DATABASE::"Gen. Journal Line", "Journal Template Name", "Journal Batch Name", "Line No.",
              "Posting Date")) // P8000920
        else begin
            CustLedger.SetCurrentKey("Customer No.", "Applies-to ID");
            CustLedger.SetRange("Customer No.", "Account No.");
            CustLedger.SetRange("Applies-to ID", "Document No.");
            CustLedger.CalcSums("Amount to Apply");
            exit(CustLedger."Amount to Apply");
        end;
    end;
