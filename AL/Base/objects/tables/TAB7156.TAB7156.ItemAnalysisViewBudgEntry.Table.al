table 7156 "Item Analysis View Budg. Entry"
{
    ...
    keys
    {
        ...
        {
            Clustered = true;
            SumIndexFields = "Sales Amount", "Cost Amount", Quantity, "Quantity (Alt.)";
        }
        key(Key2; "Analysis View Code", "Analysis Area", "Budget Name", "Item No.", "Source Type", "Source No.", "Dimension 1 Value Code", "Dimension 2 Value Code", "Dimension 3 Value Code", "Location Code", "Posting Date", "Entry No.")
        {
            SumIndexFields = "Sales Amount (FOB)", "Sales Amount (Freight)";
        }
    }
