...
{
    // PR3.61
    //   Add usage option for Container
    // 
    // PR3.70.01
    //   Add usage option for S.Pick Ticket
    // 
    // PR4.00.01
    // P8000267B, VerticalSoft, Jack Reynolds, 12 DEC 05
    //   Move P800 values in option string for Usage
    // 
    // PR4.00.04
    // P8000333A, VerticalSoft, Jack Reynolds, 30 AUG 06
    //   Add M.Work Order as option to Usage field
    // 
    // PR4.00.06
    // P8000496A, VerticalSoft, Jack Reynolds, 23 JUL 07
    //   Update usage to include option for Repack Order
    // 
    // PR5.00.01
    ...
    // 
    // PRW16.00
    // P8000651, VerticalSoft, Jack Reynolds, 08 DEC 08
    //   Push P800 additions out further to accomodate NAV additions in the NA database
