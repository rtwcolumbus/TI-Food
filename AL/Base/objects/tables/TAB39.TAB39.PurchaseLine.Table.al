            ...
            begin
                ...
                if not IsHandled then begin
                    ...
                    if "Qty. to Receive" = Quantity - "Quantity Received" - GetContainerQuantity('') then begin // P80046533
                        ...
                        "Qty. to Receive (Base)" := CalcBaseQty("Quantity Received" + "Qty. to Receive", FieldCaption("Qty. to Receive"), FieldCaption("Qty. to Receive (Base)")) - "Qty. Received (Base)"; // P8000550A
...
#pragma warning restore
        ...
        field(5803; "Return Qty. to Ship"; Decimal)
        {
            ...
            begin
                ...
                if "Return Qty. to Ship" = Quantity - "Return Qty. Shipped" - GetContainerQuantity('') then // P80046533
                    ...
                    "Return Qty. to Ship (Base)" := CalcBaseQty("Return Qty. Shipped" + "Return Qty. to Ship", FieldCaption("Return Qty. to Ship"), FieldCaption("Return Qty. to Ship (Base)")) - "Return Qty. Shipped (Base)"; // P8000550A
                    if "Qty. per Unit of Measure" <> 0 then
    ...
    keys
    {
        ...
        key(Key37002000; "Recalculate Invoice Disc.")
        {
        }
        key(Key37002001; "Outstanding Quantity")
        {
        }
        key(Key37002002; "Location Code", "Quantity Invoiced")
        {
        }
    }
