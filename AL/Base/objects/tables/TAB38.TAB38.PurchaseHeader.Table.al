table 38 "Purchase Header"
{
    ...
    // 
    // PR3.70.06
    // P8000080A, Myers Nissi, Steve Post, 25 AUG 04
    //   Added fields Pickup Location Code and Pickup Load No.
    // 
    // PR3.70.07
    ...
    //   Recreate extra charges when recreating purchase lines; include currency code
    // 
    // PR5.00
    // P8000466A, VerticalSoft, Jack Reynolds, 17 AUG 07
    //   Fixes to LookupShortcutECVendor
    // 
    // PRW15.00.01
    // P8000547A, VerticalSoft, Jack Reynolds, 02 MAY 08
    //   Add field for Delivery Route No. and logic to assign it
    // 
    ...
    //   Add "Combine Lots Method" field and logic
    // 
    ...
    // 
    // PRW16.00.05
    // P8000924, Columbus IT, Jack Reynolds, 29 MAR 11
    //   Fixes to StartADC
    // 
    ...
    //   Default Purchaser from User ID
    // 
    // P8000954, Columbus IT, Jack Reynolds, 08 JUL 11
    //   Add key for delivery routes
    // 
    // PRW16.00.06
    ...
    //   Add Delivery Stop No.
    // 
    // PRW18.00.03
    // P8006483, To-Increase, Jack Reynolds, 15 FEB 16
    //   When changing Buy-from Vendor, write transaction is started before validating new pay-to vendor
    // 
    // PRW19.00
    ...
    fields
    {
        field(37002000; "Allow Unapproved Items"; Boolean)
        {
            Caption = 'Allow Unapproved Items';

            trigger OnValidate()
            begin
                // P8001230
                CheckLineApprovedVendor;
            end;
        }
        ...
        field(37002060; "Pickup Location Code"; Code[10])
        {
            Caption = 'Pickup Location Code';
            Description = 'PR3.70.06';
            TableRelation = "Pickup Location".Code WHERE("Vendor No." = FIELD("Buy-from Vendor No."));
        }
        field(37002061; "Pickup Load No."; Code[20])
        {
        ...
        field(37002062; "Delivery Route No."; Code[20])
        {
            ...
            begin
                ...
                if CurrFieldNo = FieldNo("Delivery Route No.") then begin
                    DeliveryRouteMgmt.CheckDeliveryRouteLocation("Delivery Route No.", "Location Code");
                    DeliveryRouteMgmt.CheckDeliveryRouteDOW("Delivery Route No.", "Expected Receipt Date");
                end;
            end;
        }
        ...
        field(37002660; "Received By"; Code[20])
        {
            Caption = 'Received By';
            Description = 'PR3.70.01';
        }
        field(37002661; "Checked By"; Code[20])
        {
            Caption = 'Checked By';
            Description = 'PR3.70.01';
        }
        field(37002662; "Recorder Unit No."; Text[30])
        {
            Caption = 'Recorder Unit No.';
            Description = 'PR3.70.01';
        }
        field(37002663; "Low Temperature"; Decimal)
        {
            Caption = 'Low Temperature';
            Description = 'PR3.70.01';
        }
        field(37002664; "High Temperature"; Decimal)
        {
            Caption = 'High Temperature';
            Description = 'PR3.70.01';
        }
        field(37002685; "Posting Comm. Manifest No."; Code[20])
        {
            Caption = 'Posting Comm. Manifest No.';
            Editable = false;
            TableRelation = "Commodity Manifest Header";
        }
        field(37002686; "Commodity Manifest Order"; Boolean)
        {
            Caption = 'Commodity Manifest Order';
            Editable = false;
        }
        field(37002687; "Comm. Receiving Complete"; Boolean)
        {
            Caption = 'Comm. Receiving Complete';

            trigger OnValidate()
            begin
                CheckCommRcptComplete; // P8000890
            end;
        }
        field(37002688; "Comm. P.O. Manifest No."; Code[20])
        {
            Caption = 'Comm. P.O. Manifest No.';
            Editable = false;
            TableRelation = "Commodity Manifest Header";
        }
        field(37002689; "Comm. P.O. Start Date"; Date)
        {
            Caption = 'Comm. P.O. Start Date';
            Editable = false;
        }
        field(37002690; "Comm. P.O. End Date"; Date)
        {
            Caption = 'Comm. P.O. End Date';
            Editable = false;
        }
        field(37002691; "Commodity Item No."; Code[20])
        {
        ...
        field(37002692; "Commodity Cost Calculated"; Boolean)
        {
            CalcFormula = - Exist("Purchase Line" WHERE("Document Type" = FIELD("Document Type"),
                                                        "Document No." = FIELD("No."),
                                                        "Commodity Cost Calculated" = CONST(false)));
            Caption = 'Commodity Cost Calculated';
            Editable = false;
            FieldClass = FlowField;
        }
        field(37002693; "Commodity Amount"; Decimal)
        {
            AutoFormatType = 2;
            BlankZero = true;
            CalcFormula = Sum("Purchase Line"."Commodity Amount" WHERE("Document Type" = FIELD("Document Type"),
                                                                        "Document No." = FIELD("No."),
                                                                        "Commodity Cost Calculated" = CONST(true)));
            Caption = 'Commodity Amount';
            Editable = false;
            FieldClass = FlowField;
        }
        field(37002694; "Commodity Qty. (Base)"; Decimal)
        {
            BlankZero = true;
            CalcFormula = Sum("Purchase Line"."Quantity (Base)" WHERE("Document Type" = FIELD("Document Type"),
                                                                       "Document No." = FIELD("No."),
                                                                       "Commodity Cost Calculated" = CONST(true)));
            Caption = 'Commodity Qty. (Base)';
            DecimalPlaces = 0 : 5;
            Editable = false;
            FieldClass = FlowField;
        }
        field(37002695; "Commodity P.O. Type"; Option)
        {
        ...
        field(37002696; "Blended Comm. Unit Cost"; Decimal)
        {
            AutoFormatType = 2;
            BlankZero = true;
        ...
        field(2; "Buy-from Vendor No."; Code[20])
        {
            ...
            begin
                ...
                then begin
                    ...
                    if ConfirmUpdateField(FieldNo("Buy-from Vendor No.")) then begin
                        ...
                        if ProcessFns.ProcessDataCollectionInstalled then
                            DataCollectionMgmt.CheckPurchHeaderModify(xRec, Rec);
                        // P8001090
                ...
                UpdateLocationCode(Vend."Location Code"); //P8006483, P800-MegaApp
                "Order Address Code" := '';
        ...
        field(4; "Pay-to Vendor No."; Code[20])
        {
            ...
            begin
                ...
                SetPurchaserCode(SetPurchaser(Vend."Purchaser Code"), "Purchaser Code"); // P8000942
        ...
        field(19; "Order Date"; Date)
        {
            ...
            begin
                ...
                UpdatePurchLines(FieldCaption("Order Date"), CurrFieldNo <> 0); // P8000691
            end;
        }
        field(20; "Posting Date"; Date)
        {
            ...
            begin
                ...
                UpdatePurchLines(FieldCaption("Posting Date"), CurrFieldNo <> 0); // P8000691
            end;
        }
        ...
        field(28; "Location Code"; Code[10])
        {
            ...
            begin
                ...
                TestStatusOpen();
                if "Location Code" <> xRec."Location Code" then // P8000549A
                    TestField("Pickup Load No.", '');              // P8000549A
                ...
                if ProcessFns.DistPlanningInstalled then          // P8000547A
                    DeliveryRouteMgmt.GetPurchDeliveryRouting(Rec); // P8000547A
    ...
    keys
    {
        ...
        key(Key7; "Buy-from Vendor No.", "Pay-to Vendor No.", "Commodity Item No.", "Commodity P.O. Type")
        {
        }
        key(Key8; "Document Type", "Delivery Route No.")
        {
        }
        key(Key9; "Document Date")
        {
        }
        key(Key10; Status, "Expected Receipt Date", "Location Code", "Responsibility Center")
        {
        }
        key(Key11; "Assigned User ID")
        {
        }
    }
    ...
    begin
        ...
        if ProcessFns.AccrualsInstalled() then
            AccrualMgmt.PurchDeleteDocument(Rec);
        // P8000119A
        ...
        DeleteExtraCharges(); // PR3.70.01 Begin
    ...
    var
        ...
        PurchAccrualMgmt: Codeunit "Purchase Accrual Management";
        SkipAccrualRecalc: Boolean;
        Text37002685: Label 'Manifest No. %1';
        Text37002686: Label '<Month Text>, <Year4>';
        Text37002687: Label 'From %1 to %2';
        Text37002688: Label 'Manual';
    ...
    var
        ...
        TempDocLineExtraCharge: Record "Document Extra Charge" temporary;
        ConfirmText: Text;
        IsHandled: Boolean;
    begin
        ...
        if Confirmed then begin
            ...
            if PurchLine.FindSet() then begin
                ...
                // P8000487A
                DocLineExtraCharge.SetRange("Table ID", DATABASE::"Purchase Line"); // P8001032
                DocLineExtraCharge.SetRange("Document Type", "Document Type");
                DocLineExtraCharge.SetRange("Document No.", "No.");
                //DocLineExtraCharge.SETFILTER("Line No.",'<>0');                   // P8001032
                if DocLineExtraCharge.Find('-') then
                    repeat
                        TempDocLineExtraCharge := DocLineExtraCharge;
                        TempDocLineExtraCharge.Insert;
                    until DocLineExtraCharge.Next = 0;
                // P8000487A
                ...
                // P8000487A
                if TempDocLineExtraCharge.Find('-') then
                    repeat
                        DocLineExtraCharge := TempDocLineExtraCharge;
                        DocLineExtraCharge."Currency Code" := "Currency Code";
                        DocLineExtraCharge.UpdateCurrencyFactor;
                        DocLineExtraCharge.Validate("Charge (LCY)");
                        DocLineExtraCharge.Insert;
                    until TempDocLineExtraCharge.Next = 0;
                // P8000487A
                ...
                if not IsHandled then
                    case ChangedFieldNo of
                        ...
                        FieldNo("Posting Date"), FieldNo("Order Date"): // P80066030
                            if PurchLine.Type = PurchLine.Type::Item then begin // P8001287
                                if ProcessFns.AccrualsInstalled and (not SkipAccrualRecalc) then // P8000694
                                    PurchAccrualMgmt.PurchRecalcLines(PurchLine);
                        ...
                        FieldNo("Currency Factor"):
                            if PurchLine.Type <> PurchLine.Type::" " then begin // P8000694
                                //PurchLine.VALIDATE("Direct Unit Cost");         // P8000694
                                PurchLine.UpdateDirectUnitCost(0);                // P8000694
                                                                                  // P8000694
                                if ProcessFns.AccrualsInstalled then
                                    PurchAccrualMgmt.PurchRecalcLines(PurchLine);
    ...
    begin
        ...
        DocExtraCharge.SetFilter("Table ID", '%1|%2', DATABASE::"Purchase Header", DATABASE::"Purchase Line"); // P8000928, P8001032
    ...
    begin
        ...
        if "No." <> '' then
            ExtraChargeMgt.ShowExtraCharge(DATABASE::"Purchase Header", "Document Type", "No.", 0, ShortcutECCharge) // P8000928, P8001032
        else
            ExtraChargeMgt.ShowTempExtraCharge(ShortcutECCharge);
        // PR3.70.01
    end;

    procedure ShowShortcutECVendor(var ShortcutECVendor: array[5] of Code[20])
    begin
        // PR3.70.01
        if not ProcessFns.FreshProInstalled then
            exit;
        ...
        if "No." <> '' then
            ExtraChargeMgt.ShowExtraVendor(DATABASE::"Purchase Header", "Document Type", "No.", ShortcutECVendor) // P8000928, P8001032
        else
            ExtraChargeMgt.ShowTempExtraVendor(ShortcutECVendor);
        // PR3.70.01
    end;
    ...
    begin
        ...
        if "No." <> '' then
            ExtraChargeMgt.SaveExtraCharge(DATABASE::"Purchase Header", "Document Type", "No.", 0, FieldNumber, Charge) // P8000928, P8001032
        else
            ExtraChargeMgt.SaveTempExtraCharge(FieldNumber, Charge);
        // PR3.70.01
    end;

    procedure ValidateShortcutECVendor(FieldNumber: Integer; VendorNo: Code[20])
    begin
        // PR3.70.01
        ExtraChargeMgt.ValidateExtraVendor(FieldNumber, VendorNo);
        if "No." <> '' then
            ExtraChargeMgt.SaveExtraVendor(DATABASE::"Purchase Header", "Document Type", "No.", 0, FieldNumber, VendorNo) // P8000928, P8001032
        else
            ExtraChargeMgt.SaveTempExtraVendor(FieldNumber, VendorNo);
        // PR3.70.01
    end;

    procedure LookupShortcutECVendor(FieldNumber: Integer; var VendorNo: Text[1024])
    begin
        // PR3.70.01
        // P8000466A - VendorNo changed to TEXT1024
        if not ExtraChargeMgt.LookupExtraVendor(FieldNumber, VendorNo) then // P8000466A
            exit;                                                            // P8000466A
        if "No." <> '' then
            ExtraChargeMgt.SaveExtraVendor(DATABASE::"Purchase Header", "Document Type", "No.", 0, FieldNumber, VendorNo) // P8000928, P8001032
        else
        ...
        if PurchLine.Find('-') then
            repeat
                if PurchLine.Type = PurchLine.Type::Item then begin
                    if PurchLine."Alt. Qty. Transaction No." <> 0 then
                        AltQtyMgmt.DeleteAltQtyLines(PurchLine."Alt. Qty. Transaction No.");

                    // P8000924
                    //      PurchLineReserve.RetainTrackingSpec; // P8000410A
                    //      PurchLineReserve.DeleteLine(PurchLine);
                    //      PurchLine."Lot No." := ''; // P8000043A
                    // P8000924
                end;
                case "Document Type" of
                    "Document Type"::Order:
                ...
                PurchLine.ADCStarting(true); // P8001189
                PurchLine.UpdateLotTracking(true); // P8000924
                PurchLine.Modify;
            until PurchLine.Next = 0;
    ...
    begin
        ...
        case Vendor."Minimum Order Basis" of
            Vendor."Minimum Order Basis"::" ": // P8000185B
                exit;
            Vendor."Minimum Order Basis"::Amount:
                begin
                    GLSetup.Get;
                    MinText := StrSubstNo(Text001, Format(Vendor."Minimum Order Basis"),
                      Format(Vendor."Minimum Order Amount", 0,
                        StrSubstNo('<Precision,%1><Integer Thousand><Decimal>', GLSetup."Amount Decimal Places")));
                    if PurchLine.Find('-') then
                        repeat
                            MinValue += PurchLine."Line Amount";
                        until PurchLine.Next = 0;
                    Result := Vendor."Minimum Order Amount" <= MinValue;
                end;
            Vendor."Minimum Order Basis"::Weight:
                begin
                    MinText := StrSubstNo(Text002, Format(Vendor."Minimum Order Basis"),
                      Vendor."Minimum Order Amount", Vendor."Minimum Order Unit of Measure");
                    PurchLine.SetRange(Type, PurchLine.Type::Item);
                    PurchLine.SetFilter("No.", '<>%1', '');
                    if PurchLine.Find('-') then
                        repeat
                            MinValue += P800UOMFns.ItemWeight(PurchLine."No.", PurchLine."Quantity (Base)", PurchLine."Quantity (Alt.)");
                        until PurchLine.Next = 0;
                    MinValue := MinValue / P800UOMFns.UOMtoMetricBase(Vendor."Minimum Order Unit of Measure");
                    Result := Vendor."Minimum Order Amount" <= MinValue;
                end;
            Vendor."Minimum Order Basis"::Quantity:
                begin
                    MinText := StrSubstNo(Text001, Format(Vendor."Minimum Order Basis"), Vendor."Minimum Order Amount");
                    PurchLine.SetRange(Type, PurchLine.Type::Item);
                    PurchLine.SetFilter("No.", '<>%1', '');
                    if PurchLine.Find('-') then
                        repeat
                            MinValue += PurchLine.Quantity;
                        until PurchLine.Next = 0;
                    Result := Vendor."Minimum Order Amount" <= MinValue;
                end;
        end;
    ...
    procedure CheckCommRcptComplete()
    var
        PurchLine2: Record "Purchase Line";
        CommManifestLine: Record "Commodity Manifest Line";
    begin
        // P8000890, P8000902
        if "Comm. Receiving Complete" then begin
            TestField("Commodity Manifest Order");
            PurchLine2.SetRange("Document Type", "Document Type");
            PurchLine2.SetRange("Document No.", "No.");
            if PurchLine2.FindSet then
                repeat
                    if CommManifestLine.Get(PurchLine2."Commodity Manifest No.", PurchLine2."Commodity Manifest Line No.") then
                        CommManifestLine.TestField("Purch. Order Status", CommManifestLine."Purch. Order Status"::Posted);
                    if (PurchLine2."Commodity P.O. Type" <> PurchLine2."Commodity P.O. Type"::Hauler) then
                        PurchLine2.TestField("Quantity Received", PurchLine2.Quantity);
                until (PurchLine2.Next = 0);
        end;
    end;

    procedure CommOrderDescription(): Text[250]
    begin
        // P8000890
        if "Commodity Manifest Order" then begin
            if ("Comm. P.O. Manifest No." <> '') then
                exit(StrSubstNo(Text37002685, "Comm. P.O. Manifest No."));
            if ("Comm. P.O. Start Date" <> 0D) and ("Comm. P.O. End Date" <> 0D) then begin
                if (CalcDate('-CM', "Comm. P.O. Start Date") = "Comm. P.O. Start Date") and
                   (CalcDate('+CM', "Comm. P.O. End Date") = "Comm. P.O. End Date")
                then
                    exit(Format("Comm. P.O. Start Date", 0, Text37002686));
                exit(StrSubstNo(Text37002687, "Comm. P.O. Start Date", "Comm. P.O. End Date"));
            end;
            exit(Text37002688);
        end;
    end;

    local procedure ValidateBlendedCost()
    var
        PurchLine2: Record "Purchase Line";
    ...
    begin
        ...
        PurchLine2.SetRange("Document Type", "Document Type");
        PurchLine2.SetRange("Document No.", "No.");
        PurchLine2.SetFilter("Commodity Manifest No.", '<>%1', '');
        if PurchLine2.FindSet then
            repeat
                if CommCostMgmt.CalcPurchLine(PurchLine2, false) then
                    PurchLine2.Modify;
            until (PurchLine2.Next = 0);
    end;

    procedure SetPurchaser(VendorPurchaser: Code[10]): Code[10]
    var
        SalespersonPurchaser: Record "Salesperson/Purchaser";
    begin
        // P8000942
    ...
    procedure CheckLineApprovedVendor()
    var
        PurchLine2: Record "Purchase Line";
    begin
        // P8001230
        ...
        if not "Allow Unapproved Items" then begin
            PurchLine2.SetRange("Document Type", "Document Type");
            PurchLine2.SetRange("Document No.", "No.");
            ...
            if PurchLine2.FindSet then
                repeat
                    PurchLine2.TestApprovedItem("Allow Unapproved Items");
                until PurchLine2.Next = 0;
        end;
    end;
    ...
    procedure UpdateReturnQtyToShip()
    var
        PurchLine: Record "Purchase Line";
    begin
        //P8001373
        ...
        if PurchLine.Find('-') then begin
            repeat
                if PurchLine.GetContainerQuantity(true) <> 0 then // P80046533
                    PurchLine.Validate("Return Qty. to Ship", PurchLine.GetContainerQuantity(true)) // P80046533
                else
