table 49 "Invoice Post. Buffer"
{
    ...
    //   Add Accrual Plan option to Type, add Accrual Line No.
    // 
    // PRW111.00.01
...
#pragma warning restore AS0074
    ...
    fields
    {
        ...
        field(37002120; "Accrual Line No."; Integer)
        {
            Caption = 'Accrual Line No.';
            DataClassification = SystemMetadata;
        }
    }
    ...
    keys
    {
        key(Key1; Type, "G/L Account", "Gen. Bus. Posting Group", "Gen. Prod. Posting Group", "VAT Bus. Posting Group", "VAT Prod. Posting Group", "Tax Area Code", "Tax Group Code", "Tax Liable", "Use Tax", "Dimension Set ID", "Job No.", "Fixed Asset Line No.", "Deferral Code", "Additional Grouping Identifier", "Accrual Line No.")
        {
            Clustered = true;
        }
    }
