    ...
    begin
        ...
        if ValueEntry.FindSet then
            repeat
                ...
                if ItemLedgerEntry."Document Type" = ItemLedgerEntry."Document Type"::"Purchase Return Shipment" then begin
                    ReturnShipmentHeader.Get(ItemLedgerEntry."Document No.");
                    exit(ReturnShipmentHeader."Document Date");
                end;
                if ItemLedgerEntry."Document Type" = ItemLedgerEntry."Document Type"::"Purchase Credit Memo" then begin
                    PurchaseCrMemoHeader.Get(ItemLedgerEntry."Document No.");
