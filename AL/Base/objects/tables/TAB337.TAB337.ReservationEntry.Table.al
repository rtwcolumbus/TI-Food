table 337 "Reservation Entry"
{
    ...
    keys
    {
        ...
        {
            IncludedFields = "Quantity (Base)", "Qty. to Handle (Base)", "Quantity (Alt.)", "Qty. to Handle (Alt.)", "Qty. to Invoice (Alt.)";
        }
        ...
        {
            IncludedFields = Quantity, "Quantity (Alt.)", "Qty. to Invoice (Alt.)";
        }
