report 10130 "Availability Projection" // Version: FOODNA
{
    // PRNA6.00.06
    ...
    //   Available for restored; layout cleaned up
    
    DefaultLayout = RDLC;
    RDLCLayout = './layout/local/AvailabilityProjection.rdlc';
                ...
                begin
                    ...
                    for i := 1 to 7 do begin
                        if i = 1 then begin
                            ...
                            LotStatusMgmt.QuantityAdjForItemLedger(ItemLedgerEntry, LotStatusExclusionFilter, ItemLedgerEntry.Quantity); // P8001083
                        ...
                        LotStatusMgmt.AdjustItemFlowFields(Item, LotStatusExclusionFilter, false, false, 0, // P8001083
