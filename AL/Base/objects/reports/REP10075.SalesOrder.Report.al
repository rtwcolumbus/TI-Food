report 10075 "Sales Order" // Version: FOODNA
{
    // PR3.60
    ...
    DefaultLayout = RDLC;
    RDLCLayout = './layout/local/SalesOrder.rdlc';
    Caption = 'Sales Order';
    ...
    dataset
    {
        dataitem("Sales Header"; "Sales Header")
        {
            ...
            dataitem("Sales Line"; "Sales Line")
            {
                ...
                begin
                    ...
                    if "Off-Invoice Allowance Code" <> '' then begin
                        ...
                        //AllowanceAmount -= "Line Amount"; // P8001152
                        CurrReport.Skip;
                    end;
                    // PR3.70
                    ...
                    if OrderAllowance.Find('-') then begin
                        ...
                        repeat
                            ...
                            if AllowanceLine2.Allowance <> 0 then begin // P8000908
                                ...
                                //AllowanceTotal += AllowanceLine2.Allowance; // P8000908, P8001252
                            end;
            ...
            dataitem(CopyLoop; "Integer")
            {
                ...
                dataitem(PageLoop; "Integer")
                {
                    ...
                    dataitem(SalesLine; "Integer")
                    {
                        ...
                        column(TempSalesLineLineAmtTaxAmtInvDiscAmt; TempSalesLine."Line Amount" + TaxAmount - TempSalesLine."Inv. Discount Amount" + AllowanceAmount)
                        {
                        }
                        ...
                        column(OffInvoiceAllowanceCode; TempSalesLine."Off-Invoice Allowance Code")
                        {
                        }
                        dataitem(AltQtyLine; "Integer")
                        {
                            ...
                            begin
                                ...
                                if ProcessFns.AltQtyInstalled then begin
                                    if not AltQtyMgmt.StartLineReport(TempSalesLine."Alt. Qty. Transaction No.", TempSalesLine."Quantity (Base)") then
                                        CurrReport.Break;
                                end else
                                    CurrReport.Break;
                                // PR3.60
            ...
            begin
                ...
                AllowanceAmount := 0;    // PR3.70, PR8001152
            end;
        }
    }
