...
report 7052 "Suggest Sales Price on Wksh."
{
    ...
    dataset
    {
        ...
        {
            DataItemTableView = SORTING("Item Type", "Item Code") WHERE("Item Type" = CONST(Item), "Pricing Method" = CONST("Fixed Amount"));
            RequestFilterFields = "Sales Type", "Sales Code", "Item Code", "Currency Code", "Starting Date";
            ...
            begin
                ...
                */
                //
                if (Item."No." <> "Item Code") then begin
                    Item.Get("Item Code");
                    Window.Update(1, "Item Code");
                end;
                // PR3.60
                ...
                SalesPriceWksh."Price Type" := "Price Type"; // PR3.60
