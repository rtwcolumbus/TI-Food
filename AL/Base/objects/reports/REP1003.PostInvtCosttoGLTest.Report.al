report 1003 "Post Invt. Cost to G/L - Test"
{
    ...
    // 
    // PRW16.00.03
    // P8000813, VerticalSoft, MMAS, 15 APR 10
    //   Report design for RTC
    DefaultLayout = RDLC;
    RDLCLayout = './layout/PostInvtCosttoGLTest.rdlc';
        ...
        dataitem("Integer"; "Integer")
        {
            ...
            dataitem(PostValueEntryToGL; "Post Value Entry to G/L")
            {
                ...
                begin
                    ...
                    InvtPostToGL.Initialize(PostMethod = PostMethod::"per Posting Group"); // P8000466A
