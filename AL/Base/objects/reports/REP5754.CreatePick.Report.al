...
//   Upgrade to 21.0 - CheckSourceDocument for Staged Pick
    ...
    begin
        case PickWhseWkshLine."Source Type" of
            ...
            DATABASE::"Whse. Staged Pick Line":
                begin 
                    WhseStagedPickLine.SetRange("No.", PickWhseWkshLine."Source No.");
                    WhseStagedPickLine.SetRange("Line No.", PickWhseWkshLine."Source Line No.");
                    if WhseStagedPickLine.IsEmpty() then
                        Error(SourceDocumentDoesNotExistErr, WhseStagedPickLine.TableCaption(), WhseStagedPickLine.GetFilters());
                end;
        // P800155629
        end;
    end;
