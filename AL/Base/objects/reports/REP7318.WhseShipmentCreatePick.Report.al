report 7318 "Whse.-Shipment - Create Pick"
{
    ...
    dataset
    {
        dataitem("Warehouse Shipment Line"; "Warehouse Shipment Line")
        {
            ...
            begin
                ...
                CreatePickParameters."Create Pick Per Source Doc." := CreatePickperSourceDoc;  // P80038975
    ...
    requestpage
    {
        layout
        {
            area(content)
            {
                group(Options)
                {
                    ...
                    field(CreatePickperSourceDoc; CreatePickperSourceDoc)
                    {
                        ApplicationArea = FOODBasic;
                        Caption = 'Create Pick per Source Document';
                    }
                }
            }
        }
        ...
        begin
            ...
            CreatePickperSourceDoc := (WhseShptHeader."Delivery Trip" <> '');  // P80038975
        end;
    }
    ...
    var
        ...
        CreatePickperSourceDoc: Boolean;
