report 35 "Document Entries"
{
    ...
    //   Add data item for Repack Orders
    // 
    // PRW15.00.01
    // P8000584A, VerticalSoft, Jack Reynolds, 20 FEB 08
    //   Add data items for work orders, accrual ledger, container ledger, and maintenance ledger
    // 
    // PRW16.00.03
    // P8000813, VerticalSoft, MMAS, 07 MAY 10
    //   Report design for RTC
    //     1. Tables for the following dataitems added: Repack Orders,work orders, accrual ledger, container ledger, and maintenance ledger
    //     2. DateFormat added to the new tables
    // 
    // PRW111.00.01
    // P800057408, to Increase, Jack Reynolds, 12 APR 18
    //   Cleanup alignment isses in the Food data items
    DefaultLayout = RDLC;
    RDLCLayout = './layout/DocumentEntries.rdlc';
    ...
    dataset
    {
        dataitem("Integer"; "Integer")
        {
            ...
            {
                DataItemTableView = SORTING("No.");
                column(Repack_Order__No__; "No.")
                {
                    IncludeCaption = true;
                }
                column(Repack_Order__Item_No__; "Item No.")
                {
                    IncludeCaption = true;
                }
                column(Repack_Order_Description; Description)
                {
                    IncludeCaption = true;
                }
                column(Repack_Order__Unit_of_Measure_Code_; "Unit of Measure Code")
                {
                    IncludeCaption = true;
                }
                column(Repack_Order__Quantity_Produced_; "Quantity Produced")
                {
                    IncludeCaption = true;
                }
                column(RepackOrderNoCaption; FieldCaption("No."))
                {
                }
                ...
                begin
                    // P8000496A
                    if TempDocumentEntry."Table ID" <> DATABASE::"Repack Order" then
                        CurrReport.Break;
            ...
            {
                DataItemTableView = SORTING("No.");
                column(Work_Order__No__; "No.")
                {
                    IncludeCaption = true;
                }
                column(Work_Order__Asset_No__; "Asset No.")
                {
                    IncludeCaption = true;
                }
                column(Work_Order__Origination_Date_; "Origination Date")
                {
                    IncludeCaption = true;
                }
                column(Work_Order__Asset_Description_; "Asset Description")
                {
                    IncludeCaption = true;
                }
                column(Work_Order__Completion_Date_; "Completion Date")
                {
                    IncludeCaption = true;
                }
                column(Work_Order__Total_Cost__Actual__; "Total Cost (Actual)")
                {
                    IncludeCaption = true;
                }
                column(WorkOrderNoCaption; FieldCaption("No."))
                {
                }
                ...
                begin
                    // P8000584A
                    if TempDocumentEntry."Table ID" <> DATABASE::"Work Order" then
                        CurrReport.Break;
            ...
            {
                DataItemTableView = SORTING("Document No.", "Posting Date");
                column(Accrual_Ledger_Entry__Accrual_Plan_No__; "Accrual Plan No.")
                {
                    IncludeCaption = true;
                }
                column(Accrual_Ledger_Entry__Entry_Type_; "Entry Type")
                {
                    IncludeCaption = true;
                }
                column(Accrual_Ledger_Entry__Source_No__; "Source No.")
                {
                    IncludeCaption = true;
                }
                column(Accrual_Ledger_Entry__Source_Document_Type_; "Source Document Type")
                {
                    IncludeCaption = true;
                }
                column(Accrual_Ledger_Entry__Source_Document_No__; "Source Document No.")
                {
                    IncludeCaption = true;
                }
                column(Accrual_Ledger_Entry__Item_No__; "Item No.")
                {
                    IncludeCaption = true;
                }
                column(Accrual_Ledger_Entry_Amount; Amount)
                {
                    IncludeCaption = true;
                }
                column(Accrual_Ledger_Entry__Posting_Date_; "Posting Date")
                {
                    IncludeCaption = true;
                }
                column(Accrual_Ledger_Entry__Document_No__; "Document No.")
                {
                    IncludeCaption = true;
                }
                column(Accrual_Ledger_Entry__Entry_No__; "Entry No.")
                {
                    IncludeCaption = true;
                }
                column(AccrualLedgerEntryPostDtCaption; AccrualLedgerEntryPostDtCaptionLbl)
                {
                }
                ...
                begin
                    // P8000584A
                    if TempDocumentEntry."Table ID" <> DATABASE::"Accrual Ledger Entry" then
                        CurrReport.Break;
            ...
            {
                DataItemTableView = SORTING("Document No.", "Posting Date");
                column(Container_Ledger_Entry__Entry_No__; "Entry No.")
                {
                    IncludeCaption = true;
                }
                column(Container_Ledger_Entry__Container_No__; "Container Item No.")
                {
                    IncludeCaption = true;
                }
                column(Container_Ledger_Entry__Container_Serial_No__; "Container Serial No.")
                {
                    IncludeCaption = true;
                }
                column(Container_Ledger_Entry__Entry_Type_; "Entry Type")
                {
                    IncludeCaption = true;
                }
                column(Container_Ledger_Entry__Posting_Date_; "Posting Date")
                {
                    IncludeCaption = true;
                }
                column(Container_Ledger_Entry__Document_No__; "Document No.")
                {
                    IncludeCaption = true;
                }
                column(Container_Ledger_Entry__Source_Type_; "Source Type")
                {
                    IncludeCaption = true;
                }
                column(Container_Ledger_Entry__Source_No__; "Source No.")
                {
                    IncludeCaption = true;
                }
                column(Container_Ledger_Entry__Fill_Item_No__; "Fill Item No.")
                {
                    IncludeCaption = true;
                }
                column(Container_Ledger_Entry__Fill_Quantity_; "Fill Quantity")
                {
                    IncludeCaption = true;
                }
                column(ContainerLedgerEntryPostDtCaption; ContainerLedgerEntryPostDtCaptionLbl)
                {
                }
                ...
                begin
                    // P8000584A
                    if TempDocumentEntry."Table ID" <> DATABASE::"Container Ledger Entry" then
                        CurrReport.Break;
            ...
            {
                DataItemTableView = SORTING("Document No.", "Posting Date");
                column(Maintenance_Ledger__Entry_No__; "Entry No.")
                {
                    IncludeCaption = true;
                }
                column(Maintenance_Ledger__Work_Order_No__; "Work Order No.")
                {
                    IncludeCaption = true;
                }
                column(Maintenance_Ledger__Asset_No__; "Asset No.")
                {
                    IncludeCaption = true;
                }
                column(Maintenance_Ledger__Entry_Type_; "Entry Type")
                {
                    IncludeCaption = true;
                }
                column(Maintenance_Ledger__Posting_Date_; "Posting Date")
                {
                    IncludeCaption = true;
                }
                column(Maintenance_Ledger__Cost_Amount_; "Cost Amount")
                {
                    IncludeCaption = true;
                }
                column(Maintenance_Ledger_Quantity; Quantity)
                {
                    IncludeCaption = true;
                }
                column(Maintenance_Ledger__Document_No__; "Document No.")
                {
                    IncludeCaption = true;
                }
                column(Maintenance_Ledger__Vendor_No__; "Vendor No.")
                {
                    IncludeCaption = true;
                }
                column(Maintenance_Ledger__Maintenance_Trade_Code_; "Maintenance Trade Code")
                {
                    IncludeCaption = true;
                }
                column(Maintenance_Ledger__Item_No__; "Item No.")
                {
                    IncludeCaption = true;
                }
                column(MaintenanceLedgerPostDtCaption; MaintenanceLedgerPostDtCaptionLbl)
                {
                }
                ...
                begin
                    // P8000584A
                    if TempDocumentEntry."Table ID" <> DATABASE::"Maintenance Ledger" then
                        CurrReport.Break;
    ...
    var
        Maintenance_Ledger__Maintenance_Trade_Code_CaptionLbl: Label 'Trade Code';
        DateFormat: Label 'MM/dd/yy';
        AccrualLedgerEntryPostDtCaptionLbl: Label 'Posting Date';
        ContainerLedgerEntryPostDtCaptionLbl: Label 'Posting Date';
        MaintenanceLedgerPostDtCaptionLbl: Label 'Posting Date';
