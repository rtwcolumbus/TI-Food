report 7380 "Calculate Phys. Invt. Counting"
{
    ...
    begin
        ...
        exit(GetRequest(PostingDate2, NextDocNo2, SortingMethod2, PrintDoc2, PrintDocPerItem2, ZeroQty2, ShowQtyCalculated2, ZeroCount));
    end;

    procedure GetRequest(var PostingDate2: Date; var NextDocNo2: Code[20]; var SortingMethod2: Option " ",Item,Bin; var PrintDoc2: Boolean; var PrintDocPerItem2: Boolean; var ZeroQty2: Boolean; var ShowQtyCalculated2: Boolean; var ZeroCount: Boolean): Boolean
    begin
        ...
        ZeroCount := SetCountToZero; // P8001052
        exit(OKPressed);
    end;
