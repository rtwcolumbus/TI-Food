report 208 "Sales - Shipment"
{
    ...
    //   Add country/region of origin
    // 
    // PRW16.00
    // P8000646, VerticalSoft, Jack Reynolds, 01 DEC 08
    //   Add "Show Country of Origin" to request page
    // 
    // PRW16.00.03
    // P8000812, VerticalSoft, Rick Tweedle, 28 APR 10
    //   RTC Reporting Upgrade
    DefaultLayout = RDLC;
    RDLCLayout = './layout/SalesShipment.rdlc';
                ...
                dataitem(PageLoop; "Integer")
                {
                    ...
                    dataitem(ItemTrackingLine; "Integer")
                    {
                        ...
                        begin
                            ...
                            // P8000624A Begin
                            if ShowCOO then begin
                                COOLabel := Text37002000;
                                Clear(Country);
                                if LotInfo.Get(TempTrackingSpecBuffer."Item No.", TempTrackingSpecBuffer."Variant Code", TempTrackingSpecBuffer."Lot No.") then
                                    if LotInfo."Country/Region of Origin Code" <> '' then
                                        Country.Get(LotInfo."Country/Region of Origin Code");
                            end;
                            // P8000624B End
            ...
            area(content)
            {
                group(Options)
                {
                    ...
                    field(ShowLotSN; ShowLotSN)
                    {
                        ...
                        trigger OnValidate()
                        begin
                            COOEnable := ShowLotSN; // P8000646
                        end;
                    }
                    field(ShowCOO; ShowCOO)
                    {
    ...
    begin
        ...
        if ShowCOO then             // P8000624A
            COOLabel := Text37002000; // P8000624A
    ...
    var
        ...
        Text37002000: Label 'Country of Origin';
