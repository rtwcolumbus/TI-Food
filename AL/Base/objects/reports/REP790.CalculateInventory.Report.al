report 790 "Calculate Inventory"
{
    ...
    begin
        ...
        then begin
            ...
            ItemTrackingBuffer.SetRange("Dimension Entry No.", TempQuantityOnHandBuffer."Dimension Entry No.");
            ...
            if not ItemTrackingBuffer.Find('-') then begin
                ...
                ItemTrackingBuffer."Dimension Entry No." := TempQuantityOnHandBuffer."Dimension Entry No.";
