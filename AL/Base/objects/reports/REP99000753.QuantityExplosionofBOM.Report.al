report 99000753 "Quantity Explosion of BOM"
{
    ...
    DefaultLayout = RDLC;
    RDLCLayout = './layout/QuantityExplosionofBOM.rdlc';
        ...
        dataitem(Item; Item)
        {
            ...
            dataitem(BOMLoop; "Integer")
            {
                ...
                dataitem("Integer"; "Integer")
                {
                    ...
                    column(BomCompLevel_Variant; BomComponent[Level]."Variant Code")
                    {
                    }
                                        ...
                                        if BomItem.Get(BomComponent[Level - 1]."No.") then
                                            QtyPerUnitOfMeasure :=
                                              ...
                                              UOMMgt.GetQtyPerUnitOfMeasure(
                                                BomItem, VersionMgt.GetBOMUnitOfMeasure(BomItem.ProductionBOMNo('', LocationCode), // P8001030
                                                  VersionCode[Level]));
                            end;
                ...
                begin
                    ...
                    Item."Production BOM No." := Item.ProductionBOMNo('', LocationCode); // P8001030
