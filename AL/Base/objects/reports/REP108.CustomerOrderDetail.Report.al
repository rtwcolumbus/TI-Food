...
{
    // PRW18.00.01
    // P8001378, Columbus IT, Jack Reynolds, 06 MAR 15
    //   Fix problem with Container lines
    DefaultLayout = RDLC;
    RDLCLayout = './layout/CustomerOrderDetail.rdlc';
                ...
                begin
                    ...
                    if Type = Type::FOODContainer then begin
                        ...
                        if ContainerType.FindFirst then
                            if ContainerType."Container Sales Processing" <> ContainerType."Container Sales Processing"::Sale then
                                CurrReport.Skip;
                    end;
                    // P8001378
