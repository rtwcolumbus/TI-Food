report 702 "Inventory Posting - Test"
{
    ...
    DefaultLayout = RDLC;
    RDLCLayout = './layout/InventoryPostingTest.rdlc';
                ...
                begin
                    ...
                    then begin
                        ...
                        if ItemJnlLine4.Find('-') then begin
                            ...
                            // P8001083
                            LotStatusMgmt.QuantityAdjforItem(Item,
                              LotStatusMgmt.SetLotStatusExclusionFilter(LotStatusMgmt.ItemJnlLineToFieldNo(ItemJnlLine4)),
                              Item.Inventory, Item."Quantity on Hand (Alt.)");
                            // P8001083
