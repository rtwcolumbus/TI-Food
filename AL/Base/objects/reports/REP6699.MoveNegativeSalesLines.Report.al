report 6699 "Move Negative Sales Lines"
{
    ...
    //   added 'Standing Order' option to FromDocType,ToDocType& ToDocType2 fields option string
    //
    // PRW117.3
                ...
                group(Options)
                {
                    ...
                    group("Order && Invoice")
                    {
                        ...
                        field(DropDownForOrderAndInvoice; ToDocType)
                        {
                            ...
                            OptionCaption = ',,,,,Return Order,Credit Memo'; // P80096165
                    ...
                    group("Return Order && Credit Memo ")
                    {
                        ...
                        field(DropDownForRetOrderAndCrMemo; ToDocType2)
                        {
                            ...
                            OptionCaption = ',,,Order,Invoice'; // P80096165
                            ToolTip = 'Specifies which document type you want to move the negative sales lines to.';
                        }
                    }
                    label(Control4)
    ...
    var
        ...
        ToDocType: Option ,,"Standing Order","Order",Invoice,"Return Order","Credit Memo";
        FromDocType: Option Quote,"Blanket Order","Standing Order","Order",Invoice,"Return Order","Credit Memo";
    ...
    protected var
        ...
        ToDocType2: Option ,,"Standing Order","Order",Invoice,"Return Order","Credit Memo";
