report 7391 "Whse. Get Bin Content"
{
    ...
    //   Add Lot No. to Worksheet
    //   Use Remaining Qty. fields in Warehouse Entry table
    // 
    // PRW15.00.02
    ...
    // 
    // PRW15.00.03
    // P8000632A, VerticalSoft, Don Bresee, 19 SEP 08
    //   Add calls to Easy Lot Tracking to update fields (Item Journal & Transfers)
    // 
    // PRW16.00
    // P8000646, VerticalSoft, Jack Reynolds, 02 DEC 08
    //   Add "One Line Per Lot" to request page
    ...
    requestpage
    {
        ...
        layout
        {
            area(content)
            {
                group(Options)
                {
                    ...
                    field(OneLinePerLot; OneLinePerLot)
                    {
                        ApplicationArea = FOODBasic;
                        Caption = 'One Line Per Lot No.';
                        Visible = OneLinePerLotVISIBLe;
                    }
                }
            }
        }
        ...
        begin
            ...
            OneLinePerLotVisible := DestinationType2 = 0; // P8000646
        end;
    }
    ...
    protected var
        ...
        OneLinePerLot: Boolean;
        [InDataSet]
        OneLinePerLotVisible: Boolean;
                    ...
                    if TrackingExists() then begin
                        ...
                        if TrackedQtyToEmptyBase > 0 then begin
                            ...
                            case DestinationType2 of
                                ...
                                begin
                                    if OneLinePerLot then begin
                                        if MoreThanOneLot then
                                            InsertWWL
                                        else begin
                                            MoreThanOneLot := true;
                                            WhseWorksheetLine.Validate(Quantity, CalcQtyUOM(TrackedQtyToEmptyBase, WhseWorksheetLine."Qty. per From Unit of Measure"));
                                        end;
                                        WhseWorksheetLine."Lot No." := "Lot No.";
