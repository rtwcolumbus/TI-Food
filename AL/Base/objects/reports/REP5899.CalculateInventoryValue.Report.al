report 5899 "Calculate Inventory Value"
{
    ...
    dataset
    {
        dataitem(Item; Item)
        {
            ...
            begin
                ...
                if ByLocation then
                    CopyFilter("Location Filter", TempNewStdCostSKU."Location Code"); // P8001030
                if ByVariant then
                    CopyFilter("Variant Filter", TempNewStdCostSKU."Variant Code");   // P8001030
                ...
                if Item.Find('-') then
                    repeat
                        TempNewStdCostSKU.SetRange("Item No.", Item."No.");
                        if TempNewStdCostSKU.Find('-') then
                            repeat
                                if not TempUpdatedStdCostSKU.Get(TempNewStdCostSKU."Location Code", TempNewStdCostSKU."Item No.", TempNewStdCostSKU."Variant Code") then begin
                                    if (TempNewStdCostSKU."Location Code" = '') and (TempNewStdCostSKU."Variant Code" = '') then begin
                                        ItemCostMgt.TransferCostsFromSKUToItem(TempNewStdCostSKU, Item);
                                        ItemCostMgt.UpdateStdCostShares(Item);
                                    end else
                                        ItemCostMgt.UpdateStdCostSharesSKU(TempNewStdCostSKU);
                                end;
                            until TempNewStdCostSKU.Next() = 0;
                    until Item.Next() = 0;
                // P8001030
            end;
            ...
            begin
                ...
                if CalcBase in [CalcBase::"Standard Cost - Assembly List", CalcBase::"Standard Cost - Manufacturing"] then begin
                    ...
                    CalculateStdCost.CalcItems(Item, TempNewStdCostSKU); // P8001030
    ...
    var
        TempNewStdCostSKU: Record "Stockkeeping Unit" temporary;
    ...
    begin
        ...
        if TempValJnlBuffer.FindFirst() then begin
            ...
            TempValJnlBuffer."Quantity (Alt.)" := TempValJnlBuffer."Quantity (Alt.)" + AltQuantity2; // P8000106A
          ...
          begin // P8000106A
            ...
            TempValJnlBuffer."Quantity (Alt.)" := AltQuantity2; // P8000106A
            TempValJnlBuffer."Inventory Value (Calculated)" := Amount2;
        ...
        with ItemJnlLine do begin
            ...
            case CalcBase of
                ...
                CalcBase::"Standard Cost - Manufacturing":
                    begin
                        // P8001030
                        UseNewStd := TempNewStdCostSKU.Get(LocationCode2, ItemNo2, VariantCode2);
                        if not UseNewStd then
                            UseNewStd := TempNewStdCostSKU.Get('', ItemNo2, '');
                        if UseNewStd then begin
                            //IF NewStdCostItem.GET(ItemNo2) THEN BEGIN
                            // P8001030
                            Validate("Unit Cost (Revalued)", TempNewStdCostSKU."Standard Cost");                 // P8001030
                            "Single-Level Material Cost" := TempNewStdCostSKU."Single-Level Material Cost";     // P8001030
                            "Single-Level Capacity Cost" := TempNewStdCostSKU."Single-Level Capacity Cost";     // P8001030
                            "Single-Level Subcontrd. Cost" := TempNewStdCostSKU."Single-Level Subcontrd. Cost"; // P8001030
                            "Single-Level Cap. Ovhd Cost" := TempNewStdCostSKU."Single-Level Cap. Ovhd Cost";   // P8001030
                            "Single-Level Mfg. Ovhd Cost" := TempNewStdCostSKU."Single-Level Mfg. Ovhd Cost";   // P8001030
                            "Rolled-up Material Cost" := TempNewStdCostSKU."Rolled-up Material Cost";           // P8001030
                            "Rolled-up Capacity Cost" := TempNewStdCostSKU."Rolled-up Capacity Cost";           // P8001030
                            "Rolled-up Subcontracted Cost" := TempNewStdCostSKU."Rolled-up Subcontracted Cost"; // P8001030
                            "Rolled-up Mfg. Ovhd Cost" := TempNewStdCostSKU."Rolled-up Mfg. Ovhd Cost";         // P8001030
                            "Rolled-up Cap. Overhead Cost" := TempNewStdCostSKU."Rolled-up Cap. Overhead Cost"; // P8001030
    ...
    begin
        TempValJnlBuffer."Item No." := Item."No."; // P8008177
        TempValJnlBuffer.CalcSums(Quantity, "Quantity (Alt.)", "Inventory Value (Calculated)"); // P8007748
        if TempValJnlBuffer.GetCostingQty <> 0 then begin // P8007748
            AppliedAmount := 0;
            if Item."Costing Method" = Item."Costing Method"::Average then
                CalcAverageUnitCost(
                  TempValJnlBuffer.GetCostingQty, TempValJnlBuffer."Inventory Value (Calculated)", AppliedAmount); // P8007748
            InsertItemJnlLine(
                ItemJnlLine."Entry Type"::"Positive Adjmt.",
                Item."No.", VariantCode, LocationCode, TempValJnlBuffer.Quantity, TempValJnlBuffer."Quantity (Alt.)", TempValJnlBuffer."Inventory Value (Calculated)", // P8007748
                0, AppliedAmount);
        end;
    end;
