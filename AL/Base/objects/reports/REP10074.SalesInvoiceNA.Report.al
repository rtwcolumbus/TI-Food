report 10074 "Sales Invoice NA" // Version: FOODNA
{
    // PR3.60
    ...
    //   Fix name conflicts in RDLC

    DefaultLayout = RDLC;
    RDLCLayout = './layout/local/SalesInvoiceNA.rdlc';
            ...
            dataitem(CopyLoop; "Integer")
            {
                ...
                dataitem(PageLoop; "Integer")
                {
                    ...
                    dataitem(SalesInvLine; "Integer")
                    {
                        ...
                        column(TempSalesInvoiceLineAmtInclVAT; TempSalesInvoiceLine."Amount Including VAT" + AllowanceAmount)
                        {
                        }
                        ...
                        dataitem(AsmLoop; "Integer")
                        {
                            ...
                            begin
                                ...
                                // P8001252
                                if TempPostedAsmLine.Count = 0 then
                                    CurrReport.Break;
                                // P8001252
                            end;
                        }
