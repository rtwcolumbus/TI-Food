report 10151 "Physical Inventory Count" // Version: FOODNA
{
    // PRW16.00.03
    ...
    DefaultLayout = RDLC;
    RDLCLayout = './layout/local/PhysicalInventoryCount.rdlc';
        ...
        dataitem("Item Journal Template"; "Item Journal Template")
        {
            ...
            dataitem("Item Journal Batch"; "Item Journal Batch")
            {
                ...
                dataitem("Item Journal Line"; "Item Journal Line")
                {
                    ...
                    column(ContainerID; "New Container ID")
                    {
                        IncludeCaption = true;
                    }
                    ...
                    begin
                        if "Item No." <> '' then begin
                            ...
                            if Item."Catch Alternate Qtys." then
                                UOMToPrint := StrSubstNo('%1/%2', "Unit of Measure Code", Item."Alternate Unit of Measure")
                            else
                                UOMToPrint := "Unit of Measure Code";
                            // P8001252
                        end else
                            Clear(Item);
                    end;
