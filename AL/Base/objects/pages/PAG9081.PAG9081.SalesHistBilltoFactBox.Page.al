page 9081 "Sales Hist. Bill-to FactBox"
{
    ...
    //   Add field for "Bill-To No. of Standing Orders"
    // 
    // PRW110.0
    ...
    layout
    {
        area(content)
        {
            ...
            group(Control2)
            {
                ...
                field("Bill-To No. of Standing Orders"; Rec."Bill-To No. of Standing Orders")
                {
            ...
            cuegroup(Control23)
            {
                ...
                field("NoofStandingOrders>"; Rec."Bill-To No. of Standing Orders")
                {
                    ApplicationArea = FOODBasic;
                    Caption = 'Standing Orders';
                    DrillDownPageID = "Standing Orders";
