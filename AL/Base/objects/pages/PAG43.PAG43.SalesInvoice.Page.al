page 43 "Sales Invoice"
{
    ...
    //   Correct placement of actions, Promote Calculate Freight
    // 
    // PRW110.0
    ...
    layout
    {
        area(content)
        {
            ...
            group("Invoice Details")
            {
                ...
                field("Off-Invoice Allowance Exists"; Rec."Off-Invoice Allowance Exists")
                {
                    ApplicationArea = FOODBasic;
                }
    ...
    actions
    {
        ...
        area(Promoted)
        {
            ...
            group(Category_Category6)
            {
                ...
                actionref(CalculateFreight_Promoted; "Calculate &Freight")
                {
                }
