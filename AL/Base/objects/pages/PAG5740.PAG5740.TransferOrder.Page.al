...
{
    // PR3.70.02
    //   Added menu button items for container specification (were left off in original 3.70 upgrade)
    // 
    // PRW16.00.05
        ...
        area(navigation)
        {
            ...
            group(Warehouse)
            {
                ...
                action("Con&tainers")
                {
                    ...
                    trigger OnAction()
                    begin
                        ContainerSpecification; //PR3.70.02
                    end;
                }
                ...
                action("Data Sheets")
                {
                    ...
                    begin
                        // P8001090
                        DataCollectionMgmt.DataSheetsForTransHeader(Rec);
                    end;
                }
            }
        }
