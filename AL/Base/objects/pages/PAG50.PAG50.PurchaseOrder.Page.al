    ...
    layout
    {
        area(content)
        {
            group(General)
            {
                ...
                field("Allow Unapproved Items"; Rec."Allow Unapproved Items")
                {
            ...
            group("Invoice Details")
            {
                ...
                field("Allow Order Below Minimum"; Rec."Allow Order Below Minimum")
                {
                    ApplicationArea = FOODBasic;
                }
            ...
            group("Shipping and Payment")
            {
                ...
                field("Pickup Location Code"; Rec."Pickup Location Code")
                {
                    ApplicationArea = FOODBasic;
                }
                group(Control71)
            ...
            {
                Caption = 'Commodities';
                field("Comm. Receiving Complete"; Rec."Comm. Receiving Complete")
                {
                    ApplicationArea = FOODBasic;
                }
