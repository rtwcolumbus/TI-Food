page 9080 "Sales Hist. Sell-to FactBox"
{
    ...
    //   Add field for "No. of Standing Orders"
    // 
    // PRW110.0
    ...
    layout
    {
        area(content)
        {
            ...
            group(Control23)
            {
                ...
                field("No. of Standing Orders"; Rec."No. of Standing Orders")
                {
                    ApplicationArea = FOODBasic;
                    Caption = 'Ongoing Standing Orders';
            ...
            cuegroup(Control2)
            {
                ...
                field("NoofStandingOrders>"; Rec."No. of Standing Orders")
                {
                    ApplicationArea = FOODBasic;
                    Caption = 'Ongoing Standing Orders';
                    DrillDownPageID = "Standing Orders";
