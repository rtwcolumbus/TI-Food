...
page 9245 "Demand Forecast Matrix"
{
    ...
    begin
        ...
        LoadMatrix(
            MatrixColumns1, MatrixRecords1, ProductionForecastName1, DateFilter1, LocationFilter1, '', // P800144605
    ...
    begin
        ...
        LoadMatrix(
        MatrixColumns1, MatrixRecords1, ProductionForecastName1, DateFilter1, LocationFilter1, VariantFilter1,
        ForecastType1, QtyType1, NoOfMatrixColumns1);
    end;
