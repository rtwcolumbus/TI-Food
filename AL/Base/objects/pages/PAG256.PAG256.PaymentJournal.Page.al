page 256 "Payment Journal"
{
    ...
    //   Add ellipsis to Suggest Comm. Adv. Payments action
    ...
    actions
    {
        ...
        area(processing)
        {
            group("F&unctions")
            {
                ...
                action("Suggest &Comm. Adv. Payments")
                {
                    ...
                    trigger OnAction()
                    begin
                        CreateCommAdvPmtSuggestion.SetGenJnlLine(Rec);
                        CreateCommAdvPmtSuggestion.RunModal;
                        Clear(CreateCommAdvPmtSuggestion);
                    end;
                }
    ...
    var
        CreateCommAdvPmtSuggestion: Report "Suggest Comm. Adv. Payments";
