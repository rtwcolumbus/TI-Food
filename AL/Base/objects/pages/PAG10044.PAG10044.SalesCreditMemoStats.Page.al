page 10044 "Sales Credit Memo Stats." // Version: FOODNA
{
    // PR3.60
    ...
    begin
        ...
        if SalesCrMemoLine.Find('-') then
            repeat
                ...
                // CostLCY := CostLCY + (SalesCrMemoLine.Quantity * SalesCrMemoLine."Unit Cost (LCY)"); // PR3.60
                CostLCY := CostLCY +                                                                    // PR3.60
                  (SalesCrMemoLine.GetCostingQty() * SalesCrMemoLine."Unit Cost (LCY)");                // PR3.60
    ...
    var
        TempSalesCrMemoLine: Record "Sales Statistic Line" temporary;
        SalesStatFns: Codeunit "Sales Statistics Functions";
    begin
        // PR3.70
        SalesStatFns.GetTempSalesCrMemoLine("No.", TempSalesCrMemoLine);
        CurrPage.SalesLine.PAGE.SetTempSalesLine(TempSalesCrMemoLine);
        // PR3.70
    end;
