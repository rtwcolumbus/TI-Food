page 99000816 "Production Order Statistics"
{
    ...
    //   Transfer changes from the original form
    //     Methods changed:
    //       OnAfterGetRecord()
    // 
    // PRW16.00.06
    // P8001007, Columbus IT, Jack Reynolds, 21 DEC 11
    //   Fix incorrect expected costs
    ...
    begin
        ...
        P800ProdOrderMgmt.InitStatisticsTotals; // PR3.60 //P8000761
        ...
        if ProdOrderLine.Find('-') then
            repeat
                ...
                P800ProdOrderMgmt.AddToStatisticsTotals(ProdOrderLine, StdCost, ExpCost, ActCost); // PR3.60 //P8000761
                                                                                                   // P8001007
                Clear(StdCost);
                Clear(ExpCost);
                Clear(ActCost);
        ...
        P800ProdOrderMgmt.GetStatisticsTotals(StdCost, ExpCost, ActCost); // PR3.60  //P8000761
