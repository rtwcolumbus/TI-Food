    ...
    layout
    {
        area(content)
        {
            repeater(Control1)
            {
                ...
                field("By-Product"; Rec."By-Product")
                {
                    ApplicationArea = FOODBasic;
                    Visible = false;
                }
                ...
                field("Qty. in Batch (Base)"; Rec."Qty. in Batch (Base)")
                {
                    ApplicationArea = FOODBasic;
                    Visible = false;
                }
                ...
                field("Finished Qty. (Alt.)"; Rec."Finished Qty. (Alt.)")
                {
                    ApplicationArea = FOODBasic;
                ...
                field("Actual Stop Date"; Rec."Actual Stop Date")
                {
                    ApplicationArea = FOODBasic;
                    Visible = false;
                }
                field("Actual Stop Time"; Rec."Actual Stop Time")
                {
                    ApplicationArea = FOODBasic;
                    Visible = false;
                }
