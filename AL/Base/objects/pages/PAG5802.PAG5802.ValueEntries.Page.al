...
{
    // PR3.70.01
    //   Add entry menu item to show extra charges
    // 
    // PR4.00.04
    // P8000375A, VerticalSoft, Jack Reynolds, 07 SEP 06
    //   Add menu item to Entry button to display ABC Details
    // 
    // PRW16.00.05
        ...
        area(navigation)
        {
            group("Ent&ry")
            {
                ...
                action("E&xtra Charges")
                {
                    ...
                    Image = Costs;
                    RunObject = Page "Value Entry Extra Charges";
                ...
                action("ABC Details")
                {
                    ...
                    Caption = 'ABC Details';
                    Image = ViewDetails;
                    RunObject = Page "Value Entry ABC Details";
                    RunPageLink = "Entry No." = FIELD("Entry No.");
                }
            }
        }
