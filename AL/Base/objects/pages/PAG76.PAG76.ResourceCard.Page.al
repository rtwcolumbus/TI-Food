...
{
    // PR1.00
    //   General - Equipment Capacity, Capacity UOM, Capacity Level
    // 
    // PR2.00
    //   Change tab sequence
    // 
    ...
    //   Add controls for Location Code
    // 
    // PRW16.00.04
    ...
    layout
    {
        area(content)
        {
            ...
            group("Production Planning")
            {
                ...
                field("Equipment Capacity"; Rec."Equipment Capacity")
                {
                    ApplicationArea = FOODBasic;
                }
                ...
                field("Capacity Level %"; Rec."Capacity Level %")
                {
                    ApplicationArea = FOODBasic;
                }
                field("Minimum Equipment Qty."; Rec."Minimum Equipment Qty.")
                {
                    ApplicationArea = FOODBasic;
                }
        ...
        area(navigation)
        {
            group("&Resource")
            {
                ...
                action(DataCollectionLines)
                {
                    ...
                    RunPageLink = "Source ID" = CONST(156),
