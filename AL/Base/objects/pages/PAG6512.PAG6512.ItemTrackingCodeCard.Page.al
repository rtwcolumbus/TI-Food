...
{
    // PR2.00
    //   Add controls for Strict Quarantine Posting
    // 
    // PR3.70.01
    //   Add controls for Allow Loose Lot Control
    // 
    // PR4.00
    // P8000250B, Myers Nissi, Jack Reynolds, 16 OCT 05
    //   Add controls for automatic lot number assignment preferences (purchase, sales, manufacturing)
    // 
    // PR4.00.02
    // P8000282A, VerticalSoft, Jack Reynolds, 23 MAR 06
    //   Disable SN Warehouse Tracking and Lot Warehouse Tracking
    // 
    // PR4.00.04
    ...
    // 
    // PRW16.00.20
    //  P800 Modifications made to base NAV page
        ...
        area(content)
        {
            ...
            group("Lot No.")
            {
                ...
                group(Control74)
                {
                    ...
                    field("Allow Loose Lot Control"; Rec."Allow Loose Lot Control")
                    {
                ...
                {
                    Caption = 'Automatic No. Assignment';
                    field("Lot Purch. Inbound Assignment"; Rec."Lot Purch. Inbound Assignment")
                    {
                        ApplicationArea = FOODBasic;
                        Caption = 'Lot Purchase Tracking';
                    }
                    field("Lot Sales Inbound Assignment"; Rec."Lot Sales Inbound Assignment")
                    {
                        ApplicationArea = FOODBasic;
                        Caption = 'Lot Sales Tracking';
                    }
                    field("Lot Manuf. Inbound Assignment"; Rec."Lot Manuf. Inbound Assignment")
                    {
                        ApplicationArea = FOODBasic;
                        Caption = 'Lot Manufacturing Tracking';
                    }
            ...
            group("Misc.")
            {
                ...
                field("Strict Quarantine Posting"; "Strict Quarantine Posting")
                {
                    ApplicationArea = FOODBasic;
                }
                field("Lot Warehouse Picking Method"; "Lot Warehouse Picking Method")
                {
                    ApplicationArea = FOODBasic;
                }
            }
