page 30 "Item Card"
{
    ...
    // 
    // PR3.60.02
    //   Change OnLookup code for UOM fields
    // 
    // PR3.61
    //   Container Tracking
    // 
    // PR3.70
    //   Enable container controls based on item type
    // 
    // PR3.70.01
    //   Units per Parcel
    // 
    ...
    //   Add controls for Case Label and Container Label
    // 
    // PR3.70.03
    //   Add controls for Proper Shipping Name
    // 
    // PR3.70.07
    ...
    //   Add controls for Lot. No.Assignment Method
    // 
    // PR4.00.02
    // P8000312A, VerticalSoft, Jack Reynolds, 17 MAR 06
    //   Add controls for purchasing group code and usage formula
    // 
    // P8000321A, VerticalSoft, Jack Reynolds, 04 APR 06
    //   Change tab sequence for density, weight/volume UOM, specific gravity
    // 
    // PR4.00.04
    // P8000333A, VerticalSoft, Jack Reynolds, 31 AUG 06
    //   Add Part No. to Specifications tab
    // 
    // PR5.00
    // P8000498A, VerticalSoft, Jack Reynolds, 27 JUL 07
    //   Restore assembly list support
    // 
    // P8000494A, VerticalSoft, Don Bresee, 18 JUL 07
    //   Add Production Bins/Replenishment
    // 
    // PRW15.00.01
    // P8000539A, VerticalSoft, Jack Reynolds, 26 FEB 08
    //   Add Item menu button choice for Cost Conversion Factors
    // 
    // P8000549A, VerticalSoft, Jack Reynolds, 04 MAY 08
    //   Add controls for pick class
    // 
    // PRW15.00.02
    ...
    //   Add  controls to item tracking card for country/region of origin
    // 
    // PRW16.00.01
    ...
    // 
    // PRW16.00.02
    // P8000778, VerticalSoft, Rick Tweedle, 26 FEB 10
    //   Code changes to allow auto tranform to page
    // 
    // PRW16.00.03
    // P8000778, VerticalSoft, Rick Tweedle, 26 FEB 10
    //   Layout changes after auto transformation
    // 
    // PWR16.00.04
    ...
    //   Added Freshness Calc. Method and Shelf Life fieldds.
    // 
    ...
    //   Add "Pricing Unit" field
    // 
    // PRW16.00.06
    // P8001009, Columbus IT, Jack Reynolds, 03 JAN 12
    //   Update Control IDs
    // 
    // P8001029, Columbus IT, Jack Reynolds, 27 JAN 12
    //   Fix issues with BOM Type not updating
    // 
    ...
    //   Added "Pre-Process Label Code" used when completing Pre-Process activities
    // 
    ...
    //   Cleanup page, fix issues with UOM lookups and density
    // 
    // PRW18.00
    ...
    // 
    // PRW18.00.02
    // P8004341, To-Increase, Jack Reynolds, 07 OCT 15
    //   Remove "Type" and "Non-Warehouse Item" fields
    // 
    // PRW19.00
    ...
    // 
    // PRW111.00.01
    // P80048583, To-Increase, Jack Reynolds, 09 AUG 18
    //   Allow Allergen changes with non-editable lifecycle states
    // 
    // PRW113.00
    ...
    //   Upgrade to 19.0 - Restore Units per Parcel  
    //
    // PRW119.03
    ...
    layout
    {
        area(content)
        {
            group(Item)
            {
                ...
                field("Item Category Code"; Rec."Item Category Code")
                {
                    ...
                    begin
                        ...
                        SetVendorApprovalRequired; // P8001230
                    end;
                }
                    ...
                    begin
                        ...
                        case StrMenu(StrSubstNo('%1,%2', CreateNewSpecialPriceTxt, CreateNewSpecialDiscountTxt), 1, '') of
                            1:
                                ...
                                //    END;
                                ProcessFns.RunSalesPrices(Rec, true);
                            // P8007749
                            2:
                                // P8007749
                                //    BEGIN
                                ...
                                //    END;
                                ProcessFns.RunSalesLineDiscounts(Rec, true);
                        // P8007749
                        end;
            ...
            group(Replenishment)
            {
                ...
                field("Supply Chain Group Code"; Rec."Supply Chain Group Code")
                {
                    ApplicationArea = FOODBasic;
                }
                field("Label Unit of Measure"; Rec."Label Unit of Measure")
                {
                    ApplicationArea = FOODBasic;
                }
                group(Purchase)
                {
                    Caption = 'Purchase';
                    grid(Control37002032)
                    {
                        GridLayout = Rows;
                        ShowCaption = false;
                        group("Vendor Approval Required")
                        {
                            Caption = 'Vendor Approval Required';
                            field(Control37002000; Rec."Vendor Approval Required")
                            {
                                ApplicationArea = FOODBasic;
                                ColumnSpan = 2;
                                ShowCaption = false;
                    ...
                    field("Purchasing Group Code"; Rec."Purchasing Group Code")
                    {
                        ApplicationArea = FOODBasic;
                    }
                    field("Usage Formula"; Rec."Usage Formula")
                    {
                        ApplicationArea = FOODBasic;
                    }
                ...
                group(Replenishment_Production)
                {
                    ...
                    field("Production BOM No."; Rec."Production BOM No.")
                    {
                        ...
                        trigger OnValidate()
                        begin
                            CurrPage.Update(false); // P8001029
                        end;
                    }
                    field("BOM Type"; Rec."BOM Type")
                    {
                        ApplicationArea = FOODBasic;
                        HideValue = BOMTypeHideValue;
                    }
                    field("Auto Plan if Component"; Rec."Auto Plan if Component")
                    {
                        ApplicationArea = FOODBasic;
                    }
                    field("Production Grouping Item"; Rec."Production Grouping Item")
                    {
                        ApplicationArea = FOODBasic;
                    }
            ...
            group(ItemTracking)
            {
                ...
                field("Lot No. Assignment Method"; Rec."Lot No. Assignment Method")
                {
                    ApplicationArea = FOODBasic;
                }
                ...
                field("Freshness Calc. Method"; Rec."Freshness Calc. Method")
                {
                    ApplicationArea = FOODBasic;

                    trigger OnValidate()
                    begin
                        EnableFreshnessControls; // P8000899
                    end;
                }
                field("Shelf Life"; Rec."Shelf Life")
                {
                    ApplicationArea = FOODBasic;
                    Enabled = ShelfLifeEnable;
                }
                field("Lot Strength"; Rec."Lot Strength")
                {
                    ApplicationArea = FOODBasic;
                }
                field("Country/Region of Origin Reqd."; Rec."Country/Region of Origin Reqd.")
                {
                    ApplicationArea = FOODBasic;
                }
                field("Comm. Manifest Lot Nos."; Rec."Comm. Manifest Lot Nos.")
                {
                    ApplicationArea = FOODBasic;
                }
                field("Comm. Manifest UOM Code"; Rec."Comm. Manifest UOM Code")
                {
                    ApplicationArea = FOODBasic;
                }
            }
            group(Specifications)
            {
                ...
                field("Weight UOM"; Rec."Weight UOM")
                {
                    ...
                    begin
                        ...
                        CurrPage.SaveRecord;
                        Commit;
                        res := P800UOMFns.ItemUOMLookup(Text, Rec, FieldNo("Weight UOM"));
                        //Density := CalcDensity("Weight UOM","Volume UOM"); // P8001273
                        exit(res);
                        // PR3.60.02 End
                    end;
                    ...
                    trigger OnValidate()
                    begin
                        Density := CalcDensity; // P8001273
                    end;
                }
                field("Volume UOM"; Rec."Volume UOM")
                {
                    ApplicationArea = FOODBasic;
                    ...
                    begin
                        ...
                        CurrPage.SaveRecord;
                        Commit;
                        res := P800UOMFns.ItemUOMLookup(Text, Rec, FieldNo("Volume UOM"));
                        //Density := CalcDensity("Weight UOM","Volume UOM"); // P8001273
                        exit(res);
                        // PR3.60.02 End
                    end;
                ...
                field("Specific Gravity"; Rec."Specific Gravity")
                {
                    ApplicationArea = FOODBasic;
                ...
                field("Alternate Unit of Measure"; Rec."Alternate Unit of Measure")
                {
                    ApplicationArea = FOODBasic;
                    ...
                    begin
                        ...
                        CurrPage.SaveRecord;
                        Commit;
                        res := P800UOMFns.ItemUOMLookup(Text, Rec, FieldNo("Alternate Unit of Measure"));
                        //Density := CalcDensity("Weight UOM","Volume UOM"); // P8001273
                        exit(res);
                        // PR3.60.02 End
                    end;
                ...
                field("Costing Unit"; Rec."Costing Unit")
                {
                    ApplicationArea = FOODBasic;
                }
                field("Pricing Unit"; Rec."Pricing Unit")
                {
                    ApplicationArea = FOODBasic;
                }
                field("Catch Alternate Qtys."; Rec."Catch Alternate Qtys.")
                {
                    ApplicationArea = FOODBasic;
                }
                field("Alternate Qty. Tolerance %"; Rec."Alternate Qty. Tolerance %")
                {
                    ApplicationArea = FOODBasic;
                    BlankZero = true;
                }
                field("Quantity on Hand (Alt.)"; Rec."Quantity on Hand (Alt.)")
                {
                    ApplicationArea = FOODBasic;
                    Visible = QuantityOnHandAltVisible;
                }
                field("Net Invoiced Qty. (Alt.)"; Rec."Net Invoiced Qty. (Alt.)")
                {
                    ApplicationArea = FOODBasic;
                    Visible = NetInvoicedQtyAltVisible;
                }
                field("Proper Shipping Name"; Rec."Proper Shipping Name")
                {
                    ApplicationArea = FOODBasic;
                }
                ...
                field(Allergens; (Rec."Direct Allergen Set ID" <> 0) or (Rec."Indirect Allergen Set ID" <> 0))
                {
                    ApplicationArea = FOODBasic;
                    Caption = 'Allergens';
                }
                field("Commodity Cost Item"; Rec."Commodity Cost Item")
                {
                    ApplicationArea = FOODBasic;
                }
                field("Comm. Payment Class Code"; Rec."Comm. Payment Class Code")
                {
                    ApplicationArea = FOODBasic;
                }
            ...
            group(Warehouse)
            {
                ...
                field("Replenishment Not Required"; Rec."Replenishment Not Required")
                {
                    ApplicationArea = FOODBasic;
                }
                field("Replenishment UOM Code"; Rec."Replenishment UOM Code")
                {
                    ApplicationArea = FOODBasic;
                }
                ...
                field("Replenishment Areas Exist"; Rec."Replenishment Areas Exist")
                {
                    ApplicationArea = FOODBasic;
                }
                field("Fixed Prod. Bins Exist"; Rec."Fixed Prod. Bins Exist")
                {
                    ApplicationArea = FOODBasic;
                }
                field("Pick Class Code"; Rec."Pick Class Code")
                {
                    ApplicationArea = FOODBasic;
                }
            }
            ...
            group(PricesandDiscounts)
            {
                ...
                action("Set Special Prices")
                {
                    ...
                    var
                        ProcessFns: Codeunit "Process 800 Functions";
                    begin
                        ProcessFns.RunSalesPrices(Rec, false); // P8007748
                    end;
                }
                action("Price Templates")
                {
                    ...
                    RunPageLink = "Item Type" = CONST(Item),
                                  "Item Code" = FIELD("No.");
                ...
                action("Set Special Discounts")
                {
                    ...
                    var
                        ProcessFns: Codeunit "Process 800 Functions";
                    begin
                        ProcessFns.RunSalesLineDiscounts(Rec, false); // P8007748
                    end;
                }
        ...
        area(navigation)
        {
            ...
            group(Navigation_Item)
            {
                ...
                action("Cost Conversion &Factors")
                {
                    ...
                    begin
                        // P8000539A
                        ItemCostFactorForm.SetCostCalcItemNo("No.");
            ...
            group(Sales)
            {
                ...
                separator(Separator1102603063)
                {
                }
                action("Page Accrual Group List")
                {
                    ApplicationArea = FOODBasic;
                    Caption = 'Accrual Groups';
                    Image = Group;
                    RunObject = Page "Accrual Group List";
                    RunPageLink = "No." = FIELD("No.");
                    RunPageView = SORTING("Accrual Group Type", "No.", "Accrual Group Code")
                                  WHERE("Accrual Group Type" = CONST(Item));
                }
                action(Action83)
                {
                    ApplicationArea = Basic, Suite;
            ...
            group(BillOfMaterials)
            {
                ...
                action("Fixed Prod. Bins")
                {
                    ApplicationArea = FOODBasic;
                    Caption = 'Fixed Prod. Bins';
                    Image = Bins;
    ...
    var
        ...
        Text37002000: Label 'Density must be greater than zero.';
        DensityCaption: Text[30];
        [InDataSet]
        BOMTypeHideValue: Boolean;
        [InDataSet]
        QuantityOnHandAltVisible: Boolean;
        [InDataSet]
        NetInvoicedQtyAltVisible: Boolean;
        [InDataSet]
        DensityEditable: Boolean;
        Text37002001: Label 'Density (%1/%2)';
        Text37002002: Label 'Density';
        [InDataSet]
        ShelfLifeEnable: Boolean;
        VendAppReq: Text[30];
    ...
    begin
        ...
        SetExpirationCalculationEditable();
        // P8007748
        DensityCaption := Text37002002; // P8000664
        DensityEditable := false;       // P8000778
        BOMTypeHideValue := false;
        Density := CalcDensity; // PR1.00, P8001273
    ...
    local procedure CalcDensity() Density: Decimal
    begin
        // PR1.00 Begin
        // P8001273 - remove parameters - they aren't used
        DensityEditable := false;      //P8000778
        if ("Weight UOM" <> '') and ("Volume UOM" <> '') then begin
            Clear(DensityCaption);                                                            // P8000664
            DensityEditable := true;     //P8000778
            if not ItemUOM.Get("No.", "Volume UOM") then begin
                "Volume UOM" := '';
                if not ItemUOM.Get("No.", "Weight UOM") then
                    "Weight UOM" := '';
            end else begin
                Density := ItemUOM."Qty. per Unit of Measure";
                DensityCaption := StrSubstNo(Text37002001, "Weight UOM", "Volume UOM");           // P8000664
                if not ItemUOM.Get("No.", "Weight UOM") then
                    "Weight UOM" := ''
                else begin
                    Density := Density / ItemUOM."Qty. per Unit of Measure";
                    DensityCaption := StrSubstNo(Text37002001, "Weight UOM", "Volume UOM");         // P8000664
                end;
            end;
        end else
    ...
    local procedure UpdateAltQtys()
    begin
        //CurrForm."Quantity on Hand (Alt.)".VISIBLE(TrackAlternateUnits());    //P8000778
        QuantityOnHandAltVisible := TrackAlternateUnits();    //P8000778, P8007748
        //CurrForm."Net Invoiced Qty. (Alt.)".VISIBLE(TrackAlternateUnits());   //P8000778
        NetInvoicedQtyAltVisible := TrackAlternateUnits();   //P8000778
        // PR3.60
    end;
    ...
    begin
        // P8001352 - Renamed
        xRec := Rec;
        UpdateAltQtys; // PR3.60
        SetVendorApprovalRequired; // P8001230
    end;

    local procedure BOMTypeOnFormat()
    begin
        if "Production BOM No." = '' then // PR1.20
            BOMTypeHideValue := true;       // PR1.20
    end;

    procedure EnableFreshnessControls()
    begin
        // P8000899
        ShelfLifeEnable := UseFreshnessDate; // P8000969
    end;

    procedure SetVendorApprovalRequired()
    begin
        // P8001230
        VendAppReq := Format(VendorApprovalRequired);
    end;
    ...
    begin
        ...
        UnitCostEditable := true;
        QuantityOnHandAltVisible := true; // P8007748
        ShelfLifeEnable := true;  // P8007748
