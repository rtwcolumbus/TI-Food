page 10038 "Sales Order Stats." // Version: FOODNA
{
    // PR3.70
    ...
    begin
        ...
        TotalAmount1[IndexNo] :=
          TotalSalesLine[IndexNo]."Line Amount" - TotalSalesLine[IndexNo]."Inv. Discount Amount" - // PR3.70
            Allowance1[IndexNo] - Allowance2[IndexNo];
