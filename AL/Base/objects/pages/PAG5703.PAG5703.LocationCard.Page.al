    ...
    layout
    {
        area(content)
        {
            ...
            group(Warehouse)
            {
                ...
                field("Container Pick and Ship"; Rec."Container Pick and Ship")
                {
                    ApplicationArea = FOODBasic;
                }
                field("Combine Reg. Whse. Activities"; Rec."Combine Reg. Whse. Activities")
                {
                    ApplicationArea = FOODBasic;
                }
                ...
                field("Catch Alt. Qtys. On Whse. Pick"; Rec."Catch Alt. Qtys. On Whse. Pick")
                {
                    ApplicationArea = FOODBasic;
            ...
            group("Bin Policies")
            {
                ...
                field("Replenishment Zone Code"; Rec."Replenishment Zone Code")
                {
                    ApplicationArea = FOODBasic;
                    Enabled = "Replenishment Zone CodeEnable";
                }
                field("Require Replenishment Area"; Rec."Require Replenishment Area")
                {
                    ApplicationArea = FOODBasic;
                    Enabled = RequireReplenishmentAreaEnable;
                }
                field("Def. Replenishment Area Code"; Rec."Def. Replenishment Area Code")
                {
                    ApplicationArea = FOODBasic;
                    Enabled = DefReplenishmentAreaCodeEnable;
                }
                field("Require Production Picking"; Rec."Require Production Picking")
                {
                    ApplicationArea = FOODBasic;
                    Enabled = RequireProductionPickingEnable;
                }
                field("Staging Bin Code"; Rec."Staging Bin Code")
                {
                    ApplicationArea = FOODBasic;
                    Enabled = "Staging Bin CodeEnable";
                }
                field("Sample Staging Bin Code"; Rec."Sample Staging Bin Code")
                {
                    ApplicationArea = FOODBasic;
                ...
                group(Pick)
                {
                    ...
                    field("Pick Production by Line"; Rec."Pick Production by Line")
                    {
                        ApplicationArea = FOODBasic;
                    }
                }
            ...
            group("Delivery Trips")
            {
                ...
                field("Use Delivery Trips (Sales)"; Rec."Use Delivery Trips (Sales)")
                {
                    ApplicationArea = FOODBasic;
                }
                field("Use Delivery Trips (Purchase)"; Rec."Use Delivery Trips (Purchase)")
                {
                    ApplicationArea = FOODBasic;
                }
                field("Use Delivery Trips (Transfer)"; Rec."Use Delivery Trips (Transfer)")
                {
                    ApplicationArea = FOODBasic;
                }
            }
            ...
            {
                Caption = '1-Doc';
                field("Receipt Bin Code (1-Doc)"; Rec."Receipt Bin Code (1-Doc)")
                {
                    ApplicationArea = FOODBasic;
                    Enabled = "Receipt Bin Code (1-Doc)Enable";
                }
                field("Shipment Bin Code (1-Doc)"; Rec."Shipment Bin Code (1-Doc)")
                {
                    ApplicationArea = FOODBasic;
            ...
            {
                Caption = 'Commodities';
                field("Comm. Manifest Bin Code"; Rec."Comm. Manifest Bin Code")
                {
                    ApplicationArea = FOODBasic;
                }
                field("Comm. Manifest Item No."; Rec."Comm. Manifest Item No.")
                {
                    ApplicationArea = FOODBasic;
                }
            }
