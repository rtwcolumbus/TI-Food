page 7377 "Inventory Pick"
{
    ...
    begin
        ...
        CurrPage.WhseActivityLines.PAGE.RunFromOrderShipping(RunFromOrderShip); // P8000282A
        CurrPage.WhseActivityLines.PAGE.PostPickYesNo();
        Posted := CurrPage.WhseActivityLines.PAGE.PickPosted; // P8000282A
    end;
