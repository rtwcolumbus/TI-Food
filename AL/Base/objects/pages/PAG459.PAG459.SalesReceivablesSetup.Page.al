page 459 "Sales & Receivables Setup"
{
    ...
    // 
    // PR3.70.07
    // P8000126A, Myers Nissi, Jack Reynolds, 20 DEC 04
    //   Add controls for minimum order specification
    // 
    // PR3.70.08
    ...
    //   Add controls for Delivery Trip Nos.
    // 
    ...
    //   Add field for "Terminal Market Item Level"
    // 
    // P8000941, Columbus IT, Jack Reynolds, 24 SEP 11
    //   Sales Payments
    // 
    // PRW16.00.06
    ...
    layout
    {
        area(content)
        {
            group(General)
            {
                ...
                field("Sales Contracts Mandatory"; Rec."Sales Contracts Mandatory")
                {
                ...
                field("Deduction Management Cust. No."; Rec."Deduction Management Cust. No.")
                {
                    ApplicationArea = FOODBasic;
                }
                field("Resolve Ded. With Orig. Cust."; Rec."Resolve Ded. With Orig. Cust.")
                {
                    ApplicationArea = FOODBasic;
                }
                field("Recent Sales Calculation"; Rec."Recent Sales Calculation")
                {
                    ApplicationArea = FOODBasic;
                }
                field("Terminal Market Item Level"; Rec."Terminal Market Item Level")
                {
                    ApplicationArea = FOODBasic;
                }
                field("Default Customer Price Group"; Rec."Default Customer Price Group")
                {
                    ApplicationArea = FOODBasic;
                }
                field("Delivered Pricing Calc. Method"; Rec."Delivered Pricing Calc. Method")
                {
                    ApplicationArea = FOODBasic;
                }
                field("Del. Pricing Calc. Codeunit ID"; Rec."Del. Pricing Calc. Codeunit ID")
                {
                    ApplicationArea = FOODBasic;
                }
                field(CodeunitCaption; Process800Utility.GetObjectCaption(5, Rec."Del. Pricing Calc. Codeunit ID"))
                {
                    ApplicationArea = FOODBasic;
                    Caption = 'Codeunit Name';
                }
                field("Calc. Freight on Release/Post"; Rec."Calc. Freight on Release/Post")
                {
                    ApplicationArea = FOODBasic;
                }
            ...
            group("Number Series")
            {
                ...
                field("Deduction Management Doc. Nos."; Rec."Deduction Management Doc. Nos.")
                {
                    ApplicationArea = FOODBasic;
                }
                ...
                field("Sales Payment Nos."; Rec."Sales Payment Nos.")
                {
                    ApplicationArea = FOODBasic;
                }
                field("Posted Sales Payment Nos."; Rec."Posted Sales Payment Nos.")
                {
                    ApplicationArea = FOODBasic;
                }
                ...
                field("<Sales Contract Nos.>"; Rec."Sales Contract Nos.")
                {
                    ApplicationArea = FOODBasic;
                }
            }
