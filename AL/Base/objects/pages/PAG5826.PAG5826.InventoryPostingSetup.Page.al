...
{
    // PR3.61.01
    //   Add controls for writeoff accounts
    // 
    // PRW16.00.06
    ...
    layout
    {
        area(content)
        {
            repeater(Control1)
            {
                ...
                field("Writeoff Account (Company)"; Rec."Writeoff Account (Company)")
                {
                    ApplicationArea = FOODBasic;
                }
                field("Writeoff Account (Vendor)"; Rec."Writeoff Account (Vendor)")
                {
                    ApplicationArea = FOODBasic;
                }
