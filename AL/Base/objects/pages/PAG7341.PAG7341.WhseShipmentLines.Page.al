page 7341 "Whse. Shipment Lines"
{
    ...
    layout
    {
        area(content)
        {
            repeater(Control1)
            {
                ...
                field(GetDeliveryTripWeight; GetDeliveryTripWeight)
                {
    ...
    [Obsolete('Replaced with page 37002783 - Whse. Shipment Lines Temporary', 'FOOD-22')]
    ...
    local procedure GetDeliveryTripWeight(): Decimal
    begin
        // P80058367
        if P800Functions.DistPlanningInstalled then
            DeliveryTripMgt.CalculateShipmentLineWeight(Rec)
        // P80058367
    end;
}
