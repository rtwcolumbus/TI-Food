page 6562 "Invt. Receipt Subform"
{
    ...
    layout
    {
        area(content)
        {
            repeater(Control1)
            {
                ...
                field(FOODAllergens; AllergenManagement.AllergenCodeForRecord(0, 0, Rec."Item No."))
                {
                    ...
                    trigger OnDrillDown()
                    begin
                        AllergenManagement.AllergenDrilldownForRecord(0, 0, Rec."Item No.");
                    end;
                }
                field("Variant Code"; Rec."Variant Code")
                {
                    ...
                    trigger OnValidate()
                    begin
                        CurrPage.Update(true);  // P800127049
                    end;
                }
                ...
                field(FOODContainerLicensePlate; Rec."FOOD Container License Plate")
                {
                    ...
                    begin
                        exit(ContainerFns.LookupContainerOnInvtDocLine(Rec, Text));
                    end;
                ...
                field(FOODLotNo; Rec."FOOD Lot No.")
                {
                    ApplicationArea = FOODBasic;
                    ...
                    begin
                        ...
                        if EasyLotTracking.AssistEdit(Rec."FOOD Lot No.") then
                            Rec.UpdateLotTracking(true);
                        CurrPage.SaveRecord();
                    end;
                ...
                field(FOODCreationDate; Rec."FOOD Creation Date")
                {
                    ApplicationArea = FOODBasic;
                    Editable = LotNoEditable;
                    Visible = false;
                ...
                field(FOODCountryRegOfOrigCode; Rec."FOOD Country/Reg of Orig Code")
                {
                    ApplicationArea = FOODBasic;
                    Editable = LotNoEditable;
                    Visible = false;
                ...
                field(FOODQuantityAlt; Rec."FOOD Quantity (Alt.)")
                {
                    ApplicationArea = FOODBasic;
                    DrillDown = true;
                    ...
                    begin
                        CurrPage.SaveRecord();
                        AltQtyMgmt.ShowInvtDocAltQtyLines(Rec);
                        CurrPage.Update();
                    end;
                    ...
                    begin
                        CurrPage.SaveRecord();
                        AltQtyMgmt.ValidateInvtDocAltQtyLine(Rec);
                        CurrPage.Update();
                    end;
                }
    ...
    actions
    {
        area(processing)
        {
            ...
            group("&Line")
            {
                ...
                action(FOODAlternateQuantityLines)
                {
                    ApplicationArea = FOODBasic;
                    Caption = 'Alternate Quantity Lines';
                    Image = AllLines;
                    Promoted = true; // P800127049???
                ...
                action(FOODNewContainer)
                {
                    ...
                    var
                        ContainerFns: Codeunit "Container Functions";
                    begin
                        ContainerFns.NewContainerOnInvtDocLine(Rec);
                        CurrPage.Update;
                    end;
                }
            }
    ...
    begin
        ...
        LotNoEditable := ProcessFns.TrackingInstalled() and (Rec."FOOD Lot No." <> P800Globals.MultipleLotCode()); // P800127049
    end;
    ...
    begin
        if (Rec.Quantity <> 0) and (Rec."Item No." <> '') then begin
            Commit();
