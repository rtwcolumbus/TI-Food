page 96 "Sales Cr. Memo Subform"
{
    ...
    // 
    // PR3.61.01
    //   Add controls for Return Qty. to Receive (Alt.)
    //   Add controls for Writeoff and Writeoff Responsibility
    // 
    // PR3.70.04
    ...
    //   Amendment to allow page transformation
    // 
    // PRW16.00.03
    ...
    layout
    {
        area(content)
        {
            repeater(Control1)
            {
                ...
                field("Accrual Source No."; Rec."Accrual Source No.")
                {
                    ApplicationArea = FOODBasic;
                    Visible = false;
                }
                field("Accrual Source Doc. Type"; Rec."Accrual Source Doc. Type")
                {
                    ApplicationArea = FOODBasic;
                    Visible = false;
                }
                field("Accrual Source Doc. No."; Rec."Accrual Source Doc. No.")
                {
                    ApplicationArea = FOODBasic;
                    Visible = false;
                    ...
                    begin
                        // P8002744
                        exit(AccrualFldMgmt.LookupSourceDoc("Accrual Plan Type", "No.", "Accrual Source No.", "Accrual Source Doc. Type", Text));
                    end;
                }
                field("Accrual Source Doc. Line No."; Rec."Accrual Source Doc. Line No.")
                {
                    ApplicationArea = FOODBasic;
                    Visible = false;
                    ...
                    begin
                        // P8002744
                        exit(AccrualFldMgmt.LookupSourceDocLine("Accrual Plan Type", "No.", "Accrual Source No.", "Accrual Source Doc. Type", "Accrual Source Doc. No.", Text));
                    end;
                }
                ...
                field("Writeoff Responsibility"; Rec."Writeoff Responsibility")
                {
                    ApplicationArea = FOODBasic;
                    Visible = false;
                }
                ...
                field("Return Qty. to Receive (Alt.)"; Rec."Return Qty. to Receive (Alt.)")
                {
                    ApplicationArea = FOODBasic;
                    ...
                    trigger OnValidate()
                    begin
                        ReturnQtytoReceiveAltOnAfterVa;
                    end;
                }
    ...
    local procedure ReturnQtytoReceiveAltOnAfterVa()
    begin
        // PR3.61.01
        CurrPage.SaveRecord;
    ...
    begin
        ...
        SalesPriceCalcMgt.FindSalesLinePrice(SalesHeader, Rec, 0);
        InitOutstandingQtyCont;
    end;
