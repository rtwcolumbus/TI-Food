page 99000831 "Released Production Order"
{
    ...
    // 
    // PR3.61
    //   Add functions menu item to create containers
    // 
    // PR3.70.06
    // P8000081A, Myers Nissi, Jack Reynolds, 04 AUG 04
    //   Add menu item to Print menu button to print summary report
    // 
    // PR4.00
    // P8000259A, VerticalSoft, Jack Reynolds, 28 OCT 05
    //   Add controls for Production Sequence Code
    // 
    // PR5.00
        ...
        area(content)
        {
            group(General)
            {
                ...
                field("Source Type"; Rec."Source Type")
                {
                    ...
                    trigger OnValidate()
                    begin
                        if xRec."Source Type" <> Rec."Source Type" then begin // PR2.00.05
                            "Source No." := '';
                            "Variant Code" := '';                               // PR2.00.05
                        end;                                                  // PR2.00.05
                    end;
                }
                field("Source No."; Rec."Source No.")
                {
                    ...
                    var
                        Item: Record "Item";
                    begin
                        if xRec."Source No." <> Rec."Source No." then // PR2.00.05
                            "Variant Code" := '';                       // PR2.00.05
            ...
            group(Schedule)
            {
                ...
                field("Production Sequence Code"; Rec."Production Sequence Code")
                {
                ...
                field("Replenishment Area Code"; Rec."Replenishment Area Code")
                {
                    ...
                    trigger OnValidate()
                    begin
                        ReplenishmentAreaCodeOnAfterVa;
                    end;
                }
    ...
    begin
        CurrPage.Update; // PR3.60
    end;

    local procedure ReplenishmentAreaCodeOnAfterVa()
    begin
        CurrPage.Update; // P8000631A
    end;
}
