page 98 "Purch. Cr. Memo Subform"
{
    ...
    // 
    // PR3.61.01
    //   Add controls for Return Qty. to Ship (Alt.)
    // 
    // PR3.70.01
    //   Extra Charges
    // 
    ...
    //   Amended code to work with page transformation tool
    // 
    // PRW16.00.03
    ...
    layout
    {
        area(content)
        {
            repeater(Control1)
            {
                ...
                field("Return Qty. to Ship (Alt.)"; Rec."Return Qty. to Ship (Alt.)")
                {
                    ApplicationArea = FOODBasic;
                    ...
                    trigger OnValidate()
                    begin
                        ReturnQtytoShipAltOnAfterValid;
                    end;
                }
            ...
            group("&Line")
            {
                ...
                group("Item Availability by")
                {
                    ...
                    action(Lot)
                    {
                        ...
                        trigger OnAction()
                        begin
                            ItemAvailFormsMgt.ShowItemAvailFromPurchLine(Rec, ItemAvailFormsMgt.ByLot());
                        end;
                    }
                    action("BOM Level")
                    {
    ...
    local procedure ReturnQtytoShipAltOnAfterValid()
    begin
        // PR3.61.01
        CurrPage.SaveRecord;
