    ...
    layout
    {
        area(content)
        {
            ...
            repeater(Control1)
            {
                ...
                field("Accrual Bal. Acc. Type"; Rec."Accrual Bal. Acc. Type")
                {
                    ApplicationArea = FOODBasic;
                    Visible = false;
                }
                field("Accrual Bal. Acc. No."; Rec."Accrual Bal. Acc. No.")
                {
                    ApplicationArea = FOODBasic;
                    Visible = false;
                }
                ...
                field("Accrual Source Doc. No."; Rec."Accrual Source Doc. No.")
                {
                    ...
                    trigger OnLookup(var Text: Text): Boolean
                    begin
                        exit(AccrualFldMgmt.GenJnlLookupSourceDoc(Rec, Text)); // P8000241A
                    end;
                }
                field("Accrual Source Doc. Line No."; Rec."Accrual Source Doc. Line No.")
                {
                    ...
                    trigger OnLookup(var Text: Text): Boolean
                    begin
                        exit(AccrualFldMgmt.GenJnlLookupSourceDocLine(Rec, Text)); // P8000241A
                    end;
                }
