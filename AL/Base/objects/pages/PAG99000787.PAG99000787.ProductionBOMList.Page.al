...
{
    // PRW16.00.04
    // P8000841, VerticalSoft, Jack Reynolds, 13 JUL 10
    //   Remove ability to get to standard NAV BOM card and take user to appropriate
    //   P800 BOM (i.e. package, formula, item process, co-product process)
    // 
    // PRW19.00
    ...
    // ApplicationArea = Manufacturing; // P800-MegaApp
    ...
    // UsageCategory = Lists; // P800-MegaApp
