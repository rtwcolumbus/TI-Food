page 7376 "Invt. Put-away Subform"
{
    ...
    //   Support for running for order receiving; alternate quantites
    // 
    // PRW16.00.02
    // P8000778, VerticalSoft, Rick Tweedle, 25 FEB 10
    //   Amended code to allow auto transformation to page
        ...
        area(content)
        {
            repeater(Control1)
            {
                ...
                field("Serial No."; Rec."Serial No.")
                {
                    ...
                    begin
                        exit(PutAwayLookupLotSerialNo("Item Tracking Type"::"Serial No.", Text)); // P8000282A, P800144605
                    end;
                ...
                field("Lot No."; Rec."Lot No.")
                {
                    ...
                    trigger OnLookup(var Text: Text): Boolean
                    begin
                        exit(PutAwayLookupLotSerialNo("Item Tracking Type"::"Lot No.", Text)); // P8000282A, P800144605
                    end;
    ...
    begin
        WhseActivLine.Copy(Rec);
        WhseActivPostYesNo.RunFromOrderReceiving(RunFromOrderRec); // P8000282A
