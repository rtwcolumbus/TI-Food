page 167 "Item Ledger Entries Preview"
{
    ...
    layout
    {
        area(content)
        {
            repeater(Control1)
            {
                ...
                field(SalesAmountFOB; SalesAmountFOB)
                {
                    ApplicationArea = FOODBasic;
                    Caption = 'Sales Amount (FOB)';
                    Visible = false;
                }
                field(SalesAmountFreight; SalesAmountFreight)
                {
                    ApplicationArea = FOODBasic;
    ...
    var
        ...
        SalesAmountFOB: Decimal;
        SalesAmountFreight: Decimal;
    ...
    begin
        ...
        SalesAmountFOB := 0; // P8004516
        SalesAmountFreight := 0; // P8004516
        ...
        if TempValueEntry.FindSet() then
            repeat
                ...
                SalesAmountFOB += TempValueEntry."Sales Amount (FOB)"; // P8004516
                SalesAmountFreight += TempValueEntry."Sales Amount (Freight)"; // P8004516
