        ...
        area(content)
        {
            repeater(Control1)
            {
                ...
                field("Quantity (Alt.)"; Rec."Quantity (Alt.)")
                {
                    ...
                    trigger OnDrillDown()
                    begin
                        AltQtyMgmt.ShowShipmentLineAltQtyEntries(Rec, FieldNo("Quantity (Alt.)")); // PR3.60
                    end;
                }
                ...
                field("Qty. Invoiced (Alt.)"; Rec."Qty. Invoiced (Alt.)")
                {
                    ...
                    trigger OnDrillDown()
                    begin
                        AltQtyMgmt.ShowShipmentLineAltQtyEntries(Rec, FieldNo("Qty. Invoiced (Alt.)")); // PR3.60
                    end;
                }		
        ...
        area(processing)
        {
            group("F&unctions")
            {
                ...
                action(Settlement)
                {
                    ...
                    trigger OnAction()
                    var
                        N138TripSettlement: Codeunit "N138 Trip Settlement Mgt.";
                    begin
                        N138TripSettlement.Settlement2(Rec);
                    end;
                }
            }
            group("&Line")
