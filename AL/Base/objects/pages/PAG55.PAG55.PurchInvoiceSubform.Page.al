    ...
    layout
    {
        area(content)
        {
            repeater(PurchDetailLine)
            {
                ...
                field("Maintenance Entry Type"; Rec."Maintenance Entry Type")
                {
                    ApplicationArea = FOODBasic;
                    Visible = false;
                }
                field("Maintenance Trade Code"; Rec."Maintenance Trade Code")
                {
                    ApplicationArea = FOODBasic;
                    Visible = false;
                }
                ...
                field("Receiving Reason Code"; Rec."Receiving Reason Code")
                {
                    ApplicationArea = FOODBasic;
                    Visible = false;
                }
