page 21 "Customer Card"
{
    ...
    // 
    // PR3.70
    //   Allow Off-Invoice Allowance
    //   Contract Items Only
    // 
    // PR3.70.06
    // P8000078A, Myers Nissi, Steve Post, 13 SEP 04
    //   added "exclude from sales forecast" control to shipping tab
    // 
    // PR3.70.07
    ...
    //   Added minimum order controls to Invoicing tab
    // 
    // P8000153A, Myers Nissi, Jack Reynolds, 16 DEC 04
    //   Add menu item for lot preferences
    // 
    // PR4.00.02
    // P8000298A, VerticalSoft, Jack Reynolds, 15 FEB 06
    //   Fix problem running Line Discounts form
    // 
    // PR5.00
    ...
    //   Change to link to Delivery Route Matrix
    // 
    ...
    //   Moved Price List report to Reports Actions list & promoted
    // 
    // PRW16.00.05
    // P8000921, Columbus IT, Don Bresee, 08 APR 11
    //   Added "FOB Pricing" field
    // 
    // PRW16.00.06
        ...
        area(content)
        {
            ...
            group(Invoicing)
            {
                ...
                field("Bill-to Customer No."; Rec."Bill-to Customer No.")
                {
                    ...
                    trigger OnValidate()
                    begin
                        BillToEntered := "Bill-to Customer No." <> ''; // P8001026
                    end;
                }
                ...
                field("Minimum Order Basis"; Rec."Minimum Order Basis")
                {
                    ApplicationArea = FOODBasic;
                }
                field("Minimum Order Unit of Measure"; Rec."Minimum Order Unit of Measure")
                {
                    ApplicationArea = FOODBasic;
                }
                field("Minimum Order Amount"; Rec."Minimum Order Amount")
                {
                    ApplicationArea = FOODBasic;
                }
                ...
                group(PricesandDiscounts)
                {
                    ...
                    field("Use Sell-to Price Group"; Rec."Use Sell-to Price Group")
                    {
                        ApplicationArea = FOODBasic;
                        Enabled = BillToEntered;
                    }
                    ...
                    field("Price Orders at Shipment"; Rec."Price Orders at Shipment")
                    {
                        ApplicationArea = FOODBasic;
                    }
                    field("Allow Off-Invoice Allowance"; Rec."Allow Off-Invoice Allowance")
                    {
                        ApplicationArea = FOODBasic;
                    }
                    field("Contract Items Only"; Rec."Contract Items Only")
                    {
                        ApplicationArea = FOODBasic;
                    }
                    field("FOB Pricing"; Rec."FOB Pricing")
                    {
                        ApplicationArea = FOODBasic;
                    }
                }
    ...
    actions
    {
        area(navigation)
        {
            group("&Customer")
            {
                ...
                action(DataCollectionLines)
                {
                    ...
                    RunPageLink = "Source ID" = CONST(18),
            ...
            group(Action82)
            {
                Caption = 'S&ales';
                Image = Sales;
                action("Cust./Item Price/Disc. Groups")
                {
                    ApplicationArea = FOODBasic;
                    Caption = 'Cust./Item Price/Disc. Groups';
                    Image = Group;
                    RunObject = Page "Cust./Item Price/Disc. Groups";
                    RunPageLink = "Customer No." = FIELD("No.");
                    RunPageView = SORTING("Customer No.", "Item Category Code");
                }
                action("Accrual Groups")
                {
                    ApplicationArea = FOODBasic;
                    ...
                    RunPageView = SORTING("Accrual Group Type", "No.", "Accrual Group Code")
                                  WHERE("Accrual Group Type" = CONST(Customer));
                }
                ...
                action("Lot Preferences")
                {
                    ...
                    RunObject = Page "Customer Lot Preferences";
                    RunPageLink = "No." = FIELD("No.");
                }
        ...
        area(creation)
        {
            ...
            action("Standing Order")
            {
                ...
                RunObject = Page "Standing Sales Order";
                RunPageLink = "Sell-to Customer No." = FIELD("No.");
                RunPageMode = Create;
            }
        ...
        area(reporting)
        {
            ...
            action(PriceList)
            {
                ...
                begin
                    ...
                    REPORT.RunModal(REPORT::"Customer Price List", true, false, Customer);
                    // PR3.60
                end;
            }
        ...
        area(Promoted)
        {
            ...
            group(Category_Category4)
            {
                ...
                actionref(StandingOrder_Promoted; "Standing Order")
                {
                }
            ...
            group(Category_Category7)
            {
                ...
                actionref(PriceList_Promoted; PriceList)
                {
                }
#if not CLEAN19
