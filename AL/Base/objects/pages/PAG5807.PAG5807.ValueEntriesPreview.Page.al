page 5807 "Value Entries Preview"
{
    ...
    layout
    {
        area(content)
        {
            repeater(Control1)
            {
                ...
                field(ExtraChargeAmount; ExtraChargeAmount)
                {
                    ApplicationArea = FOODBasic;
    ...
    var
        TempExtraCharge2: Record "Value Entry Extra Charge" temporary;
    begin
        // P80096141 - Original signature
        Set(TempValueEntry, TempExtraCharge2);
    end;

    procedure Set(var TempValueEntry: Record "Value Entry" temporary; var TempExtraCharge2: Record "Value Entry Extra Charge" temporary)
    begin
        // P8004516 - add parameter TempExtraCharge2
        ...
        // P8004516
        if TempExtraCharge2.Find('-') then
            repeat
                TempExtraCharge := TempExtraCharge2;
                TempExtraCharge.Insert;
            until TempExtraCharge2.Next = 0;
        // P8004516
    end;
    ...
    begin
        ...
        TempExtraCharge.SetRange("Entry No.", "Entry No.");
        if TempExtraCharge.FindSet then
            repeat
                ExtraChargeAmount += TempExtraCharge.Charge;
            until TempExtraCharge.Next = 0;
    end;

    local procedure DrilldownAmounts(AmountType: Option ExtraCharge)
    var
        ExtraChargePreview: Page "Value Entry Extra Chgs. Prev.";
    begin
        // P8004516
        case AmountType of
            AmountType::ExtraCharge:
                begin
                    TempExtraCharge.SetRange("Entry No.", "Entry No.");
                    ExtraChargePreview.Set(TempExtraCharge);
                    ExtraChargePreview.Run;
                end;
        end;
    end;
}
