...
{
    // PRW111.00.03
    // P80079755, To Increase, Gangabhushan, 31 JUL 19
    //   CS00071759 - Subonctract Worksheet Show First Order Does Not Work.
    ...
    begin
        ...
        if PurchHeader.Get(PurchHeader."Document Type"::Order, CarryOutActionMsgReq.GetFirstOrder) then
