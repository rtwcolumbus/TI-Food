    ...
    layout
    {
        area(content)
        {
            ...
            repeater(Control1)
            {
                ...
                field("From Container License Plate"; Rec."From Container License Plate")
                {
                ...
                field("To Zone Code"; Rec."To Zone Code")
                {
                    ...
                    trigger OnValidate()
                    begin
                        if "Container Master Line No." <> 0 then // P8001323
                            CurrPage.Update;                       // P8001323
                    end;
                }
                ...
                field("To Container License Plate"; Rec."To Container License Plate")
                {
                    AccessByPermission = TableData "Container Header" = R;
                    ApplicationArea = FOODBasic;
                    Visible = false;
