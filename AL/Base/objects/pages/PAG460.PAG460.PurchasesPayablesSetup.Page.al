...
{
    // PR3.70.01
    //   Add shortcut extra charge codes
    // 
    // PR3.70.06
    // P8000080A, Myers Nissi, Steve Post, 25 AUG 04
    //   Added field Pickup Load Nos. to Numbering tab
    // 
    // PRW16.00.04
    ...
    layout
    {
        area(content)
        {
            group(General)
            {
                ...
                field("Check COO at Order Release"; Rec."Check COO at Order Release")
                {
            ...
            group("Number Series")
            {
                ...
                field("Pickup Load Nos."; Rec."Pickup Load Nos.")
                {
                    ApplicationArea = FOODBasic;
                }
                field("Commodity Order Nos."; Rec."Commodity Order Nos.")
                {
                    ApplicationArea = FOODBasic;
                }
            }
            ...
            group("Extra Charges")
            {
                ...
                field("Shortcut Extra Charge 1 Code"; Rec."Shortcut Extra Charge 1 Code")
                {
                    ApplicationArea = FOODBasic;
                }
                field("Shortcut Extra Charge 2 Code"; Rec."Shortcut Extra Charge 2 Code")
                {
                    ApplicationArea = FOODBasic;
                }
                field("Shortcut Extra Charge 3 Code"; Rec."Shortcut Extra Charge 3 Code")
                {
                    ApplicationArea = FOODBasic;
                }
                field("Shortcut Extra Charge 4 Code"; Rec."Shortcut Extra Charge 4 Code")
                {
                    ApplicationArea = FOODBasic;
                }
                field("Shortcut Extra Charge 5 Code"; Rec."Shortcut Extra Charge 5 Code")
                {
                    ApplicationArea = FOODBasic;
                }
            }
