page 137 "Posted Purchase Rcpt. Subform"
{
    ...
    //   Amended code  to allow page  transformation
    // 
    // PRW16.00.03
        ...
        area(content)
        {
            repeater(Control1)
            {
                ...
                field("Quantity (Alt.)"; Rec."Quantity (Alt.)")
                {
                    ...
                    trigger OnDrillDown()
                    begin
                        AltQtyMgmt.ShowReceiptLineAltQtyEntries(Rec, FieldNo("Quantity (Alt.)")); // PR3.60
                    end;
                }
                ...
                field("Qty. Invoiced (Alt.)"; Rec."Qty. Invoiced (Alt.)")
                {
                    ...
                    trigger OnDrillDown()
                    begin
                        AltQtyMgmt.ShowReceiptLineAltQtyEntries(Rec, FieldNo("Qty. Invoiced (Alt.)")); // PR3.60
                    end;
                }
