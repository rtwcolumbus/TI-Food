report 1701 "Deferral Summary - Sales"
{
    ...
    DefaultLayout = RDLC;
    RDLCLayout = './layout/DeferralSummarySales.rdlc';
        ...
        dataitem("Posted Deferral Header"; "Posted Deferral Header")
        {
            ...
            begin
                ...
                case "Document Type" of
                    "Sales Document Type From"::"Posted Invoice": // Posted Invoice // P80096165
                    ...
                    "Sales Document Type From"::"Posted Credit Memo": // Posted Credit Memo // P80096165
                    ...
                    "Sales Document Type From"::"Posted Return Receipt": // Posted Return Receipt // P80096165
    ...
    begin
        ...
        P80096165 */
        // P80096165
        SalesCommentDocumentType := "Sales Comment Document Type".FromInteger(SalesDocType);
        exit(Format(SalesCommentDocumentType));
        // P80096165
    end;
}
