...
#pragma warning restore AS0070
        ...
        field(37002000; "Quantity (Alt.)"; Decimal)
        {
            CalcFormula = Sum ("Item Ledger Entry"."Quantity (Alt.)" WHERE("Item No." = FIELD("Item Filter"),
                                                                           "Source Type" = FIELD("Source Type Filter"),
                                                                           "Source No." = FIELD("Source No. Filter"),
                                                                           "Posting Date" = FIELD("Date Filter"),
                                                                           "Entry Type" = FIELD("Item Ledger Entry Type Filter"),
        ...
        field(37002001; "Invoiced Quantity (Alt.)"; Decimal)
        {
            CalcFormula = Sum ("Value Entry"."Invoiced Quantity" WHERE("Item No." = FIELD("Item Filter"),
                                                                       "Posting Date" = FIELD("Date Filter"),
                                                                       "Variant Code" = FIELD("Variant Filter"),
        ...
        field(37002002; "Analysis - Quantity (Alt.)"; Decimal)
        {
            CalcFormula = Sum ("Item Analysis View Entry"."Quantity (Alt.)" WHERE("Analysis Area" = FIELD("Analysis Area Filter"),
                                                                                  "Analysis View Code" = FIELD("Analysis View Filter"),
                                                                                  "Item No." = FIELD("Item Filter"),
                                                                                  "Location Code" = FIELD("Location Filter"),
                                                                                  "Dimension 1 Value Code" = FIELD("Dimension 1 Filter"),
                                                                                  ...
                                                                                  "Item Ledger Entry Type" = FIELD("Item Ledger Entry Type Filter"),
                                                                                  "Entry Type" = FIELD("Entry Type Filter")));
            Caption = 'Analysis - Quantity (Alt.)';
            DecimalPlaces = 0 : 5;
            Editable = false;
            FieldClass = FlowField;
        }
        field(37002003; "Analysis - Inv. Qty. (Alt.)"; Decimal)
        {
            CalcFormula = Sum ("Item Analysis View Entry"."Invoiced Quantity (Alt.)" WHERE("Analysis Area" = FIELD("Analysis Area Filter"),
                                                                                           "Analysis View Code" = FIELD("Analysis View Filter"),
                                                                                           "Item No." = FIELD("Item Filter"),
                                                                                           "Location Code" = FIELD("Location Filter"),
                                                                                           "Dimension 1 Value Code" = FIELD("Dimension 1 Filter"),
                                                                                           ...
                                                                                           "Item Ledger Entry Type" = FIELD("Item Ledger Entry Type Filter"),
                                                                                           "Entry Type" = FIELD("Entry Type Filter")));
            Caption = 'Analysis - Inv. Qty. (Alt.)';
            DecimalPlaces = 0 : 5;
            Editable = false;
            FieldClass = FlowField;
        }
        field(37002004; "Budgeted Quantity (Alt.)"; Decimal)
        {
            CalcFormula = Sum ("Item Budget Entry"."Quantity (Alt.)" WHERE("Analysis Area" = FIELD("Analysis Area Filter"),
                                                                           "Budget Name" = FIELD("Budget Filter"),
                                                                           "Item No." = FIELD("Item Filter"),
                                                                           Date = FIELD("Date Filter"),
                                                                           "Global Dimension 1 Code" = FIELD("Global Dimension 1 Filter"),
                                                                           ...
                                                                           "Source No." = FIELD("Source No. Filter"),
                                                                           "Location Code" = FIELD("Location Filter")));
            Caption = 'Budgeted Quantity (Alt.)';
            DecimalPlaces = 0 : 5;
            Editable = false;
            FieldClass = FlowField;
        }
        field(37002005; "Analysis - Budgeted Qty (Alt.)"; Decimal)
        {
            CalcFormula = Sum ("Item Analysis View Budg. Entry"."Quantity (Alt.)" WHERE("Analysis Area" = FIELD("Analysis Area Filter"),
                                                                                        "Analysis View Code" = FIELD("Analysis View Filter"),
                                                                                        "Budget Name" = FIELD("Budget Filter"),
                                                                                        "Item No." = FIELD("Item Filter"),
                                                                                        "Location Code" = FIELD("Location Filter"),
                                                                                        ...
                                                                                        "Source Type" = FIELD("Source Type Filter"),
                                                                                        "Source No." = FIELD("Source No. Filter")));
            Caption = 'Analysis - Budgeted Qty (Alt.)';
            DecimalPlaces = 0 : 5;
            Editable = false;
            FieldClass = FlowField;
        }
        ...
        {
            AutoFormatType = 1;
            CalcFormula = Sum ("Value Entry"."Sales Amount (FOB)" WHERE("Item No." = FIELD("Item Filter"),
                                                                        "Posting Date" = FIELD("Date Filter"),
                                                                        "Item Ledger Entry Type" = FIELD("Item Ledger Entry Type Filter"),
                                                                        "Entry Type" = FIELD("Entry Type Filter"),
                                                                        "Variance Type" = FIELD("Variance Type Filter"),
        ...
        {
            AutoFormatType = 1;
            CalcFormula = Sum ("Value Entry"."Sales Amount (Freight)" WHERE("Item No." = FIELD("Item Filter"),
                                                                            "Posting Date" = FIELD("Date Filter"),
                                                                            "Item Ledger Entry Type" = FIELD("Item Ledger Entry Type Filter"),
                                                                            "Entry Type" = FIELD("Entry Type Filter"),
                                                                            "Variance Type" = FIELD("Variance Type Filter"),
        ...
        field(37002051; "Budg. Sales Amount (FOB)"; Decimal)
        {
            AutoFormatType = 1;
            CalcFormula = Sum ("Item Budget Entry"."Sales Amount (FOB)" WHERE("Analysis Area" = FIELD("Analysis Area Filter"),
                                                                              "Budget Name" = FIELD("Budget Filter"),
                                                                              "Item No." = FIELD("Item Filter"),
                                                                              Date = FIELD("Date Filter"),
                                                                              "Global Dimension 1 Code" = FIELD("Global Dimension 1 Filter"),
                                                                              ...
                                                                              "Source No." = FIELD("Source No. Filter"),
                                                                              "Location Code" = FIELD("Location Filter")));
            Caption = 'Budg. Sales Amount (FOB)';
            Editable = false;
            FieldClass = FlowField;
        }
        field(37002052; "Budg. Sales Amount (Freight)"; Decimal)
        {
            AutoFormatType = 1;
            CalcFormula = Sum ("Item Budget Entry"."Sales Amount (Freight)" WHERE("Analysis Area" = FIELD("Analysis Area Filter"),
                                                                                  "Budget Name" = FIELD("Budget Filter"),
                                                                                  "Item No." = FIELD("Item Filter"),
                                                                                  Date = FIELD("Date Filter"),
                                                                                  "Global Dimension 1 Code" = FIELD("Global Dimension 1 Filter"),
                                                                                  ...
                                                                                  "Source No." = FIELD("Source No. Filter"),
                                                                                  "Location Code" = FIELD("Location Filter")));
            Caption = 'Budg. Sales Amount (Freight)';
            Editable = false;
            FieldClass = FlowField;
        }
        field(37002053; "Analysis - Sales Amt (FOB)"; Decimal)
        {
            AutoFormatType = 1;
            CalcFormula = Sum ("Item Analysis View Entry"."Sales Amount (FOB)" WHERE("Analysis Area" = FIELD("Analysis Area Filter"),
                                                                                     "Analysis View Code" = FIELD("Analysis View Filter"),
                                                                                     "Item No." = FIELD("Item Filter"),
                                                                                     "Location Code" = FIELD("Location Filter"),
                                                                                     "Dimension 1 Value Code" = FIELD("Dimension 1 Filter"),
                                                                                     ...
                                                                                     "Item Ledger Entry Type" = FIELD("Item Ledger Entry Type Filter"),
                                                                                     "Entry Type" = FIELD("Entry Type Filter")));
            Caption = 'Analysis - Sales Amt (FOB)';
            Editable = false;
            FieldClass = FlowField;
        }
        field(37002054; "Analysis - Sales Amt (Freight)"; Decimal)
        {
            AutoFormatType = 1;
            CalcFormula = Sum ("Item Analysis View Entry"."Sales Amount (Freight)" WHERE("Analysis Area" = FIELD("Analysis Area Filter"),
                                                                                         "Analysis View Code" = FIELD("Analysis View Filter"),
                                                                                         "Item No." = FIELD("Item Filter"),
                                                                                         "Location Code" = FIELD("Location Filter"),
                                                                                         "Dimension 1 Value Code" = FIELD("Dimension 1 Filter"),
                                                                                         ...
                                                                                         "Item Ledger Entry Type" = FIELD("Item Ledger Entry Type Filter"),
                                                                                         "Entry Type" = FIELD("Entry Type Filter")));
            Caption = 'Analysis - Sales Amt (Freight)';
            Editable = false;
            FieldClass = FlowField;
        }
        field(37002055; "Analysis-Budg. Sales (FOB)"; Decimal)
        {
            AutoFormatType = 1;
            CalcFormula = Sum ("Item Analysis View Budg. Entry"."Sales Amount (FOB)" WHERE("Analysis Area" = FIELD("Analysis Area Filter"),
                                                                                           "Analysis View Code" = FIELD("Analysis View Filter"),
                                                                                           "Budget Name" = FIELD("Budget Filter"),
                                                                                           "Item No." = FIELD("Item Filter"),
                                                                                           "Location Code" = FIELD("Location Filter"),
                                                                                           ...
                                                                                           "Source Type" = FIELD("Source Type Filter"),
                                                                                           "Source No." = FIELD("Source No. Filter")));
            Caption = 'Analysis-Budg. Sales (FOB)';
            Editable = false;
            FieldClass = FlowField;
        }
        field(37002056; "Analysis-Budg. Sales (Freight)"; Decimal)
        {
            AutoFormatType = 1;
            CalcFormula = Sum ("Item Analysis View Budg. Entry"."Sales Amount (Freight)" WHERE("Analysis Area" = FIELD("Analysis Area Filter"),
                                                                                               "Analysis View Code" = FIELD("Analysis View Filter"),
                                                                                               "Budget Name" = FIELD("Budget Filter"),
                                                                                               "Item No." = FIELD("Item Filter"),
                                                                                               "Location Code" = FIELD("Location Filter"),
                                                                                               ...
                                                                                               "Source Type" = FIELD("Source Type Filter"),
                                                                                               "Source No." = FIELD("Source No. Filter")));
            Caption = 'Analysis-Budg. Sales (Freight)';
            Editable = false;
            FieldClass = FlowField;
        }
    }
