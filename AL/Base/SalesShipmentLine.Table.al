table 111 "Sales Shipment Line"
{
    ...
    //   Sales Pricing - Add Invoice at Shipped Price
    // 
    // PR3.70
    ...
    // 
    // PRW15.00.01
    // P8000549A, VerticalSoft, Jack Reynolds, 14 MAY 08
    ...
    keys
    {
        ...
        key(Key37002000; Type, "Shipment Date", "Delivery Route No.", "Delivery Stop No.")
        {
            SumIndexFields = Quantity, "Total Net Weight";
        }
        key(Key37002001; Type, "No.")
        {
            Enabled = false;
        }
        key(Key37002002; "Delivery Trip No.", "Order No.", "Order Line No.")
        {
        }
    ...
    begin
        ...
        if ItemLedgEntry.FindSet then
            repeat
                ...
                ShippedQtyNotReturnedAlt := ShippedQtyNotReturnedAlt - ItemLedgEntry."Shipped Qty. Not Ret. (Alt.)"; // P8000466A
    ...
    begin
        ...
        "Delivery Trip No." := SalesShptHeader."Delivery Trip No."; // P8004516
        ...
        // P8004516
        "Quantity (Alt.)" := SalesLine."Qty. to Ship (Alt.)";
        if Abs(SalesLine."Qty. to Invoice") > Abs(SalesLine."Qty. to Ship") then
            "Qty. Invoiced (Alt.)" := SalesLine."Qty. to Ship (Alt.)"
        else
    ...
    begin
        ...
        // P80070933
        SalesLine."Quantity (Alt.)" := 0;
        SalesLine."Qty. Shipped (Alt.)" := 0;
        SalesLine."Qty. Invoiced (Alt.)" := 0;
        // P80070933   
        SalesLine.Amount := 0;
