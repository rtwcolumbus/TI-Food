page 50 "Purchase Order"
{
    ...
    //     Added Pickup Fields to Shipping Tab
    // 
    // PR3.70.07
    // P8000126A, Myers Nissi, Jack Reynolds, 21 DEC 04
    //     Added controls for Allow Order Below Minimum
    // 
    // PR4.00.02
    // P8000314A, VerticalSoft, Jack Reynolds, 28 MAR 06
    //   Add menu item to Order menu button for order guide
    // 
    // PRW16.00.01
    ...
    layout
    {
        area(content)
        {
            group(General)
            {
                ...
                field("Allow Unapproved Items"; "Allow Unapproved Items")
                {
                    ...
                    begin
                        ...
                        //     SignalFns.AddEvent(2, StrSubstNo('ALLOWUNAPPR,%1', "Allow Unapproved Items"));
        ...
        area(navigation)
        {
            group("O&rder")
            {
                ...
                action("Order &Guide")
                {
                    ...
                    trigger OnAction()
                    var
                        OrderGuide: Page "Purchase Order Guide";
                    begin
                        // P8000999
                ...
                action("Data Sheets")
                {
                    ...
                    begin
                        // P8001090
                        DataCollectionMgmt.DataSheetsForPurchHeader(Rec);
                    end;
                }
                action("Co&mments")
                {
