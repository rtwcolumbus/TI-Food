codeunit 365 "Format Address"
{
    ...
    //   PickupLocation - formats address for pickup location
    // 
    // PRW113.00
    ...
    procedure CustShipTo(var AddrArray: array[8] of Text[100]; var CustShipTo: Record "Ship-to Address")
    begin
        // PR1.30 Begin
        // P80066030 - expand AddArray to Text90
        with CustShipTo do
            FormatAddr(
              AddrArray, Name, "Name 2", Contact, Address, "Address 2",
              City, "Post Code", County, "Country/Region Code");
    ...
    procedure PickupLocation(var AddrArray: array[8] of Text[100]; var PickupLocation: Record "Pickup Location")
    begin
        // P8000080A
        // P80066030 - expand AddArray to Text90
        with PickupLocation do
            FormatAddr(
              AddrArray, Name, "Name 2", '', Address, "Address 2", City, "Post Code", County, "Country/Region Code");
    end;
