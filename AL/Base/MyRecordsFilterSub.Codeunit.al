codeunit 9150 "My Records Filter Sub."
{
    ...
    var
        ...
        MyAssetsTxt: Label 'MYASSETS', Comment = 'Must be uppercase';
    ...
    begin
        case TextToken of
            ...
            // P9800-MegaApp            
            CopyStr('MYASSETS', 1, StrLen(TextToken)), CopyStr(MyAssetsTxt, 1, StrLen(TextToken)):
                begin
                    GetMyFilterText(TextFilter, DATABASE::"My Asset");
                    Handled := true;
                end;
                // P800-MegsApp
        end;
