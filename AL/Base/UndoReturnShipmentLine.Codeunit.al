codeunit 5814 "Undo Return Shipment Line"
{
    ...
    begin
        with ReturnShptLine do begin
            if PurchHeader.Get(PurchHeader."Document Type"::"Return Order", "Return Order No.") then // PR3.61.02
        ...
        with ReturnShptLine do begin
            ...
            if Type = Type::Item then begin
                ...
                UndoPostingMgt.CollectItemLedgEntries(TempItemLedgEntry, DATABASE::"Return Shipment Line",
                  "Document No.", "Line No.", "Quantity (Base)", "Quantity (Alt.)", "Item Shpt. Entry No."); // P8000267B
    ...
    begin
        ...
        with ReturnShptLine do begin
            ...
            ItemJnlLine."Quantity (Alt.)" := -"Quantity (Alt.)"; // PR3.60
            ...
            UndoPostingMgt.CollectItemLedgEntries(
                TempApplyToEntryList, DATABASE::"Return Shipment Line", "Document No.", "Line No.", "Quantity (Base)", "Quantity (Alt.)", "Item Shpt. Entry No."); // P8000267B
    ...
    begin
        with OldReturnShptLine do begin
            ...
            NewReturnShptLine."Quantity (Alt.)" := -"Quantity (Alt.)"; // PR3.60
            ...
            NewReturnShptLine."Qty. Invoiced (Alt.)" := NewReturnShptLine."Quantity (Alt.)"; // PR3.70
            ...
            if ProcessFns.FreshProInstalled then
                ExtraChargeMgmt.CopyDocExtraCharge(
                  ...
                  DATABASE::"Return Shipment Line", NewReturnShptLine."Document No.", NewReturnShptLine."Line No.", -1);
            // PR3.70.01 End

            InsertItemEntryRelation(TempGlobalItemEntryRelation, NewReturnShptLine);
            // PR3.60 Begin
            if OldReturnShptLine.AltQtyEntriesExist then
                AltQtyMgmt.UndoAltQtyEntries(
                  DATABASE::"Return Shipment Line", OldReturnShptLine."Document No.", OldReturnShptLine."Line No.",
                  DATABASE::"Return Shipment Line", NewReturnShptLine."Document No.", NewReturnShptLine."Line No.",
                  false);
            // PR3.60 End
        end;
    end;
    ...
    begin
        ...
        with ReturnShptLine do begin
            ...
            UndoPostingMgt.UpdatePurchLine(PurchLine, Quantity, "Quantity (Base)", "Quantity (Alt.)", TempGlobalItemLedgEntry); // P8000267B
                                                                                                                                // P8000267B Begin
            if ReturnShptLine.AltQtyEntriesExist then begin
                AltQtyMgmt.AltQtyEntriesToPurchLine(DATABASE::"Return Shipment Line", "Document No.", "Line No.", PurchLine);
                PurchLine.Modify;
            end;
            // P8000267B End
