table 925 "Item Availability Buffer"
{
    ...
    fields
    {
        ...
        field(37002000; "Total Scheduled Receipt"; Decimal)
        {
            Caption = 'Total Scheduled Receipt';
            DataClassification = SystemMetadata;
        }
        field(37002001; "Total Planned Order Receipt"; Decimal)
        {
            Caption = 'Total Planned Order Receipt';
            DataClassification = SystemMetadata;
        }
        field(37002002; "Total Inventory"; Decimal)
        {
            Caption = 'Total Inventory';
            DataClassification = SystemMetadata;
        }
        field(37002003; "Total Planned Order Releases"; Decimal)
        {
            Caption = 'TotalPlanned Order Releases';
            DataClassification = SystemMetadata;
        }
    }
