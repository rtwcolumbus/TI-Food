table 6651 "Return Shipment Line"
{
    ...
    keys
    {
        ...
        key(Key7; "Delivery Trip No.", "Return Order No.", "Return Order Line No.")
        {
        }
    }
    ...
    begin
        ...
        PostedExtraCharge.SetRange("Table ID", DATABASE::"Return Shipment Line");
    ...
    begin
        ...
        "Delivery Trip No." := ReturnShptHeader."Delivery Trip No."; // P8000549A, P8004516
        ...
        // P8004516
        "Quantity (Alt.)" := PurchLine."Return Qty. to Ship (Alt.)";
        if Abs(PurchLine."Qty. to Invoice") > Abs(PurchLine."Return Qty. to Ship") then
            "Qty. Invoiced (Alt.)" := PurchLine."Return Qty. to Ship (Alt.)"
        else
