table 37 "Sales Line"
{
    ...
    keys
    {
        ...
        key(Key378002000; "Document Type", "Bill-to Customer No.", Type, "No.", "Shipment Date")
        {
        }
...
        // P8000885 
        ...
        // VALIDATE("Unit Price");          // P8000921
        ValidateUnitPriceFOB("Unit Price"); // P8000921
        ...
        if SalesHeader."Document Type" <> SalesHeader."Document Type"::Invoice then begin
            ...
            if "Prepmt. Line Amount" <> 0 then begin
                RemLineAmountToInvoice :=
                    Round(LineAmtExclAltQtys() * (Quantity - "Quantity Invoiced") / Quantity, Currency."Amount Rounding Precision"); // P8001132
