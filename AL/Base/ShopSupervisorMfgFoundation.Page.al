page 9011 "Shop Supervisor Mfg Foundation"
{
    ...
    actions
    {
        ...
        area(embedding)
        {
            ...
            action("Registered Pre-Process Activities")
            {
                ApplicationArea = FOODBasic;
        ...
        area(processing)
        {
            ...
            action("Proce&ss Reporting")
            {
                ApplicationArea = FOODBasic;
                Caption = 'Proce&ss Reporting';
                Image = TestReport;
            ...
            action("Proc&ess Setup")
            {
                ApplicationArea = FOODBasic;
                Caption = 'Proc&ess Setup';
                Image = Setup;
