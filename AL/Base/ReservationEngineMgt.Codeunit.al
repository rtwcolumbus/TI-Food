codeunit 99000831 "Reservation Engine Mgt."
{
    ...
    //   Transfer Supplier Lot No. to reservation entries
    // 
    // PRW19.00.01
    ...
    // 
    // PRW111.00.02
    // P80077940, To-Increase, Jack Reynolds, 28 JUN 19
    //   Fix problem updating Lot Creation Date, Supplier Lot No, Country of Origin
