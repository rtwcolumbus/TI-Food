codeunit 7110 "Analysis Report Management"
{
    ...
    //   Handle "Sales Amount (FOB)" and "Sales Amount (Freight)" options for "Value Type"
            ...
            case AnalysisColumn."Ledger Entry Type" of
                    ...
                    if DrillDown then
                        case AnalysisColumn."Value Type" of
                            AnalysisColumn."Value Type"::Quantity:
                                DrillDownQuantity(ItemStatisticsBuf, AnalysisColumn.Invoiced, false); // P800-MegaApp
                            AnalysisColumn."Value Type"::FOODQuantityAlt:                       // P8000500A
                                DrillDownQuantity(ItemStatisticsBuf, AnalysisColumn.Invoiced, true);  // P8000500A
                            AnalysisColumn."Value Type"::"Sales Amount":
                                DrillDownSalesAmount(ItemStatisticsBuf, AnalysisColumn.Invoiced);
                            // P8000921
                            AnalysisColumn."Value Type"::FOODSalesAmountFOB:
                                DrillDownSalesAmountFOB(ItemStatisticsBuf, AnalysisColumn.Invoiced);
                            AnalysisColumn."Value Type"::FOODSalesAmounttFreight:
                                DrillDownSalesAmountFreight(ItemStatisticsBuf, AnalysisColumn.Invoiced);
                            // P8000921
                        ...
                        case AnalysisColumn."Value Type" of
                            AnalysisColumn."Value Type"::Quantity:
                                ColValue := CalcQuantity(ItemStatisticsBuf, AnalysisColumn.Invoiced, false); // P8000500A
                            AnalysisColumn."Value Type"::FOODQuantityAlt:                              // P8000500A
                                ColValue := CalcQuantity(ItemStatisticsBuf, AnalysisColumn.Invoiced, true);  // P8000500A
                            AnalysisColumn."Value Type"::"Sales Amount":
                                ColValue := CalcSalesAmount(ItemStatisticsBuf, AnalysisColumn.Invoiced);
                            // P8000921
                            AnalysisColumn."Value Type"::FOODSalesAmountFOB:
                                ColValue := CalcSalesAmountFOB(ItemStatisticsBuf, AnalysisColumn.Invoiced);
                            AnalysisColumn."Value Type"::FOODSalesAmounttFreight:
                                ColValue := CalcSalesAmountFreight(ItemStatisticsBuf, AnalysisColumn.Invoiced);
                            // P8000921
                            AnalysisColumn."Value Type"::"Cost Amount":
                ...
                AnalysisColumn."Ledger Entry Type"::"Item Budget Entries":
                    if DrillDown then
                        case AnalysisColumn."Value Type" of
                            AnalysisColumn."Value Type"::Quantity:
                                DrillDownBudgetQuantity(ItemStatisticsBuf, false); // P800-MegaApp
                            AnalysisColumn."Value Type"::FOODQuantityAlt:     // P8000500A
                                DrillDownBudgetQuantity(ItemStatisticsBuf, true);  // P8000500A
                            AnalysisColumn."Value Type"::"Sales Amount":
                                DrillDownBudgetSalesAmount(ItemStatisticsBuf);
                            // P8000921
                            AnalysisColumn."Value Type"::FOODSalesAmountFOB:
                                DrillDownBudgSalesAmtFOB(ItemStatisticsBuf);
                            AnalysisColumn."Value Type"::FOODSalesAmounttFreight:
                                DrillDownBudgSalesAmtFreight(ItemStatisticsBuf);
                            // P8000921
                            AnalysisColumn."Value Type"::"Cost Amount":
                        ...
                        case AnalysisColumn."Value Type" of
                            AnalysisColumn."Value Type"::Quantity:
                                ColValue := CalcBudgetQuantity(ItemStatisticsBuf, false); // P800-MegaApp
                            AnalysisColumn."Value Type"::FOODQuantityAlt:            // P8000500A
                                ColValue := CalcBudgetQuantity(ItemStatisticsBuf, true);  // P8000500A
                            AnalysisColumn."Value Type"::"Sales Amount":
                                ColValue := CalcBudgetSalesAmount(ItemStatisticsBuf);
                            // P8000921
                            AnalysisColumn."Value Type"::FOODSalesAmountFOB:
                                ColValue := CalcBudgSalesAmtFOB(ItemStatisticsBuf);
                            AnalysisColumn."Value Type"::FOODSalesAmounttFreight:
                                ColValue := CalcBudgSalesAmtFreight(ItemStatisticsBuf);
                            // P8000921
                            AnalysisColumn."Value Type"::"Cost Amount":
    ...
    local procedure CalcQuantity(var ItemStatisticsBuf: Record "Item Statistics Buffer"; Invoiced: Boolean; AltQty: Boolean): Decimal
    begin
        // P8000500A - add parameter for AltQty
        with ItemStatisticsBuf do begin
            if GetFilter("Source No. Filter") = '' then
                SetRange("Source Type Filter");
            ...
            if AnalysisLineTemplate."Item Analysis View Code" = '' then begin
                ...
                case true of
                    ...
                    Invoiced and AltQty:
                        begin
                            CalcFields("Invoiced Quantity (Alt.)");
                            exit("Invoiced Quantity (Alt.)");
                        end;
                    (not Invoiced) and (not AltQty):
                        begin
                            CalcFields(Quantity);
                            exit(Quantity);
                        end;
                    (not Invoiced) and AltQty:
                        begin
                            CalcFields("Quantity (Alt.)");
                            exit("Quantity (Alt.)");
                        end;
                end;
                // P8000500A
            ...
            case true of
                ...
                Invoiced and AltQty:
                    begin
                        CalcFields("Analysis - Inv. Qty. (Alt.)");
                        exit("Analysis - Inv. Qty. (Alt.)");
                    end;
                (not Invoiced) and (not AltQty):
                    begin
                        CalcFields("Analysis - Quantity");
                ...
                (not Invoiced) and AltQty:
                    begin
                        CalcFields("Analysis - Quantity (Alt.)");
                        exit("Analysis - Quantity (Alt.)");
                    end;
            end;
            // P8000500A
        end;
    ...
    local procedure CalcBudgetQuantity(var ItemStatisticsBuf: Record "Item Statistics Buffer"; AltQty: Boolean): Decimal
    begin
        // P8000500A - add parameter for AltQty
        with ItemStatisticsBuf do begin
            if GetFilter("Source No. Filter") = '' then
            ...
            if AnalysisLineTemplate."Item Analysis View Code" = '' then begin
                // P8000500A
                if AltQty then begin
                    CalcFields("Budgeted Quantity (Alt.)");
                    exit("Budgeted Quantity (Alt.)");
                end else begin
                    // P8000500A
            ...
            // P8000500A
            if AltQty then begin
                CalcFields("Analysis - Budgeted Qty (Alt.)");
                exit("Analysis - Budgeted Qty (Alt.)");
            end else begin
                // P8000500A
    ...
    local procedure DrillDownQuantity(var ItemStatisticsBuf: Record "Item Statistics Buffer"; Invoiced: Boolean; AltQty: Boolean)
    var
        ValueEntry: Record "Value Entry";
        ...
        with ItemStatisticsBuf do begin
            ...
            if AnalysisLineTemplate."Item Analysis View Code" = '' then begin
                if Invoiced then begin
                    ...
                    // P8000500A
                    if AltQty then
                        PAGE.Run(0, ItemLedgEntry, ItemLedgEntry."Quantity (Alt.)")
                    else
                ...
                if Invoiced then
                    // P8000500A
                    if AltQty then
                        PAGE.Run(0, ItemAnalysisViewEntry, ItemAnalysisViewEntry."Invoiced Quantity (Alt.)")
                    else
                        // P8000500A
                    ...
                    // P8000500A
                    if AltQty then
                        PAGE.Run(0, ItemAnalysisViewEntry, ItemAnalysisViewEntry."Quantity (Alt.)")
                    else
                        // P8000500A
    ...
    local procedure DrillDownBudgetQuantity(var ItemStatisticsBuf: Record "Item Statistics Buffer"; AltQty: Boolean)
    var
        ItemBudgetEntry: Record "Item Budget Entry";
        ItemAnalysisViewBudgEntry: Record "Item Analysis View Budg. Entry";
    begin
        ...
        with ItemStatisticsBuf do begin
            ...
            if AnalysisLineTemplate."Item Analysis View Code" = '' then begin
                ...
                // P8000500A
                if AltQty then
                    PAGE.Run(0, ItemBudgetEntry, ItemBudgetEntry."Quantity (Alt.)")
                else
                    // P8000500A
                ...
                // P8000500A
                if AltQty then
                    PAGE.Run(0, ItemAnalysisViewBudgEntry, ItemAnalysisViewBudgEntry."Quantity (Alt.)")
                else
                    // P8000500A
    ...
    local procedure DrillDownSalesAmountFOB(var ItemStatisticsBuf: Record "Item Statistics Buffer"; Invoiced: Boolean)
    var
        ValueEntry: Record "Value Entry";
        ItemAnalysisViewEntry: Record "Item Analysis View Entry";
    begin
        ...
        with ItemStatisticsBuf do begin
            ...
            if AnalysisLineTemplate."Item Analysis View Code" = '' then begin
                FilterValueEntry(ItemStatisticsBuf, ValueEntry);
                if Invoiced then
                    PAGE.Run(0, ValueEntry, ValueEntry."Sales Amount (FOB)")
                else
                    PAGE.Run(0, ValueEntry, ValueEntry."Sales Amount (Expected)");
            end else begin
                FilterItemAnalyViewEntry(ItemStatisticsBuf, ItemAnalysisViewEntry);
                if Invoiced then
                    PAGE.Run(0, ItemAnalysisViewEntry, ItemAnalysisViewEntry."Sales Amount (FOB)")
                else
                    PAGE.Run(0, ItemAnalysisViewEntry, ItemAnalysisViewEntry."Sales Amount (Expected)");
            end;
        end;
    ...
    local procedure DrillDownSalesAmountFreight(var ItemStatisticsBuf: Record "Item Statistics Buffer"; Invoiced: Boolean)
    var
        ValueEntry: Record "Value Entry";
        ItemAnalysisViewEntry: Record "Item Analysis View Entry";
    begin
        ...
        with ItemStatisticsBuf do begin
            ...
            if AnalysisLineTemplate."Item Analysis View Code" = '' then begin
                FilterValueEntry(ItemStatisticsBuf, ValueEntry);
                if Invoiced then
                    PAGE.Run(0, ValueEntry, ValueEntry."Sales Amount (Freight)");
            end else begin
                FilterItemAnalyViewEntry(ItemStatisticsBuf, ItemAnalysisViewEntry);
                if Invoiced then
                    PAGE.Run(0, ItemAnalysisViewEntry, ItemAnalysisViewEntry."Sales Amount (Freight)");
            end;
        end;
    end;

    local procedure CalcSalesAmountFOB(var ItemStatisticsBuf: Record "Item Statistics Buffer"; Invoiced: Boolean): Decimal
    begin
        // P8000921
        with ItemStatisticsBuf do begin
            if GetFilter("Source No. Filter") = '' then
            ...
            if AnalysisLineTemplate."Item Analysis View Code" = '' then begin
                if Invoiced then begin
                    CalcFields("Sales Amount (FOB)");
                    exit("Sales Amount (FOB)");
                end;
                CalcFields("Sales Amount (Expected)");
                exit("Sales Amount (Expected)");
            end else begin
                if Invoiced then begin
                    CalcFields("Analysis - Sales Amt (FOB)");
                    exit("Analysis - Sales Amt (FOB)");
                end;
                CalcFields("Analysis - Sales Amt. (Exp)");
                exit("Analysis - Sales Amt. (Exp)");
            end;
    ...
    local procedure CalcSalesAmountFreight(var ItemStatisticsBuf: Record "Item Statistics Buffer"; Invoiced: Boolean): Decimal
    begin
        // P8000921
        with ItemStatisticsBuf do begin
            if GetFilter("Source No. Filter") = '' then
            ...
            if AnalysisLineTemplate."Item Analysis View Code" = '' then begin
                if Invoiced then begin
                    ...
                    exit("Sales Amount (Freight)");
                end;
            end else begin
                if Invoiced then begin
                    CalcFields("Analysis - Sales Amt (Freight)");
                    exit("Analysis - Sales Amt (Freight)");
                end;
            end;
        end;
    end;

    local procedure DrillDownBudgSalesAmtFOB(var ItemStatisticsBuf: Record "Item Statistics Buffer")
    var
        ItemBudgetEntry: Record "Item Budget Entry";
        ItemAnalysisViewBudgEntry: Record "Item Analysis View Budg. Entry";
    begin
        ...
        with ItemStatisticsBuf do begin
            ...
            if AnalysisLineTemplate."Item Analysis View Code" = '' then begin
                FilterItemBudgetEntry(ItemStatisticsBuf, ItemBudgetEntry);
                PAGE.Run(0, ItemBudgetEntry, ItemBudgetEntry."Sales Amount (FOB)");
            end else begin
                FilterItemAnalyViewBudgEntry(ItemStatisticsBuf, ItemAnalysisViewBudgEntry);
                PAGE.Run(0, ItemAnalysisViewBudgEntry, ItemAnalysisViewBudgEntry."Sales Amount (FOB)");
            end;
        end;
    end;

    local procedure DrillDownBudgSalesAmtFreight(var ItemStatisticsBuf: Record "Item Statistics Buffer")
    var
        ItemBudgetEntry: Record "Item Budget Entry";
        ItemAnalysisViewBudgEntry: Record "Item Analysis View Budg. Entry";
    begin
        ...
        with ItemStatisticsBuf do begin
            ...
            if AnalysisLineTemplate."Item Analysis View Code" = '' then begin
                FilterItemBudgetEntry(ItemStatisticsBuf, ItemBudgetEntry);
                PAGE.Run(0, ItemBudgetEntry, ItemBudgetEntry."Sales Amount (Freight)");
            end else begin
                FilterItemAnalyViewBudgEntry(ItemStatisticsBuf, ItemAnalysisViewBudgEntry);
                PAGE.Run(0, ItemAnalysisViewBudgEntry, ItemAnalysisViewBudgEntry."Sales Amount (Freight)");
            end;
        end;
    end;

    local procedure CalcBudgSalesAmtFOB(var ItemStatisticsBuf: Record "Item Statistics Buffer"): Decimal
    begin
        // P8000921
        with ItemStatisticsBuf do begin
            if GetFilter("Source No. Filter") = '' then
            ...
            if AnalysisLineTemplate."Item Analysis View Code" = '' then begin
                CalcFields("Budg. Sales Amount (FOB)");
                exit("Budg. Sales Amount (FOB)");
            end;
            CalcFields("Analysis-Budg. Sales (FOB)");
            exit("Analysis-Budg. Sales (FOB)");
        end;
    end;

    local procedure CalcBudgSalesAmtFreight(var ItemStatisticsBuf: Record "Item Statistics Buffer"): Decimal
    begin
        // P8000921
        with ItemStatisticsBuf do begin
            if GetFilter("Source No. Filter") = '' then
            ...
            if AnalysisLineTemplate."Item Analysis View Code" = '' then begin
                CalcFields("Budg. Sales Amount (Freight)");
                exit("Budg. Sales Amount (Freight)");
            end;
            CalcFields("Analysis-Budg. Sales (Freight)");
            exit("Analysis-Budg. Sales (Freight)");
        end;
    end;
