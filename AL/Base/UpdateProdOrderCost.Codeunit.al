codeunit 99000757 "Update Prod. Order Cost"
{
    ...
    begin
        ...
        P800ProdOrderMgmt.AddProdLineExpCost(ProdOrderLine, ProdOrderLine."Expected Component Cost Amt."); // PR3.60
    ...
    begin
        ...
        TotalUnitCost :=
            TotalUnitCost +
            //(Item."Unit Cost" *                          // PR3.60
            (Item."Unit Cost" * Item.CostingQtyPerBase() * // PR3.60
            (ProdOrderComp."Expected Qty. (Base)" - ProdOrderComp."Reserved Qty. (Base)"));
    end;
