report 5405 "Calc. Consumption"
{
    ...
    // 
    // PR3.70.03
    //   Modified CreateConsumptionJnlLine Function
        ...
        dataitem("Production Order"; "Production Order")
        {
            ...
            dataitem("Prod. Order Component"; "Prod. Order Component")
            {
                ...
                begin
                    ...
                    Clear(ItemJnlLine);
                    Item.Get("Item No.");
                    if ("Prod. Order Line No." <> 0) then // PR3.60
    ...
    begin
        ...
        // (Item."Rounding Precision" > 0) and not IgnoreRoundingPrecision then              // PR3.70.03
        Item.GetItemUOMRndgPrecision("Prod. Order Component"."Unit of Measure Code", true);  // PR3.70.03
        ItemJnlLine.Validate(Quantity, ItemJnlLine.Quantity + UOMMgt.RoundToItemRndPrecision(QtyToPost, Item."Rounding Precision"));
        // else                                                                                 // PR3.70.03
        //   ItemJnlLine.Validate(Quantity, ItemJnlLine.Quantity + UOMMgt.RoundQty(QtyToPost)); // PR3.70.03            
    end;
