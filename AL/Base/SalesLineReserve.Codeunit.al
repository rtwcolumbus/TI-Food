codeunit 99000832 "Sales Line-Reserve"
{
    ...
    //   Extend to sales line type of Container
    // 
    // PR4.00.01
    ...
    begin
        ...
        if not (SalesLine.Type in [SalesLine.Type::Item, SalesLine.Type::FOODContainer]) then // P8000140A
            exit;
        if ((SalesLine."Document Type" = SalesLine."Document Type"::Invoice) and
            (SalesLine."Shipment No." <> '')) or
           ((SalesLine."Document Type" = SalesLine."Document Type"::"Credit Memo") and
    ...
    begin
        ...
        repeat
            ...
            // P80047943
            if (SalesLine."Shipment No." <> '') or (SalesLine."Return Receipt No." <> '') then
    ...
    begin
        ...
        case ReturnOption of
            ...
            ReturnOption::"Gross Qty. (Alt.)":     // P8000267B
                exit(SalesLine."Quantity (Alt.)"); // P8000267B
        end;
    end;
