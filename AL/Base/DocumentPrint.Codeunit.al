codeunit 229 "Document-Print"
{
    ...
    begin
        ...
        ReportSelection.Print(ReportSelection.Usage::FOODMWorkOrder, WorkOrder, 0); // P8007748, P80060684
    end;
    ...
    begin
        ...
        ReportSelection.Print(ReportSelection.Usage::FOODRepackOrder, RepackOrder, 0); // P8007748, P80060684
    end;
