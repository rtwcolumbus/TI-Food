codeunit 5851 "Invt. Doc.-Post Shipment"
{
        ...
        with InvtDocHeader do begin
            ...
            if InvtDocLine.Find('-') then
                repeat
                    ...
                    InvtShptLine."FOOD Quantity (Alt.)" := InvtDocLine."FOOD Quantity (Alt.)"; // P800127049
                    ...
                    AltQtyMgt.InvtDocLineToPostedInvtDocLine(InvtDocLine, InvtShptLine); // P800127049

                    PostItemJnlLine(InvtShptHeader, InvtShptLine, InvtDocLine); // P800127049
    ...
    local procedure PostItemJnlLine(InvtShptHeader2: Record "Invt. Shipment Header"; InvtShptLine2: Record "Invt. Shipment Line"; InvtDocLine: Record "Invt. Document Line")
    var
    ...
    begin
        ...
        // P800127049
        ItemJnlLine."Quantity (Alt.)" := Sign * InvtShipmentLine."FOOD Quantity (Alt.)";
        ItemJnlLine."Invoiced Qty. (Alt.)" := Sign * InvtShipmentLine."FOOD Quantity (Alt.)";
        // P800127049
