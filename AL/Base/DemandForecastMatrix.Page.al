page 9245 "Demand Forecast Matrix"
{
    ...
    begin
        ...
        LoadMatrix(MatrixColumns1, MatrixRecords1, ProductionForecastName1, DateFilter1, LocationFilter1, '', ForecastType1, QtyType1, NoOfMatrixColumns1); 
    end;
#endif
    procedure Load(MatrixColumns1: array[32] of Text[1024]; var MatrixRecords1: array[32] of Record Date; ProductionForecastName1: Code[10]; DateFilter1: Text; LocationFilter1: Text; VariantFilter1: Code[10]; ForecastType1: Option "Sales Item",Component,Both; QtyType1: Option "Net Change","Balance at Date"; NoOfMatrixColumns1: Integer)
    begin
        // P8000869 - added parameter VariantFilter1
        LoadMatrix(MatrixColumns1, MatrixRecords1, ProductionForecastName1, DateFilter1, LocationFilter1, VariantFilter1, ForecastType1, QtyType1, NoOfMatrixColumns1);
    end;

    procedure LoadMatrix(NewMatrixColumns: array[32] of Text[1024]; var NewMatrixRecords: array[32] of Record Date; NewProductionForecastName: Code[10]; NewDateFilter: Text; NewLocationFilter: Text; NewVariantFilter: Text; NewForecastType: Enum "Demand Forecast Type"; NewQtyType: Enum "Analysis Amount Type"; NewNoOfMatrixColumns: Integer)
    begin
        ...
        VariantFilter := NewVariantFilter; // P8000869
    ...
    begin
        ...
        // P8000869
        if VariantFilter <> '' then
            ProductionForecastEntry.SetFilter("Variant Code", VariantFilter)
        else
    ...
    begin
        ...
        ProdForecastEntry.SetFilter("Variant Code", GetFilter("Variant Filter")); // P8000869
