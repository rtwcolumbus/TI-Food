page 5540 "Item Availability by Timeline"
{
        ...
        area(content)
        {
            group(Options)
            {
                ...
                field(AvailableFor; AvailableFor)
                {
                    ...
                    trigger OnValidate()
                    var
                        AvailableFor2: Option;
                    begin
                        // P8001144
                        AvailableFor2 := AvailableFor;
                        InitAndCreateTimelineEvents;
    ...
    trigger OnOpenPage()
    begin
        AvailableFor := LotStatusMgmt.ItemAvailabilityContext(Context); // P8001144
    ...
    begin
        ...
        CalcItemAvailTimeline.SetAvailableFor(LotStatusExclusionFilter, ExcludePurch, ExcludeSalesRet, ExcludeOutput);
        // P8001144
    ...
    procedure SetContext(NewContext: Code[12])
    begin
        Context := NewContext; // P8001144
    end;
