codeunit 80 "Sales-Post" // Version: FOODNA
{
    // --------------------------------------------------------------------------------
    ...
    // 
    // PR1.00.04
    //   When deleting sales order also delete production order xref records
    // 
    // PR1.10.02
    //   Set permissions
    // 
    // PR2.00
    //   Changed due to changes in production order xref key fields
    // 
    // PR2.00.04
    //   Document Management
    // 
    ...
    //   Add Pricing - Reprice at shipment
    //   Delivery Routing
    // 
    // PR3.61
    ...
    // 
    // PR3.61.01
    //   Add logic for posting alternate quantity for credit memos
    //   Modify posting of sales container line
    //   Add logic for assigning posted receipt number for drop shipments
    //   Add permission checking for delivery route management
    //   Add logic for posting credit memo writeoff
    // 
    // PR3.70
    //   Off-Invoice Allowance
    // 
    // PR3.70.01
    //   Post sales lines repacks
    // 
    // PR3.70.03
    //   Accruals
    //   Clear ADC Started
    ...
    //   Set ItemJnlLine."Exclude from Sales Forecast";
    // 
    // PR3.70.07
    // P8000119A, Myers Nissi, Don Bresee, 20 SEP 04
    //   Accruals update/fixes
    // 
    // P8000121A, Myers Nissi, Jack Reynolds, 23 SEP 04
    //   OnRun - remove calls to AdjustQuantityRounding
    // 
    // P8000144A, Myers Nissi, Jack Reynolds, 18 NOV 04
    //   OnRun - when calling PostItemJnlLine for items also post for containers if PostAsItem is set
    // 
    // P8000153A, Myers Nissi, Jack Reynolds, 16 DEC 04
    //   Delete related lot preferences when deleting completed orders
    // 
    // PR3.70.08
    // P8000175A, Myers Nissi, Jack Reynolds, 31 JAN 05
    //   Fix dimension problem for off-invoice lines added
    // 
    // PR3.70.09
    // P8000207A, Myers Nissi, Jack Reynolds, 16 MAR 05
    //   Fix container posting when shipping and invoicing at the same time
    // 
    // PR3.70.10
    // P8000211A, Myers Nissi, Jack Reynolds, 13 MAY 05
    //   Fix problem with price extension on invoices for partial shipments
    // 
    // P8000233A, Myers Nissi, Phyllis McGovern, 21 Jul 05
    //   Set ItemJnlLine."Delivery Route No.";
    // 
    ...
    //   Changes required to bring P800 into line with changes to standard code
    // 
    // P8000274A, VerticalSoft, Jack Reynolds, 29 DEC 05
    //   Move posting of accruals until after creation of posted document lines
    // 
    // PR4.00.02
    // P8000303A, VerticalSoft, Jack Reynolds, 24 FEB 06
    //   Change so credit memo writeoff dimensions are taken from credit memo line
    // 
    // P8000282A, VerticalSoft, Jack Reynolds, 23 MAR 06
    //   P800 WMS Project - posting by location
    // 
    // PR4.00.04
    // P8000373A, VerticalSoft, Jack Reynolds, 07 SEP 06
    //   Delete the SalesRepack record after posting
    // 
    // P8000374A, VerticalSoft, Jack Reynolds, 07 SEP 06
    //   Set Don't Apply on item journal line for credit memo writeoffs
    // 
    // P8000403A, VerticalSoft, Jack Reynolds, 05 OCT 06
    //   Modify to make calls to the extra charge management codeunit to handle the posting of extra charges
    //    for drop shipments
    // 
    // PR4.00.06
    // P8000464A, VerticalSoft, Don Bresee, 9 APR 07
    //   Add fields for accrual dates
    // 
    // PR5.00
    // P8000466A, VerticalSoft, Don Bresee, 12 JUN 07
    //   Use LineAmtExclAltQtys() for prepayment calculations
    //   Fix Division by 0 bug - "Qty. to Invoice (Alt.)"
    // 
    // P8000506A, VerticalSoft, Jack Reynolds, 10 AUG 07
    //   Fix problem with getting alternate quantity for drop shipments
    // 
    // PRW15.00.01
    // P8000558A, VerticalSoft, Jack Reynolds, 18 JAN 08
    //   Check license permission before calls to Item Sales Price Management codeunit
    // 
    ...
    // 
    // PRW15.00.02
    // P8000610A, VerticalSoft, Jack Reynolds, 14 JUL 08
    //   Fix easy lot problem when not invoicing all of the lines
    // 
    // PRW15.00.03
    ...
    // 
    // P8000633A, VerticalSoft, Jack Reynolds, 30 SEP 08
    //   Fix dimension problem with text lines
    // 
    // PRW16.00.01
    // P8000669, VerticalSoft, Jack Reynolds, 29 JAN 09
    //   Fix problem with posting drop shipments and country of origin
    // 
    // PRW16.00.04
    // P8000852, VerticalSoft, Jack Reynolds, 05 AUG 10
    //   Fix problem wih records accumulating in Dimension Buffer table
    // 
    // P8000885, VerticalSoft, Ron Davidson, 06 DEC 10
    //   Added a Function calls to insert a record in the Sales Contract History table if Sales Line is tied to a
    //   Sales Contract.
    // 
    ...
    //   Add scaling of FOB/Freight for partial invoicing
    //   Add posting of freight revenue
    // 
    ...
    //   Don't allow direct posting of orders associated with delivery trips
    // 
    // P8000956, Columbus IT, Jack Reynolds, 09 JUN 11
    //   Fix problem with warehouse entries for credit memo writeoffs
    // 
    ...
    // 
    // PRNA6.00.06
    // P8001005, Columbus IT, Jack Reynolds, 20 DEC 11
    //   Fix problems w/ Sales Tax and Delivered Pricing
    // 
    // PRW16.00.06
    // P8001006, Columbus IT, Jack Reynolds, 21 DEC 11
    //   Update sales lines when modifying posting date
    // 
    // P8001010, Columbus IT, Jack Reynolds, 05 JAN 12
    //   Fix problem updating Qty. Invoiced (Alt.)
    // 
    ...
    // 
    // P8001125, Columbus IT, Jack Reynolds, 03 JAN 13
    //   Fix problem posting invoices with delivery trips enabled
    // 
    // PRW17.00
    ...
    // 
    // PRW17.10.03
    // P8001329, Columbus IT, Jack Reynolds, 19 JUN 14
    //   Fix problem with Sales Comment Line Document Type for posted documents
    // 
    ...
    // 
    // P80047148, To-Increase, Dayakar Battini, 29 SEP 17
    //   Refresh Temperary records after actual record modifications
    // 
    // P80048121, To-Increase, Dayakar Battini, 01 NOV 17
    //   Fix for missing value entries for multi line item charges
    // 
    // P80048210, To-Increase, Dayakar Battini, 03 NOV 17
    //   Fix to include extended text lines
    // 
    // PRW110.0.02
    // P80047943, To-Increase, Dayakar Battini, 22 NOV 17
    //   Fix issue with Qty to Invoice (alt) updation with lot tracking
    // 
    ...
    // 
    // P80055951, To-Increase, Dayakar Battini, 22 MAR 18
    //   Fix for inbound container receiving/shipping
    // 
    // PRW111.00
    ...
    //
    // P80097194, To Increase, Jack Reynolds, 12 JUN 19
    //     Problem reopening warehouse request with approvals
    //
    // PRNA19.3
    // P800146078, To Increase, Jack Reynolds, 2 JUN 22
    //   Correct data type error (was integer, changed to decinmal)
    ...
    Permissions = TableData "Sales Line" = imd,
                  ...
                  TableData "Production Order XRef" = d;
    ...
    var
        ...
        SavedPostingLocationCode: Code[10];
    begin
        ...
        //N138F0000.sn
        if not SettlementPosting then
            if Rec.Settlement then
                Error(N138Text000);
        //N138F0000.en
        ...
        // P80066030
        if not Invoice then
            SavedPostingLocationCode := PostingLocation;
        // P80066030
        ClearAllVariables();
        SuppressCommit := SavedSuppressCommit;
        PreviewMode := SavedPreviewMode;
        HideProgressWindow := SavedHideProgressWindow;
        PostingLocation := SavedPostingLocationCode; // P80066030

        GetGLSetup();
        DeliveryTripNo := "Delivery Trip No."; // P8000549A
        "Delivery Trip No." := '';             // P8000549A
        ...
        if ProcessFns.AltQtyInstalled() then
            AltQtyMgmt.CopyWhseActToSale(TempWhseActHeader, SalesHeader);
        // P8000282A
        if ProcessFns.FreshProInstalled then          // P8000403A
            ExtraChargeMgmt.ClearDropShipPostingBuffer; // P8000403A
        ...
        if TempSalesLineGlobal.FindSet() then
            repeat
                ...
                if ProcessFns.ContainerTrackingInstalled then               // P8001342
                    ContainerFns.SetContainerDocumentLineSource(TempSalesLineGlobal, 0); // P8001342
                TempSalesLineGlobal.AutoLotNo(true); // P8000250B
                PostRepack(SalesHeader, TempSalesLineGlobal); // PR3.70.01, P8007748
        ...
        if SalesHeader.Invoice then
            PostInvoice(SalesHeader, TempSalesLineGlobal, CustLedgEntry, LineCount);
    ...
    var
        ...
        N138Text000: Label 'This is a settlement order. Post first the settlement';
        ProcessFns: Codeunit "Process 800 Functions";
        ContainerFns: Codeunit "Container Functions";
        AltQtyMgmt: Codeunit "Alt. Qty. Management";
        ItemSalesPriceMgmt: Codeunit "Item Sales Price Management";
        AllowanceMgmt: Codeunit "Off-Invoice Allowance Mgt.";
        ...
        PostAccrualBatch: Codeunit "Accrual Jnl.-Post Batch";
        ...
        Text37002000: Label '-1';
        Text37002671: Label 'You cannot manually invoice an order that is associated to a Sales Payment.';
        TempWhseActHeader: Record "Warehouse Activity Header" temporary;
        DocAccrualLine: Record "Document Accrual Line";
        RemQtyToBeInvoicedAlt: Decimal;
        RemFreightAmt: Decimal;
    ...
    begin
        ...
        if PostingLocation <> '' then                          // P8001323
                                                               //SalesLine.SETRANGE("Location Code",PostingLocation); // P8001323, P80048210
            SalesLine.SetFilter("Location Code", '%1|%2', '', PostingLocation); // P80048210
    ...
    begin
        with SalesHeader do begin
            ...
            // P8000941
            if OnSalesPayment(SalesPaymentLine) then begin
                if (not Ship) and Invoice then
                    Error(Text37002671);
                Invoice := false;
            ...
            // P8000282A
            if ProcessFns.AltQtyInstalled() then
                AltQtyMgmt.CheckSalesRelease(SalesHeader);
            // P8000282A
            ...
            if ProcessFns.PricingInstalled then begin            // PR3.60
                ItemSalesPriceMgmt.PriceAtShipment(SalesHeader, PostingLocation);   // PR3.60, P8000282A
                AllowanceMgmt.AddAllowanceSalesLines(SalesHeader, PostingLocation); // PR3.70, P8000282A
                RefreshTempLines(SalesHeader, TempSalesLineGlobal); // P80047148, P80066030
            end;                                                 // PR3.70
    ...
    begin
        with SalesLine do begin
            // PR3.61
            if SalesLine.Type = SalesLine.Type::FOODContainer then begin
                ContainerType.SetRange("Container Item No.", SalesLine."No."); // P8001290
                if ContainerType.FindFirst then // P8001290
                    PostAsItem := ContainerType."Container Sales Processing" = ContainerType."Container Sales Processing"::Sale // P8001290
                else
                    PostAsItem := false;
            end else
            PostAsItem := SalesLine.Type = SalesLine.Type::Item;
            // PR3.61
            if PostAsItem then begin // PR3.61
            ...
            // P8002745
            if (SalesLine.Type = SalesLine.Type::FOODAccrualPlan) then
                AccrualFldMgmt.SalesPostCheckLine(SalesLine);
            // P8002745
            ...
            if not IsHandled then
                if Quantity <> 0 then
                    // DivideAmount(SalesHeader,SalesLine,1,"Qty. to Invoice",TempVATAmountLine,TempVATAmountLineRemainder);                       // PR3.60
                    DivideAmount(SalesHeader, SalesLine, 1, "Qty. to Invoice", "Qty. to Invoice (Alt.)", TempVATAmountLine, TempVATAmountLineRemainder); // PR3.60
            ...
            // RoundAmount(SalesHeader, SalesLine, "Qty. to Invoice");                       // PR3.60
            RoundAmount(SalesHeader, SalesLine, "Qty. to Invoice", "Qty. to Invoice (Alt.)"); // PR3.60
            ...
            RoundingAdjmtMgmt.SetFixedAltQtySalesLine(SalesLine); // P8000550A

            RemQtyToBeInvoiced := "Qty. to Invoice";
            RemQtyToBeInvoicedBase := "Qty. to Invoice (Base)";
            RemQtyToBeInvoicedAlt := "Qty. to Invoice (Alt.)"; // PR3.60

            OnPostSalesLineOnBeforePostItemTrackingLine(SalesHeader, SalesLine, WhseShip, WhseReceive, InvtPickPutaway);

            PostItemTrackingLine(SalesHeader, SalesLine, TempItemLedgEntryNotInvoiced, HasATOShippedNotInvoiced, PostAsItem); // P8007748
            ...
            case Type of
                ...
                Type::Item, Type::FOODContainer: // PR3.61
                    PostItemLine(SalesHeader, SalesLine, TempDropShptPostBuffer, TempPostedATOLink, PostAsItem); // P8007748
                Type::Resource:
            ...
            if not IsHandled then
                ...
                then
                    InsertShipmentLine(SalesHeader, SalesShptHeader, SalesLine, CostBaseAmount, TempServiceItem2, TempServiceItemComp2, PostAsItem); // P8007748
            ...
            then
                InsertReturnReceiptLine(SalesHeader, ReturnRcptHeader, SalesLine, CostBaseAmount, PostAsItem); // P8007748
            ...
            if SalesHeader.Invoice then
                if SalesHeader."Document Type" in [SalesHeader."Document Type"::Order, SalesHeader."Document Type"::Invoice] then begin
                    ...
                    if not IsHandled then begin
                        ...
                        // P8000885
                        if ProcessFns.PricingInstalled and (SalesHeader."Document Type" <> SalesHeader."Document Type"::Order) then
                            SalesContMgmt.InsertSalesContractHist(SalesInvLine."Document No.", SalesLine, SalesHeader); // P8001076
                                                                                                                        // P8000885
                        if xSalesLine."Alt. Qty. Transaction No." <> 0 then                                      // PR3.60
                            AltQtyMgmt.CreateInvoiceEntries(DATABASE::"Sales Invoice Line", SalesInvHeader."No."); // PR3.60
                    ...
                    if not IsHandled then begin
                        ...
                        if ProcessFns.PricingInstalled then
                            SalesContMgmt.InsertSalesContractHist(SalesCrMemoLine."Document No.", SalesLine, SalesHeader); // P8001076
                                                                                                                           // P8000885
                        if xSalesLine."Alt. Qty. Transaction No." <> 0 then                                       // PR3.60
                                                                                                                  // PR3.61.01
                            if ("Document Type" = "Document Type"::"Return Order") or SalesSetup."Return Receipt on Credit Memo" then
                                AltQtyMgmt.CreateInvoiceEntries(DATABASE::"Sales Cr.Memo Line", SalesCrMemoHeader."No.") // PR3.60
                            else begin
                                AltQtyMgmt.SalesLineToCreditMemoLine(xSalesLine, SalesCrMemoLine);
                                AltQtyMgmt.UpdateAltQtyEntriesInvQty(TempValueEntryRelation, SalesCrMemoLine.RowID1, ItemLedgShptEntryNo);
                            end;
                        // PR3.61.01
                        PostCMWriteoff(SalesLine, SalesCrMemoLine); // PR3.60.01, P8004516 // P8007748
            ...
            if ProcessFns.AccrualsInstalled() then
                PostAccrualBatch.PostSalesLineAccruals(SalesHeader, SalesLine, SrcCode); // P8001133
            // P8000274A
        end;
    ...
    local procedure PostInvoice(var SalesHeader: Record "Sales Header"; var SalesLine: Record "Sales Line"; var CustLedgEntry: Record "Cust. Ledger Entry"; LineCount: Integer)
    var
        TotalAmount: Decimal;
        IsHandled: Boolean;
    begin
        ...
        with SalesHeader do begin
            // P8002745
            if ProcessFns.AccrualsInstalled() then
                AccrualFldMgmt.SalesPrePost(SalesLine);
            // P8002745
            ...
            // PR3.70.03
            if ProcessFns.AccrualsInstalled() then begin
                PostAccrualBatch.PostSalesHeaderAccruals(SalesHeader, SrcCode); // P8001133

                PostAccrualsToGL(SalesHeader); // P8007748
            end;
            // PR3.70.03
        end;
    ...
    local procedure PostItemLine(SalesHeader: Record "Sales Header"; var SalesLine: Record "Sales Line"; var TempDropShptPostBuffer: Record "Drop Shpt. Post. Buffer" temporary; var TempPostedATOLink: Record "Posted Assemble-to-Order Link" temporary; PostAsItem: Boolean)
    var
        ...
        QtyToInvoiceAlt: Decimal;
        IsHandled: Boolean;
    begin
        ItemLedgShptEntryNo := 0;
        QtyToInvoice := RemQtyToBeInvoiced;
        QtyToInvoiceBase := RemQtyToBeInvoicedBase;
        QtyToInvoiceAlt := RemQtyToBeInvoicedAlt; // P80060684
        with SalesHeader do      // P8007748
            if PostAsItem then begin // P8007748
                ...
                if QtyToInvoice <> 0 then
                    ItemLedgShptEntryNo :=
                      PostItemJnlLine(
                        ...
                        QtyToInvoiceAlt, // PR3.60, P80060684
                        QtyToInvoice, QtyToInvoiceBase,
                        QtyToInvoiceAlt, // PR3.60, P80060684
                        0, '', DummyTrackingSpecification, false, PostAsItem); // P8007748
                    ...
                    if Abs(SalesLineToShip."Return Qty. to Receive") > Abs(QtyToInvoice) then
                        ItemLedgShptEntryNo :=
                          PostItemJnlLine(
                            ...
                            SalesLineToShip."Return Qty. to Receive (Alt.)" - QtyToInvoiceAlt, // PR3.60, P80060684
                                                                                               //0,0,0,'',DummyTrackingSpecification,FALSE);  // PR3.60
                            0, 0, 0, 0, '', DummyTrackingSpecification, false, PostAsItem); // PR3.60, P8007748
                end else begin
                    if Abs(SalesLineToShip."Qty. to Ship") > Abs(QtyToInvoice) + Abs(TempPostedATOLink."Assembled Quantity") then
                        ItemLedgShptEntryNo :=
                          PostItemJnlLine(
                            ...
                            SalesLineToShip."Qty. to Ship (Alt.)" - QtyToInvoiceAlt, // PR6.10, P80060684
                                                                                     // 0,0,0,'',DummyTrackingSpecification,FALSE); // PR6.10
                            0, 0, 0, 0, '', DummyTrackingSpecification, false, PostAsItem); // PR6.10, P8007748
                end;
            end else
                if Ship or Receive then                               // P8000207A
                    if ProcessFns.ContainerTrackingInstalled then // P80046533
                        if ContainerFns.PostSalesContainerLine(SalesHeader, SalesLine, SalesShptHeader, ReturnRcptHeader, SrcCode, ItemJnlLine) then
                            PostSalesContainerLine(ItemJnlLine, SalesLine); // P8000631A, P8001133
    ...
    begin
        ...
        if (SalesLine."Qty. to Ship" <> 0) and (SalesLine."Purch. Order Line No." <> 0) then begin
            ...
            TempDropShptPostBuffer."Quantity (Alt.)" := -SalesLine."Qty. to Ship (Alt.)"; // P8000506A
            ...
            TempDropShptPostBuffer."Item Shpt. Entry No." :=
                PostAssocItemJnlLine(SalesHeader, SalesLine, TempDropShptPostBuffer.Quantity, TempDropShptPostBuffer."Quantity (Base)", TempDropShptPostBuffer."Quantity (Alt.)"); // P8007748
    ...
    local procedure PostItemTrackingLine(SalesHeader: Record "Sales Header"; SalesLine: Record "Sales Line"; var TempItemLedgEntryNotInvoiced: Record "Item Ledger Entry" temporary; HasATOShippedNotInvoiced: Boolean; PostAsItem: Boolean)
    var
        TempTrackingSpecification: Record "Tracking Specification" temporary;
    ...
    begin
        ...
        PostItemTracking(
          ...
          TempItemLedgEntryNotInvoiced, HasATOShippedNotInvoiced, PostAsItem); // P8007748

        if TrackingSpecificationExists then
            SaveInvoiceSpecification(TempTrackingSpecification);
    end;

    procedure PostItemJnlLine(SalesHeader: Record "Sales Header"; SalesLine: Record "Sales Line"; QtyToBeShipped: Decimal; QtyToBeShippedBase: Decimal; QtyToBeShippedAlt: Decimal; QtyToBeInvoiced: Decimal; QtyToBeInvoicedBase: Decimal; QtyToBeInvoicedAlt: Decimal; ItemLedgShptEntryNo: Integer; ItemChargeNo: Code[20]; TrackingSpecification: Record "Tracking Specification"; IsATO: Boolean; PostAsItem: Boolean): Integer
    var
        ItemJnlLine: Record "Item Journal Line";
    ...
    begin
        ...
        with ItemJnlLine do begin
            PostItemJnlLinePrepareJournalLine(ItemJnlLine, SalesHeader, SalesLine, QtyToBeShipped, QtyToBeShippedBase, QtyToBeShippedAlt, QtyToBeInvoiced, QtyToBeInvoicedBase, QtyToBeInvoicedAlt,
                ItemLedgShptEntryNo, ItemChargeNo, TrackingSpecification, IsATO, PostAsItem);
            ...
            if ShouldPostItemJnlLine then begin
                PostItemJnlLineBeforePost(ItemJnlLine, SalesLine, TempWhseJnlLine, PostWhseJnlLine, QtyToBeShippedBase, PostAsItem);
    ...
    procedure PostItemJnlLinePrepareJournalLine(var ItemJnlLine: Record "Item Journal Line"; SalesHeader: Record "Sales Header"; SalesLine: Record "Sales Line"; QtyToBeShipped: Decimal; QtyToBeShippedBase: Decimal; QtyToBeShippedAlt: Decimal; QtyToBeInvoiced: Decimal; QtyToBeInvoicedBase: Decimal; QtyToBeInvoicedAlt: Decimal; ItemLedgShptEntryNo: Integer; ItemChargeNo: Code[20]; TrackingSpecification: Record "Tracking Specification"; IsATO: Boolean; PostAsItem: Boolean)
    var
    ...
    begin
        ...
        with ItemJnlLine do begin
            ...
            // PR3.60
            "Quantity (Alt.)" := -QtyToBeShippedAlt;
            "Invoiced Qty. (Alt.)" := -QtyToBeInvoicedAlt;
            if (QtyToBeShippedAlt <> 0) then
                "Alt. Qty. Transaction No." := SalesLine."Alt. Qty. Transaction No.";
            // PR3.60

            PostItemJnlLineCopyDocumentFields(ItemJnlLine, SalesHeader, SalesLine, QtyToBeShipped, QtyToBeInvoiced, QtyToBeShippedAlt, QtyToBeInvoicedAlt);

            if (QtyToBeInvoiced <> 0) or (QtyToBeInvoicedAlt <> 0) then // P8000971
            ...
            if (QtyToBeInvoiced <> 0) or (QtyToBeInvoicedAlt <> 0) then // P8000971
                CalcItemJnlAmountsFromQtyToBeInvoiced(ItemJnlLine, SalesHeader, SalesLine, QtyToBeInvoiced, QtyToBeInvoicedBase, QtyToBeInvoicedAlt, ItemChargeNo)
            else
                CalcItemJnlAmountsFromQtyToBeShipped(ItemJnlLine, SalesHeader, SalesLine, QtyToBeShipped, QtyToBeShippedAlt);
        end;
    ...
    local procedure CalcItemJnlAmountsFromQtyToBeInvoiced(var ItemJnlLine: Record "Item Journal Line"; SalesHeader: Record "Sales Header"; SalesLine: Record "Sales Line"; QtyToBeInvoiced: Decimal; QtyToBeInvoicedBase: Decimal; QtyToBeInvoicedAlt: Decimal; ItemChargeNo: Code[20])
    var
        Factor: Decimal;
    begin
        with ItemJnlLine do begin
            ...
            if ItemChargeNo <> '' then
                ...
                if SalesLine.PriceInAlternateUnits() then begin
                    if (QtyToBeInvoicedAlt <> 0) and (SalesLine.Type = SalesLine.Type::Item) then
                        Factor := QtyToBeInvoicedAlt / SalesLine."Qty. to Invoice (Alt.)"
                    else
                        Factor := QtyToBeInvoiced / SalesLine."Qty. to Invoice";
                end else begin
                    if (QtyToBeInvoicedBase <> 0) and (SalesLine.Type = SalesLine.Type::Item) then
                        Factor := QtyToBeInvoicedBase / SalesLine."Qty. to Invoice (Base)"
                    else
                        Factor := QtyToBeInvoiced / SalesLine."Qty. to Invoice";
                end;
            // P8000971
	    
	    //Amount := -(SalesLine.Amount * (QtyToBeInvoiced / SalesLine."Qty. to Invoice") - RemAmt); // P8000971
            Amount := -(SalesLine.Amount * Factor - RemAmt);                                            // P8000971
            "Amount (Freight)" :=                                            // P8000921
              -(SalesLine."Line Amount (Freight)" * Factor - RemFreightAmt); // P8000921, P8000971
            if SalesHeader."Prices Including VAT" then
                "Discount Amount" :=
                  -((SalesLine."Line Discount Amount" + SalesLine."Inv. Discount Amount") /
		    //(1 + SalesLine."VAT %" / 100) * (QtyToBeInvoiced / SalesLine."Qty. to Invoice") - RemDiscAmt) // P8000971
                    (1 + SalesLine."VAT %" / 100) * Factor - RemDiscAmt)                  
            else
                "Discount Amount" :=
                  -((SalesLine."Line Discount Amount" + SalesLine."Inv. Discount Amount") *
		    //(QtyToBeInvoiced / SalesLine."Qty. to Invoice") - RemDiscAmt); // P8000971
		    Factor - RemDiscAmt);                                            // P8000971
            RemAmt := Amount - Round(Amount);
            RemDiscAmt := "Discount Amount" - Round("Discount Amount");
            Amount := Round(Amount);
            "Discount Amount" := Round("Discount Amount");
            RemFreightAmt := "Amount (Freight)" - Round("Amount (Freight)"); // P8000921
            "Amount (Freight)" := Round("Amount (Freight)");                 // P8000921
            "Amount (FOB)" := Amount - "Amount (Freight)";                   // P8000921
        end;
    end;

    local procedure CalcItemJnlAmountsFromQtyToBeShipped(var ItemJnlLine: Record "Item Journal Line"; SalesHeader: Record "Sales Header"; SalesLine: Record "Sales Line"; QtyToBeShipped: Decimal; QtyToBeShippedAlt: Decimal)
    var
    ...
    begin
        ...
        with ItemJnlLine do begin
            ...
            // P80066030
            if SalesLine.PriceInAlternateUnits then begin
                InvDiscAmountPerShippedQty := Abs(SalesLine."Inv. Discount Amount") * QtyToBeShippedAlt / SalesLine.GetPricingQty;
                Amount := QtyToBeShippedAlt * SalesLine."Unit Price";
            end;
            // P80066030
            if SalesHeader."Prices Including VAT" then
                Amount :=
    ...
    begin
        ...
        if not ItemJnlRollRndg then begin
            RemAmt := 0;
            RemDiscAmt := 0;
            RemFreightAmt := 0; // P8000921
        end;
    end;

    local procedure PostItemJnlLineCopyDocumentFields(var ItemJnlLine: Record "Item Journal Line"; SalesHeader: Record "Sales Header"; SalesLine: Record "Sales Line"; QtyToBeShipped: Decimal; QtyToBeInvoiced: Decimal; QtyToBeShippedAlt: Decimal; QtyToBeInvoicedAlt: Decimal)
    var
        QtyToBeShippedIsZero: Boolean;
    begin
        QtyToBeShippedIsZero := (QtyToBeShipped = 0) and (QtyToBeShippedAlt = 0); // P8000971
        ...
        with ItemJnlLine do
            if QtyToBeShippedIsZero then
                ...
                if (QtyToBeInvoiced <> 0) or (QtyToBeInvoicedAlt <> 0) then begin // P8000971
                    if "Document No." = '' then
    ...
    local procedure PostItemJnlLineBeforePost(var ItemJnlLine: Record "Item Journal Line"; SalesLine: Record "Sales Line"; var TempWhseJnlLine: Record "Warehouse Journal Line" temporary; var PostWhseJnlLine: Boolean; QtyToBeShippedBase: Decimal; PostAsItem: Boolean)
    var
    ...
    begin
        ...
        with ItemJnlLine do begin
            ...
            if (SalesLine."Location Code" <> '') and PostAsItem and (Quantity <> 0) then  // PR3.61
        ...
        with TempItemChargeAssgntSales do begin
            ...
            if "Document Type" in ["Document Type"::"Return Order", "Document Type"::"Credit Memo"] then
                ...
                if SalesLine.PriceInAlternateUnits then
                    QtyToInvoice :=
                      CalcQtyToInvoice(SalesLine."Return Qty. to Receive (Alt.)", SalesLine."Qty. to Invoice (Alt.)")
                else
                    // P8000971
                    QtyToInvoice :=
                ...
                if SalesLine.PriceInAlternateUnits then
                    QtyToInvoice :=
                      CalcQtyToInvoice(SalesLine."Qty. to Ship (Alt.)", SalesLine."Qty. to Invoice (Alt.)")
                else
                    // P8000971
                    QtyToInvoice :=
            ...
            if ItemJnlLine2."Invoiced Quantity" = 0 then begin
                ...
                ItemJnlLine2."Invoiced Qty. (Alt.)" := ItemJnlLine2."Quantity (Alt.)"; // P8000971
            end;
            ItemJnlLine2."Document Line No." := ItemChargeSalesLine."Line No.";

            ItemJnlLine2.Amount := "Amount to Assign" *                                                // P8000971
              ItemJnlLine2.GetCostingQty(ItemJnlLine2.FieldNo("Invoiced Qty. (Base)")) / QtyToInvoice; // P8000971
            if "Document Type" in ["Document Type"::"Return Order", "Document Type"::"Credit Memo"] then
                ItemJnlLine2.Amount := -ItemJnlLine2.Amount;
            ItemJnlLine2."Unit Cost (ACY)" :=
              Round(
                //ItemJnlLine2.Amount / ItemJnlLine2."Invoiced Qty. (Base)",                                    // P8000971
                ItemJnlLine2.Amount / ItemJnlLine2.GetCostingQty(ItemJnlLine2.FieldNo("Invoiced Qty. (Base)")), // P8000971
            ...
            ItemJnlLine2."Unit Cost" := Round(
              ...
              ItemJnlLine2.Amount / ItemJnlLine2.GetCostingQty(ItemJnlLine2.FieldNo("Invoiced Qty. (Base)")),
            ...
            if SalesHeader."Currency Code" <> '' then
                ItemJnlLine2."Discount Amount" := Round(
                    CurrExchRate.ExchangeAmtFCYToLCY(
                      ...
                      ItemJnlLine2.GetCostingQty(ItemJnlLine2.FieldNo("Invoiced Qty. (Base)")) / ItemChargeSalesLine."Quantity (Base)" * // P8000971
        ...
        with TempTrackingSpecificationInv do begin
            ...
            if not IsHandled then
                if IsEmpty() then
                    ...
                    OriginalQty := NonDistrItemJnlLine.GetCostingQty(NonDistrItemJnlLine.FieldNo("Quantity (Base)")); // P8000971
                    if (GetCostingQtyBase / OriginalQty) > 0 then // P8000971
                        SignFactor := 1
                    else
                        SignFactor := -1;
                    repeat
                        Factor := GetCostingQtyBase / OriginalQty * SignFactor; // P8000971
                        if Abs(GetCostingQtyBase) <                                                               // P8000971
                           Abs(NonDistrItemJnlLine.GetCostingQty(NonDistrItemJnlLine.FieldNo("Quantity (Base)"))) // P8000971
                        then begin                                                                                // P8000971
                            ItemJnlLine2."Quantity (Base)" := -"Quantity (Base)";
                            ItemJnlLine2."Invoiced Qty. (Base)" := ItemJnlLine2."Quantity (Base)";
                            // P8000971
                            ItemJnlLine2."Quantity (Alt.)" := -"Quantity (Alt.)";
                            ItemJnlLine2."Invoiced Qty. (Alt.)" := ItemJnlLine2."Quantity (Alt.)";
                            // P8000971
                            ...
                            ItemJnlLine2."Unit Cost" :=
                                Round(ItemJnlLine2.Amount / ItemJnlLine2.GetCostingQty(ItemJnlLine2.FieldNo("Invoiced Qty. (Base)")), // P8000971
                            ...
                            NonDistrItemJnlLine."Quantity (Alt.)" -= ItemJnlLine2."Quantity (Alt.)"; // P8000971
                            ...
                            // P8000971
                            NonDistrItemJnlLine."Quantity (Alt.)" := -"Quantity (Alt.)";
                            NonDistrItemJnlLine."Invoiced Qty. (Alt.)" := -"Quantity (Alt.)";
                            // P8000971
                            NonDistrItemJnlLine."Unit Cost" :=
                              Round(NonDistrItemJnlLine.Amount /                                                        // P8000971
                                NonDistrItemJnlLine.GetCostingQty(NonDistrItemJnlLine.FieldNo("Invoiced Qty. (Base)")), // P8000971
                                GLSetup."Unit-Amount Rounding Precision");
    ...
    begin
        ...
        if SalesShptLine."Item Shpt. Entry No." <> 0 then
            ...
            if not ItemTrackingMgt.CollectItemEntryRelation(TempItemLedgEntry,
                 ...
                 '', 0, SalesShptLine."Line No.", -SalesShptLine."Quantity (Base)", -SalesShptLine."Quantity (Alt.)") // P8000267B
            then
        ...
        if DistributeCharge then
            PostDistributeItemCharge(
              SalesHeader, SalesLine, TempItemLedgEntry, SalesShptLine.GetCostingQtyBase, // P8000971
            ...
            PostItemCharge(SalesHeader, SalesLine,
              ...
              SalesShptLine."Quantity (Alt.)", // PR3.60
    ...
    begin
        ...
        if ReturnRcptLine."Item Rcpt. Entry No." <> 0 then
            ...
            if not ItemTrackingMgt.CollectItemEntryRelation(TempItemLedgEntry,
                 ...
                 '', 0, ReturnRcptLine."Line No.", ReturnRcptLine."Quantity (Base)", ReturnRcptLine."Quantity (Alt.)") // P8000267B
            then
                Error(RelatedItemLedgEntriesNotFoundErr);
        end;
        ...
        if DistributeCharge then
            PostDistributeItemCharge(
              SalesHeader, SalesLine, TempItemLedgEntry, ReturnRcptLine.GetCostingQtyBase, // P8000971
              TempItemChargeAssgntSales."Qty. to Assign", TempItemChargeAssgntSales."Amount to Assign")
        else
            PostItemCharge(SalesHeader, SalesLine,
              ReturnRcptLine."Item Rcpt. Entry No.", ReturnRcptLine."Quantity (Base)",
              ReturnRcptLine."Quantity (Alt.)", // PR3.60
              TempItemChargeAssgntSales."Amount to Assign",
              TempItemChargeAssgntSales."Qty. to Assign")
    end;
    ...
    begin
        if TempItemLedgEntry.FindSet() then
            repeat
                //Factor := ABS(TempItemLedgEntry.Quantity / NonDistrQuantity);    // P8000971
                Factor := Abs(TempItemLedgEntry.GetCostingQty / NonDistrQuantity); // P8000971, P8006630
                ...
                if Factor < 1 then begin
                    PostItemCharge(SalesHeader, SalesLine,
                      ...
                      -TempItemLedgEntry."Quantity (Alt.)", // PR3.60, P80066030
                      AmountToAssign, QtyToAssign);
                    //NonDistrQuantity := NonDistrQuantity + TempItemLedgEntry.Quantity;    // P8000971
                    NonDistrQuantity := NonDistrQuantity + TempItemLedgEntry.GetCostingQty; // P8000971, P8006630
                    ...
                    PostItemCharge(SalesHeader, SalesLine,
                      TempItemLedgEntry."Entry No.", -TempItemLedgEntry.Quantity,
                      -TempItemLedgEntry."Quantity (Alt.)", // PR3.60, P8006630
    ...
    local procedure PostAssocItemJnlLine(SalesHeader: Record "Sales Header"; SalesLine: Record "Sales Line"; QtyToBeShipped: Decimal; QtyToBeShippedBase: Decimal; QtyToBeShippedAlt: Decimal): Integer
    var
        ItemJnlLine: Record "Item Journal Line";
        ...
        IsHandled: Boolean;
    begin
        // P8007748 - add parameter QtyToBeShippedAlt
        ...
        // PR3.60
        ItemJnlLine."Quantity (Alt.)" := QtyToBeShippedAlt;
        ItemJnlLine."Invoiced Qty. (Alt.)" := 0;
        if (QtyToBeShippedAlt <> 0) then
            ItemJnlLine."Alt. Qty. Transaction No." := SalesLine."Alt. Qty. Transaction No.";
        // PR3.60
        ...
        if (PurchOrderLine."Job No." = '') or IsHandled then begin
            ...
            // P8000403A
            if ProcessFns.FreshProInstalled then begin
                ExtraChargeMgmt.StartDropShipPosting(PurchOrderHeader, PurchOrderLine, SalesHeader, SalesLine);
            ...
            if Ship and ("Shipping No." = '') then
                ...
                then
                    if not PreviewMode then begin
                        ...
                        "Shipping No." := AssignPostingNo(SalesHeader, "Shipping No. Series", "Last Shipping No."); // P8007748
                                                                                                                    // PR3.60
                        ModifyHeader := true;
            ...
            if Invoice and ("Posting No." = '') then begin
                ...
                then begin
                    if not PreviewMode then begin
                        ...
                        "Posting No." := AssignPostingNo(SalesHeader, "Posting No. Series", "Last Posting No."); // P8007748
                                                                                                                 // PR3.60
                        ModifyHeader := true;
                    end;
                end;
            ...
            if Receive and ("Return Receipt No." = '') then
                ...
                then
                    if not PreviewMode then begin
                        ...
                        "Return Receipt No." := AssignPostingNo(SalesHeader, "Return Receipt No. Series", "Last Return Receipt No."); // P8007748
                                                                                                                                      // PR3.60
                        ModifyHeader := true;
    ...
    begin
        ...
        repeat
            ...
            if ProcessFns.AltQtyInstalled then begin
                AltQtyMgmt.TestDropShipAltQtys(
                  PurchOrderLine."Alt. Qty. Transaction No.", PurchOrderLine.TableCaption,
                  PurchOrderHeader."No.", SalesLine.TableCaption);
                PurchOrderLine."Qty. Received (Alt.)" :=
                  PurchOrderLine."Qty. Received (Alt.)" + TempDropShptPostBuffer."Quantity (Alt.)";  // P8000506A
            end;
            // PR3.60
    ...
    begin
        ...
        with SalesHeader do begin
            ...
            if PostingLocation <> '' then                              // P8000282A
                TempSalesLine.SetRange("Location Code", PostingLocation); // P8000282A, P8007748
                    ...
                    repeat
                        if PurchOrderHeader."No." <> TempSalesLine."Purchase Order No." then begin
                            ...
                            if PurchOrderHeader."Receiving No." = '' then begin
                                ...
                                AssignReceiptPostingNo(PurchOrderHeader);
                                // PR3.61.01
                                PurchOrderHeader.Modify();
                            end;
    ...
    begin
        ...
        with SalesLine do begin
            //IF NOT (SalesHeader.Ship OR RoundingLineInserted) THEN BEGIN       // P8000282A
            if (not (SalesHeader.Ship or RoundingLineInserted)) or               // P8000282A
              ((PostingLocation <> '') and ("Location Code" <> PostingLocation)) // P8000282A
            then begin                                                           // P8000282A
                "Qty. to Ship" := 0;
                "Qty. to Ship (Base)" := 0;
                "Qty. to Ship (Alt.)" := 0; // PR3.60
            end;
            //IF NOT (SalesHeader.Receive OR RoundingLineInserted) THEN BEGIN    // P8000282A
            if (not (SalesHeader.Receive or RoundingLineInserted)) or            // P8000282A
              ((PostingLocation <> '') and ("Location Code" <> PostingLocation)) // P8000282A
            then begin                                                           // P8000282A
                "Return Qty. to Receive" := 0;
                "Return Qty. to Receive (Base)" := 0;
                "Return Qty. to Receive (Alt.)" := 0; // PR3.60
            end;
            ...
            if (SalesHeader."Document Type" = SalesHeader."Document Type"::Invoice) and ("Shipment No." <> '') then begin
                ...
                "Qty. to Ship (Base)" := 0;
                // PR3.60
                "Qty. Shipped (Alt.)" := SalesLine."Quantity (Alt.)";
                "Qty. to Ship (Alt.)" := 0;
                // PR3.60
            end;
            ...
            if (SalesHeader."Document Type" = SalesHeader."Document Type"::"Credit Memo") and ("Return Receipt No." <> '') then begin
                ...
                "Return Qty. to Receive (Base)" := 0;
                // PR3.60
                "Return Qty. Received (Alt.)" := SalesLine."Quantity (Alt.)";
    ...
    begin
        ...
        with SalesHeader do begin
            ...
            // PR2.00 Begin
            ProdOrderXref.SetRange("Source Table ID", DATABASE::"Sales Line");
            ProdOrderXref.SetRange("Source Type", "Document Type");
            ProdOrderXref.SetRange("Source No.", "No.");
            ProdOrderXref.DeleteAll(true);
            // PR2.00 End
            if ProcessFns.PricingInstalled then                 // PR3.70
                AllowanceMgmt.DeleteOrderAllowances(SalesHeader); // PR3.70
            if ProcessFns.TrackingInstalled then              // P8000153A
                LotSpecFns.DeleteSalesDocLotPrefs(SalesHeader); // P8000153A
    ...
    begin
        ...
        with SalesHeader do begin
            if ProcessFns.ContainerTrackingInstalled then                                // P80046533
                ContainerFns.CloseContainerForPostedDocument(SalesHeader, PostingLocation, TempWhseShptHeader, TempWhseRcptHeader); // P80046533, P80097092
            ...
            then begin
                ...
                WhseSalesRelease.SetCalledFromPost; // P8000549A
                ...
                // P8000941
                if OnSalesPayment(SalesPaymentLine) then
                ...
                case "Document Type" of
                    "Document Type"::Invoice:
                        begin
                            InsertTrackingSpecification(SalesHeader);    // P80047943
            ...
            if not EverythingInvoiced then                  // P8007609
                WhseRqstUpdateCompletelyHandled(SalesHeader);   // P8007609
    ...
    begin
        ...
        if InvoiceDiscountPosting then begin
            ...
            if not IsHandled then begin
                ...
                if (InvoicePostBuffer.Amount <> 0) or (InvoicePostBuffer."Amount (ACY)" <> 0) then begin
                    ...
                    UpdateInvoicePostBuffer(InvoicePostBuffer, true, SalesLine); // P8007748
        ...
        // P8000921
        if (SalesSetup."Delivered Pricing Calc. Method" <> SalesSetup."Delivered Pricing Calc. Method"::None) then begin
            InvoicePostBuffer.SetAmounts(
              0, 0, SalesLine."Line Amount (Freight)", SalesLineACY."Line Amount (Freight)", 0, 0, 0); // P8007748
            if (InvoicePostBuffer.Amount <> 0) or
               (InvoicePostBuffer."Amount (ACY)" <> 0)
            then begin
                InvoicePostBuffer.SetAccount(
                  GenPostingSetup.GetSalesAccountFreight, TotalVAT, TotalVATACY, TotalAmount, TotalAmountACY); // P80053245
                InvoicePostBuffer.UpdateVATBase(TotalVATBase, TotalVATBaseACY); // P80066030
                ClearVATForSalesTax(InvoicePostBuffer);
                UpdateInvoicePostBuffer(InvoicePostBuffer, true, SalesLine); // P8001132, P8007748
            end;
        end;
        // P8000921
        ...
        UpdateInvoicePostBuffer(InvoicePostBuffer, false, SalesLine); // P8007748
    ...
    begin
        ...
        if (SalesLine.Type in [SalesLine.Type::"G/L Account", SalesLine.Type::"Fixed Asset", SalesLine.Type::FOODAccrualPlan]) then
            // P8002745
...
#if not CLEAN19
    [Obsolete('Moved to Sales Invoice Posting implementation.', '19.0')]
    local procedure UpdateInvoicePostBuffer(InvoicePostBuffer: Record "Invoice Post. Buffer"; ForceGLAccountType: Boolean; SalesLine: Record "Sales Line")
    var
        RestoreFAType: Boolean;
    begin
        // P8007748 - add parameter SalesLine
        ...
        // P8002745
        if (InvoicePostBuffer.Type = InvoicePostBuffer.Type::FOODAccrualPlan) then
            AccrualFldMgmt.SalesPostUpdatePostingBuffer(InvoicePostBuffer, SalesLine);
        // P8002745
    ...
    local procedure DivideAmount(SalesHeader: Record "Sales Header"; var SalesLine: Record "Sales Line"; QtyType: Option General,Invoicing,Shipping; SalesLineQty: Decimal; SalesLineQtyAlt: Decimal; var TempVATAmountLine: Record "VAT Amount Line" temporary; var TempVATAmountLineRemainder: Record "VAT Amount Line" temporary)
    begin
        DivideAmount(SalesHeader, SalesLine, QtyType, SalesLineQty, SalesLineQtyAlt, TempVATAmountLine, TempVATAmountLineRemainder, true);
    end;

    local procedure DivideAmount(SalesHeader: Record "Sales Header"; var SalesLine: Record "Sales Line"; QtyType: Option General,Invoicing,Shipping; SalesLineQty: Decimal; SalesLineQtyAlt: Decimal; var TempVATAmountLine: Record "VAT Amount Line" temporary; var TempVATAmountLineRemainder: Record "VAT Amount Line" temporary; IncludePrepayments: Boolean)
    var
        OriginalDeferralAmount: Decimal;
        UseAltQty: Boolean;
        OldSalesLineQty: Decimal;
        IsHandled: Boolean;
    begin
        ...
        // PR3.60
        UseAltQty := SalesLine.PriceInAlternateUnits();
        if UseAltQty then begin
            OldSalesLineQty := SalesLine.Quantity;
            SalesLine.Quantity := SalesLine."Quantity (Alt.)";
            SalesLineQty := SalesLineQtyAlt;
        end;
        // PR3.60
        ...
        with SalesLine do
            ...
            SalesTaxCalculate.HasExciseTax(SalesLine."Tax Area Code", SalesLine."Tax Group Code", SalesLine."Tax Liable", SalesLine.Quantity, SalesHeader."Document Date") then begin
                "Line Amount" := 0;
                "Line Amount (Freight)" := 0; // P8000921
                ...
                if "VAT Calculation Type" = "VAT Calculation Type"::"Sales Tax" then begin
                    ...
                    then begin
                        ...
                        "Line Amount (Freight)" := TempSalesLineForSalesTax."Line Amount (Freight)"; // P8001005
                        ...
                        "Line Amount (Freight)" :=                                                           // P8000921
                          ROUND(SalesLineQty * "Unit Price (Freight)", Currency."Amount Rounding Precision"); // P8000921
        ...
        // PR3.60
        if UseAltQty then
            SalesLine.Quantity := OldSalesLineQty;
        // PR3.60
    ...
    local procedure RoundAmount(SalesHeader: Record "Sales Header"; var SalesLine: Record "Sales Line"; SalesLineQty: Decimal; SalesLineQtyAlt: Decimal)
    var
        CurrExchRate: Record "Currency Exchange Rate";
        NoVAT: Boolean;
    begin
        ...
        with SalesLine do begin
            ...
            Increment(TotalSalesLine."Quantity (Alt.)", SalesLineQtyAlt); // PR3.60
            ...
            if SalesHeader."Currency Code" <> '' then begin
                ...
                "Line Amount (Freight)" :=
                  Round(
                    CurrExchRate.ExchangeAmtFCYToLCY(
                      SalesHeader.GetUseDate(), SalesHeader."Currency Code",
                      TotalSalesLine."Line Amount (Freight)", SalesHeader."Currency Factor")) -
                        TotalSalesLineLCY."Line Amount (Freight)";
                // P8000921
                "Line Discount Amount" :=
                  Round(
                    CurrExchRate.ExchangeAmtFCYToLCY(
            ...
            if CostInAlternateUnits() then    // P8000981
                Increment(TotalSalesLineLCY."Unit Cost (LCY)",
                          Round(SalesLineQtyAlt * "Unit Cost (LCY)") - Round(SalesLineQty * "Unit Cost (LCY)"));
            // PR3.60
        end;
    ...
    begin
        with SalesLine do begin
            ...
            // PR3.60
            "Qty. to Ship (Alt.)" := -"Qty. to Ship (Alt.)";
            "Return Qty. to Receive (Alt.)" := -"Return Qty. to Receive (Alt.)";
            "Qty. to Invoice (Alt.)" := -"Qty. to Invoice (Alt.)";
            // PR3.60
            "Line Amount" := -"Line Amount";
            "Line Amount (Freight)" := -"Line Amount (Freight)"; // P8000921
            Amount := -Amount;
    ...
    begin
        with SalesLine do begin
            ...
            Increment(TotalSalesLine."Line Amount (Freight)", "Line Amount (Freight)"); // P8000921
        ...
        with SalesHeader do begin
            ...
            if OldSalesLine.FindSet() then
                repeat
                    ...
                    case QtyType of
                        QtyType::General:
                            SalesLineQtyAlt := SalesLine."Quantity (Alt.)";
                        QtyType::Invoicing:
                            SalesLineQtyAlt := SalesLine."Qty. to Invoice (Alt.)";
                        QtyType::Shipping:
                            begin
                                if "Document Type" in ["Document Type"::"Return Order", "Document Type"::"Credit Memo"] then
                                    SalesLineQtyAlt := SalesLine."Return Qty. to Receive (Alt.)"
                                else
                                    SalesLineQtyAlt := SalesLine."Qty. to Ship (Alt.)";
                            end;
                    end;
                    // PR3.60
                    ...
                    if not IsHandled then
                        // DivideAmount(SalesHeader, SalesLine, QtyType, SalesLineQty, TempVATAmountLine, TempVATAmountLineRemainder, IncludePrepayments);               // PR3.60
                        DivideAmount(SalesHeader, SalesLine, QtyType, SalesLineQty, SalesLineQtyAlt, TempVATAmountLine, TempVATAmountLineRemainder, IncludePrepayments); // PR3.60
                    OnSumSalesLines2OnAfterDivideAmount(OldSalesLine, SalesLineQty, QtyType);
                    SalesLine.Quantity := SalesLineQty;
                    SalesLine."Quantity (Alt.)" := SalesLineQtyAlt; // PR3.60
                    if SalesLineQty <> 0 then begin
                        ...
                        // RoundAmount(SalesHeader,SalesLine,SalesLineQty);               // PR3.60
                        RoundAmount(SalesHeader, SalesLine, SalesLineQty, SalesLineQtyAlt); // PR3.60
    ...
    var
        ...
        IsHandled: Boolean;
    begin
        if (DeliveryTripNo <> '') then // P8000630A
            exit;                        // P8000630A
    ...
    begin
        ...
        if TempInvoicingSpecification.FindSet() then begin
            repeat
                ...
                TempInvoicingSpecification."Quantity Invoiced (Alt.)" += TempInvoicingSpecification."Qty. to Invoice (Alt.)"; // PR3.60
                ...
                if not TempTrackingSpecification.Insert() then begin
                    ...
                    TempTrackingSpecification."Quantity Invoiced (Alt.)" += TempInvoicingSpecification."Qty. to Invoice (Alt.)"; // P8001132   // P80050544
    ...
    begin
        ...
        if not TempTrackingSpecification.IsEmpty() then begin
            ...
            if ProcessFns.ContainerTrackingInstalled then begin
                UpdateDocumentLine.SetApplication(false, DATABASE::"Sales Line", SalesHeader."Document Type", SalesHeader."No.", 0); // Value of first parameter doesn't matter
    ...
    procedure PostItemCharge(SalesHeader: Record "Sales Header"; var SalesLine: Record "Sales Line"; ItemLedgEntryNo: Integer; QuantityBase: Decimal; QuantityAlt: Decimal; AmountToAssign: Decimal; QtyToAssign: Decimal)
    var
        DummyTrackingSpecification: Record "Tracking Specification";
    ...
    begin
        ...
        with TempItemChargeAssgntSales do begin
            ...
            if Item.CostInAlternateUnits then
                CostingQty := QuantityAlt
            else
                CostingQty := QuantityBase;
            // PR3.60 End

            if SalesLineToPost."Currency Code" <> '' then
                SalesLineToPost."Unit Cost" := Round(
                    SalesLineToPost.Amount / CostingQty, Currency."Unit-Amount Rounding Precision") // P8001213
            else
                SalesLineToPost."Unit Cost" := Round(
                    SalesLineToPost.Amount / CostingQty, GLSetup."Unit-Amount Rounding Precision"); // P8001213
            ...
            SalesLineToPost."Unit Cost (LCY)" := Round(
              SalesLineToPost.Amount / CostingQty, GLSetup."Unit-Amount Rounding Precision"); // PR3.60
            ...
            PostItemJnlLine(
              SalesHeader, SalesLineToPost, 0, 0, 0, -QuantityBase, -QuantityBase, -QuantityAlt, // PR3.60
              SalesLineToPost."Appl.-to Item Entry", "Item Charge No.", DummyTrackingSpecification, false, false); // P8007748  // P80048121
    ...
    begin
        ...
        with TempPrepmtDeductLCYSalesLine do begin
            ...
            if "Document Type" = "Document Type"::Order then begin                        // P8001366
                "Qty. to Invoice" := GetQtyToInvoice(SalesLine, SalesHeader.Ship);           // P8001366
                "Qty. to Invoice (Alt.)" := GetQtyToInvoiceAlt(SalesLine, SalesHeader.Ship); // P8001366
            end else                                                                      // P8001366
                ...
                if FindSet(true) then begin
                    ...
                    repeat
                        ...
                        if "Document Type" = "Document Type"::Invoice then begin
                            ...
                            SalesLine."Qty. to Invoice (Alt.)" := SalesInvoiceLine."Qty. to Invoice (Alt.)"; // P8001366
    ...
    begin
        with SalesLine do begin
            ...
            "Qty. to Invoice (Alt.)" := GetQtyToInvoiceAlt(SalesLine, Ship); // P8001366
            CalcPrepaymentToDeduct;
    ...
    begin
        with SalesLine do begin
            ...
            // P8001366
            "Quantity (Alt.)" := SalesOrderLine."Quantity (Alt.)";
            "Qty. Shipped (Alt.)" := SalesOrderLine."Qty. Shipped (Alt.)";
            "Qty. Invoiced (Alt.)" := SalesOrderLine."Qty. Invoiced (Alt.)";
            // P8001366
                ...
                repeat
                    if IsFinalInvoice then begin
                        ...
                        if "Document Type" = "Document Type"::Order then
                            DiffToLineDiscAmt := DiffToLineDiscAmt * GetPricingQuantity(FieldNo(Quantity), '') / GetPricingQuantity(FieldNo("Qty. to Invoice"), ''); // P8001366
    ...
    begin
        ...
        with TempSalesLineForSalesTax do begin
            ...
            if ("Document Type" = "Document Type"::Invoice) and ("Shipment No." <> '') then begin
                "Quantity Shipped" := Quantity;
                "Qty. Shipped (Base)" := "Quantity (Base)";
                "Qty. Shipped (Alt.)" := "Quantity (Alt.)"; // P8000886
                "Qty. to Ship" := 0;
                "Qty. to Ship (Base)" := 0;
                "Qty. to Ship (Alt.)" := 0; // P8000886
            end;
            if ("Document Type" = "Document Type"::"Credit Memo") and ("Return Receipt No." <> '') then begin
                "Return Qty. Received" := Quantity;
                "Return Qty. Received (Base)" := "Quantity (Base)";
                "Return Qty. Received (Alt.)" := "Quantity (Alt.)"; // P8000886
                "Return Qty. to Receive" := 0;
                "Return Qty. to Receive (Base)" := 0;
                "Return Qty. to Receive (Alt.)" := 0; // P8000886
            end;
            if "Document Type" in ["Document Type"::"Return Order", "Document Type"::"Credit Memo"] then begin
                MaxInvQty := ("Return Qty. Received" - "Quantity Invoiced");
                MaxInvQtyBase := ("Return Qty. Received (Base)" - "Qty. Invoiced (Base)");
                MaxInvQtyAlt := ("Return Qty. Received (Alt.)" - "Qty. Invoiced (Alt.)"); // P8000886
            ...
            "Quantity (Alt.)" := "Qty. to Invoice (Alt.)"; // P8000886
            if CostInAlternateUnits then begin // P8001005
                "Line Amount" := Round("Qty. to Invoice" * "Unit Price", Currency."Amount Rounding Precision");
                "Line Amount (Freight)" :=                                                                       // P8001005
                  Round("Qty. to Invoice (Alt.)" * "Unit Price (Freight)", Currency."Amount Rounding Precision"); // P8001005
            end else begin // P8001005
                           // P8000886
                "Line Amount" := Round("Qty. to Invoice" * "Unit Price", Currency."Amount Rounding Precision");
                "Line Amount (Freight)" :=                                                                // P8001005
                  Round("Qty. to Invoice" * "Unit Price (Freight)", Currency."Amount Rounding Precision"); // P8001005
            end; // P8001005
    ...
    begin
        ...
        DocAccrualLine.LockTable(); // P8000119A
        SalesLine.LockTable();
    ...
    local procedure UpdateQtyToBeInvoicedForShipment(var QtyToBeInvoiced: Decimal; var QtyToBeInvoicedBase: Decimal; var QtyToBeInvoicedAlt: Decimal; TrackingSpecificationExists: Boolean; HasATOShippedNotInvoiced: Boolean; SalesLine: Record "Sales Line"; SalesShptLine: Record "Sales Shipment Line"; InvoicingTrackingSpecification: Record "Tracking Specification"; ItemLedgEntryNotInvoiced: Record "Item Ledger Entry")
    begin
        ...
        if TrackingSpecificationExists then begin
            ...
            QtyToBeInvoicedAlt := InvoicingTrackingSpecification."Qty. to Invoice (Alt.)"; // PR3.60
        end else
            if HasATOShippedNotInvoiced then begin
                ...
                QtyToBeInvoicedBase := RemQtyToBeInvoicedBase - SalesLine."Qty. to Ship (Base)";
                QtyToBeInvoicedAlt := RemQtyToBeInvoicedAlt - SalesLine."Qty. to Ship (Alt.)"; // PR3.60
            end;
        ...
        if Abs(QtyToBeInvoiced) > Abs(SalesShptLine.Quantity - SalesShptLine."Quantity Invoiced") then begin
            ...
            QtyToBeInvoicedAlt := -(SalesShptLine."Quantity (Alt.)" - SalesShptLine."Qty. Invoiced (Alt.)"); // PR3.60
        end;
    end;

    local procedure UpdateQtyToBeInvoicedForReturnReceipt(var QtyToBeInvoiced: Decimal; var QtyToBeInvoicedBase: Decimal; var QtyToBeInvoicedAlt: Decimal; TrackingSpecificationExists: Boolean; SalesLine: Record "Sales Line"; ReturnReceiptLine: Record "Return Receipt Line"; InvoicingTrackingSpecification: Record "Tracking Specification")
    begin
        ...
        if TrackingSpecificationExists then begin
            QtyToBeInvoiced := InvoicingTrackingSpecification."Qty. to Invoice";
            QtyToBeInvoicedBase := InvoicingTrackingSpecification."Qty. to Invoice (Base)";
            QtyToBeInvoicedAlt := TempTrackingSpecification."Qty. to Invoice (Alt.)"; // PR3.60   // P80050544
        end else begin
            ...
            QtyToBeInvoicedAlt := RemQtyToBeInvoicedAlt - SalesLine."Return Qty. to Receive (Alt.)"; // PR3.60  // P80050544
        end;
        ...
        then begin
            ...
            QtyToBeInvoicedAlt := ReturnReceiptLine."Quantity (Alt.)" - ReturnReceiptLine."Qty. Invoiced (Alt.)"; // PR3.60  // P80050544
        end;
    end;
            ...
            if SalesLine."Document Type" = SalesLine."Document Type"::Order then begin
                ...
                if Abs(RemQtyToBeInvoiced) >= Abs("Assembled Quantity") then begin
                    ItemLedgShptEntryNo :=
                      PostItemJnlLine(
                        SalesHeader, SalesLine,
                        "Assembled Quantity", "Assembled Quantity (Base)", 0, // P8001132
                        "Assembled Quantity", "Assembled Quantity (Base)", 0, // P8001132
                        0, '', DummyTrackingSpecification, true, true); // P8007748
    ...
    begin
        with SalesHeader do begin
            ...
            SalesShptHeader."Delivery Trip No." := DeliveryTripNo; // P8000549A
            ...
            if WhseShip then begin
                ...
                if ProcessFns.ContainerTrackingInstalled then
                    if ContainerFns.UpdateContainerQtyToShip(WhseShptHeader, DATABASE::"Sales Line", SalesHeader."Document Type", SalesHeader."No.") then // P8007748
                        RefreshTempLines(SalesHeader, TempSalesLineGlobal); // P8007748, P80066030
                                                                            // P8001323
                if WhseReceive then begin
                    ...
                    // P8001323
                    if ProcessFns.ContainerTrackingInstalled then
                        if ContainerFns.UpdateContainerQtyToReceive(WhseRcptHeader, DATABASE::"Sales Line", SalesHeader."Document Type", SalesHeader."No.") then // P8007748
                            RefreshTempLines(SalesHeader, TempSalesLineGlobal); // P8007748, P80066030
                                                                                // P8001323
                end;
            end;
    ...
    begin
        ...
        with SalesHeader do begin
            ...
            if WhseReceive then begin
                ...
                // P8001323
                if ProcessFns.ContainerTrackingInstalled then
                    if ContainerFns.UpdateContainerQtyToReceive(WhseRcptHeader, DATABASE::"Sales Line", SalesHeader."Document Type", SalesHeader."No.") then // P80046533
                        RefreshTempLines(SalesHeader, TempSalesLineGlobal); // P80046533, P8006630
                                                                            // P8001323
            end;
            if WhseShip then begin
                WhseShptHeader.Get(TempWhseShptHeader."No.");
                ...
                // P8001323
                if ProcessFns.ContainerTrackingInstalled then
                    if ContainerFns.UpdateContainerQtyToShip(WhseShptHeader, DATABASE::"Sales Line", SalesHeader."Document Type", SalesHeader."No.") then // P80046533
                        RefreshTempLines(SalesHeader, TempSalesLineGlobal); // P80046533, P8006630
                                                                            // P8001323
            end;
        end;
    ...
    begin
        with PurchRcptHeader do begin
            ...
            if ProcessFns.FreshProInstalled then
                ExtraChargeMgmt.MoveToDocumentHeader(DATABASE::"Purchase Header", // P8001032
                  PurchaseHeader."Document Type", PurchaseHeader."No.",                  // P8000928
                  PurchaseHeader."Posting Date", DATABASE::"Purch. Rcpt. Header", "No."); // P8000928
    ...
    begin
        with PurchRcptLine do begin
            ...
            "Qty. Invoiced (Base)" := 0;
            // PR3.60
            "Quantity (Alt.)" := DropShptPostBuffer."Quantity (Alt.)"; // P8000506A
            "Qty. Invoiced (Alt.)" := 0;
            // PR3.60
            ...
            if ProcessFns.AltQtyInstalled then                     // PR3.60
                AltQtyMgmt.DropShipRcptToReceiptLine(PurchRcptLine); // PR3.60
    ...
    local procedure InsertShipmentLine(SalesHeader: Record "Sales Header"; SalesShptHeader: Record "Sales Shipment Header"; SalesLine: Record "Sales Line"; CostBaseAmount: Decimal; var TempServiceItem2: Record "Service Item" temporary; var TempServiceItemComp2: Record "Service Item Component" temporary; PostAsItem: Boolean)
    var
        SalesShptLine: Record "Sales Shipment Line";
        TempServiceItem1: Record "Service Item" temporary;
        TempServiceItemComp1: Record "Service Item Component" temporary;
    begin
        // P8007748 - add parameter PostAsItem
        ...
        if PostAsItem and (xSalesLine."Qty. to Ship" <> 0) then begin // PR3.61
            if WhseShip and (SalesLine.Type = SalesLine.Type::Item) then begin // P8001323
            ...
            // PR3.60
            //IF SalesLine.PriceInAlternateUnits() THEN // P8000981
            if SalesLine.CostInAlternateUnits() then    // P8000981
                SalesShptLine."Item Charge Base Amount" :=
                  Round(CostBaseAmount / SalesLine."Quantity (Alt.)" * SalesShptLine."Quantity (Alt.)");
            // PR3.60
        end;
        SalesShptLineInsert(SalesShptLine, SalesShptHeader, SalesLine, SalesHeader);
        // P8000885
        if ProcessFns.PricingInstalled and (SalesHeader."Document Type" = SalesHeader."Document Type"::Order) then
            SalesContMgmt.InsertSalesContractHist(SalesShptLine."Document No.", SalesLine, SalesHeader); // P8001076
        // P8000885
        if xSalesLine."Alt. Qty. Transaction No." <> 0 then              // PR3.60
            AltQtyMgmt.SalesLineToShipmentLine(xSalesLine, SalesShptLine); // PR3.60
    ...
    local procedure InsertReturnReceiptLine(SalesHeader: Record "Sales Header"; ReturnRcptHeader: Record "Return Receipt Header"; SalesLine: Record "Sales Line"; CostBaseAmount: Decimal; PostAsItem: Boolean)
    var
        ReturnRcptLine: Record "Return Receipt Line";
    begin
        // P8007748 - add parameters SalesHeader, PostAsItem
        ...
        InsertReturnReceiptLineWhsePost(SalesLine, ReturnRcptHeader, ReturnRcptLine, CostBaseAmount, PostAsItem);
        ...
        // P8000885
        if ProcessFns.PricingInstalled then
            SalesContMgmt.InsertSalesContractHist(ReturnRcptLine."Document No.", SalesLine, SalesHeader); // P8001076
        // P8000885
        if xSalesLine."Alt. Qty. Transaction No." <> 0 then                 // PR3.60
            AltQtyMgmt.SalesLineToReturnRcptLine(xSalesLine, ReturnRcptLine); // PR3.60
    end;

    local procedure InsertReturnReceiptLineWhsePost(var SalesLine: Record "Sales Line"; ReturnRcptHeader: Record "Return Receipt Header"; var ReturnRcptLine: Record "Return Receipt Line"; CostBaseAmount: Decimal; PostAsItem: Boolean)
    var
        WhseShptLine: Record "Warehouse Shipment Line";
        WhseRcptLine: Record "Warehouse Receipt Line";
    ...
    begin
        ...
        if PostAsItem and (SalesLine.Type = SalesLine.Type::Item) and (SalesLine."Return Qty. to Receive" <> 0) then begin
            ...
            if SalesLine.CostInAlternateUnits() then    // P8000981
                ReturnRcptLine."Item Charge Base Amount" :=
                  Round(CostBaseAmount / SalesLine."Quantity (Alt.)" * ReturnRcptLine."Quantity (Alt.)");
            // PR3.60
        end;
    ...
    begin
        with TempSalesLine do begin
            ResetTempLines(TempSalesLine);
            if PostingLocation <> '' then                // P8000282A
                SetRange("Location Code", PostingLocation); // P8000282A
            SetFilter(Quantity, '<>0');
            if SalesHeader."Document Type" = SalesHeader."Document Type"::Order then
    ...
    local procedure UpdateInvoicedQtyOnShipmentLine(var SalesShptLine: Record "Sales Shipment Line"; QtyToBeInvoiced: Decimal; QtyToBeInvoicedBase: Decimal; QtyToBeInvoicedAlt: Decimal)
    begin
        ...
        with SalesShptLine do begin
            ...
            "Qty. Invoiced (Alt.)" := "Qty. Invoiced (Alt.)" - QtyToBeInvoicedAlt; // P8001386
                ...
                repeat
                    ...
                    repeat
                        PurchOrderLine.Get(
                          PurchOrderLine."Document Type"::Order,
                          TempDropShptPostBuffer."Order No.", TempDropShptPostBuffer."Order Line No.");
                        InsertPurchRcptLine(PurchRcptHeader, PurchOrderLine, PurchRcptLine, TempDropShptPostBuffer); // P80073095
                        ...
                        // P8000403A
                        if ProcessFns.FreshProInstalled then
                            ExtraChargeMgmt.DropShipMoveToDocumentLine(
                              PurchRcptLine."Document No.", PurchRcptLine."Line No.", PurchOrderLine."Sales Order Line No.");
                    // P8000403A
                    until TempDropShptPostBuffer.Next() = 0;
                    // P8000403A
                    if ProcessFns.FreshProInstalled then begin
    ...
    begin
        with GenJnlLine do begin
            ...
            // P8002745
            if (InvoicePostBuffer.Type = InvoicePostBuffer.Type::FOODAccrualPlan) then
                AccrualFldMgmt.SalesPostPrepareGenJnlLine(
                  SalesHeader, InvoicePostBuffer."Accrual Line No.", GenJnlLine);
            // P8002745
    ...
    local procedure PostItemTracking(SalesHeader: Record "Sales Header"; SalesLine: Record "Sales Line"; TrackingSpecificationExists: Boolean; var TempTrackingSpecification: Record "Tracking Specification" temporary; var TempItemLedgEntryNotInvoiced: Record "Item Ledger Entry" temporary; HasATOShippedNotInvoiced: Boolean; PostAsItem: Boolean)
    var
            ...
            if SalesLine.IsCreditDocType then begin
                ...
                then
                    PostItemTrackingForReceipt(
                      SalesHeader, SalesLine, TrackingSpecificationExists, TempTrackingSpecification, PostAsItem); // P8006630
                ...
                then
                    PostItemTrackingForShipment(
                      SalesHeader, SalesLine, TrackingSpecificationExists, TempTrackingSpecification,
                      TempItemLedgEntryNotInvoiced, HasATOShippedNotInvoiced, PostAsItem); // P80066030
    ...
    local procedure PostItemTrackingForReceipt(SalesHeader: Record "Sales Header"; SalesLine: Record "Sales Line"; TrackingSpecificationExists: Boolean; var TempTrackingSpecification: Record "Tracking Specification" temporary; PostAsItem: Boolean)
    var
        ItemEntryRelation: Record "Item Entry Relation";
        ReturnRcptLine: Record "Return Receipt Line";
        SalesShptLine: Record "Sales Shipment Line";
            ...
            if ReturnRcptLine.FindSet() then begin
                ...
                repeat
                    ...
                    UpdateQtyToBeInvoicedForReturnReceipt(
                      QtyToBeInvoiced, QtyToBeInvoicedBase, QtyToBeInvoicedAlt,      // P80050544
                    ...
                    RemQtyToBeInvoicedAlt := RemQtyToBeInvoicedAlt - QtyToBeInvoicedAlt; // PR3.60
                    ...
                    ReturnRcptLine."Qty. Invoiced (Alt.)" :=                      // PR3.60
                      ReturnRcptLine."Qty. Invoiced (Alt.)" + QtyToBeInvoicedAlt; // PR3.60
                    ...
                    if PostAsItem or PostItemTrackingForReceiptCondition(SalesLine, ReturnRcptLine) then // P80073095
                        PostItemJnlLine(
                          SalesHeader, SalesLine, 0, 0, 0, QtyToBeInvoiced, QtyToBeInvoicedBase, QtyToBeInvoicedAlt, // PR3.60
                          ItemEntryRelation."Item Entry No.", '', TempTrackingSpecification, false, PostAsItem); // P8007748
                    if SalesLine."Alt. Qty. Transaction No." <> 0 then          // PR3.60
                        AltQtyMgmt.UpdateReturnRcptAltQtyEntries(ReturnRcptLine); // PR3.60
        ...
        with SalesHeader do begin
            ...
            if SalesShptLine.FindFirst() then begin
                ...
                repeat
                    ...
                    if ProcessFns.PricingInstalled then // P8000558A
                        ItemSalesPriceMgmt.CheckPriceAtInvoice(SalesLine, SalesShptLine); // PR3.60
                    if ProcessFns.DistPlanningInstalled then // PR3.61.01
                        DeliveryRouteMgmt.CheckRouteAtInvoice(SalesLine, SalesShptLine); // PR3.60

                    UpdateQtyToBeInvoicedForShipment(
                      QtyToBeInvoiced, QtyToBeInvoicedBase,
                      QtyToBeInvoicedAlt, // P8001132
                      TrackingSpecificationExists, HasATOShippedNotInvoiced,
                    ...
                    UpdateInvoicedQtyOnShipmentLine(SalesShptLine, QtyToBeInvoiced, QtyToBeInvoicedBase, QtyToBeInvoicedAlt); // P8001386
                    ...
                    if PostAsItem or PostItemTrackingForShipmentCondition(SalesLine, SalesShptLine) then // P80073095
                        PostItemJnlLine(
                          SalesHeader, SalesLine, 0, 0, 0, QtyToBeInvoiced, QtyToBeInvoicedBase, QtyToBeInvoicedAlt, // PR3.60
                          ItemEntryRelation."Item Entry No.", '', TempTrackingSpecification, false, PostAsItem); // P8007748
                    if SalesLine."Alt. Qty. Transaction No." <> 0 then       // PR3.60
                        AltQtyMgmt.UpdateShipmentAltQtyEntries(SalesShptLine); // PR3.60
            ...
            if FindSet() then
                repeat
                    ...
                    if SalesHeader.Ship then begin
                        ...
                        "Qty. Shipped (Alt.)" += "Qty. to Ship (Alt.)"; // PR3.60
                    end;
                    if SalesHeader.Receive then begin
                        "Return Qty. Received" += "Return Qty. to Receive";
                        "Return Qty. Received (Base)" += "Return Qty. to Receive (Base)";
                        "Return Qty. Received (Alt.)" += "Return Qty. to Receive (Alt.)"; // PR3.60
                    end;
                    if SalesHeader.Invoice then begin
                        IsHandled := false;
                        ...
                        if not IsHandled then begin
                            if "Document Type" = "Document Type"::Order then begin
                                if Abs("Quantity Invoiced" + "Qty. to Invoice") > Abs("Quantity Shipped") then begin
                                    ...
                                    "Qty. to Invoice (Alt.)" := "Qty. Shipped (Alt.)" - "Qty. Invoiced (Alt.)"; // PR3.60
                                end
                            end else
                                if Abs("Quantity Invoiced" + "Qty. to Invoice") > Abs("Return Qty. Received") then begin
                                    ...
                                    "Qty. to Invoice (Alt.)" := "Return Qty. Received (Alt.)" - "Qty. Invoiced (Alt.)"; // PR3.60
                                end;

                            "Quantity Invoiced" += "Qty. to Invoice";
                            "Qty. Invoiced (Base)" += "Qty. to Invoice (Base)";
                            "Qty. Invoiced (Alt.)" += "Qty. to Invoice (Alt.)"; // P8001010
                    ...
                    if WhseHandlingRequiredExternal(TempSalesLine) or (Type = Type::FOODContainer) or SetDefaultQtyBlank then begin
                        if "Document Type" = "Document Type"::"Return Order" then begin
                            "Return Qty. to Receive" := 0;
                            "Return Qty. to Receive (Base)" := 0;
                            "Return Qty. to Receive (Alt.)" := 0; // P8000282A
                        end else begin
                            "Qty. to Ship" := 0;
                            "Qty. to Ship (Base)" := 0;
                            "Qty. to Ship (Alt.)" := 0; // P8000282A
                        end;
                    ...
                    SetDefaultQuantity;
                    UpdateLotTracking(true, 0); // P8000610A, P80077569
                    IsHandled := false;
        ...
        with TempSalesLine do begin
            ...
            if FindSet() then
                repeat
                    ...
                    SalesOrderLine."Qty. Invoiced (Alt.)" += "Qty. to Invoice (Alt.)"; // PR3.60
    ...
    begin
        ...
        if PostingDateExists and (ReplacePostingDate or (SalesHeader."Posting Date" = 0D)) then begin
            ...
            SalesHeader.UpdateSalesLines(SalesHeader.FieldCaption("Posting Date"), false); // P8001006, P80041198
            ModifyHeader := true;
        end;
    ...
    local procedure AssignPostingNo(var SalesHeader: Record "Sales Header"; PostingNoSeries: Code[10]; LastPostingNo: Code[20]): Code[20]
    var
        NoSeriesMgt: Codeunit NoSeriesManagement;
    begin
        // PR3.60
        // P8007748 - add parameter SalesHeader
        with SalesHeader do begin
            if (PostingNoSeries <> "No. Series") then
                exit(NoSeriesMgt.GetNextNo(PostingNoSeries, "Posting Date", true));
            if (LastPostingNo = '') then
                exit("No.");
            if (LastPostingNo = "No.") then
                exit(LastPostingNo + Text37002000);
            exit(IncStr(LastPostingNo));
        end;
        // PR3.60
    end;

    local procedure AssignReceiptPostingNo(var PurchHeader: Record "Purchase Header"): Code[20]
    var
        NoSeriesMgt: Codeunit NoSeriesManagement;
    begin
        // PR3.61.01
        with PurchHeader do
            if ("Receiving No. Series" <> "No. Series") then
                "Receiving No." := NoSeriesMgt.GetNextNo("Receiving No. Series", "Posting Date", true)
            else
                if ("Last Receiving No." = '') then
                    "Receiving No." := "No."
                else
                    if ("Last Receiving No." = "No.") then
                        "Receiving No." := "Last Receiving No." + Text37002000
                    else
                        "Receiving No." := IncStr("Last Receiving No.");
        // PR3.61.01
    end;

    procedure PostCMWriteoff(var SalesLine: Record "Sales Line"; SalesCrMemoLine: Record "Sales Cr.Memo Line")
    var
        ...
        TempWhseJnlLine2: Record "Warehouse Journal Line" temporary;
        TempHandlingSpecification: Record "Tracking Specification" temporary;
        DummyValueEntryRelation: Record "Value Entry Relation" temporary;
        Process800CoreFns: Codeunit "Process 800 Core Functions";
        EntryNo: Integer;
    begin
        // PR3.61.01
        // P8004516 - add parameter for SalesCrMemoLine
        // P8007748 - add parameter SalesLine
        if SalesLine."Writeoff Responsibility" = 0 then
            exit;

        TempValueEntryRelation.SetRange("Source RowId", SalesCrMemoLine.RowID1);
        if not TempValueEntryRelation.Find('-') then     // P8000956
            TempValueEntryRelation."Value Entry No." := 0; // P8000956
        repeat
            if TempValueEntryRelation."Value Entry No." <> 0 then begin // P8000956
                ValueEntry.Get(TempValueEntryRelation."Value Entry No.");
                // P8000956
                EntryNo := ValueEntry."Item Ledger Entry No.";
            end else
                EntryNo := ItemLedgShptEntryNo;
            // P8000956
            Process800CoreFns.CreateCMWriteoff(SalesCrMemoHeader, SalesCrMemoLine,
              EntryNo, SrcCode, SalesLine."Writeoff Responsibility", ItemJnlLine); // P8000303A, P8000956
            if SalesLine."Bin Code" <> '' then
                ItemJnlLine.Validate("Bin Code", SalesLine."Bin Code");
            ItemJnlPostLine.RunWithCheck(ItemJnlLine); // P8001133
            XferWhseRoundingAdjmts(SalesLine."Bin Code" <> ''); // P8001039
                                                                // P8000956
        ...
        //END ELSE BEGIN
        //  Process800CoreFns.CreateCMWriteoff(SalesCrMemoHeader,SalesCrMemoLine,
        //    ItemLedgShptEntryNo,SrcCode,SalesLine."Writeoff Responsibility",ItemJnlLine); // P8000303A
        //  ItemJnlPostLine.RunWithCheck(ItemJnlLine,TempJnlLineDim);
        //END;
        // P8000956
        ItemJnlPostLine.CollectValueEntryRelation(DummyValueEntryRelation, SalesCrMemoLine.RowID1);
        // PR3.61.01
    end;

    procedure PostRepack(var SalesHeader: Record "Sales Header"; var SalesLine: Record "Sales Line")
    var
        ...
        TempWhseJnlLine: Record "Warehouse Journal Line" temporary;
        TempWhseJnlLine2: Record "Warehouse Journal Line" temporary;
        TermMktSelling: Codeunit "Terminal Market Selling";
        i: Integer;
    begin
        // PR3.70.01 Begin
        // P8007748 - add parameter SalesHeader
        ...
        if SalesLine."Qty. to Ship" = 0 then
            exit;
        if (PostingLocation <> '') and (PostingLocation <> SalesLine."Location Code") then // P8000282A
            exit;                                                                            // P8000282A
        if not SalesRepack.Get(SalesLine."Document Type", SalesLine."Document No.", SalesLine."Line No.") then
            exit;

        GetLocation(SalesLine."Location Code"); // P8001039
        TermMktSelling.StartRepack(SalesHeader."Document Type", SalesHeader."No.");

        for i := 0 to 1 do begin
            TermMktSelling.CreateRepackItemJnlLine(i, SalesLine, SalesRepack, ItemJnlLine);
            ItemJnlLine.Validate("Document No.", SalesHeader."Shipping No.");
            ItemJnlLine.Validate("Source Code", SrcCode);
            ItemJnlLine."Order Type" := ItemJnlLine."Order Type"::FOODSalesRepack; // P8001134
            ItemJnlLine."Order No." := SalesHeader."Shipping No.";                // P8001134
            ItemJnlLine."Order Line No." := SalesLine."Line No."; // P8001195
            ItemJnlPostLine.RunWithCheck(ItemJnlLine); // P8001133
                                                       // P8001039
            if Location."Bin Mandatory" then begin
                CreateWhseJnlLine(ItemJnlLine, SalesLine, TempWhseJnlLine);
                ItemJnlPostLine.CollectTrackingSpecification(TempHandlingSpecification);
                XferWhseRoundingAdjmts(true);
                XferRegsToWhse;
                ItemTrackingMgt.SplitWhseJnlLine(TempWhseJnlLine, TempWhseJnlLine2, TempHandlingSpecification, false);
                if TempWhseJnlLine2.FindSet then
                    repeat
            ...
            // P8001039
            if i = 1 then
                SalesLine."Appl.-to Item Entry" := ItemJnlLine."Item Shpt. Entry No.";
        end;
        SalesRepack.Delete;
        TermMktSelling.FinishRepack(ItemJnlLine);
        // PR3.70.01 End
    end;

    local procedure PostAccrualsToGL(SalesHeader: Record "Sales Header")
    var
        GenJnlLine: Record "Gen. Journal Line";
        FirstLine: Boolean;
    begin
        ...
        // P8007748 - add parameter SalesHeader
        FirstLine := true;
        while PostAccrualBatch.GetNextGenJnlLine(FirstLine, false, GenJnlLine) do begin // P8001133
            FirstLine := false;
            GenJnlLine.Description := SalesHeader."Posting Description";
    ...
    procedure SetPostingLocation(LocCode: Code[10])
    begin
        // P8000282A
        PostingLocation := LocCode;
    end;
    ...
    local procedure PostSalesContainerLine(var ItemJnlLine: Record "Item Journal Line"; var SalesLine: Record "Sales Line")
    var
        TempWhseJnlLine: Record "Warehouse Journal Line" temporary;
        TempWhseJnlLine2: Record "Warehouse Journal Line" temporary;
        PostWhseJnlLine: Boolean;
    begin
        // P8000631A
        // P8001133 - removed parameter for TempJnlLineDim
        with SalesLine do begin
            ...
            if ItemJnlPostLine.CollectTrackingSpecification(TempHandlingSpecification) then
                if TempHandlingSpecification.FindSet then
                    repeat
                        ...
                        if TempTrackingSpecification.Insert then;
                    until TempHandlingSpecification.Next = 0;
            XferWhseRoundingAdjmts(PostWhseJnlLine); // P8001039
            if PostWhseJnlLine then begin
                XferRegsToWhse; // P8000888
    ...
    local procedure GetQtyToInvoiceAlt(SalesLine: Record "Sales Line"; Ship: Boolean): Decimal
    begin
        // P8001366
        // P8007748 - add parameter Ship
        with SalesLine do begin
            "Qty. Shipped Not Invoiced" := "Qty. Shipped (Alt.)" - "Qty. Invoiced (Alt.)";
            "Qty. to Ship" := "Qty. to Ship (Alt.)";
            "Qty. to Invoice" := "Qty. to Invoice (Alt.)";
            exit(GetQtyToInvoice(SalesLine, Ship)); // P8007748
        end;
    end;

    procedure SetSettlement()
    begin
        SettlementPosting := true; //N138F0000.n
    end;

    local procedure WhseRqstUpdateCompletelyHandled(var SalesHeader: Record "Sales Header")
    var
        ReleaseSalesDocument: Codeunit "Release Sales Document";
        WarehouseRequest: Record "Warehouse Request";
    begin
        // P8007609
        // Only to handle completely Handled of Warehouse Request.
        ...
        ReleaseSalesDocument.SetSkipCheckReleaseRestrictions; // P80097194
        ReleaseSalesDocument.Run(SalesHeader);
    end;

    local procedure DeleteDocAccrualLine(SalesHeader: Record "Sales Header")
    begin
        // P8007748
        DocAccrualLine.Reset;
        DocAccrualLine.SetRange("Accrual Plan Type", DocAccrualLine."Accrual Plan Type"::Sales);
        DocAccrualLine.SetRange("Document Type", SalesHeader."Document Type");
        DocAccrualLine.SetRange("Document No.", SalesHeader."No.");
        DocAccrualLine.DeleteAll;
    end;
