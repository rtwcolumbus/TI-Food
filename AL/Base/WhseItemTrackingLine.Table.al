table 6550 "Whse. Item Tracking Line"
{
    ...
    fields
    {
        ...
        field(90; "Source Type Filter"; Option)
        {
            ...
            OptionCaption = ' ,Receipt,Shipment,Internal Put-away,Internal Pick,Production,Movement Worksheet,Assembly,,Staged Pick';
            OptionMembers = " ",Receipt,Shipment,"Internal Put-away","Internal Pick",Production,"Movement Worksheet",Assembly,,"Staged Pick";
        }
