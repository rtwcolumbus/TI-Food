...
{
    // PR3.70.01
    //   Add fields for shortcut extra charge codes
    // 
    // PR3.70.06
    // P8000080A, Myers Nissi, Steve Post, 25 AUG 04
    //   Added field Pickup Load Nos.
    // 
    // PRW16.00.04
    ...
    fields
    {
        field(37002020; "Check COO at Order Release"; Boolean)
        {
            Caption = 'Check Country/Region of Origin at Order Release';
        }
        field(37002060; "Pickup Load Nos."; Code[20])
        {
            Caption = 'Pickup Load Nos.';
            Description = 'PR3.70.06';
            TableRelation = "No. Series";
        }
        field(37002660; "Shortcut Extra Charge 1 Code"; Code[10])
        {
            Caption = 'Shortcut Extra Charge 1 Code';
            Description = 'PR3.70.01';
            TableRelation = "Extra Charge";
        }
        field(37002661; "Shortcut Extra Charge 2 Code"; Code[10])
        {
            Caption = 'Shortcut Extra Charge 2 Code';
            Description = 'PR3.70.01';
            TableRelation = "Extra Charge";
        }
        field(37002662; "Shortcut Extra Charge 3 Code"; Code[10])
        {
            Caption = 'Shortcut Extra Charge 3 Code';
            Description = 'PR3.70.01';
            TableRelation = "Extra Charge";
        }
        field(37002663; "Shortcut Extra Charge 4 Code"; Code[10])
        {
            Caption = 'Shortcut Extra Charge 4 Code';
            Description = 'PR3.70.01';
            TableRelation = "Extra Charge";
        }
        field(37002664; "Shortcut Extra Charge 5 Code"; Code[10])
        {
            Caption = 'Shortcut Extra Charge 5 Code';
            Description = 'PR3.70.01';
            TableRelation = "Extra Charge";
        }
        field(37002685; "Commodity Order Nos."; Code[20])
        {
            Caption = 'Commodity Order Nos.';
            TableRelation = "No. Series";
        }
