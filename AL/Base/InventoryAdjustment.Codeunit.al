codeunit 5895 "Inventory Adjustment" implements "Inventory Adjustment"
{
                ...
                if FindSet() then
                    repeat
                        ...
                        then begin
                            ...
                            //CalcCostPerUnit(OutbndValueEntry, OutbndCostElementBuf, OutbndItemLedgEntry.Quantity);    // P8000304A
                            CalcCostPerUnit(OutbndValueEntry, OutbndCostElementBuf, OutbndItemLedgEntry.GetCostingQty); // PR4.00
    ...
    begin
        with InbndItemApplnEntry do begin
            ...
            // CalcItemApplnEntryOldCost(OldCostElementBuf,OutbndItemLedgEntry,Quantity);   // PR4.00
            CalcItemApplnEntryOldCost(OldCostElementBuf, OutbndItemLedgEntry, GetCostingQty); // PR4.00
