codeunit 37002540 "Process 800 Q/C Functions"
{
    ...
    [Obsolete('Replaced by AddTest', '18.1')]
    procedure AddReTest(LotInfo: Record "Lot No. Information")
    begin
        AddTest(LotInfo, true);
    end;
    ...
    begin
        ...
        if QCSampleLine.FindSet() then
            repeat
                ...
                SetItemJnlDefaultDim(ItemJournalLine);
    ...
    local procedure SetItemJnlDefaultDim(var ItemJournalLine: Record "Item Journal Line")
    var
    ...
    begin
        ...
        No[1] := ItemJournalLine."Item No.";

        ItemJournalLine."Shortcut Dimension 1 Code" := '';
        ItemJournalLine."Shortcut Dimension 2 Code" := '';
        ItemJournalLine."Dimension Set ID" := DimensionManagement.GetDefaultDimID(
          TableID, No, ItemJournalLine."Source Code", ItemJournalLine."Shortcut Dimension 1 Code", ItemJournalLine."Shortcut Dimension 2 Code", 0, 0);
