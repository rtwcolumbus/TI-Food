page 37002103 "Order Shipping-Purch." // Version: FOODNA
{
    // PR4.00.02
    // P8000282A, VerticalSoft, Jack Reynolds, 23 MAR 06
    //   Purchase return order form for posting shipments from order shipping
    // 
    // PRW15.00.01
    ...
    layout
    {
        area(content)
        {
            part(Lines; "Order Shipping-Purch. Subform")
            {
            ...
            group(Shipping)
            {
                ...
                field(ReceiptDate2; ShipDate)
                {
                    ApplicationArea = FOODBasic;
                    Caption = 'Date Shipped';
                    Editable = ReceiptDate2Editable;
                    NotBlank = true;
                }
    ...
    begin
        ...
        if PostingDisabled then begin
            ...
            ReceiptDateEditable := false;
            ReceiptDate2Editable := false;
    ...
    var
        ...
        [InDataSet]
        ReceiptDateEditable: Boolean;
        [InDataSet]
        ReceiptDate2Editable: Boolean;
        bnOrderXPos: Integer;
        bnLineXPos: Integer;
        bnPostXPos: Integer;
        LinesYPos: Integer;
    ...
    begin
        ...
        Process800WarehouseMgmt.PostPurchase(Rec, ShipDate, PostingLocation, Print);
    end;
}
