                        ...
                        if ApprovalMgt.PrePostApprovalCheckSales(Rec) then begin // P8004516
                            if PrePaymentMgt.TestSalesPrepayment(Rec) then // P8004516
                                ...
                                if PrePaymentMgt.TestSalesPayment(Rec) then // P8004516
                                    ...
                                    PostDocument(CODEUNIT::"Sales-Post (Yes/No)"); // P800162917
                            end;
                        end;
                    end;
                }
                        ...
                        if ApprovalMgt.PrePostApprovalCheckSales(Rec) then begin // P8004516
                            if PrePaymentMgt.TestSalesPrepayment(Rec) then // P8004516
                                ...
                                if PrePaymentMgt.TestSalesPayment(Rec) then // P8004516
                                    ...
                                    PostDocument(CODEUNIT::"Sales-Post + Print"); // P800162917
                            end;
                        end;
                    end;
                }
        ...
        area(Promoted)
        {
            group(Category_Process)
            {
                ...
                group(Post)
                {
                    ...
                    actionref(PostBatch_Promoted; "Post &Batch")
                    {
                    }
                }
                group(Release)
                ...
                actionref("Pick Ticket_Promoted"; "Pick Ticket")
                {
                }
            }
        }
