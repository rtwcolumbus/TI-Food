page 37002069 "Standing Sales Order" // Version: FOODNA
{
    ...
    //   Upgrade to 21.0 - Lines Editable
    ...
    layout
    {
        area(content)
        {
            group(General)
            {
                ...
                field("Sell-to Customer Name"; "Sell-to Customer Name")
                {
                    ...
                    begin
                        ...
                        IsSalesLinesEditable := Rec.SalesLinesEditable(); // P800155629
            ...
            {
                ApplicationArea = FOODBasic;
                Editable = IsSalesLinesEditable; // P800155629
                Enabled = IsSalesLinesEditable;  // P800155629
