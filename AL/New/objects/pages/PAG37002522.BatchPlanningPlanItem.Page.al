page 37002522 "Batch Planning - Plan Item"
{
    ...
    actions
    {
        ...
        area(Promoted)
        {
            actionref("Create &Orders_Promoted"; "Create &Orders")
            {
            }
            group(Category_ShowPackageOrders)
            {
                Caption = 'Show Package Orders';

                actionref(ShowPackageOrdersByBatch_Promoted; "Show Package Orders by Batch")
                {

                }
                actionref(ShowPackageOrdersByItem_Promoted; "Show Package Orders by Item")
                {
                }
            }
        }
