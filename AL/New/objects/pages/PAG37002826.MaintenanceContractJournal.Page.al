page 37002826 "Maintenance Contract Journal"
{
    // PR4.00.04
    // P8000333A, VerticalSoft, Jack Reynolds, 01 SEP 06
    //   Standard journal style form for maintenance journal (contract)
    // 
    // PR5.00
    // P8000466A, VerticalSoft, Jack Reynolds, 09 AUG 07
    //   Expand VendorName to TEXT50
    // 
    // PRW16.00.20
    ...
    AutoSplitKey = true;
    Caption = 'Maintenance Contract Journals';
    DelayedInsert = true;
    PageType = Worksheet;
    SaveValues = true;
    ...
    begin
        SetUpNewLine(xRec);
        Validate("Entry Type", "Entry Type"::Contract);
    ...
    begin
        ...
        // P8000672
        MaintJnlMgt.TemplateSelection(PAGE::"Maintenance Contract Journal", 2, Rec, JnlSelected);
