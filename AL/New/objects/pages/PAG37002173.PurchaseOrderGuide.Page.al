page 37002173 "Purchase Order Guide"
{
    ...
    actions
    {
        ...
        area(Promoted)
        {
            ...
            group(Category_Vendor)
            {
                Caption = 'Vendor';

                actionref(VendorCard_Promoted; Card)
                {
                }
                actionref(VendorLedgerEntries_Promoted; "Ledger E&ntries")
                {
                }
            }
            group(Category_Item)
            {
                ...
                actionref(ItemCard_Promoted; Action1102603054)
                {
                }
                actionref(ItemLedgerEntries_Promoted; Action1102603055)
                {
                }
            }
        }
