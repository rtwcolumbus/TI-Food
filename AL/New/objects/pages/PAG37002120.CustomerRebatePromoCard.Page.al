page 37002120 "Customer Rebate/Promo Card"
{
    // PR3.70.05
    ...
    //   Rewrite view handling functions; Cleanup action names

    Caption = 'Customer Rebate/Promo Card';
    PageType = Document;
    SourceTable = "Accrual Plan";
    SourceTableView = WHERE(Type = CONST(Sales),
                            "Plan Type" = FILTER(<> Commission));
    ...
    layout
    {
        area(content)
        {
            group(General)
            {
                ...
                {
                    ApplicationArea = FOODBasic;
                    OptionCaption = 'Promo/Rebate,,Reporting';
                }
                field(Accrue; Accrue)
                {
                    ApplicationArea = FOODBasic;
                ...
                group("Source Selection")
                {
                    ...
                    field(Control37002000; "Source Selection")
                    {
                        ApplicationArea = FOODBasic;
                ...
                group("Item Selection")
                {
                    ...
                    field(Control37002007; "Item Selection")
                    {
                        ApplicationArea = FOODBasic;
                        trigger OnValidate()
                        begin
