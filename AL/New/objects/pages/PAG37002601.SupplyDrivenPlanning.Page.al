page 37002601 "Supply Driven Planning"
{
    ...
    actions
    {
        ...
        area(Promoted)
        {
            actionref(CreateOrders_Promoted; "Create &Orders")
            {
            }
            actionref(ResetQuantities_Promoted; "&Reset Quantities")
            {
            }
            group(Category_Item)
            {
            ...
            group(Category_Preview)
            {
                ...
                actionref(ProcessOrders_Promoted; "P&rocess Orders")
                {
                }
                actionref(PackageOrders_Promoted; "P&ackage Orders")
                {
                }
            }
        }
