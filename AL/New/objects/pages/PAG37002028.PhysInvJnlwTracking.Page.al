    ...
    actions
    {
        ...
        area(Promoted)
        {
            ...
            group(Category_Prepare)
            {
                ...
                actionref(CalculateInventory_Promoted; "Calculate &Inventory")
                {
                }
                actionref(CalculateCountingPeriod_Promoted; "&Calculate Counting Period")
                {
                }
            }
            group(Category_Line)
            ...
            group(Category_Item)
            {
                ...
                actionref(PhysInventoryLedgerEntries_Promoted; "Phys. In&ventory Ledger Entries")
                {
                }
            }
            group(Category_Availability)
            {
                Caption = 'Availability by';
