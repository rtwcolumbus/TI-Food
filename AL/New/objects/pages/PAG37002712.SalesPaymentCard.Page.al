page 37002712 "Sales Payment Card"
{
    ...
    actions
    {
        ...
        area(Promoted)
        {
            ...
            group(Category_Lines)
            {
                Caption = 'Lines';

                actionref(AddOrders_Promoted; "&Add Orders")
                {
                }
                actionref(AddOpenEntries_Promoted; "Add &Open Entries")
                {
                }
            }
            group(Category_Tenders)
            {
                Caption = 'Tenders';

                actionref(Cash_Promoted; "&Cash")
                {
                }
                actionref(CheckOther_Promoted; "Check/&Other")
                {
                }
            }
        }
