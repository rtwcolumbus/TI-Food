    ...
    actions
    {
        ...
        area(Promoted)
        {
            group(Category_Process)
            {
                ...
                actionref(PlanItem_Promoted; "Plan Item")
                {
                }
                actionref(CalculateWorksheet_Promoted; "Calculate Worksheet")
                {
                }
            }
            group(Category_Navigate)
            {
                ...
                actionref(FinishedItem_Promoted; "Finished Item")
                {
                }
                actionref(IntermediateItem_Promoted; "Intermediate Item")
                {
                }
            }
        }
