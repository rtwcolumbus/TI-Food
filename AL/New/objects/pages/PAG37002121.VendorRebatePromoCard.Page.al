page 37002121 "Vendor Rebate/Promo Card"
{
    // PR3.70.05
    ...
    Caption = 'Vendor Rebate/Promo Card';
    PageType = Document;
        ...
        area(content)
        {
            group(General)
            {
                ...
                group("Source Selection")
                {
                    ...
                    field(Control37002031; "Source Selection")
                    {
                        ApplicationArea = FOODBasic;
                        OptionCaption = 'All Vendors,Specific Vendor,,Vendor Group';
                ...
                group("<Control37002008>")
                {
                    ...
                    field("<Item Selection>"; "Item Selection")
                    {
                        ApplicationArea = FOODBasic;
                        Caption = 'Item Selection';
            ...
            group(Payments)
            {
                ...
                field("Total Estimated Amount"; GetEstimatedAccrualAmount())
                {
                    ApplicationArea = FOODBasic;
                    Caption = 'Total Estimated Amount';
                    DrillDown = false;
            ...
            group(Posting)
            {
                ...
                {
                    ApplicationArea = FOODBasic;
                    Editable = "Exclude Promo/RebateEditable";
                }
    ...
    actions
    {
        area(navigation)
        {
            group(CustomerMenu)
            {
                ...
                separator(Separator1102603057)
                {
                }
                action("Show Vendors")
                {
                    ApplicationArea = FOODBasic;
                    Caption = 'Show Vendors';
                    Ellipsis = true;
                    Image = Vendor;
                ...
                action("Add Vendors to Plan")
                {
                    ApplicationArea = FOODBasic;
                    Caption = 'Add Vendors to Plan';
                    Ellipsis = true;
                    Image = AddAction;
            ...
            group("&Promo/Rebate")
            {
                ...
                action("Ledger E&ntries")
                {
                    ...
                    RunPageView = SORTING("Accrual Plan Type", "Accrual Plan No.", "Posting Date")
                                  WHERE("Accrual Plan Type" = CONST(Purchase));
                    ShortCutKey = 'Ctrl+F7';
                }
    ...
    trigger OnInit()
    begin
        "Exclude Promo/RebateEditable" := true;
    end;
    ...
    var
        [InDataSet]
        "Exclude Promo/RebateEditable": Boolean;

    local procedure SetPlanTypeControls()
    begin
        "Exclude Promo/RebateEditable" := "Plan Type" = "Plan Type"::Commission;
    end;
    ...
    local procedure PlanTypeOnAfterValidate()
    begin
        SetPlanTypeControls;
    end;
}
