codeunit 37002462 "Process 800 BOM Functions"
{
    ...
    //
    // PRW120.02
    // P800149978, To-Increase, Gangabhushan, 02 AUG 22
    //  Resource Type not filled in Value Entry ABC Details for Type = Other
            ...
            if BOMCost[BOMIndex].FindSet then // P8006471
                repeat
                    ...
                    if not ValueEntryABCDetail.Find('-') then begin
                        ...
                        // P800149978
                        if BOMCost[BOMIndex]."Resource Type" = BOMCost[BOMIndex]."Resource Type"::Other then
                            ValueEntryABCDetail.Type := ValueEntryABCDetail.Type::Other
                        else
