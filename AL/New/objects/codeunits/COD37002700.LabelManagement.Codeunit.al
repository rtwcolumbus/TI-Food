codeunit 37002700 "Label Management"
{
    ...
    begin
        ...
        OnBeforeGetLabelPrinter(Label, LocationCode, LabelData); // P800149380
        ...
        for Index := (Power(2, Field.Count) - 1) downto 0 do begin
            ...
            repeat
                ...
                if 1 = (Index div Field.Len) mod 2 then
                    ...
                    LabelPrinterSelectionFieldRef.SetRange(LabelPrinterSelectionFieldRef.Value); // P800149380
            until Field.Next() = 0;
    ...
    // P800149380
    [IntegrationEvent(false, false)]
    local procedure OnBeforeGetLabelPrinter(var Label: Record Label; LocationCode: Code[10]; var LabelData: RecordRef)
    begin
    end;
