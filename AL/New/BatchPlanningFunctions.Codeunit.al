codeunit 37002468 "Batch Planning Functions"
{
    ...
    begin
        // P8001182
        if UpdAction <> '' then
            SignalFns.AddEvent(Position, UpdAction);
        // SignalFns.Signal(Position); // P80059471
    end;

    procedure GetUpdateAction(Position: Integer) UpdAction: Code[20]
    begin
        // P8001182
        UpdAction := SignalFns.GetNextEvent(Position);
    end;
    ...
    procedure CalculateBatches(SignalRequired: Boolean)
    var
        EntryNo: Integer;
        QtyRequired: Decimal;
    begin
    ...
    // procedure SetSignalControl(Index: Integer; ID: Text[50]; Control: DotNet ISignalWebControlAddIn)
    // begin
    //     // P8001182
    //     SignalFns.SetControl(Index, ID, Control); // P80059471
    // end;
}
