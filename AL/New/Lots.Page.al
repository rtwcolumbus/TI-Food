page 37002020 Lots
{
    ...
    Editable = false;
    PageType = List;
    PromotedActionCategories = 'New,Process,Reports,Filter,Lot,Find Entries,Print,Reports';
        ...
        area(navigation)
        {
            group("&Lot")
            {
                ...
                action("Item &Tracking Entries")
                {
                    ...
                    begin
                        ItemTrackingDocMgt.ShowItemTrackingForMasterData(0, '', Rec."Item No.", Rec."Variant Code", '', Rec."Lot No.", ''); // PR3.70, P8004516
                    end;
                }
