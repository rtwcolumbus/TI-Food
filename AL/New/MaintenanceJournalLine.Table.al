table 37002816 "Maintenance Journal Line"
{
    ...
    begin
        ...
        case "Entry Type" of
            ...
            "Entry Type"::"Material-Stock", "Entry Type"::"Material-Nonstock":
                begin
                    ...
                    if "Entry Type" = "Entry Type"::"Material-Stock" then begin
        ...
        if WorkOrder.Get("Work Order No.") then // P8001133
            "Dimension Set ID" := DimMgt.GetDefaultDimID( // P8001133
              TableID, No, SourceCodeSetup."Work Order",
              "Shortcut Dimension 1 Code", "Shortcut Dimension 2 Code", WorkOrder."Dimension Set ID", DATABASE::Asset) // P8001133
        // P8001133
        else
            "Dimension Set ID" := DimMgt.GetDefaultDimID(
              TableID, No, SourceCodeSetup."Work Order", "Shortcut Dimension 1 Code", "Shortcut Dimension 2 Code", 0, 0);
        // P8001133

        DimMgt.UpdateGlobalDimFromDimSetID("Dimension Set ID", "Shortcut Dimension 1 Code", "Shortcut Dimension 2 Code"); // P8001133
    end;
