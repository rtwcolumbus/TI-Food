codeunit 37002811 "Event Subscribers (Maint)"
{
    ...
    begin
        ...
        Process800CoreFunctions.InsertSourceCode(SourceCode, SourceCodeSetup."Maintenance Material Journal", MAINTLAB, Process800CoreFunctions.PageName(PAGE::"Maintenance Material Journal"));
