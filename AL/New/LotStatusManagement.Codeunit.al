codeunit 37002161 "Lot Status Management"
{
    ...
    begin
        ...
        CreateReservEntry.SetNewSerialLotNo('', NewLotNo);
        // P80041970
    ...
    begin
        ...
        ItemJnlLine."Dimension Set ID" := DimMgt.GetDefaultDimID( // P8001133
          TableID, No, ItemJnlLine."Source Code", ItemJnlLine."Shortcut Dimension 1 Code", ItemJnlLine."Shortcut Dimension 2 Code", 0, 0); // P8001133
