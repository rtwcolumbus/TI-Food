table 37002576 "Container Ledger Entry"
{
    ...
    fields
    {
        ...
        field(3; "Container Serial No."; Code[50])
        {
            ...
            trigger OnLookup()
            begin
                ItemTrackingMgt.LookupLotSerialNoInfo("Container Item No.", '', 0, "Container Serial No.");
            end;
        }
        ...
        field(36; "Fill Lot No."; Code[50])
        {
            ...
            trigger OnLookup()
            begin
                ItemTrackingMgt.LookupLotSerialNoInfo("Fill Item No.", "Fill Variant Code", 1, "Fill Lot No.");
            end;
        }
        field(37; "Fill Serial No."; Code[50])
        {
            ...
            trigger OnLookup()
            begin
                ItemTrackingMgt.LookupLotSerialNoInfo("Fill Item No.", "Fill Variant Code", 0, "Fill Serial No.");
            end;
        }
